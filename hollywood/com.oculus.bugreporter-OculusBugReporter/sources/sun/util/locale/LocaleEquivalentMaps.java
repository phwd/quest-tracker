...
public final class LocaleEquivalentMaps {
    ...
    static {
        ...
        singleEquivMap.put(PolicyInformation.ID, "in");
        singleEquivMap.put("ilw", "gal");
        singleEquivMap.put("in", PolicyInformation.ID);
        ...
        singleEquivMap.put(DateFormat.HOUR_GENERIC_TZ, "jw");
        singleEquivMap.put("jw", DateFormat.HOUR_GENERIC_TZ);
