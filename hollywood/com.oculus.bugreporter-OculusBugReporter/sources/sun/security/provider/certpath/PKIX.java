        ...
        public List<X509Certificate> certificates() {
            if (this.certs == null) {
                ...
                if (certPath2 == null) {
                    ...
                    List<X509Certificate> xc = new ArrayList<>(certPath2.getCertificates());
        ...
        private static X500Principal getTargetSubject(List<CertStore> stores2, X509CertSelector sel) throws InvalidAlgorithmParameterException {
            ...
            for (CertStore store : stores2) {
                try {
                    ...
                    if (PKIX.debug != null) {
                        Debug debug = PKIX.debug;
                        debug.println("BuilderParams.getTargetSubjectDN: non-fatal exception retrieving certs: " + ((Object) e));
                        e.printStackTrace();
                    }
                }
            }
