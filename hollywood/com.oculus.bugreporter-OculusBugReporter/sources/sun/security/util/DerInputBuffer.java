    ...
    private Date getTime(int len, boolean generalized) throws IOException {
        ...
        if (len3 == 1 || len3 == 5) {
            ...
            if (b == 43) {
                ...
                int i25 = this.pos;
                this.pos = i25 + 1;
                int hr = (Character.digit((char) bArr24[i24], 10) * 10) + Character.digit((char) bArr25[i25], 10);
                ...
                time = time2 - ((long) ((((hr * 60) + min) * 60) * 1000));
            } else if (b == 45) {
                ...
                int i29 = this.pos;
                this.pos = i29 + 1;
                int hr2 = (Character.digit((char) bArr28[i28], 10) * 10) + Character.digit((char) bArr29[i29], 10);
                ...
                int i31 = this.pos;
                this.pos = i31 + 1;
                int min2 = (Character.digit((char) bArr30[i30], 10) * 10) + Character.digit((char) bArr31[i31], 10);
                if (hr2 >= 24 || min2 >= 60) {
                    throw new IOException("Parse " + type + " time, -hhmm");
                }
                time = time2 + ((long) (((hr2 * 60) + min2) * 60 * 1000));
            } else if (b == 90) {
                time = time2;
            } else {
