...
public class PolicyInformation {
    ...
    public PolicyInformation(CertificatePolicyId policyIdentifier2, Set<PolicyQualifierInfo> policyQualifiers2) throws IOException {
        if (policyQualifiers2 != null) {
            this.policyQualifiers = new LinkedHashSet(policyQualifiers2);
    ...
    public String toString() {
        ...
        s.append(((Object) this.policyQualifiers) + "  ]\n");
        return s.toString();
    }
