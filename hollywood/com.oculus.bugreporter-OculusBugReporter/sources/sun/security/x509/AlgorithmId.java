...
public class AlgorithmId implements Serializable, DerEncoder {
    public static final ObjectIdentifier AES_oid = oid(2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 1);
    private static final int[] DH_PKIX_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10046, 2, 1};
    ...
    private static final int[] DSA_PKIX_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10040, 4, 1};
    ...
    public static final ObjectIdentifier EC_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 2, 1);
    public static final ObjectIdentifier MD2_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 2, 2});
    public static final ObjectIdentifier MD5_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 2, 5});
    private static final int[] RSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 1};
    ...
    public static final ObjectIdentifier SHA224_oid = ObjectIdentifier.newInternal(new int[]{2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 2, 4});
    public static final ObjectIdentifier SHA256_oid = ObjectIdentifier.newInternal(new int[]{2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 2, 1});
    public static final ObjectIdentifier SHA384_oid = ObjectIdentifier.newInternal(new int[]{2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 2, 2});
    public static final ObjectIdentifier SHA512_oid = ObjectIdentifier.newInternal(new int[]{2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 2, 3});
    public static final ObjectIdentifier SHA_oid = ObjectIdentifier.newInternal(new int[]{1, 3, 14, 3, 2, 26});
    private static final int[] dsaWithSHA1_PKIX_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10040, 4, 3};
    private static int initOidTableVersion = -1;
    private static final int[] md2WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 2};
    public static final ObjectIdentifier md2WithRSAEncryption_oid = ObjectIdentifier.newInternal(md2WithRSAEncryption_data);
    private static final int[] md5WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 4};
    ...
    public static final ObjectIdentifier pbeWithMD5AndDES_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 5, 3});
    public static final ObjectIdentifier pbeWithMD5AndRC2_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 5, 6});
    public static final ObjectIdentifier pbeWithSHA1AndDES_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 5, 10});
    ...
    public static final ObjectIdentifier pbeWithSHA1AndRC2_oid = ObjectIdentifier.newInternal(new int[]{1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 5, 11});
    ...
    public static final ObjectIdentifier sha1WithECDSA_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 4, 1);
    ...
    private static final int[] sha1WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 5};
    public static final ObjectIdentifier sha1WithRSAEncryption_oid = ObjectIdentifier.newInternal(sha1WithRSAEncryption_data);
    public static final ObjectIdentifier sha224WithDSA_oid = oid(2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 3, 1);
    public static final ObjectIdentifier sha224WithECDSA_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 4, 3, 1);
    private static final int[] sha224WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 14};
    ...
    public static final ObjectIdentifier sha256WithDSA_oid = oid(2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 101, 3, 4, 3, 2);
    public static final ObjectIdentifier sha256WithECDSA_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 4, 3, 2);
    private static final int[] sha256WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 11};
    ...
    public static final ObjectIdentifier sha384WithECDSA_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 4, 3, 3);
    private static final int[] sha384WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 12};
    ...
    public static final ObjectIdentifier sha512WithECDSA_oid = oid(1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 10045, 4, 3, 4);
    private static final int[] sha512WithRSAEncryption_data = {1, 2, DatatypeConstants.MIN_TIMEZONE_OFFSET, 113549, 1, 1, 13};
    ...
    public boolean equals(AlgorithmId other) {
        DerValue derValue = this.params;
        return this.algid.equals(other.algid) && (derValue == null ? other.params == null : derValue.equals(other.params));
    }
