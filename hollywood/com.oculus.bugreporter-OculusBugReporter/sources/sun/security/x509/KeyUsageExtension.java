...
public class KeyUsageExtension extends Extension implements CertAttrSet<String> {
    ...
    public KeyUsageExtension(byte[] bitString2) throws IOException {
    ...
    public KeyUsageExtension(boolean[] bitString2) throws IOException {
    ...
    public KeyUsageExtension(BitArray bitString2) throws IOException {
        this.bitString = bitString2.toBooleanArray();
        this.extensionId = PKIXExtensions.KeyUsage_Id;
        this.critical = true;
        encodeThis();
    }
