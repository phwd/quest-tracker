...
public class Net {
    ...
    static final ProtocolFamily UNSPEC = new ProtocolFamily() {
        /* class sun.nio.ch.Net.AnonymousClass1 */
    ...
    static {
        ...
        if (availLevel >= 0) {
            String exclBindProp = (String) AccessController.doPrivileged(new PrivilegedAction<String>() {
                /* class sun.nio.ch.Net.AnonymousClass4 */
    ...
    static Inet4Address anyInet4Address(final NetworkInterface interf) {
        return (Inet4Address) AccessController.doPrivileged(new PrivilegedAction<Inet4Address>() {
            /* class sun.nio.ch.Net.AnonymousClass2 */
    ...
    static int inet4AsInt(InetAddress ia) {
        if (ia instanceof Inet4Address) {
            ...
            return (addr[3] & 255) | ((addr[2] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK) | ((addr[1] << 16) & 16711680) | ((addr[0] << 24) & ViewCompat.MEASURED_STATE_MASK);
        }
            ...
            if (type == SocketFlow.class) {
                ...
                if (name == StandardSocketOptions.IP_TOS && ((i2 = ((Integer) value).intValue()) < 0 || i2 > 255)) {
                    ...
                    if (key != null) {
                        ...
                        setIntOption0(fd, family == UNSPEC, key.level(), key.name(), b ? 1 : 0, family == StandardProtocolFamily.INET6);
                        return;
                    }
    ...
    public static boolean isFastTcpLoopbackRequested() {
        String loopbackProp = (String) AccessController.doPrivileged(new PrivilegedAction<String>() {
            /* class sun.nio.ch.Net.AnonymousClass3 */
