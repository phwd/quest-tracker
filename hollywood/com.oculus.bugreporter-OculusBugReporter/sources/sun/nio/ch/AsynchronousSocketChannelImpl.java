...
abstract class AsynchronousSocketChannelImpl extends AsynchronousSocketChannel implements Cancellable, Groupable {
    ...
    @Override // java.nio.channels.AsynchronousByteChannel, java.nio.channels.AsynchronousSocketChannel
    public final Future<Integer> read(ByteBuffer dst) {
        if (!dst.isReadOnly()) {
            return read(false, dst, (ByteBuffer[]) null, 0L, TimeUnit.MILLISECONDS, (Object) null, (CompletionHandler) null);
        }
    ...
    public final <A> void read(ByteBuffer dst, long timeout, TimeUnit unit, A attachment, CompletionHandler<Integer, ? super A> handler) {
        if (handler == null) {
            ...
            read(false, dst, (ByteBuffer[]) null, timeout, unit, (Object) attachment, (CompletionHandler) handler);
        } else {
            throw new IllegalArgumentException("Read-only buffer");
        }
    }
        ...
        if (handler != null) {
            if (offset >= 0 && length >= 0) {
                if (offset <= dsts.length - length) {
                    ...
                    read(true, (ByteBuffer) null, bufs, timeout, unit, (Object) attachment, (CompletionHandler) handler);
                    return;
                }
            }
    ...
    public final Future<Integer> write(ByteBuffer src) {
        return write(false, src, (ByteBuffer[]) null, 0L, TimeUnit.MILLISECONDS, (Object) null, (CompletionHandler) null);
    }
    ...
    public final <A> void write(ByteBuffer src, long timeout, TimeUnit unit, A attachment, CompletionHandler<Integer, ? super A> handler) {
        if (handler != null) {
            write(false, src, (ByteBuffer[]) null, timeout, unit, (Object) attachment, (CompletionHandler) handler);
            return;
        }
        throw new NullPointerException("'handler' is null");
    }
        ...
        if (handler != null) {
            if (offset >= 0 && length >= 0) {
                if (offset <= srcs.length - length) {
                    write(true, (ByteBuffer) null, Util.subsequence(srcs, offset, length), timeout, unit, (Object) attachment, (CompletionHandler) handler);
                    return;
                }
            }
            throw new IndexOutOfBoundsException();
    ...
    @Override // java.nio.channels.NetworkChannel, java.nio.channels.AsynchronousSocketChannel, java.nio.channels.AsynchronousSocketChannel
    ...
    @Override // java.nio.channels.NetworkChannel, java.nio.channels.AsynchronousSocketChannel
