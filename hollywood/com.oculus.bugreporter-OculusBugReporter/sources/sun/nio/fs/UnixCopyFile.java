...
class UnixCopyFile {
    ...
    /* JADX INFO: Multiple debug info for r2v0 boolean: [D('x' sun.nio.fs.UnixException), D('done' boolean)] */
    /* JADX INFO: Multiple debug info for r1v3 'done'  boolean: [D('x' sun.nio.fs.UnixException), D('done' boolean)] */
    ...
    /* JADX INFO: Multiple debug info for r0v0 boolean: [D('x' sun.nio.fs.UnixException), D('done' boolean)] */
