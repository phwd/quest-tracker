...
public class JarIndex {
    ...
    public static JarIndex getJarIndex(JarFile jar, MetaIndex metaIndex) throws IOException {
        JarEntry e;
        if ((metaIndex == null || metaIndex.mayContain(INDEX_NAME)) && (e = jar.getJarEntry(INDEX_NAME)) != null) {
    ...
    public LinkedList<String> get(String fileName) {
        int pos;
        LinkedList<String> jarFiles2 = this.indexMap.get(fileName);
        if (jarFiles2 != null || (pos = fileName.lastIndexOf("/")) == -1) {
            return jarFiles2;
        }
