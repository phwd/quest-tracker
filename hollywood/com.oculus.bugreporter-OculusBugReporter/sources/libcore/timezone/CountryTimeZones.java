...
public final class CountryTimeZones {
    ...
    public static final class OffsetResult {
        ...
        public String toString() {
            return "Result{mTimeZone='" + ((Object) this.mTimeZone) + PatternTokenizer.SINGLE_QUOTE + ", mOneMatch=" + this.mOneMatch + '}';
        }
    }
    ...
    public static final class TimeZoneMapping {
        ...
        public int hashCode() {
            return Objects.hash(this.timeZoneId, Boolean.valueOf(this.showInPicker), this.notUsedAfter);
        }

        public String toString() {
            return "TimeZoneMapping{timeZoneId='" + this.timeZoneId + PatternTokenizer.SINGLE_QUOTE + ", showInPicker=" + this.showInPicker + ", notUsedAfter=" + ((Object) this.notUsedAfter) + '}';
        }
    ...
    public boolean equals(Object o) {
        ...
        String str = this.defaultTimeZoneId;
        if (str == null ? that.defaultTimeZoneId == null : str.equals(that.defaultTimeZoneId)) {
    ...
    public int hashCode() {
        ...
        String str = this.defaultTimeZoneId;
        return ((((hashCode + (str != null ? str.hashCode() : 0)) * 31) + this.timeZoneMappings.hashCode()) * 31) + (this.everUsesUtc ? 1 : 0);
    }
    ...
    public OffsetResult lookupByOffsetWithBias(int offsetMillis, boolean isDst, long whenMillis, TimeZone bias) {
        List<TimeZoneMapping> list = this.timeZoneMappings;
    ...
    private static boolean offsetMatchesAtTime(TimeZone timeZone, int offsetMillis, boolean isDst, long whenMillis) {
        ...
        if (isDst == (offsets[1] != 0) && offsetMillis == offsets[0] + offsets[1]) {
            return true;
        }
        return false;
    }
    ...
    private static boolean offsetMatchesAtTime(TimeZone timeZone, int offsetMillis, Integer dstOffsetMillis, long whenMillis) {
        int[] offsets = new int[2];
        timeZone.getOffset(whenMillis, false, offsets);
        if ((dstOffsetMillis == null || dstOffsetMillis.intValue() == offsets[1]) && offsetMillis == offsets[0] + offsets[1]) {
            return true;
        }
        return false;
    }
