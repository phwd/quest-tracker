...
public final class AnnotationFactory implements InvocationHandler, Serializable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0042, code lost:
        r2 = libcore.reflect.AnnotationFactory.cache;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0044, code lost:
        monitor-enter(r2);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:?, code lost:
        libcore.reflect.AnnotationFactory.cache.put(r8, r1);
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (Proxy.isProxyClass(obj.getClass())) {
            ...
            if (handler instanceof AnnotationFactory) {
                ...
                if (annotationMemberArr.length != other.elements.length) {
                    return false;
                }
                for (AnnotationMember el1 : annotationMemberArr) {
        ...
        AnnotationMember[] annotationMemberArr2 = this.elements;
        for (AnnotationMember el : annotationMemberArr2) {
            if (el.tag == '!') {
                return false;
            }
            try {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.elements.length; i++) {
            ...
            result.append((Object) this.elements[i]);
        }
        result.append(')');
