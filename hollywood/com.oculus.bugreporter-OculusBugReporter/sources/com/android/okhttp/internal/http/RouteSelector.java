...
public final class RouteSelector {
    ...
    private Proxy nextProxy() throws IOException {
        ...
        throw new SocketException("No route to " + this.address.getUriHost() + "; exhausted proxy configurations: " + ((Object) this.proxies));
    }
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (proxyAddress instanceof InetSocketAddress) {
                ...
                throw new IllegalArgumentException("Proxy.address() is not an InetSocketAddress: " + ((Object) proxyAddress.getClass()));
            }
        }
    ...
    private InetSocketAddress nextInetSocketAddress() throws IOException {
        ...
        throw new SocketException("No route to " + this.address.getUriHost() + "; exhausted inet socket addresses: " + ((Object) this.inetSocketAddresses));
    }
