...
public final class ConnectionSpecSelector {
    ...
    public ConnectionSpec configureSecureSocket(SSLSocket sslSocket) throws IOException {
        ...
        throw new UnknownServiceException("Unable to find acceptable protocols. isFallback=" + this.isFallback + ", modes=" + ((Object) this.connectionSpecs) + ", supported protocols=" + Arrays.toString(sslSocket.getEnabledProtocols()));
    }
