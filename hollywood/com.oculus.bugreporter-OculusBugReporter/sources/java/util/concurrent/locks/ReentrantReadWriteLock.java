    ...
    static abstract class Sync extends AbstractQueuedSynchronizer {
        ...
        public final boolean tryReleaseShared(int unused) {
            ...
            if (this.firstReader == current) {
                int i = this.firstReaderHoldCount;
                if (i == 1) {
                    this.firstReader = null;
                } else {
                    this.firstReaderHoldCount = i - 1;
                }
            } else {
        ...
        public final int fullTryAcquireShared(Thread current) {
            ...
            do {
                ...
                if (exclusiveCount(c) != 0) {
                    ...
                    if (rh == null && ((rh = this.cachedHoldCounter) == null || rh.tid != ReentrantReadWriteLock.getThreadId(current))) {
                        rh = (HoldCounter) this.readHolds.get();
                        if (rh.count == 0) {
                            this.readHolds.remove();
                        }
