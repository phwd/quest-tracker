...
public class JapaneseImperialCalendar extends Calendar {
    ...
    /* JADX INFO: Multiple debug info for r9v36 long: [D('fd' long), D('year' int)] */
    /* JADX INFO: Multiple debug info for r7v25 long: [D('fd' long), D('lastDays' int)] */
    /* JADX INFO: Multiple debug info for r7v29 int: [D('min' int), D('unit' int)] */
    @Override // java.util.Calendar
