...
public final class SplittableRandom {
    ...
    static {
        if (((Boolean) AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
            /* class java.util.SplittableRandom.AnonymousClass1 */
    ...
    private static final class RandomIntsSpliterator implements Spliterator.OfInt {
        ...
        /* Return type fixed from 'java.util.SplittableRandom$RandomIntsSpliterator' to match base method */
    ...
    private static final class RandomLongsSpliterator implements Spliterator.OfLong {
        ...
        /* Return type fixed from 'java.util.SplittableRandom$RandomLongsSpliterator' to match base method */
    ...
    private static final class RandomDoublesSpliterator implements Spliterator.OfDouble {
        ...
        /* Return type fixed from 'java.util.SplittableRandom$RandomDoublesSpliterator' to match base method */
