...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
    ...
    public static class Builder {
        ...
        /* JADX INFO: Multiple debug info for r1v9 int: [D('field' int), D('i' int)] */
        public Builder setFields(int... fieldValuePairs) {
            ...
            if (len % 2 != 0) {
                ...
                while (field < len) {
                    int i = field + 1;
                    int i2 = fieldValuePairs[field];
                    if (i2 < 0 || i2 >= 17) {
                        throw new IllegalArgumentException("field is invalid");
                    }
                    internalSet(i2, fieldValuePairs[i]);
                    field = i + 1;
                }
                return this;
            } else {
    ...
    public String toString() {
        StringBuilder buffer = new StringBuilder((int) MediaPlayer2.MEDIA_INFO_BAD_INTERLEAVING);
