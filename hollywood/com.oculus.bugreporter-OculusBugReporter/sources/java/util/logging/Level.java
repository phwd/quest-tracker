...
public class Level implements Serializable {
    ...
    public static final Level CONFIG = new Level("CONFIG", MediaPlayer2.MEDIA_INFO_VIDEO_TRACK_LAGGING, defaultBundle);
    public static final Level FINE = new Level("FINE", 500, defaultBundle);
    public static final Level FINER = new Level("FINER", 400, defaultBundle);
    public static final Level FINEST = new Level("FINEST", 300, defaultBundle);
    public static final Level INFO = new Level("INFO", MediaPlayer2.MEDIA_INFO_BAD_INTERLEAVING, defaultBundle);
    public static final Level OFF = new Level("OFF", Integer.MAX_VALUE, defaultBundle);
    public static final Level SEVERE = new Level("SEVERE", 1000, defaultBundle);
    public static final Level WARNING = new Level("WARNING", MediaPlayer2.MEDIA_INFO_TIMED_TEXT_ERROR, defaultBundle);
