...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    public static ZoneOffsetTransitionRule of(Month month2, int dayOfMonthIndicator, DayOfWeek dayOfWeek, LocalTime time2, boolean timeEndOfDay2, TimeDefinition timeDefnition, ZoneOffset standardOffset2, ZoneOffset offsetBefore2, ZoneOffset offsetAfter2) {
        ...
        } else if (!timeEndOfDay2 || time2.equals(LocalTime.MIDNIGHT)) {
    ...
    public void writeExternal(DataOutput out) throws IOException {
        ...
        int stdOffsetByte = stdOffset % MediaPlayer2.MEDIA_INFO_TIMED_TEXT_ERROR == 0 ? (stdOffset / MediaPlayer2.MEDIA_INFO_TIMED_TEXT_ERROR) + 128 : 255;
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput in) throws IOException {
        ...
        ZoneOffset std = ZoneOffset.ofTotalSeconds(stdByte == 255 ? in.readInt() : (stdByte - 128) * MediaPlayer2.MEDIA_INFO_TIMED_TEXT_ERROR);
