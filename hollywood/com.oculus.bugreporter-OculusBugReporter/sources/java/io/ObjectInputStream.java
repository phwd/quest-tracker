        ...
        public long skip(long len) throws IOException {
            ...
            while (remain > 0) {
                if (this.blkmode) {
                    ...
                    int nread2 = this.in.read(this.buf, 0, (int) Math.min(remain, (long) PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID));
                    if (nread2 < 0) {
                        break;
                    }
                    remain -= (long) nread2;
        ...
        private String readUTFBody(long utflen) throws IOException {
            ...
            while (utflen > 0) {
                ...
                if (avail >= 3 || ((long) avail) == utflen) {
                    ...
                    this.pos = 0;
                    this.end = (int) Math.min((long) PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID, utflen);
