...
public class PlainDatagramSocketImpl extends AbstractPlainDatagramSocketImpl {
    ...
    public <T> void setOption(SocketOption<T> name, T value) throws IOException {
        if (!name.equals(ExtendedSocketOptions.SO_FLOW_SLA)) {
            ...
            ExtendedOptionsImpl.setFlowOption(getFileDescriptor(), value);
        } else {
    ...
    public <T> T getOption(SocketOption<T> name) throws IOException {
        if (!name.equals(ExtendedSocketOptions.SO_FLOW_SLA)) {
            return (T) super.getOption(name);
        }
        if (!isClosed()) {
            ExtendedOptionsImpl.checkGetOptionPermission(name);
            T t = (T) SocketFlow.create();
            ExtendedOptionsImpl.getFlowOption(getFileDescriptor(), t);
            return t;
        }
        throw new SocketException("Socket closed");
    }
    ...
    /* access modifiers changed from: protected */
    @Override // java.net.DatagramSocketImpl, java.net.AbstractPlainDatagramSocketImpl
