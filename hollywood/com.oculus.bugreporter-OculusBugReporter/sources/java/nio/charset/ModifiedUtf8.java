        ...
        for (int i = 0; i < strLen; i++) {
            ...
            if (c < 128) {
                if (c == 0) {
                    ...
                    dst[offset] = DerValue.TAG_PRIVATE;
                    offset = offset2 + 1;
                    dst[offset2] = Byte.MIN_VALUE;
                } else {
                    dst[offset] = (byte) c;
                    offset++;
                }
    ...
    public static String decode(byte[] in, char[] out, int offset, int length) throws UTFDataFormatException {
        ...
        while (offset < limitIndex) {
            ...
            if (i < 128) {
                ...
                } else if ((in[offset] & DerValue.TAG_PRIVATE) == 128) {
                ...
                if (offset + 1 >= limitIndex) {
                    ...
                    int offset2 = offset + 1;
                    if ((in[offset2] & DerValue.TAG_PRIVATE) == 128) {
