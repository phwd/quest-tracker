...
public class Logical {
    ...
    static BigInteger not(BigInteger val) {
        ...
        return new BigInteger(-val.sign, i2, resDigits);
    }
    ...
    /* JADX INFO: Multiple debug info for r7v11 int[]: [D('resDigits' int[]), D('limit' int)] */
    static BigInteger andNotNegativePositive(BigInteger negative, BigInteger positive) {
        ...
        if (iPos > iNeg) {
            ...
            while (i2 < limit) {
                resDigits[i2] = negative.digits[i2];
                i2++;
            }
            if (i2 == negative.numberLength) {
                i2 = iPos;
            ...
            int digit = (-negative.digits[i2]) & (~positive.digits[i2]);
            if (digit == 0) {
                ...
                do {
                    ...
                    i = ~(negative.digits[i2] | positive.digits[i2]);
                    digit = i;
                } while (i == 0);
                if (digit == 0) {
                    while (i2 < positive.numberLength) {
                        int i3 = ~positive.digits[i2];
                        digit = i3;
                        if (i3 != 0) {
                            break;
                        }
    ...
    /* JADX INFO: Multiple debug info for r5v1 int: [D('i' int), D('resDigits' int[])] */
    /* JADX INFO: Multiple debug info for r7v16 int[]: [D('resDigits' int[]), D('limit' int)] */
    static BigInteger xorDiffSigns(BigInteger positive, BigInteger negative) {
        ...
        if (iNeg < iPos) {
            ...
            int i3 = iNeg;
            int digit = positive.digits[i3] ^ (-negative.digits[i3]);
            if (digit == 0) {
                int limit3 = Math.min(positive.numberLength, negative.numberLength);
                do {
                    i3++;
                    ...
                    i2 = positive.digits[i3] ^ (~negative.digits[i3]);
                    digit = i2;
                } while (i2 == 0);
                if (digit == 0) {
