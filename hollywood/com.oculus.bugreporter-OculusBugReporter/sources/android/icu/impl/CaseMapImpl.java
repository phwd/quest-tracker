...
public final class CaseMapImpl {
    ...
    /* JADX INFO: Multiple debug info for r14v1 'srcIndex'  int: [D('srcIndex' int), D('cpStart' int)] */
    /* JADX INFO: Multiple debug info for r1v5 int: [D('srcIndex' int), D('props' int)] */
    /* JADX INFO: Multiple debug info for r1v16 byte: [D('delta' int), D('d' byte)] */
    ...
    /* JADX INFO: Multiple debug info for r12v1 'srcIndex'  int: [D('srcIndex' int), D('cpStart' int)] */
    /* JADX INFO: Multiple debug info for r1v6 int: [D('srcIndex' int), D('props' int)] */
    /* JADX INFO: Multiple debug info for r1v14 byte: [D('delta' int), D('d' byte)] */
