...
public final class Collation {
    ...
    static long ceFromLongPrimaryCE32(int ce32) {
        return (((long) (ce32 & InputDeviceCompat.SOURCE_ANY)) << 32) | 83887360;
    }
    ...
    static long ceFromSimpleCE32(int ce32) {
        return (((long) (-65536 & ce32)) << 32) | (((long) (65280 & ce32)) << 16) | ((long) ((ce32 & 255) << 8));
    }

    static long ceFromCE32(int ce32) {
        int tertiary = ce32 & 255;
        if (tertiary < 192) {
            return (((long) (-65536 & ce32)) << 32) | (((long) (65280 & ce32)) << 16) | ((long) (tertiary << 8));
        }
        int ce322 = ce32 - tertiary;
        if ((tertiary & 15) == 1) {
            return (((long) ce322) << 32) | 83887360;
        }
        return ((long) ce322) & 4294967295L;
    }
    ...
    public static long incTwoBytePrimaryByOffset(long basePrimary, boolean isCompressible, int offset) {
        ...
        long primary;
        if (isCompressible) {
            int offset3 = offset + ((((int) (basePrimary >> 16)) & 255) - 4);
            primary = (long) (((offset3 % 251) + 4) << 16);
            offset2 = offset3 / 251;
        } else {
            int offset4 = offset + ((((int) (basePrimary >> 16)) & 255) - 2);
            primary = (long) (((offset4 % 254) + 2) << 16);
            offset2 = offset4 / 254;
        }
        return ((4278190080L & basePrimary) + (((long) offset2) << 24)) | primary;
    }

    public static long incThreeBytePrimaryByOffset(long basePrimary, boolean isCompressible, int offset) {
        int offset2;
        long primary;
        int offset3 = offset + ((((int) (basePrimary >> 8)) & 255) - 2);
        long primary2 = (long) (((offset3 % 254) + 2) << 8);
        int offset4 = offset3 / 254;
        if (isCompressible) {
            int offset5 = offset4 + ((((int) (basePrimary >> 16)) & 255) - 4);
            primary = primary2 | ((long) (((offset5 % 251) + 4) << 16));
            offset2 = offset5 / 251;
        } else {
            int offset6 = offset4 + ((((int) (basePrimary >> 16)) & 255) - 2);
            primary = primary2 | ((long) (((offset6 % 254) + 2) << 16));
            offset2 = offset6 / 254;
        }
        return ((4278190080L & basePrimary) + (((long) offset2) << 24)) | primary;
    }
    ...
    static long decThreeBytePrimaryByOneStep(long basePrimary, boolean isCompressible, int step) {
        ...
        return (4278190080L & basePrimary) | ((long) (byte2 << 16)) | ((long) (byte32 << 8));
    }
    ...
    static long unassignedPrimaryFromCodePoint(int c) {
        int c2 = c + 1;
        int c3 = c2 / 18;
        return 4261412864L | ((long) (((c2 % 18) * 14) + 2)) | ((long) (((c3 % 254) + 2) << 8)) | ((long) ((((c3 / 254) % 251) + 4) << 16));
    }
