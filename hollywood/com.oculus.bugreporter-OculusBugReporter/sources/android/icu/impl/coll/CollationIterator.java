...
public abstract class CollationIterator {
    ...
    public final long nextCE() {
        ...
        if (t < 192) {
            ...
            this.cesIndex = i2 + 1;
            return cEBuffer2.set(i2, (((long) (ce32 & MotionEventCompat.ACTION_POINTER_INDEX_MASK)) << 16) | (((long) (-65536 & ce32)) << 32) | ((long) (t << 8)));
        }
        if (t != 192) {
            d = this.data;
        } else if (c < 0) {
            ...
            if (t < 192) {
                ...
                this.cesIndex = i4 + 1;
                return cEBuffer4.set(i4, (((long) (ce32 & MotionEventCompat.ACTION_POINTER_INDEX_MASK)) << 16) | (((long) (-65536 & ce32)) << 32) | ((long) (t << 8)));
            }
        }
        if (t != 193) {
