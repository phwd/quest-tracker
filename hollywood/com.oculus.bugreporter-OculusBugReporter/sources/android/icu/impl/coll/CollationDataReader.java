            ...
            if (inLength >= 8) {
                ...
                if (inLength >= length) {
                    ...
                    if (length2 < 4) {
                        ...
                        while (reorderRangesLength < reorderCodesLength4 && (reorderCodes[(reorderCodesLength4 - reorderRangesLength) - 1] & SupportMenu.CATEGORY_MASK) != 0) {
                            reorderRangesLength++;
                        }
                    ...
                    if (length3 >= 256) {
                        if (reorderCodesLength != 0) {
                            ...
                            length3 += InputDeviceCompat.SOURCE_ANY;
                        } else {
                    ...
                    if (length12 >= 256) {
                        if (data != null) {
                            ...
                            length12 += InputDeviceCompat.SOURCE_ANY;
                        } else {
