...
public class Trie2Writable extends Trie2 {
    ...
    private void init(int initialValueP, int errorValueP) {
        ...
        for (int i6 = 0; i6 < 576; i6++) {
            this.index2[i6 + 2080] = -1;
        }
        for (int i7 = 0; i7 < 64; i7++) {
            this.index2[i7 + UNEWTRIE2_INDEX_2_NULL_OFFSET] = 192;
        }
    ...
    private int allocIndex2Block() {
        ...
        if (newTop <= iArr.length) {
            ...
            System.arraycopy((Object) iArr, this.index2NullOffset, (Object) iArr, newBlock, 64);
            return newBlock;
        }
    ...
    private int allocDataBlock(int copyBlock) {
        ...
        if (this.firstFreeBlock != 0) {
            ...
            if (newTop > i) {
                ...
                System.arraycopy((Object) this.data, 0, (Object) newData, 0, this.dataLength);
                this.data = newData;
        ...
        int[] iArr = this.data;
        System.arraycopy((Object) iArr, copyBlock, (Object) iArr, newBlock, 32);
    ...
    public Trie2Writable setRange(int start, int end, int value, boolean overwrite) {
        ...
        if (start > 1114111 || start < 0 || end > 1114111 || end < 0 || start > end) {
            ...
            while (start3 < limit2) {
                ...
                if (value != this.initialValue || !isInNullBlock(start3, z)) {
                    int i22 = getIndex2Block(start3, z) + ((start3 >> 5) & 63);
                    int block2 = this.index2[i22];
                    if (!isWritableBlock(block2)) {
                        i2 = i22;
                        if (this.data[block2] != value && (overwrite || block2 == this.dataNullOffset)) {
                            setRepeatBlock = true;
                        }
                    ...
                    if (setRepeatBlock) {
                        if (repeatBlock >= 0) {
                            ...
                            int repeatBlock2 = getDataBlock(start3, true);
                            writeBlock(repeatBlock2, value);
            ...
            if (rest > 0) {
                fillBlock(getDataBlock(start3, true), 0, rest, value, this.initialValue, overwrite);
            }
            return this;
        }
    }
    ...
    private void compactData() {
        ...
        if (this.UTRIE2_DEBUG) {
            System.out.printf("compacting UTrie2: count of 32-bit data words %d->%d%n", Integer.valueOf(this.dataLength), Integer.valueOf(newStart));
        }
    ...
    private void compactIndex2() {
        ...
        int newStart = 2080 + ((this.highStart - 65536) >> 11) + 32;
        int start2 = UNEWTRIE2_INDEX_2_NULL_OFFSET;
        while (start2 < this.index2Length) {
            int movedStart = findSameIndex2Block(newStart, start2);
            if (movedStart >= 0) {
        ...
        if (this.UTRIE2_DEBUG) {
            System.out.printf("compacting UTrie2: count of 16-bit index-2 words %d->%d%n", Integer.valueOf(this.index2Length), Integer.valueOf(newStart));
        }
    ...
    private void compactTrie() {
        ...
        if (this.UTRIE2_DEBUG) {
            System.out.printf("UTrie2: highStart U+%04x  highValue 0x%x  initialValue 0x%x%n", Integer.valueOf(this.highStart), Integer.valueOf(highValue), Integer.valueOf(this.initialValue));
        }
    ...
    private void freeze(Trie2 dest, Trie2.ValueWidth valueBits) {
        ...
        int i5 = AnonymousClass1.$SwitchMap$android$icu$impl$Trie2$ValueWidth[valueBits.ordinal()];
        if (i5 == 1) {
            dest.data16 = destIdx;
            int i6 = 0;
            while (i6 < this.dataLength) {
                dest.index[destIdx] = (char) this.data[i6];
                i6++;
                destIdx++;
            }
        } else if (i5 == 2) {
            for (int i7 = 0; i7 < this.dataLength; i7++) {
                dest.data32[i7] = this.data[i7];
            }
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: android.icu.impl.Trie2Writable$1  reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$android$icu$impl$Trie2$ValueWidth = new int[Trie2.ValueWidth.values().length];

        static {
            try {
                $SwitchMap$android$icu$impl$Trie2$ValueWidth[Trie2.ValueWidth.BITS_16.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$android$icu$impl$Trie2$ValueWidth[Trie2.ValueWidth.BITS_32.ordinal()] = 2;
