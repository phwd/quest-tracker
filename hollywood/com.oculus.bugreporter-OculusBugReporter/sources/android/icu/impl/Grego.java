...
public class Grego {
    private static final int[] DAYS_BEFORE = {0, 31, 59, 90, 120, 151, 181, 212, 243, UCharacter.UnicodeBlock.TANGUT_COMPONENTS_ID, HttpURLConnection.HTTP_NOT_MODIFIED, 334, 0, 31, 60, 91, 121, 152, 182, 213, 244, UCharacter.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F_ID, HttpURLConnection.HTTP_USE_PROXY, 335};
    ...
    public static int[] dayToFields(long day, int[] fields) {
        ...
        int year = (int) ((400 * n400) + (100 * n100) + (n4 * 4) + n1);
    ...
    public static String timeToString(long time) {
        ...
        return String.format(null, "%04d-%02d-%02dT%02d:%02d:%02d.%03dZ", Integer.valueOf(fields[0]), Integer.valueOf(fields[1] + 1), Integer.valueOf(fields[2]), Integer.valueOf(hour), Integer.valueOf(min), Integer.valueOf(millis3 / 1000), Integer.valueOf(millis3 % 1000));
    }
}
