...
public class RBBISetBuilder {
    ...
    public void printRanges() {
        ...
        for (RangeDescriptor rlRange = this.fRangeList; rlRange != null; rlRange = rlRange.fNext) {
            ...
            printStream.print(Padder.FALLBACK_PADDING_STRING + rlRange.fNum + "   " + rlRange.fStartChar + "-" + rlRange.fEndChar);
    ...
    public void printRangeGroups() {
        ...
        for (RangeDescriptor rlRange = this.fRangeList; rlRange != null; rlRange = rlRange.fNext) {
            ...
            if (groupNum > lastPrintedGroupNum) {
                ...
                PrintStream printStream = System.out;
                printStream.print(groupNum + Padder.FALLBACK_PADDING_STRING);
