...
public final class UTF16 {
    ...
    public static int setCharAt(char[] target, int limit, int offset16, int char32) {
        if (offset16 < limit) {
            ...
            if (count != strlength) {
                System.arraycopy((Object) target, offset16 + count, (Object) target, offset16 + strlength, limit - (offset16 + count));
                if (count < strlength) {
    ...
    public static int insert(char[] target, int limit, int offset16, int char32) {
        ...
        if (limit + size <= target.length) {
            System.arraycopy((Object) target, offset16, (Object) target, offset16 + size, limit - offset16);
            target[offset16] = str.charAt(0);
            if (size == 2) {
                target[offset16 + 1] = str.charAt(1);
            }
    ...
    public static int delete(char[] target, int limit, int offset16) {
        ...
        System.arraycopy((Object) target, offset16 + count, (Object) target, offset16, limit - (offset16 + count));
            ...
            for (int r = offset; r < e; r++) {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        System.arraycopy((Object) chars, 0, (Object) temp, 0, w);
                        chars = temp;
                    }
                }
            }
