...
public class DecimalFormat_ICU58_Android extends NumberFormat {
    ...
    /* JADX INFO: Multiple debug info for r0v0 int: [D('i' int), D('backup' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v4 'pos'  int: [D('sub0Limit' int), D('sub0Start' int), D('pos' int)] */
    /* JADX INFO: Multiple debug info for r4v12 int: [D('expSignAlways' boolean), D('digitTotalCount' int)] */
    ...
    /* JADX INFO: Multiple debug info for r5v13 'padPos'  int: [D('decimalSeparator' char), D('padPos' int)] */
    /* JADX INFO: Multiple debug info for r8v6 'sub0Start'  int: [D('sub0Start' int), D('digit' char)] */
    ...
    /* JADX INFO: Multiple debug info for r12v15 int: [D('pos' int), D('subpart' int)] */
