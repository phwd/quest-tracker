...
public abstract class DateFormat extends UFormat {
    ...
    public boolean equals(Object obj) {
        ...
        if (((this.calendar != null || other.calendar != null) && ((calendar2 = this.calendar) == null || (calendar3 = other.calendar) == null || !calendar2.isEquivalentTo(calendar3))) || (((this.numberFormat != null || other.numberFormat != null) && ((numberFormat2 = this.numberFormat) == null || (numberFormat3 = other.numberFormat) == null || !numberFormat2.equals(numberFormat3))) || this.capitalizationSetting != other.capitalizationSetting)) {
            return false;
        }
        return true;
    }
    ...
    public Object clone() {
        ...
        if (numberFormat2 != null) {
            other.numberFormat = (NumberFormat) numberFormat2.clone();
        }
        return other;
    }
