...
public class RBBIRuleBuilder {
    ...
    public void flattenData(OutputStream os) throws IOException {
        ...
        int outputPos2 = outputPos + this.fForwardTable.exportTable().put(dos);
        RBBIDataWrapper.RBBIStateTable table = this.fForwardTable.exportSafeTable();
        Assert.assrt(outputPos2 == header[6]);
        int outputPos3 = outputPos2 + table.put(dos);
