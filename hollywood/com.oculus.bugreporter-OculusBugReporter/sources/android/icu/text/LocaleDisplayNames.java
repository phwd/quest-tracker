...
public abstract class LocaleDisplayNames {
    ...
    public static class UiListItem {
        ...
        public String toString() {
            return "{" + ((Object) this.minimized) + ", " + ((Object) this.modified) + ", " + this.nameInDisplayLocale + ", " + this.nameInSelf + "}";
        }
    ...
    public static class LastResortLocaleDisplayNames extends LocaleDisplayNames {
        ...
        private LastResortLocaleDisplayNames(ULocale locale2, DisplayContext... contexts2) {
            this.locale = locale2;
            this.contexts = new DisplayContext[contexts2.length];
            System.arraycopy(contexts2, 0, this.contexts, 0, contexts2.length);
        }
        ...
        public DialectHandling getDialectHandling() {
            ...
            for (DisplayContext context : displayContextArr) {
