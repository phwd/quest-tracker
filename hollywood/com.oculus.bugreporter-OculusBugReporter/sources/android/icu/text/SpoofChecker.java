...
public class SpoofChecker {
    ...
    public static class Builder {
        ...
        public static class ConfusabledataBuilder {
            ...
            public void build(Reader confusables, SpoofData dest) throws ParseException, IOException {
                ...
                while (it.hasNext()) {
                    int keyChar2 = it.next().codePointAt(0);
                ...
                for (int i2 = 0; i2 < numKeys; i2++) {
                    int key2 = this.fKeyVec.get(i2).intValue();
                    ConfusableDataUtils.keyToCodePoint(key2);
                    dest.fCFUKeys[i2] = key2;
                }
                dest.fCFUValues = new short[this.fValueVec.size()];
                int i3 = 0;
                Iterator<Integer> it2 = this.fValueVec.iterator();
                while (it2.hasNext()) {
                    dest.fCFUValues[i3] = (short) it2.next().intValue();
                    i3++;
                }
    ...
    public static class CheckResult {
        ...
        public String toString() {
            ...
            sb.append((Object) this.restrictionLevel);
            return sb.toString();
        }
    }
    ...
    public boolean failsChecks(String text, CheckResult checkResult) {
        ...
        if ((this.fChecks & 16) != 0) {
            ...
            if (textRestrictionLevel.compareTo((Enum) this.fRestrictionLevel) > 0) {
                result = 0 | 16;
            }
            if (checkResult != null) {
        ...
        if (!((this.fChecks & 256) == 0 || findHiddenOverlay(text) == -1)) {
            result |= 256;
        }
    ...
    public boolean equals(Object other) {
        ...
        SpoofData spoofData2 = otherSC.fSpoofData;
        if ((spoofData != spoofData2 && spoofData != null && !spoofData.equals(spoofData2)) || this.fChecks != otherSC.fChecks) {
            return false;
        }
        Set<ULocale> set = this.fAllowedLocales;
        Set<ULocale> set2 = otherSC.fAllowedLocales;
        if (set != set2 && set != null && !set.equals(set2)) {
            return false;
        }
        UnicodeSet unicodeSet = this.fAllowedCharsSet;
        UnicodeSet unicodeSet2 = otherSC.fAllowedCharsSet;
        if ((unicodeSet == unicodeSet2 || unicodeSet == null || unicodeSet.equals(unicodeSet2)) && this.fRestrictionLevel == otherSC.fRestrictionLevel) {
            return true;
        }
        return false;
    }
    ...
    private void getResolvedScriptSet(CharSequence input, ScriptSet result) {
        getResolvedScriptSetWithout(input, 185, result);
    }
    ...
    /* access modifiers changed from: package-private */
    public int findHiddenOverlay(String input) {
    ...
    /* access modifiers changed from: package-private */
    public boolean isIllegalCombiningDotLeadCharacterNoLookup(int cp) {
        return cp == 105 || cp == 106 || cp == 305 || cp == 567 || cp == 108 || UCharacter.hasBinaryProperty(cp, 27);
    }

    /* access modifiers changed from: package-private */
    public boolean isIllegalCombiningDotLeadCharacter(int cp, StringBuilder sb) {
    ...
    public static class SpoofData {
        ...
        public boolean equals(Object other) {
            ...
            if (Utility.sameObjects(this.fCFUStrings, otherData.fCFUStrings) || (str = this.fCFUStrings) == null || str.equals(otherData.fCFUStrings)) {
                return true;
            }
            return false;
        }
        ...
        public void appendValueTo(int index, StringBuilder dest) {
            ...
            if (stringLength == 1) {
                ...
                dest.append((CharSequence) this.fCFUStrings, (int) value, value + stringLength);
            }
        }
    }
