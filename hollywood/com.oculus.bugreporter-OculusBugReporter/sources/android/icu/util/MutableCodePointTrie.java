...
public final class MutableCodePointTrie extends CodePointMap implements Cloneable {
    ...
    /* JADX INFO: Multiple debug info for r1v2 int: [D('rest' int), D('block' int)] */
    public void setRange(int start, int end, int value) {
        ...
        if (block2 > 0) {
            fillBlock(getDataBlock(start >> 4), 0, block2, value);
        }
    }
    ...
    /* JADX INFO: Multiple debug info for r6v1 int: [D('c' int), D('i' int)] */
    ...
    /* JADX INFO: Multiple debug info for r13v11 int: [D('k' int), D('upperBits' int)] */
    /* JADX INFO: Multiple debug info for r3v16 int: [D('j' int), D('v' int)] */
    /* JADX INFO: Multiple debug info for r8v17 int: [D('k' int), D('upperBits' int)] */
        ...
        while (k < iLimit2) {
            ...
            if (f == 0) {
                ...
                while (true) {
                    ...
                    int j8 = j7 + 1;
                    int v4 = iArr[j7];
                    int upperBits2 = ((v4 & 196608) >> 8) | ((v3 & 196608) >> 6) | ((v & 196608) >> 2) | ((v2 & 196608) >> 4);
                    int upperBits3 = upperBits + 1;
                    index22 = index23;
                    cArr[upperBits] = (char) v4;
                    int j9 = j8 + 1;
                    int v5 = iArr[j8];
                    int upperBits4 = upperBits2 | ((v5 & 196608) >> 10);
                    int k6 = upperBits3 + 1;
                    cArr[upperBits3] = (char) v5;
                    int j10 = j9 + 1;
                    int v6 = iArr[j9];
                    int upperBits5 = upperBits4 | ((v6 & 196608) >> 12);
                    int k7 = k6 + 1;
                    cArr[k6] = (char) v6;
                    int j11 = j10 + 1;
                    int v7 = iArr[j10];
                    int upperBits6 = upperBits5 | ((v7 & 196608) >> 14);
                    int k8 = k7 + 1;
                    cArr[k7] = (char) v7;
                    int j12 = j11 + 1;
                    int v8 = iArr[j11];
                    int k9 = k8 + 1;
                    cArr[k8] = (char) v8;
                    cArr[k9 - 9] = (char) (upperBits6 | ((v8 & 196608) >> 16));
                    if (j12 >= jLimit2) {
                        break;
                    }
                    k2 = k9;
    ...
    private int compactTrie(int fastILimit) {
        ...
        int realHighStart = (findHighStart() + 511) & -512;
