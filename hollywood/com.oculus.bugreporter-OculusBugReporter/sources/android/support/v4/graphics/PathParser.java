...
public class PathParser {
    ...
    static float[] copyOfRange(float[] original, int start, int end) {
        if (start <= end) {
            ...
            System.arraycopy((Object) original, start, (Object) result, 0, Math.min(resultLength, originalLength - start));
            return result;
        }
    ...
    public static class PathDataNode {
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (i < numSegments) {
                ...
                p.rLineTo(0.0f, 0.0f);
                p.cubicTo((float) (e1x2 + (alpha * ep1x)), (float) (e1y2 + (alpha * ep1y)), (float) (anglePerSegment2 - (alpha * ep2x)), (float) (e2y - (alpha * ep2y)), (float) anglePerSegment2, (float) e2y);
                eta1 = eta2;
