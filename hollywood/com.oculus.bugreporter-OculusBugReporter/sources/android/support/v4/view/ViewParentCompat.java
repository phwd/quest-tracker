    ...
    public static boolean onStartNestedScroll(ViewParent parent, View child, View target, int nestedScrollAxes, int type) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onStartNestedScroll", e);
                return false;
            }
        ...
        if (parent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onNestedScrollAccepted", e);
                }
            } else if (parent instanceof NestedScrollingParent) {
        ...
        if (parent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onStopNestedScroll", e);
                }
            } else if (parent instanceof NestedScrollingParent) {
        ...
        if (parent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onNestedScroll", e);
                }
            } else if (parent instanceof NestedScrollingParent) {
        ...
        if (parent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onNestedPreScroll", e);
                }
            } else if (parent instanceof NestedScrollingParent) {
    ...
    public static boolean onNestedFling(ViewParent parent, View target, float velocityX, float velocityY, boolean consumed) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onNestedFling", e);
                return false;
            }
        } else if (parent instanceof NestedScrollingParent) {
    ...
    public static boolean onNestedPreFling(ViewParent parent, View target, float velocityX, float velocityY) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                Log.e(TAG, "ViewParent " + ((Object) parent) + " does not implement interface " + "method onNestedPreFling", e);
                return false;
            }
        } else if (parent instanceof NestedScrollingParent) {
