...
public class MediaController2ImplLegacy implements MediaController2.SupportLibraryImpl {
    ...
    public void close() {
        if (DEBUG) {
            Log.d(TAG, "release from " + ((Object) this.mToken));
        }
        synchronized (this.mLock) {
            if (!this.mIsReleased) {
    ...
    public final class ControllerCompatCallback extends MediaControllerCompat.Callback {
        ...
        public void onSessionReady() {
            ...
            mediaController2ImplLegacy.sendCommand((MediaController2ImplLegacy) "android.support.v4.media.controller.command.CONNECT", (String) new ResultReceiver(mediaController2ImplLegacy.mHandler) {
