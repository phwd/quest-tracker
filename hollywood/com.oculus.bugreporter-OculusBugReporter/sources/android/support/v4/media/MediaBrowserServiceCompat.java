...
public abstract class MediaBrowserServiceCompat extends Service {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 9:
                    ...
                    return;
                default:
                    Log.w(MediaBrowserServiceCompat.TAG, "Unhandled message: " + ((Object) msg) + "\n  Service version: " + 2 + "\n  Client version: " + msg.arg1);
                    return;
            }
        }
            ...
            if (!TextUtils.isEmpty(action) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    ...
                    public void run() {
                        ConnectionRecord connection = MediaBrowserServiceCompat.this.mConnections.get(callbacks.asBinder());
                        if (connection == null) {
                            Log.w(MediaBrowserServiceCompat.TAG, "sendCustomAction for callback that isn't registered action=" + action + ", extras=" + ((Object) extras));
                            return;
                        }
    ...
    public void performCustomAction(String action, Bundle extras, ConnectionRecord connection, final ResultReceiver receiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException("onCustomAction must call detach() or sendResult() or sendError() before returning for action=" + action + " extras=" + ((Object) extras));
        }
    }
