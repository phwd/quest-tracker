...
public final class SessionToken2ImplBase implements SessionToken2.SupportLibraryImpl {
    ...
    public String toString() {
        return "SessionToken {pkg=" + this.mPackageName + " id=" + this.mSessionId + " type=" + this.mType + " service=" + this.mServiceName + " IMediaSession2=" + ((Object) this.mISession2) + "}";
    }
    ...
    public static SessionToken2ImplBase fromBundle(@NonNull Bundle bundle) {
        ...
        } else if (iSession2 == null) {
            throw new IllegalArgumentException("Unexpected token for session, binder=" + ((Object) iSession2));
        }
