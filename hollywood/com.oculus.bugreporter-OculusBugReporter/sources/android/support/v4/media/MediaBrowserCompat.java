...
public final class MediaBrowserCompat {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
                        ...
                        if (MediaBrowserImplBase.this.mState != 0) {
                            ...
                            if (MediaBrowserCompat.DEBUG && MediaBrowserImplBase.this.mServiceConnection != null) {
                                ...
                                try {
                                    ...
                                    Log.e(MediaBrowserCompat.TAG, "Failed binding to service " + ((Object) MediaBrowserImplBase.this.mServiceComponent));
                                }
                                if (!bound) {
                ...
                public void run() {
                    if (MediaBrowserImplBase.this.mCallbacksMessenger != null) {
                        try {
                            ...
                            Log.w(MediaBrowserCompat.TAG, "RemoteException during connect for " + ((Object) MediaBrowserImplBase.this.mServiceComponent));
                        }
                    }
        ...
        public void sendCustomAction(@NonNull final String action, final Bundle extras, @Nullable final CustomActionCallback callback) {
            if (isConnected()) {
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error sending a custom action: action=" + action + ", extras=" + ((Object) extras), e);
                    if (callback != null) {
                        this.mHandler.post(new Runnable() {
                ...
                throw new IllegalStateException("Cannot send a custom action (" + action + ") with " + "extras " + ((Object) extras) + " because the browser is not connected to the " + "service.");
            }
        }
        ...
        public void onConnectionFailed(Messenger callback) {
            Log.e(MediaBrowserCompat.TAG, "onConnectFailed for " + ((Object) this.mServiceComponent));
        ...
        public void onLoadChildren(Messenger callback, String parentId, List list, Bundle options, Bundle notifyChildrenChangedOptions) {
            if (isCurrent(callback, "onLoadChildren")) {
                if (MediaBrowserCompat.DEBUG) {
                    Log.d(MediaBrowserCompat.TAG, "onLoadChildren for " + ((Object) this.mServiceComponent) + " id=" + parentId);
                }
        ...
        private boolean isCurrent(Messenger callback, String funcName) {
            ...
            Log.i(MediaBrowserCompat.TAG, funcName + " for " + ((Object) this.mServiceComponent) + " with mCallbacksMessenger=" + ((Object) this.mCallbacksMessenger) + " this=" + ((Object) this));
            return false;
        }
        ...
        public void dump() {
            ...
            Log.d(MediaBrowserCompat.TAG, "  mServiceComponent=" + ((Object) this.mServiceComponent));
            Log.d(MediaBrowserCompat.TAG, "  mCallback=" + ((Object) this.mCallback));
            Log.d(MediaBrowserCompat.TAG, "  mRootHints=" + ((Object) this.mRootHints));
            Log.d(MediaBrowserCompat.TAG, "  mState=" + getStateLabel(this.mState));
            Log.d(MediaBrowserCompat.TAG, "  mServiceConnection=" + ((Object) this.mServiceConnection));
            Log.d(MediaBrowserCompat.TAG, "  mServiceBinderWrapper=" + ((Object) this.mServiceBinderWrapper));
            Log.d(MediaBrowserCompat.TAG, "  mCallbacksMessenger=" + ((Object) this.mCallbacksMessenger));
            Log.d(MediaBrowserCompat.TAG, "  mRootId=" + this.mRootId);
            Log.d(MediaBrowserCompat.TAG, "  mMediaSessionToken=" + ((Object) this.mMediaSessionToken));
        }
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public void onServiceConnected(final ComponentName name, final IBinder binder) {
                postOrRun(new Runnable() {
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.d(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceConnected name=" + ((Object) name) + " binder=" + ((Object) binder));
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            public void onServiceDisconnected(final ComponentName name) {
                postOrRun(new Runnable() {
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            Log.d(MediaBrowserCompat.TAG, "MediaServiceConnection.onServiceDisconnected name=" + ((Object) name) + " this=" + ((Object) this) + " mServiceConnection=" + ((Object) MediaBrowserImplBase.this.mServiceConnection));
                            MediaBrowserImplBase.this.dump();
                        }
            ...
            public boolean isCurrent(String funcName) {
                ...
                Log.i(MediaBrowserCompat.TAG, funcName + " for " + ((Object) MediaBrowserImplBase.this.mServiceComponent) + " with mServiceConnection=" + ((Object) MediaBrowserImplBase.this.mServiceConnection) + " this=" + ((Object) this));
                return false;
            }
        }
    }
            ...
            if (weakReference != null && weakReference.get() != null && this.mCallbackImplRef.get() != null) {
                ...
                try {
                    ...
                    if (i == 1) {
                        ...
                        Log.w(MediaBrowserCompat.TAG, "Unhandled message: " + ((Object) msg) + "\n  Client version: " + 1 + "\n  Service version: " + msg.arg1);
                    } else {
        ...
        public void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (customActionCallback != null) {
                if (resultCode == -1) {
                    ...
                    Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + resultCode + " (extras=" + ((Object) this.mExtras) + ", resultData=" + ((Object) resultData) + ")");
                } else {
