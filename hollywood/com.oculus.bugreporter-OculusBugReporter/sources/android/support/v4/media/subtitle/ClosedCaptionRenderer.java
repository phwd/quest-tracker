    ...
    class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        private class CCLayout extends LinearLayout implements ClosedCaptionWidget.ClosedCaptionLayout {
            ...
            public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                int lineHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(((int) (((float) safeHeight) * SAFE_AREA_RATIO)) / 15, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS);
                int lineWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(safeWidth2, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS);
                for (int i = 0; i < 15; i++) {
