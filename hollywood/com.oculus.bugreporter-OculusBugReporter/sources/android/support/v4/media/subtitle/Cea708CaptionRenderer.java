    ...
    public class Cea708CCWidget extends ClosedCaptionWidget implements Cea708CCParser.DisplayListener {
                ...
                while (i < count) {
                    ...
                    if (params instanceof ScaledLayoutParams) {
                        ...
                        if (scaleStartRow < 0.0f || scaleStartRow > 1.0f) {
                            ...
                            int childWidthSpec = View.MeasureSpec.makeMeasureSpec((int) (((float) width) * (scaleEndCol - scaleStartCol)), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS);
                            ...
                            child.measure(childWidthSpec, View.MeasureSpec.makeMeasureSpec((int) (((float) height) * (scaleEndRow - scaleStartRow)), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
                            i++;
        ...
        public class CCWindowLayout extends RelativeLayout implements View.OnLayoutChangeListener {
            ...
            public void initWindow(CCLayout ccLayout, Cea708CCParser.CaptionWindow captionWindow) {
                ...
                cCLayout2.getClass();
                cCLayout2.addOrUpdateViewToSafeTitleArea(this, new ScaledLayout.ScaledLayoutParams(scaleStartRow, scaleEndRow, scaleStartCol, scaleEndCol));
