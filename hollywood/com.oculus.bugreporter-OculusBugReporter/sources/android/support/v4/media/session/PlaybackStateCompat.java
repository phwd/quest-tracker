...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public String toString() {
        return "PlaybackState {" + "state=" + this.mState + ", position=" + this.mPosition + ", buffered position=" + this.mBufferedPosition + ", speed=" + this.mSpeed + ", updated=" + this.mUpdateTime + ", actions=" + this.mActions + ", error code=" + this.mErrorCode + ", error message=" + this.mErrorMessage + ", custom actions=" + ((Object) this.mCustomActions) + ", active item id=" + this.mActiveItemId + "}";
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        @Override // java.lang.Object
        public String toString() {
            return "Action:mName='" + ((Object) this.mName) + ", mIcon=" + this.mIcon + ", mExtras=" + ((Object) this.mExtras);
        }
