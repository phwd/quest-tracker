...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (view != null) {
            view.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
            this.mCircleViewIndex = -1;
