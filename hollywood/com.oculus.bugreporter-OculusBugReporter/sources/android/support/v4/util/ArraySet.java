...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    public void ensureCapacity(int minimumCapacity) {
        if (this.mHashes.length < minimumCapacity) {
            ...
            int i = this.mSize;
            if (i > 0) {
                System.arraycopy((Object) ohashes, 0, (Object) this.mHashes, 0, i);
    ...
    public boolean add(@Nullable E value) {
        ...
        if (index2 < i2) {
            ...
            System.arraycopy((Object) iArr2, index2, (Object) iArr2, index2 + 1, i2 - index2);
    ...
    public E removeAt(int index) {
        ...
        if (i <= 1) {
            ...
            if (iArr.length <= 8 || i >= iArr.length / 3) {
                ...
                if (index < i2) {
                    int[] iArr2 = this.mHashes;
                    System.arraycopy((Object) iArr2, index + 1, (Object) iArr2, index, i2 - index);
                ...
                int i3 = this.mSize;
                if (index < i3) {
                    System.arraycopy((Object) ohashes, index + 1, (Object) this.mHashes, index, i3 - index);
