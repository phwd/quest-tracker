...
public class SimpleArrayMap<K, V> {
    ...
    public void ensureCapacity(int minimumCapacity) {
        ...
        if (this.mHashes.length < minimumCapacity) {
            ...
            if (this.mSize > 0) {
                System.arraycopy((Object) ohashes, 0, (Object) this.mHashes, 0, osize);
    ...
    public V put(K key, V value) {
        ...
        if (osize >= this.mHashes.length) {
            ...
            if (osize == this.mSize) {
                ...
                if (iArr.length > 0) {
                    System.arraycopy((Object) ohashes, 0, (Object) iArr, 0, ohashes.length);
        ...
        if (index3 < osize) {
            ...
            System.arraycopy((Object) iArr2, index3, (Object) iArr2, index3 + 1, osize - index3);
    ...
    public void putAll(SimpleArrayMap<? extends K, ? extends V> array) {
        ...
        if (this.mSize != 0) {
            ...
            System.arraycopy((Object) array.mHashes, 0, (Object) this.mHashes, 0, N);
    ...
    public V removeAt(int index) {
        ...
        if (osize <= 1) {
            ...
            if (iArr.length <= 8 || this.mSize >= iArr.length / 3) {
                if (index < nsize) {
                    int[] iArr2 = this.mHashes;
                    System.arraycopy((Object) iArr2, index + 1, (Object) iArr2, index, nsize - index);
                    Object[] objArr2 = this.mArray;
                ...
                if (osize == this.mSize) {
                    if (index > 0) {
                        System.arraycopy((Object) ohashes, 0, (Object) this.mHashes, 0, index);
                        System.arraycopy(oarray, 0, this.mArray, 0, index << 1);
                    }
                    if (index < nsize) {
                        System.arraycopy((Object) ohashes, index + 1, (Object) this.mHashes, index, nsize - index);
