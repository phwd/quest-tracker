...
public class FontsContractCompat {
                    ...
                    sBackgroundThread.postAndReply(r2, new SelfDestructiveThread.ReplyCallback<TypefaceResult>() {
                        ...
                        public void onReply(android.support.v4.provider.FontsContractCompat.TypefaceResult r5) {
                            /*
                                ...
                                monitor-enter(r0)
                                r1 = 0
                                android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r2 = android.support.v4.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x002f }
                                java.lang.String r3 = r0     // Catch:{ all -> 0x002f }
                                ...
                                return
                            L_0x0013:
                                android.support.v4.util.SimpleArrayMap<java.lang.String, java.util.ArrayList<android.support.v4.provider.SelfDestructiveThread$ReplyCallback<android.support.v4.provider.FontsContractCompat$TypefaceResult>>> r2 = android.support.v4.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x0032 }
                                java.lang.String r3 = r0     // Catch:{ all -> 0x0032 }
    ...
    public static class FontInfo {
        ...
        @IntRange(from = 1, to = RelativeDateTimeFormatter.SECOND_IN_MILLIS)
