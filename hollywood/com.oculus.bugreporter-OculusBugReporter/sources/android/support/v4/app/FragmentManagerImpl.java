...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void putFragment(Bundle bundle, String key, Fragment fragment) {
        if (fragment.mIndex < 0) {
            throwException(new IllegalStateException("Fragment " + ((Object) fragment) + " is not currently in the FragmentManager"));
        }
    ...
    public void makeActive(Fragment f) {
        if (f.mIndex < 0) {
            ...
            if (DEBUG) {
                Log.v(TAG, "Allocated fragment index " + ((Object) f));
            }
        }
    }
    ...
    public void makeInactive(Fragment f) {
        if (f.mIndex >= 0) {
            if (DEBUG) {
                Log.v(TAG, "Freeing fragment index " + ((Object) f));
            }
    ...
    public void addFragment(Fragment fragment, boolean moveToStateNow) {
        ...
        throw new IllegalStateException("Fragment already added: " + ((Object) fragment));
    }

    public void removeFragment(Fragment fragment) {
        if (DEBUG) {
            Log.v(TAG, "remove: " + ((Object) fragment) + " nesting=" + fragment.mBackStackNesting);
        }
    ...
    public void hideFragment(Fragment fragment) {
        if (DEBUG) {
            Log.v(TAG, "hide: " + ((Object) fragment));
        }
        if (!fragment.mHidden) {
    ...
    public void showFragment(Fragment fragment) {
        if (DEBUG) {
            Log.v(TAG, "show: " + ((Object) fragment));
        }
        if (fragment.mHidden) {
    ...
    public void detachFragment(Fragment fragment) {
        if (DEBUG) {
            Log.v(TAG, "detach: " + ((Object) fragment));
        }
        if (!fragment.mDetached) {
            fragment.mDetached = true;
            if (fragment.mAdded) {
                if (DEBUG) {
                    Log.v(TAG, "remove from detach: " + ((Object) fragment));
                }
                synchronized (this.mAdded) {
                    this.mAdded.remove(fragment);
                }
    ...
    public void attachFragment(Fragment fragment) {
        if (DEBUG) {
            Log.v(TAG, "attach: " + ((Object) fragment));
        }
        if (fragment.mDetached) {
            ...
            if (!this.mAdded.contains(fragment)) {
                if (DEBUG) {
                    Log.v(TAG, "add from attach: " + ((Object) fragment));
                }
                synchronized (this.mAdded) {
                    this.mAdded.add(fragment);
                }
        ...
        synchronized (this) {
            if (this.mAvailBackStackIndices != null) {
                if (this.mAvailBackStackIndices.size() > 0) {
                    ...
                    if (DEBUG) {
                        Log.v(TAG, "Adding back stack index " + index + " with " + ((Object) bse));
                    }
            ...
            if (DEBUG) {
                Log.v(TAG, "Setting back stack index " + index2 + " to " + ((Object) bse));
            }
    ...
    public void setBackStackIndex(int index, BackStackRecord bse) {
        synchronized (this) {
            ...
            if (index < N) {
                if (DEBUG) {
                    Log.v(TAG, "Setting back stack index " + index + " to " + ((Object) bse));
                }
                this.mBackStackIndices.set(index, bse);
            } else {
                while (N < index) {
            ...
            for (int i = 0; i < this.mActive.size(); i++) {
                ...
                if (f != null) {
                    if (f.mRetainInstance) {
                        ...
                        if (DEBUG) {
                            Log.v(TAG, "retainNonConfig: keeping retained " + ((Object) f));
                        }
                    }
    ...
    public Parcelable saveAllState() {
        ...
        for (int i = 0; i < N2; i++) {
            ...
            if (f != null) {
                if (f.mIndex < 0) {
                    throwException(new IllegalStateException("Failure saving state: active " + ((Object) f) + " has cleared index: " + f.mIndex));
                }
                haveFragments = true;
                ...
                if (f.mState <= 0 || fs.mSavedFragmentState != null) {
                    ...
                    if (f.mTarget != null) {
                        if (f.mTarget.mIndex < 0) {
                            throwException(new IllegalStateException("Failure saving state: " + ((Object) f) + " has target not in fragment manager: " + ((Object) f.mTarget)));
                        }
                ...
                if (DEBUG) {
                    Log.v(TAG, "Saved state of " + ((Object) f) + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) fs.mSavedFragmentState));
                }
            }
        }
        if (!haveFragments) {
        ...
        if (N3 > 0) {
            ...
            for (int i2 = 0; i2 < N3; i2++) {
                ...
                if (added[i2] < 0) {
                    throwException(new IllegalStateException("Failure saving state: active " + ((Object) this.mAdded.get(i2)) + " has cleared index: " + added[i2]));
                }
                if (DEBUG) {
                    Log.v(TAG, "saveAllState: adding fragment #" + i2 + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) this.mAdded.get(i2)));
                }
            }
        }
        ArrayList<BackStackRecord> arrayList = this.mBackStack;
        if (arrayList != null && (N = arrayList.size()) > 0) {
            ...
            for (int i3 = 0; i3 < N; i3++) {
                ...
                if (DEBUG) {
                    Log.v(TAG, "saveAllState: adding back stack #" + i3 + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) this.mBackStack.get(i3)));
                }
            }
        }
            ...
            if (fms.mActive != null) {
                if (nonConfig != null) {
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        if (DEBUG) {
                            Log.v(TAG, "restoreAllState: re-attaching retained " + ((Object) f));
                        }
                        int index = 0;
                ...
                for (int i2 = 0; i2 < fms.mActive.length; i2++) {
                    ...
                    if (fs2 != null) {
                        ...
                        if (DEBUG) {
                            Log.v(TAG, "restoreAllState: active #" + i2 + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) f2));
                        }
                ...
                if (nonConfig != null) {
                    ...
                    for (int i3 = 0; i3 < count2; i3++) {
                        ...
                        if (f3.mTargetIndex >= 0) {
                            ...
                            if (f3.mTarget == null) {
                                Log.w(TAG, "Re-attaching retained fragment " + ((Object) f3) + " target no longer exists: " + f3.mTargetIndex);
                            }
                        }
                    }
                }
                ...
                if (fms.mAdded != null) {
                    for (int i4 = 0; i4 < fms.mAdded.length; i4++) {
                        ...
                        f4.mAdded = true;
                        if (DEBUG) {
                            Log.v(TAG, "restoreAllState: added #" + i4 + PluralRules.KEYWORD_RULE_SEPARATOR + ((Object) f4));
                        }
                ...
                if (fms.mBackStack != null) {
                    ...
                    for (int i5 = 0; i5 < fms.mBackStack.length; i5++) {
                        ...
                        if (DEBUG) {
                            Log.v(TAG, "restoreAllState: back stack #" + i5 + " (index " + bse.mIndex + "): " + ((Object) bse));
                            PrintWriter pw = new PrintWriter(new LogWriter(TAG));
                            bse.dump("  ", pw, false);
                            pw.close();
                        }
    ...
    public void setPrimaryNavigationFragment(Fragment f) {
        ...
        throw new IllegalArgumentException("Fragment " + ((Object) f) + " is not an active fragment of FragmentManager " + ((Object) this));
    }
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (DEBUG) {
            Log.v(TAG, "onCreateView: id=0x" + Integer.toHexString(id) + " fname=" + fname + " existing=" + ((Object) fragment2));
        }
        if (fragment2 == null) {
