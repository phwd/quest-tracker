...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    public final void restoreViewState(Bundle savedInstanceState) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onViewStateRestored()");
        }
    }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int requestCode) {
        ...
        if (mine == null || theirs == null || mine == theirs) {
            for (Fragment check = fragment; check != null; check = check.getTargetFragment()) {
                if (check == this) {
                    throw new IllegalArgumentException("Setting " + ((Object) fragment) + " as the target of " + ((Object) this) + " would create a target cycle");
                }
            }
        ...
        throw new IllegalArgumentException("Fragment " + ((Object) fragment) + " must share the same FragmentManager to be set as a target fragment");
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " not attached to a context.");
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " not attached to an activity.");
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " not attached to a host.");
    }
    ...
    public final FragmentManager requireFragmentManager() {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " not associated with a fragment manager.");
    }
    ...
    public void startActivity(Intent intent, @Nullable Bundle options) {
        ...
        throw new IllegalStateException("Fragment " + ((Object) this) + " not attached to Activity");
    }
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        if (this.mChildFragmentManager != null) {
            writer.print(prefix);
            writer.println("Child " + ((Object) this.mChildFragmentManager) + ":");
            FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
    ...
    public void performCreate(Bundle savedInstanceState) {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onCreate()");
    }
    ...
    public void performActivityCreated(Bundle savedInstanceState) {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onActivityCreated()");
    }
    ...
    public void performStart() {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onStart()");
    }
    ...
    public void performResume() {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onResume()");
    }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onPause()");
        }
    }
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onStop()");
        }
    }
    ...
    public void performDestroyView() {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onDestroyView()");
    }
    ...
    public void performDestroy() {
        ...
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onDestroy()");
    }
    ...
    public void performDetach() {
        ...
        if (this.mCalled) {
            ...
            throw new IllegalStateException("Child FragmentManager of " + ((Object) this) + " was not " + " destroyed and this fragment is not retaining instance");
        }
        throw new SuperNotCalledException("Fragment " + ((Object) this) + " did not call through to super.onDetach()");
    }
    ...
    public void setOnStartEnterTransitionListener(OnStartEnterTransitionListener listener) {
        ...
        if (listener != this.mAnimationInfo.mStartEnterTransitionListener) {
            ...
            throw new IllegalStateException("Trying to set a replacement startPostponedEnterTransition on " + ((Object) this));
        }
    }
