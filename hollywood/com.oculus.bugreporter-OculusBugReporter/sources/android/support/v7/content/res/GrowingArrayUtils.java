...
final class GrowingArrayUtils {
    ...
    public static int[] append(int[] array, int currentSize, int element) {
        if (currentSize + 1 > array.length) {
            ...
            System.arraycopy((Object) array, 0, (Object) newArray, 0, currentSize);
            array = newArray;
        }
        array[currentSize] = element;
        return array;
    ...
    public static int[] insert(int[] array, int currentSize, int index, int element) {
        if (currentSize + 1 <= array.length) {
            System.arraycopy((Object) array, index, (Object) array, index + 1, currentSize - index);
            array[index] = element;
            return array;
        }
        int[] newArray = new int[growSize(currentSize)];
        System.arraycopy((Object) array, 0, (Object) newArray, 0, index);
        newArray[index] = element;
        System.arraycopy((Object) array, index, (Object) newArray, index + 1, array.length - index);
        return newArray;
    }
