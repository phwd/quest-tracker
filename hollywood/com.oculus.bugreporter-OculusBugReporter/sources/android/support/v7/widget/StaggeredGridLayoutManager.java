    ...
    public static class LazySpanLookup {
        ...
        public void ensureSize(int position) {
            ...
            if (iArr == null) {
                ...
                System.arraycopy((Object) old, 0, (Object) this.mData, 0, old.length);
                int[] iArr2 = this.mData;
        ...
        public void offsetForRemoval(int positionStart, int itemCount) {
            ...
            if (iArr != null && positionStart < iArr.length) {
                ...
                int[] iArr2 = this.mData;
                System.arraycopy((Object) iArr2, positionStart + itemCount, (Object) iArr2, positionStart, (iArr2.length - positionStart) - itemCount);
        ...
        public void offsetForAddition(int positionStart, int itemCount) {
            ...
            if (iArr != null && positionStart < iArr.length) {
                ensureSize(positionStart + itemCount);
                int[] iArr2 = this.mData;
                System.arraycopy((Object) iArr2, positionStart, (Object) iArr2, positionStart + itemCount, (iArr2.length - positionStart) - itemCount);
