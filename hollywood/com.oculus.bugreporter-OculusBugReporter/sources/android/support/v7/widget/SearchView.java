...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mVoiceWebSearchIntent.addFlags(VMDebug.KIND_THREAD_EXT_ALLOCATED_OBJECTS);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(VMDebug.KIND_THREAD_EXT_ALLOCATED_OBJECTS);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(width, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS), View.MeasureSpec.makeMeasureSpec(height, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
    }
    ...
    private void launchIntent(Intent intent) {
        if (intent != null) {
            try {
                ...
                Log.e(LOG_TAG, "Failed launch activity: " + ((Object) intent), ex);
            }
        }
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, VMDebug.KIND_THREAD_EXT_FREED_OBJECTS);
