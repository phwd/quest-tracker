...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public String exceptionLabel() {
        return Padder.FALLBACK_PADDING_STRING + super.toString() + ", adapter:" + ((Object) this.mAdapter) + ", layout:" + ((Object) this.mLayout) + ", context:" + ((Object) getContext());
    }
            ...
            public void attachViewToParent(View child, int index, ViewGroup.LayoutParams layoutParams) {
                ...
                if (vh != null) {
                    if (vh.isTmpDetached() || vh.shouldIgnore()) {
                        ...
                        throw new IllegalArgumentException("Called attach on a child which is not detached: " + ((Object) vh) + RecyclerView.this.exceptionLabel());
                    }
                }
            ...
            public void detachViewFromParent(int offset) {
                ...
                if (!(view == null || (vh = RecyclerView.getChildViewHolderInt(view)) == null)) {
                    if (!vh.isTmpDetached() || vh.shouldIgnore()) {
                        ...
                        throw new IllegalArgumentException("called detach on an already detached child " + ((Object) vh) + RecyclerView.this.exceptionLabel());
                    }
                }
        ...
        if (layout != this.mLayout) {
            ...
            if (layout != null) {
                if (layout.mRecyclerView == null) {
                    ...
                    throw new IllegalArgumentException("LayoutManager " + ((Object) layout) + " is already attached to a RecyclerView:" + layout.mRecyclerView.exceptionLabel());
                }
            }
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            if (!measureSpecModeIsExactly && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (other != holder && getChangedHolderKey(other) == key) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    throw new IllegalStateException("Two different ViewHolders have the same change ID. This might happen due to inconsistent Adapter update events or if the LayoutManager lays out the same View multiple times.\n ViewHolder 1:" + ((Object) other) + " \n View Holder 2:" + ((Object) holder) + exceptionLabel());
                }
                throw new IllegalStateException("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:" + ((Object) other) + " \n View Holder 2:" + ((Object) holder) + exceptionLabel());
            }
        }
        Log.e(TAG, "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + ((Object) oldChangeViewHolder) + " cannot be found but it is necessary for " + ((Object) holder) + exceptionLabel());
    }
    ...
    public void removeDetachedView(View child, boolean animate) {
        ...
        if (vh != null) {
            if (vh.isTmpDetached()) {
                ...
                throw new IllegalArgumentException("Called removeDetachedView with a view which is not flagged as tmp detached." + ((Object) vh) + exceptionLabel());
            }
        }
        child.clearAnimation();
    ...
    public ViewHolder getChildViewHolder(@NonNull View child) {
        ...
        throw new IllegalArgumentException("View " + ((Object) child) + " is not a direct child of " + ((Object) this));
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (!RecyclerView.this.dispatchNestedScroll(hresult, adapterSize, overscrollX, overscrollY, null, 1)) {
    ...
    public final class Recycler {
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            ...
            if (holder.mPosition < 0 || holder.mPosition >= RecyclerView.this.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid view holder adapter position" + ((Object) holder) + RecyclerView.this.exceptionLabel());
        ...
        public void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException("Tmp detached view should be removed from RecyclerView before it can be recycled: " + ((Object) holder) + RecyclerView.this.exceptionLabel());
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + ((Object) vh) + RecyclerView.this.exceptionLabel());
        }
    ...
    public static abstract class LayoutManager {
        ...
        public void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = VMDebug.KIND_THREAD_EXT_FREED_OBJECTS;
            this.mHeightMode = VMDebug.KIND_THREAD_EXT_FREED_OBJECTS;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = VMDebug.KIND_THREAD_EXT_FREED_OBJECTS;
                } else {
                    resultSize = 0;
                    resultMode = 0;
                }
        ...
        public void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), VMDebug.KIND_THREAD_EXT_FREED_OBJECTS));
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                Log.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started " + "more than once. Each instance of" + getClass().getSimpleName() + Padder.FALLBACK_PADDING_STRING + "is intended to only be used once. You should create a new instance for " + "each use.");
            }
            this.mRecyclerView = recyclerView;
