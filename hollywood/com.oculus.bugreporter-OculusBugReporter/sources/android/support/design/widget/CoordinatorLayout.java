...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private int getKeyline(int index) {
        int[] iArr = this.mKeylines;
        if (iArr == null) {
            Log.e(TAG, "No keylines defined for " + ((Object) this) + " - attempted index lookup " + index);
            return 0;
        } else if (index >= 0 && index < iArr.length) {
            return iArr[index];
        } else {
            Log.e(TAG, "Keyline index " + index + " out of range for " + ((Object) this));
            return 0;
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View forChild, CoordinatorLayout parent) {
            ...
            if (view != null) {
                ...
                throw new IllegalStateException("Could not find CoordinatorLayout descendant view with id " + parent.getResources().getResourceName(this.mAnchorId) + " to anchor view " + ((Object) forChild));
            }
        }
