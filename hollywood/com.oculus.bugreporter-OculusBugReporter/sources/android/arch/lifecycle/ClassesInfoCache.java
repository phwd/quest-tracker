...
class ClassesInfoCache {
    ...
    private void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> handlers, MethodReference newHandler, Lifecycle.Event newEvent, Class klass) {
        ...
        if (event != null && newEvent != event) {
            ...
            throw new IllegalArgumentException("Method " + method.getName() + " in " + klass.getName() + " already declared with different @OnLifecycleEvent value: previous value " + ((Object) event) + ", new value " + ((Object) newEvent));
        } else if (event == null) {
