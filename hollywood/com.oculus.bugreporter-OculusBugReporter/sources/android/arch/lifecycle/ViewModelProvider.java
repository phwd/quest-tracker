    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            try {
                ...
                throw new RuntimeException("Cannot create an instance of " + ((Object) modelClass), e);
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
            ...
            try {
                ...
                throw new RuntimeException("Cannot create an instance of " + ((Object) modelClass), e3);
            } catch (InvocationTargetException e4) {
                throw new RuntimeException("Cannot create an instance of " + ((Object) modelClass), e4);
            }
        }
    }
}
