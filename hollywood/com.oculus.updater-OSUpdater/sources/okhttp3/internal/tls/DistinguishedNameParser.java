...
public final class DistinguishedNameParser {
        ...
        if (i != this.length) {
            ...
            if (!(c == ' ' || c == '%' || c == '\\' || c == '_' || c == '\"' || c == '#')) {
                switch (c) {
                    ...
                    default:
                        switch (c) {
                            case UL.id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigLogoutHandler_ULSEP_BINDING_ID:
                            case '<':
                            case UL.id._UL__ULSEP_android_content_Context_ULSEP_com_facebook_inject_UnsafeContextInjection_ULSEP_BINDING_ID:
                            case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperStore_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID:
                                break;
                            default:
                                return getUTF8();
                        }
    ...
    public String findMostSpecific(String str) {
        ...
        do {
            ...
            char c = this.chars[i];
            if (c != '\"') {
                str2 = c != '#' ? (c == '+' || c == ',' || c == ';') ? BuildConfig.PROVIDER_SUFFIX : escapedAV() : hexAV();
            } else {
                str2 = quotedAV();
            }
