...
public final class HttpUrl {
    ...
    public URI uri() {
        ...
        try {
            ...
            try {
                return URI.create(builder.replaceAll("[\\u0000-\\u001F\\u007F-\\u009F\\p{javaWhitespace}]", BuildConfig.PROVIDER_SUFFIX));
    ...
    public static int defaultPort(String str) {
        if (str.equals(com.facebook.common.build.config.BuildConfig.HTTP_SCHEME)) {
            return 80;
        }
        return str.equals(com.facebook.common.build.config.BuildConfig.HTTPS_SCHEME) ? 443 : -1;
    }
    ...
    public static final class Builder {
        ...
        public Builder scheme(String str) {
            if (str != null) {
                if (str.equalsIgnoreCase(com.facebook.common.build.config.BuildConfig.HTTP_SCHEME)) {
                    this.scheme = com.facebook.common.build.config.BuildConfig.HTTP_SCHEME;
                } else if (str.equalsIgnoreCase(com.facebook.common.build.config.BuildConfig.HTTPS_SCHEME)) {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (delimiterOffset3 < skipTrailingAsciiWhitespace && str.charAt(delimiterOffset3) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + delimiterOffset3, skipTrailingAsciiWhitespace, BuildConfig.PROVIDER_SUFFIX, true, false, false, false);
            }
        ...
        private void pop() {
            ...
            List<String> list2 = this.encodedPathSegments;
            list2.set(list2.size() - 1, BuildConfig.PROVIDER_SUFFIX);
        }
        ...
        private static int parsePort(String str, int i, int i2) {
            try {
                int parseInt = Integer.parseInt(HttpUrl.canonicalize(str, i, i2, BuildConfig.PROVIDER_SUFFIX, false, false, false, true));
