...
class DumpSysCollector {
    ...
    protected static String collectLargerMemoryInfo(Context context) {
        return Build.VERSION.SDK_INT >= 11 ? Api17Utils.Api11Utils.collectLargerMemoryInfo(context) : BuildConfig.PROVIDER_SUFFIX;
    }

    protected static String collectUserInfo(Context context) {
        return Build.VERSION.SDK_INT >= 17 ? Api17Utils.collectUserInfo(context) : BuildConfig.PROVIDER_SUFFIX;
    }
