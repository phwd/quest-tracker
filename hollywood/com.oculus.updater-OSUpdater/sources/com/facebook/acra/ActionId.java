...
public class ActionId {
    ...
    public static String getActionName(int i) {
        switch (i) {
            ...
            case UL.id._UL__ULSEP_com_oculus_auth_device_DeviceAuthTokenSubscriber_ULSEP_BINDING_ID /*{ENCODED_INT: 23}*/:
                return "DB_FETCH";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_SystemProperties_ULSEP_BINDING_ID /*{ENCODED_INT: 24}*/:
                return "SERVER_FETCH";
            case 25:
                return "SUCCESS_CACHE";
            case UL.id._UL__ULSEP_com_oculus_http_core_interceptor_OculusAuthorizationInterceptor_ULSEP_BINDING_ID /*{ENCODED_INT: 26}*/:
                return "SUCCESS_DB";
            case UL.id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigInit_ULSEP_BINDING_ID /*{ENCODED_INT: 27}*/:
                return "SUCCESS_NETWORK";
            case UL.id._UL__ULSEP_com_oculus_executors_OculusThreadExecutor_ULSEP_BINDING_ID /*{ENCODED_INT: 28}*/:
                return "SUCCESS_LOCAL_UNSPECIFIED";
            case UL.id._UL__ULSEP_android_net_wifi_WifiManager_ULSEP_BINDING_ID /*{ENCODED_INT: 29}*/:
                return "CACHE_UPDATED";
            case UL.id._UL__ULSEP_com_oculus_http_core_LoggingErrorHandler_ULSEP_BINDING_ID /*{ENCODED_INT: 30}*/:
                return "DB_UPDATED";
            case UL.id._UL__ULSEP_android_content_pm_PackageManager_ULSEP_BINDING_ID /*{ENCODED_INT: 31}*/:
                return "DATA_RECEIVED";
            case UL.id._UL__ULSEP_com_facebook_xanalytics_XAnalyticsProvider_ULSEP_BINDING_ID /*{ENCODED_INT: 32}*/:
                return "DRAW_VIEW";
            case UL.id._UL__ULSEP_java_lang_String_ULSEP_com_oculus_http_core_annotations_OculusApiEndpoint_ULSEP_BINDING_ID /*{ENCODED_INT: 33}*/:
                return "DATA_EMPTY";
            case UL.id._UL__ULSEP_com_oculus_logging_utils_EventManagerImpl_ULSEP_BINDING_ID /*{ENCODED_INT: 34}*/:
                return "CACHE_FETCH";
            case UL.id._UL__ULSEP_com_oculus_updater_core_monitors_IdleMonitor_ULSEP_BINDING_ID /*{ENCODED_INT: 35}*/:
                return "PREPARE_BEGIN";
            case UL.id._UL__ULSEP_com_facebook_inject_InjectorLike_ULSEP_BINDING_ID /*{ENCODED_INT: 36}*/:
                return "PREPARE_END";
            case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperWriter_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID /*{ENCODED_INT: 37}*/:
                return "ASYNC_BEGIN";
            case UL.id._UL__ULSEP_com_oculus_updater_device_DeviceInfo_ULSEP_BINDING_ID /*{ENCODED_INT: 38}*/:
                return "ASYNC_END";
            case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperStoreLogger_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID /*{ENCODED_INT: 39}*/:
                return "REMOVE_BEGIN";
            case UL.id._UL__ULSEP_okhttp3_ConnectionSpec_ULSEP_BINDING_ID /*{ENCODED_INT: 40}*/:
                return "REMOVE_END";
            case UL.id._UL__ULSEP_java_util_Locale_ULSEP_BINDING_ID /*{ENCODED_INT: 41}*/:
                return "BROADCAST_DONE";
            case UL.id._UL__ULSEP_com_facebook_common_manifest_AppBuildInfoReader_ULSEP_BINDING_ID /*{ENCODED_INT: 42}*/:
                return "ON_RESUME_END";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_UpdateEngine_ULSEP_BINDING_ID /*{ENCODED_INT: 43}*/:
                return "ON_ATTACH_END";
            case UL.id._UL__ULSEP_okhttp3_OkHttpClient_ULSEP_BINDING_ID /*{ENCODED_INT: 44}*/:
                return "ON_FRAGMENT_CREATE_END";
            case UL.id._UL__ULSEP_com_oculus_auth_credentials_CredentialsManager_ULSEP_BINDING_ID /*{ENCODED_INT: 45}*/:
                return "ON_CREATE_VIEW_END";
            case UL.id._UL__ULSEP_com_oculus_auth_device_noop_ULUNDERSCORE_subscriber_NoOpDeviceAuthTokenSubscriber_ULSEP_BINDING_ID /*{ENCODED_INT: 46}*/:
                return "ON_ACTIVITY_CREATED_END";
            case UL.id._UL__ULSEP_com_oculus_time_Clock_ULSEP_BINDING_ID /*{ENCODED_INT: 47}*/:
                return "ON_START_END";
            case UL.id._UL__ULSEP_com_facebook_auth_viewercontext_ViewerContextManager_ULSEP_com_facebook_auth_viewercontext_ViewerContextManagerForContext_ULSEP_BINDING_ID /*{ENCODED_INT: 48}*/:
                return "QUEUED";
            case UL.id._UL__ULSEP_com_facebook_mobileconfig_impl_MobileConfigManagerSingletonHolder_ULSEP_BINDING_ID /*{ENCODED_INT: 49}*/:
                return "IN_PROGRESS";
            case UL.id._UL__ULSEP_com_oculus_logging_utils_StorageLoggingUtils_ULSEP_BINDING_ID /*{ENCODED_INT: 50}*/:
                return "INIT";
            case UL.id._UL__ULSEP_java_util_Set_ULLT_com_oculus_auth_handler_LoginHandler_ULGT__ULSEP_BINDING_ID /*{ENCODED_INT: 51}*/:
                return "UNKNOWN";
            case UL.id._UL__ULSEP_java_lang_String_ULSEP_com_oculus_http_useragent_UserAgentString_ULSEP_BINDING_ID /*{ENCODED_INT: 52}*/:
                return "RETRY_AFTER_FAILURE";
            case UL.id._UL__ULSEP_com_facebook_tigon_oktigon_OkTigonService_ULSEP_BINDING_ID /*{ENCODED_INT: 53}*/:
                return "RETRY_AFTER_RECONNECT";
            case UL.id._UL__ULSEP_com_oculus_authapi_OVRAuth_ULSEP_BINDING_ID /*{ENCODED_INT: 54}*/:
                return "QUEUEING_BEGIN";
            case UL.id._UL__ULSEP_retrofit_ErrorHandler_ULSEP_BINDING_ID /*{ENCODED_INT: 55}*/:
                return "QUEUEING_SUCCESS";
            case UL.id._UL__ULSEP_android_os_Looper_ULSEP_com_oculus_executors_ForUiThread_ULSEP_BINDING_ID /*{ENCODED_INT: 56}*/:
                return "QUEUEING_FAIL";
            case UL.id._UL__ULSEP_com_oculus_updater_core_logging_OSUpdateEventLogger_ULSEP_BINDING_ID /*{ENCODED_INT: 57}*/:
                return "MESSAGE_UPDATE_START";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_contract_OSUpdateServiceContract_ULSEP_BINDING_ID /*{ENCODED_INT: 58}*/:
                return "MESSAGE_UPDATE_END";
            case UL.id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigLogoutHandler_ULSEP_BINDING_ID /*{ENCODED_INT: 59}*/:
                return "PHOTO_CAPTURED";
            case 60:
                return "MEDIA_PREVIEW_VISIBLE";
            case UL.id._UL__ULSEP_android_content_Context_ULSEP_com_facebook_inject_UnsafeContextInjection_ULSEP_BINDING_ID /*{ENCODED_INT: 61}*/:
                return "COUNTER";
            case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperStore_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID /*{ENCODED_INT: 62}*/:
                return "INTERACTION_LOAD_TIMELINE_HEADER";
            case 63:
                return "INTERACTION_LOAD_EVENT_PERMALINK";
            case 64:
                return "INTERACTION_LOAD_GROUPS_FEED";
            case UL.id._UL__ULSEP_com_oculus_os_DeviceAuth_ULSEP_BINDING_ID /*{ENCODED_INT: 65}*/:
                return "INTERACTION_LOAD_PAGE_HEADER";
            case UL.id._UL__ULSEP_com_facebook_common_manifest_AppBuildInfo_ULSEP_BINDING_ID /*{ENCODED_INT: 66}*/:
                return "INTERACTION_LOAD_PAGE_HEADER_ADMIN";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_OSUpdateManager_ULSEP_BINDING_ID /*{ENCODED_INT: 67}*/:
                return "INTERACTION_LOAD_PERMALINK";
            case UL.id._UL__ULSEP_com_facebook_http_config_SocketConfig_ULSEP_BINDING_ID /*{ENCODED_INT: 68}*/:
                return "INTERACTION_OPEN_COMPOSER";
            case UL.id._UL__ULSEP_android_content_pm_PackageInfo_ULSEP_BINDING_ID /*{ENCODED_INT: 69}*/:
                return "INTERACTION_OPEN_MEDIA_PICKER";
            case UL.id._UL__ULSEP_com_oculus_updater_net_ApiDispatcher_ULSEP_BINDING_ID /*{ENCODED_INT: 70}*/:
                return "INTERACTION_OPEN_PHOTO_GALLERY";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_UpdateMonitor_ULSEP_BINDING_ID /*{ENCODED_INT: 71}*/:
                return "INTERACTION_OPEN_CHECK_IN";
            case UL.id._UL__ULSEP_com_oculus_updater_prefs_OSUpdaterSharedPreferences_ULSEP_BINDING_ID /*{ENCODED_INT: 72}*/:
                return "INTERACTION_LOAD_WEB_VIEW";
            case UL.id._UL__ULSEP_com_oculus_updater_credentialsmanager_OSUpdateCredentialsManager_ULSEP_BINDING_ID /*{ENCODED_INT: 73}*/:
                return "INTENT_MAPPED";
            case UL.id._UL__ULSEP_android_net_ConnectivityManager_ULSEP_BINDING_ID /*{ENCODED_INT: 74}*/:
                return "ACTIVITY_LAUNCHED";
            case UL.id._UL__ULSEP_com_oculus_managed_ManagedMode_ULSEP_BINDING_ID /*{ENCODED_INT: 75}*/:
                return "ACTIVITY_PAUSED";
            case 76:
                return "ACTIVITY_STARTED";
            case UL.id._UL__ULSEP_com_oculus_authapi_inject_CallerInfoProviderImpl_ULSEP_BINDING_ID /*{ENCODED_INT: 77}*/:
                return "ACTIVITY_RESUMED";
            case UL.id._UL__ULSEP_com_oculus_updater_core_monitors_WifiMonitor_ULSEP_BINDING_ID /*{ENCODED_INT: 78}*/:
                return "FRAGMENT_CREATED";
            case UL.id._UL__ULSEP_com_oculus_updater_net_OSUpdateProvider_ULSEP_BINDING_ID /*{ENCODED_INT: 79}*/:
                return "FRAGMENT_RESUMED";
            case UL.id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigLoginHandler_ULSEP_BINDING_ID /*{ENCODED_INT: 80}*/:
                return "ACTIVITY_ON_CREATE";
            case 81:
                return "INTENT_MAPPING_BEGIN";
            case UL.id._UL__ULSEP_java_lang_String_ULSEP_com_oculus_http_core_annotations_FacebookGraphVideoEndpoint_ULSEP_BINDING_ID /*{ENCODED_INT: 82}*/:
                return "FRAGMENT_ON_CREATE";
            case 83:
                return "FRAGMENT_NEW_INSTANCE";
            case UL.id._UL__ULSEP_okhttp3_OkHttpClient_ULSEP_com_oculus_http_customuseragentclient_CustomUserAgentHttpClient_ULSEP_BINDING_ID /*{ENCODED_INT: 84}*/:
                return "MARKER_SWAPPED";
            case 85:
                return "FRAGMENT_INSTANCE_CREATED";
            case UL.id._UL__ULSEP_com_facebook_mobileconfig_impl_MobileConfigManagerSingletonHolder_ULSEP_com_facebook_mobileconfig_factory_module_SessionlessMC_ULSEP_BINDING_ID /*{ENCODED_INT: 86}*/:
                return "PREV_ACTIVITY_PAUSED";
            case UL.id._UL__ULSEP_com_oculus_logging_utils_EventManager_ULSEP_BINDING_ID /*{ENCODED_INT: 87}*/:
                return "ERROR";
            case UL.id._UL__ULSEP_com_oculus_updater_core_monitors_CheckPeriodMonitor_ULSEP_BINDING_ID /*{ENCODED_INT: 88}*/:
                return "METHOD_INVOKE";
            case UL.id._UL__ULSEP_com_facebook_mobileconfig_factory_MobileConfig_ULSEP_com_facebook_mobileconfig_factory_module_SessionlessMC_ULSEP_BINDING_ID /*{ENCODED_INT: 89}*/:
                return "FINALLY";
            case UL.id._UL__ULSEP_com_oculus_os_SettingsManager_ULSEP_BINDING_ID /*{ENCODED_INT: 90}*/:
                return "PHOTO_DOWNLOAD_COMPLETE";
            case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperStoreConfig_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID /*{ENCODED_INT: 91}*/:
                return "MINIPREVIEW_COMPLETE";
            case UL.id._UL__ULSEP_com_oculus_auth_credentials_Credentials_ULSEP_BINDING_ID /*{ENCODED_INT: 92}*/:
                return "SEARCH_TYPEAHEAD";
            case UL.id._UL__ULSEP_com_oculus_auth_device_DeviceAuthTokenStore_ULSEP_BINDING_ID /*{ENCODED_INT: 93}*/:
                return "ANIMATION_END";
            case UL.id._UL__ULSEP_com_oculus_base_app_AppInfo_ULSEP_BINDING_ID /*{ENCODED_INT: 94}*/:
                return "UDP_REQUEST_SEND";
            case UL.id._UL__ULSEP_okhttp3_OkHttpClient_ULSEP_com_oculus_http_defaultclient_DefaultHttpClient_ULSEP_BINDING_ID /*{ENCODED_INT: 95}*/:
                return "MAIN_COMPLETE";
            case UL.id._UL__ULSEP_com_facebook_tigon_oktigon_OkTigonServiceHolder_ULSEP_BINDING_ID /*{ENCODED_INT: 96}*/:
                return "INTERRUPTED";
            case UL.id._UL__ULSEP_com_facebook_mobileconfig_factory_MobileConfig_ULSEP_BINDING_ID /*{ENCODED_INT: 97}*/:
                return "NETWORK_FAILED";
            case UL.id._UL__ULSEP_android_content_SharedPreferences_ULSEP_com_oculus_updater_prefs_DeviceProtectedPrefs_ULSEP_BINDING_ID /*{ENCODED_INT: 98}*/:
                return "NETWORK_RESPONSE";
            case UL.id._UL__ULSEP_com_oculus_updater_core_os_DeviceTokenUpdateSubscriber_ULSEP_BINDING_ID /*{ENCODED_INT: 99}*/:
                return "EDGE_PROCESSING_BEGIN";
            case UL.id._UL__ULSEP_com_oculus_http_core_ApiResponseConverter_ULSEP_BINDING_ID /*{ENCODED_INT: 100}*/:
                return "NEWSFEED_PROCESS_RESPONSE";
            case UL.id._UL__ULSEP_retrofit_RestAdapter_ULSEP_com_oculus_http_core_annotations_OculusRestAdapter_ULSEP_BINDING_ID /*{ENCODED_INT: 101}*/:
                return "ON_VIEW_CREATED_END";
            case UL.id._UL__ULSEP_com_oculus_dsatauth_DsatFetcher_ULSEP_BINDING_ID /*{ENCODED_INT: 102}*/:
                return "DATA_LOAD_START";
            case 103:
                return "LEGACY_MARKER";
            case UL.id._UL__ULSEP_okhttp3_OkHttpClient_ULSEP_com_facebook_tigon_oktigon_OkTigonClient_ULSEP_BINDING_ID /*{ENCODED_INT: 104}*/:
                return "ACTION_BAR_COMPLETE";
            case UL.id._UL__ULSEP_com_facebook_common_manifest_ManifestReader_ULSEP_BINDING_ID /*{ENCODED_INT: 105}*/:
                return "ABORTED";
            case UL.id._UL__ULSEP_com_oculus_updater_core_broadcast_BroadcastState_ULSEP_BINDING_ID /*{ENCODED_INT: 106}*/:
                return "QUERY_READY";
            case UL.id._UL__ULSEP_java_util_Set_ULLT_com_oculus_auth_handler_LogoutHandler_ULGT__ULSEP_BINDING_ID /*{ENCODED_INT: 107}*/:
                return "RTMP_PACKET_RECEIVED";
            case UL.id._UL__ULSEP_java_lang_String_ULSEP_com_oculus_http_core_annotations_FacebookApiEndpoint_ULSEP_BINDING_ID /*{ENCODED_INT: 108}*/:
                return "REQUESTED_PLAYING";
            case UL.id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigInitOptions_ULSEP_BINDING_ID /*{ENCODED_INT: 109}*/:
                return "RTMP_CONNECTION_REQUESTED";
            case UL.id._UL__ULSEP_com_oculus_updater_init_AppInitializer_ULSEP_BINDING_ID /*{ENCODED_INT: 110}*/:
                return "RTMP_CONNECTION_RELEASE";
            case UL.id._UL__ULSEP_com_oculus_common_init_AppInitLock_ULSEP_BINDING_ID /*{ENCODED_INT: 111}*/:
                return "NEW_START_FOUND";
            case UL.id._UL__ULSEP_com_oculus_updater_core_monitors_ConditionManager_ULSEP_BINDING_ID /*{ENCODED_INT: 112}*/:
                return "MISSED_EVENT";
            case UL.id._UL__ULSEP_com_oculus_errorreporting_interfaces_IErrorReporter_ULSEP_BINDING_ID /*{ENCODED_INT: 113}*/:
                return "TIMEOUT";
            case UL.id._UL__ULSEP_com_oculus_updater_credentialsmanager_OSUpdateAuthDatastore_ULSEP_BINDING_ID /*{ENCODED_INT: 114}*/:
                return "CONTROLLER_INITIATED";
            case UL.id._UL__ULSEP_com_oculus_xanalytics_OculusXAnalyticsProvider_ULSEP_BINDING_ID /*{ENCODED_INT: 115}*/:
                return "RTMP_STREAM_PREPARED";
            case UL.id._UL__ULSEP_com_oculus_updater_core_monitors_BatteryMonitor_ULSEP_BINDING_ID /*{ENCODED_INT: 116}*/:
                return "VIDEO_PLAYING";
            case UL.id._UL__ULSEP_com_oculus_updater_ovrsvcclient_OVRServiceClient_ULSEP_BINDING_ID /*{ENCODED_INT: 117}*/:
                return "RTMP_CONNECTION_CONNECTED";
            case UL.id._UL__ULSEP_com_oculus_updater_gk_GatekeeperHelper_ULSEP_BINDING_ID /*{ENCODED_INT: 118}*/:
