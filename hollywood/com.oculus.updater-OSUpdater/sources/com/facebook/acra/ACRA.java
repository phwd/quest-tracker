...
public class ACRA {
    ...
    private static void initReportSource() {
        ...
        if (property != null && !property.equals(BuildConfig.PROVIDER_SUFFIX)) {
            BLog.i("Overriding report_source from prop: %s", property);
            ErrorReporter.putCustomData("report_source", property);
            ErrorReporter.putCustomData(ErrorReportingConstants.REPORT_SOURCE_REF, BuildConfig.PROVIDER_SUFFIX);
        }
        ...
        if (reportSourceRefOverride != null) {
            ...
            if (property2 != null && !property2.equals(BuildConfig.PROVIDER_SUFFIX)) {
        ...
        if (property3 != null && !property3.equals(BuildConfig.PROVIDER_SUFFIX)) {
    ...
    private static JSONObject jsonifyReportSourceRef(String str) {
        ...
        if (str.startsWith(ErrorReportingConstants.REPORT_SOURCE_REF_LACRIMA_PREFIX)) {
            str = str.replace(ErrorReportingConstants.REPORT_SOURCE_REF_LACRIMA_PREFIX, BuildConfig.PROVIDER_SUFFIX);
        }
        try {
