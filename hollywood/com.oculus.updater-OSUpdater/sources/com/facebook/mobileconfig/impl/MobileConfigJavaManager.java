...
public class MobileConfigJavaManager implements MobileConfigManagerHolder {
    ...
    private String getDirectoryPathForSession() {
        ...
        if (str == null || str.isEmpty() || this.mSessionId.equals("0")) {
            return this.mBufferPath + "sessionless.data/";
        }
        return this.mBufferPath + this.mSessionId + ".data/";
    }
    ...
    public static String getSchemaHashFromSpecToParamFile(ReadableByteChannel readableByteChannel) {
        try {
            ...
            BLog.wtf("MobileConfigJavaManager", e, "populateTranslationTableInternal: IOException");
            return BuildConfig.PROVIDER_SUFFIX;
        }
    }
    ...
    public static boolean populateTranslationTableInternal(ReadableByteChannel readableByteChannel, ReadableByteChannel readableByteChannel2, long[][] jArr) {
        if (jArr == null) {
            BLog.wtf("MobileConfigJavaManager", "populateTranslationTableInternal: translationTable passed was null");
        }
        try {
            ...
            while (read2 == 16 && read == 16) {
                ...
                if (j3 == j) {
                    if (MobileConfigSpecifierUtil.getParamType(j2) != MobileConfigSpecifierUtil.getParamType(j4)) {
                        BLog.wtf("MobileConfigJavaManager", "populateTranslationTableInternal: invalid specifiers");
                        return false;
                    }
                    ...
                    if (paramType < 0 || paramType >= jArr.length || slotId < 0 || jArr[paramType] == null || slotId >= jArr[paramType].length) {
                        BLog.wtf("MobileConfigJavaManager", "populateTranslationTableInternal: Type/slot ids out of bound type_id: %d slot_id: %d", Integer.valueOf(paramType), Integer.valueOf(slotId));
                        return false;
                    }
            ...
            BLog.wtf("MobileConfigJavaManager", e2, "populateTranslationTableInternal: BufferUnderflowException");
            return false;
        }
    }
    ...
    public static String getConfigTableSchemaHash(@Nullable MobileConfigCaptureError mobileConfigCaptureError, MobileConfigMmapHandle mobileConfigMmapHandle) {
        ...
        try {
            ...
            BLog.wtf("MobileConfigJavaManager", e, "getConfigTableSchemaHash: IllegalArgumentException");
            return BuildConfig.PROVIDER_SUFFIX;
        }
    }
    ...
    public boolean updateConfigs() {
        BLog.i("MobileConfigJavaManager", "updateConfigs");
        return false;
    }
    ...
    public MobileConfigOverridesTable getNewOverridesTableIfExists() {
        File file = new File(this.mBufferPath + "mc_overrides.json");
        if (this.mParamsMap == null || !file.exists() || this.mParamsMap.get() == null) {
            return null;
        }
        try {
            return new MobileConfigJavaOverridesTable(FileUtils.readFileToString(file, Charset.forName("UTF-8")), this.mTranslationTable, this.mParamsMap.get());
    ...
    public String syncFetchReason() {
        return this.mTranslationTable != null ? "MobileConfigJavaManager: Using translation table." : "MobileConfigJavaManager: No sync fetch was needed";
    }
}
