...
public class MobileConfigTranslationTableVerifier {
    public static boolean verify(MobileConfigContext mobileConfigContext) {
        BLog.i("MobileConfigTranslationTableVerifier", "Start to verify translation table.");
        boolean z = true;
        ...
        BLog.i("MobileConfigTranslationTableVerifier", "Translation table is valid: %s.", z ? "yes" : "no");
        return z;
    }
    ...
    private static <T> boolean logErrorIfMismatch(T t, T t2, String str, MobileConfigOptions mobileConfigOptions) {
        ...
        BLog.wtf("MobileConfigTranslationTableVerifier", "Failed to verify mobileconfig_verify_tt.%s, expected:%s, actual:%s. actual_src:%s", str, t, t2, mobileConfigOptions.getValueSource());
        return false;
    }
}
