    ...
    private boolean isLiteral(char c) throws IOException {
        ...
        if (c != '#') {
            ...
            if (!(c == '/' || c == '=')) {
                ...
                if (c != ';') {
                    switch (c) {
                        case UL.id._UL__ULSEP_com_facebook_gk_store_GatekeeperStoreConfig_ULSEP_com_facebook_gk_sessionless_Sessionless_ULSEP_BINDING_ID:
                        case UL.id._UL__ULSEP_com_oculus_auth_device_DeviceAuthTokenStore_ULSEP_BINDING_ID:
                            return false;
                        case UL.id._UL__ULSEP_com_oculus_auth_credentials_Credentials_ULSEP_BINDING_ID:
                            break;
                        default:
                            return true;
                    }
