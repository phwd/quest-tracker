...
public class CoordinatorLayout extends ViewGroup {
    ...
    private static int resolveGravity(int i) {
        ...
        return (i & UL.id._UL__ULSEP_com_oculus_updater_core_monitors_ConditionManager_ULSEP_BINDING_ID) == 0 ? i | 48 : i;
    }
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i7 = absoluteGravity & UL.id._UL__ULSEP_com_oculus_updater_core_monitors_ConditionManager_ULSEP_BINDING_ID;
        int i8 = absoluteGravity2 & 7;
        int i9 = absoluteGravity2 & UL.id._UL__ULSEP_com_oculus_updater_core_monitors_ConditionManager_ULSEP_BINDING_ID;
        if (i8 == 1) {
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int i4 = absoluteGravity & UL.id._UL__ULSEP_com_oculus_updater_core_monitors_ConditionManager_ULSEP_BINDING_ID;
        int width = getWidth();
        int height = getHeight();
        int measuredWidth = view.getMeasuredWidth();
        int measuredHeight = view.getMeasuredHeight();
