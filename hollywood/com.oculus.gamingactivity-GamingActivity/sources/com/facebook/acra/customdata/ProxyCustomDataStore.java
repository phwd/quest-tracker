...
public class ProxyCustomDataStore implements CustomDataStore {
    ...
    public synchronized void setCustomData(String key, @Nullable String format, Object... args) {
    ...
    @Override // com.facebook.acra.customdata.CustomDataStore
    public synchronized void removeCustomData(String key) {
        dataStore.removeCustomData(key);
    }
