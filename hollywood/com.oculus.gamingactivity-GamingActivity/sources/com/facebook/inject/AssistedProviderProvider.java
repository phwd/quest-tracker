...
public class AssistedProviderProvider<T> extends AbstractProvider<AssistedProvider<T>> {
    ...
    public AssistedProviderProvider(Class<AssistedProvider<T>> assistedProviderClass) {
        this.mAssistedProviderClass = assistedProviderClass;
    ...
    private Constructor<AssistedProvider<T>> getConstructor() {
        ...
        try {
            Constructor<AssistedProvider<T>> constructor2 = this.mAssistedProviderClass.getDeclaredConstructor(InjectorLike.class);
            this.mAssistedProviderConstructor = constructor2;
            return constructor2;
