...
public class AbstractAssistedProvider<T> implements InjectorLike, AssistedProviderWithInjector<T>, StaticBindingInterceptor {
    ...
    public AbstractAssistedProvider(InjectorLike injector) {
    ...
    @Override // com.facebook.inject.Injector
    public <S> S getInstance(Class<S> type, Class<? extends Annotation> annotationSype) {
        return (S) getInstance(type, annotationSype, this.mInjector.getInjectorThreadStack().getContext());
    }
    ...
    @Override // com.facebook.inject.Injector
    public <S> S getInstance(Class<S> type, Class<? extends Annotation> annotationSype, Context context) {
        return (S) this.mInjector.getInstance(type, annotationSype, context);
    }
