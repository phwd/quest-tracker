...
public class InstallConfigBundler {
    ...
    public static Bundle toBundle(UpdateConfig updateConfig) {
        ...
        bundle.putString(UpdateConfigContract.KEY_ID, updateConfig.oculusStoreId);
