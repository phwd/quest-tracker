...
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public V put(C key, V value) {
            ...
            Preconditions.checkNotNull(value);
            return (this.backingRowMap == null || this.backingRowMap.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, key, value) : this.backingRowMap.put(key, value);
        }
        ...
        public V remove(Object key) {
            ...
            V v = (V) Maps.safeRemove(backingRowMap2, key);
        ...
        public Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>() {
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.google.common.collect.StandardTable$Row$2 */
