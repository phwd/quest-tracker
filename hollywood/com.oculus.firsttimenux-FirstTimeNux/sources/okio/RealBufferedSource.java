...
public final class RealBufferedSource implements BufferedSource {
    ...
    public long read(Buffer sink, long byteCount) throws IOException {
        ...
        } else if (this.buffer.size == 0 && this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
            return -1;
        } else {
    ...
    public boolean exhausted() throws IOException {
        if (!this.closed) {
            return this.buffer.exhausted() && this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1;
        }
        throw new IllegalStateException("closed");
    }
    ...
    public boolean request(long byteCount) throws IOException {
        if (byteCount < 0) {
            ...
            while (this.buffer.size < byteCount) {
                if (this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
                    return false;
                }
            }
            return true;
    ...
    public int select(Options options) throws IOException {
        ...
        } while (this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) != -1);
        return -1;
    }
    ...
    public int read(byte[] sink, int offset, int byteCount) throws IOException {
        ...
        if (this.buffer.size == 0 && this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
            return -1;
        }
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) throws IOException {
        if (this.closed) {
            ...
            while (fromIndex < toIndex) {
                ...
                if (lastBufferSize >= toIndex || this.source.read(this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
                    return -1;
                }
    ...
    public InputStream inputStream() {
        return new InputStream() {
            ...
            public int read() throws IOException {
                ...
                } else if (RealBufferedSource.this.buffer.size == 0 && RealBufferedSource.this.source.read(RealBufferedSource.this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
                    return -1;
                } else {
            ...
            public int read(byte[] data, int offset, int byteCount) throws IOException {
                ...
                if (RealBufferedSource.this.buffer.size == 0 && RealBufferedSource.this.source.read(RealBufferedSource.this.buffer, Systrace.TRACE_TAG_REACT_JAVA_BRIDGE) == -1) {
                    return -1;
                }
