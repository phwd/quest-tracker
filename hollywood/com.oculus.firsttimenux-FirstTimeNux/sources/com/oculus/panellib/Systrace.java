...
public class Systrace {
    ...
    public static void enable(boolean enable) {
        if (isEnabled != enable) {
            ...
            objArr[0] = isEnabled ? SharingManagerContract.ARGUMENT_IS_ENABLED : "disabled";
    ...
    public static void enableSystemTracing(boolean enable) {
        if (isSystemTracingEnabled != enable) {
            ...
            Object[] objArr = new Object[1];
            objArr[0] = isSystemTracingEnabled ? SharingManagerContract.ARGUMENT_IS_ENABLED : "disabled";
