...
public class HandTrackingSettingsModuleImpl extends HandTrackingSettingsModule {
    ...
    public void startListeningForSettingsChangesImpl(Resolver<Boolean> resolver) {
        ...
        this.mSettingsManager.registerSettingsObserver(HAND_TRACKING_OPT_IN_KEY, this.mSettingsObserverCallback, handler);
        this.mSettingsManager.registerSettingsObserver(HAND_TRACKING_ENABLED_KEY, this.mSettingsObserverCallback, handler);
    ...
    public void stopListeningForSettingsChangesImpl(Resolver<Boolean> resolver) {
        ...
        this.mSettingsManager.unregisterSettingsObserver(HAND_TRACKING_OPT_IN_KEY, this.mSettingsObserverCallback);
        this.mSettingsManager.unregisterSettingsObserver(HAND_TRACKING_ENABLED_KEY, this.mSettingsObserverCallback);
        resolver.resolve(true);
    }
    ...
    private void updateHandTrackingSettings() {
        ...
        settingsUpdate.optedIn = this.mSettingsManager.getBoolean(HAND_TRACKING_OPT_IN_KEY, false);
        settingsUpdate.enabled = this.mSettingsManager.getBoolean(HAND_TRACKING_ENABLED_KEY, false);
