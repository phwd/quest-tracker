    ...
    public void joinPartyImpl(String partyID, boolean useSocialPlatformContentProvider, Resolver<Void> resolver) {
        ...
        try {
            ...
            if (cursor2 == null || !cursor2.moveToNext()) {
                ...
                String userFacingErrorMessage = cursor2.getString(cursor2.getColumnIndexOrThrow("party_join_error"));
    ...
    public void createPartyImpl(String partyType, boolean useSocialPlatformContentProvider, String socialActivityID, Resolver<String> resolver) {
        ...
        try {
            ...
            if (socialActivityID != null && !socialActivityID.isEmpty()) {
                uriBuilder = uriBuilder.appendQueryParameter(APP_ID_PARAM_IN_CREATE_PARTY_QUERY, socialActivityID);
            }
            if (partyType != null && !partyType.isEmpty()) {
                uriBuilder = uriBuilder.appendQueryParameter(PARTY_TYPE_PARAM, partyType);
            }
            ...
            if (cursor2 != null) {
                cursor2.moveToFirst();
                String partyID = cursor2.getString(cursor2.getColumnIndexOrThrow(CURRENT_PARTY_ID_COLUMN));
