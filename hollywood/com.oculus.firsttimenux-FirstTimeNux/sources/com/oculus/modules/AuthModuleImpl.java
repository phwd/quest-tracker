...
public class AuthModuleImpl extends AuthModule {
    ...
    public IntentFilter getIntentFilter() {
        ...
        filter.addAction("com.oculus.auth.BROADCAST_LOGIN");
        return filter;
    }
    ...
    public void processIntent(Intent intent, boolean forceNativeUpdate) {
        ...
        switch (action.hashCode()) {
            case 698177661:
                if (action.equals("com.oculus.auth.BROADCAST_LOGIN")) {
                    c = 0;
                    break;
                }
                break;
    ...
    /* access modifiers changed from: protected */
    @Override // com.oculus.modules.codegen.AuthModule
    public void verifyLoginImpl(@Nullable String nonce, String pin, @Nullable String methodId, @Nullable String fbAccessToken, boolean isSecuredAction, final Resolver<AuthModule.AuthVerifyLoginResult> resolver) {
    ...
    /* access modifiers changed from: protected */
    @Override // com.oculus.modules.codegen.AuthModule
    public void verifyReloginImpl(@Nullable String nonce, String pin, @Nullable String methodId, @Nullable String fbAccessToken, boolean isSecuredAction, final Resolver<AuthModule.AuthVerifyLoginResult> resolver) {
    ...
    /* access modifiers changed from: protected */
    @Override // com.oculus.modules.codegen.AuthModule
    public void verifyLoginForAccountLinkingImpl(@Nullable String nonce, String pin, @Nullable String methodId, @Nullable String fbAccessToken, final Resolver<AuthModule.AuthVerifyLoginForAccountLinkingResult> resolver) {
        ...
        ovrAuth().status(new ResultReceiver(null) {
            ...
            public void onReceiveResult(int resultCode, Bundle resultData) {
                ...
                if (resultCode == 1) {
                    ...
                    result.error.code = (double) resultData.getInt(ServiceContract.EXTRA_ERROR_CODE);
                    Log.e(AuthModuleImpl.TAG, "statusImpl() failed");
                } else {
                    result.userId = resultData.getString(ServiceContract.EXTRA_USER_ID);
