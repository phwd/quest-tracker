...
public class ActionId {
    ...
    public static String getActionName(int actionId) {
        switch (actionId) {
            ...
            case 30:
                return "DB_UPDATED";
            case BreakpadManager.SIGSYS /*{ENCODED_INT: 31}*/:
            ...
            case Elf32_Ehdr.e_phentsize /*{ENCODED_INT: 42}*/:
            ...
            case Elf32_Ehdr.e_shentsize /*{ENCODED_INT: 46}*/:
            ...
            case 49:
                return "IN_PROGRESS";
            case Elf32_Ehdr.e_shstrndx /*{ENCODED_INT: 50}*/:
                return "INIT";
            case 51:
                return "UNKNOWN";
            case Elf64_Ehdr.e_ehsize /*{ENCODED_INT: 52}*/:
                return "RETRY_AFTER_FAILURE";
            case 53:
                return "RETRY_AFTER_RECONNECT";
            case Elf64_Ehdr.e_phentsize /*{ENCODED_INT: 54}*/:
            ...
            case Elf64_Ehdr.e_shentsize /*{ENCODED_INT: 58}*/:
