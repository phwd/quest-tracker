...
public class SoftErrorBuilder {
    ...
    private int mSamplingFrequency = SoftError.DEFAULT_SOFT_ERROR_REPORTING_FREQUENCY;
    ...
    public SoftErrorBuilder setOnlyIfEmployeeOrBetaBuild(boolean onlyIfEmployeeOrBetaBuild) {
        this.mOnlyIfEmployeeOrBetaBuild = onlyIfEmployeeOrBetaBuild;
        return this;
    }
