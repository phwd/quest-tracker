...
public class ExceptionHandlerManager implements Thread.UncaughtExceptionHandler {
    ...
    public static synchronized void crashExplicitly(Thread thread, Throwable throwable) {
        Thread.UncaughtExceptionHandler handler;
        synchronized (ExceptionHandlerManager.class) {
            ExceptionHandlerManager instance = getInstance();
            if (instance != null) {
                handler = instance.mPreviousHandler;
            } else {
    ...
    public static synchronized void setCustomStackTracer(CustomStackTracerInterface stackTracer) {
        synchronized (ExceptionHandlerManager.class) {
            getInitializedInstance().setCustomStackTracerImpl(stackTracer);
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public synchronized void setCustomStackTracerImpl(CustomStackTracerInterface stackTracer) {
        this.mStackTracer = stackTracer;
    }
