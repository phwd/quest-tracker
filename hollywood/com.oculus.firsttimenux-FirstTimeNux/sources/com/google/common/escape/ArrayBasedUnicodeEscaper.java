...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper {
    ...
    protected ArrayBasedUnicodeEscaper(Map<Character, String> replacementMap, int safeMin2, int safeMax2, @NullableDecl String unsafeReplacement) {
        this(ArrayBasedEscaperMap.create(replacementMap), safeMin2, safeMax2, unsafeReplacement);
    }

    protected ArrayBasedUnicodeEscaper(ArrayBasedEscaperMap escaperMap, int safeMin2, int safeMax2, @NullableDecl String unsafeReplacement) {
