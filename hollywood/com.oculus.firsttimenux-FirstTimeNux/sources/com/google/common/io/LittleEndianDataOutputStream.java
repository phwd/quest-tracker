...
public final class LittleEndianDataOutputStream extends FilterOutputStream implements DataOutput {
    ...
    public void writeInt(int v) throws IOException {
        this.out.write(v & ProcReader.PROC_TERM_MASK);
        this.out.write((v >> 8) & ProcReader.PROC_TERM_MASK);
        this.out.write((v >> 16) & ProcReader.PROC_TERM_MASK);
        this.out.write((v >> 24) & ProcReader.PROC_TERM_MASK);
    }
