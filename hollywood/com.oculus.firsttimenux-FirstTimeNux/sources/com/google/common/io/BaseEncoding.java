...
public abstract class BaseEncoding {
        ...
        public OutputStream encodingStream(final Writer out) {
            ...
            return new OutputStream() {
                ...
                public void write(int b) throws IOException {
                    this.bitBuffer <<= 8;
                    this.bitBuffer |= b & ProcReader.PROC_TERM_MASK;
                        ...
                        if (readChar != -1) {
                            ...
                            if (StandardBaseEncoding.this.paddingChar == null || StandardBaseEncoding.this.paddingChar.charValue() != ch) {
                                ...
                                if (this.bitBufferLength >= 8) {
                                    this.bitBufferLength -= 8;
                                    return (this.bitBuffer >> this.bitBufferLength) & ProcReader.PROC_TERM_MASK;
                                }
    ...
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        private Base16Encoding(Alphabet alphabet) {
            super(alphabet, null);
            this.encoding = new char[ProcReader.PROC_PARENS];
            Preconditions.checkArgument(alphabet.chars.length == 16);
            for (int i = 0; i < 256; i++) {
                this.encoding[i] = alphabet.encode(i >>> 4);
                this.encoding[i | ProcReader.PROC_COMBINE] = alphabet.encode(i & 15);
            }
        }
        ...
        public void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            ...
            for (int i = 0; i < len; i++) {
                ...
                target.append(this.encoding[b | ProcReader.PROC_COMBINE]);
            }
        }
        ...
        public int decodeTo(byte[] target, CharSequence chars) throws DecodingException {
            ...
            while (i < chars2.length()) {
                ...
                if (i < chars2.length()) {
                    ...
                    target[bytesWritten2] = (byte) ((chunk2 >>> 8) & ProcReader.PROC_TERM_MASK);
                    if (i3 < chars2.length()) {
                        i = i3 + 1;
                        bytesWritten2 = bytesWritten + 1;
                        target[bytesWritten] = (byte) ((chunk2 | this.alphabet.decode(chars2.charAt(i3))) & ProcReader.PROC_TERM_MASK);
                    } else {
                        i = i3;
                    }
                }
