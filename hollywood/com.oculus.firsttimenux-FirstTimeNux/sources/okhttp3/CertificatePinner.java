...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        public boolean matches(String hostname) {
            ...
            if ((hostname.length() - firstDot) - 1 != this.canonicalHostname.length() || !hostname.regionMatches(false, firstDot + 1, this.canonicalHostname, 0, this.canonicalHostname.length())) {
                return false;
            }
            return true;
        }
