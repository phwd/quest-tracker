...
public final class Http2Writer implements Closeable {
    ...
    private int maxFrameSize = ProcReader.PROC_OUT_FLOAT;
    ...
    public void frameHeader(int streamId, int length, byte type, byte flags) throws IOException {
        ...
        if (length > this.maxFrameSize) {
            ...
            this.sink.writeByte(type & UnsignedBytes.MAX_VALUE);
            this.sink.writeByte(flags & UnsignedBytes.MAX_VALUE);
    ...
    private static void writeMedium(BufferedSink sink2, int i) throws IOException {
        sink2.writeByte((i >>> 16) & ProcReader.PROC_TERM_MASK);
        sink2.writeByte((i >>> 8) & ProcReader.PROC_TERM_MASK);
        sink2.writeByte(i & ProcReader.PROC_TERM_MASK);
    }
