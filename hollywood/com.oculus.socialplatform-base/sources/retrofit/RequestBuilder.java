...
public final class RequestBuilder implements RequestInterceptor.RequestFacade {
    ...
    public void addHeader(String str, String str2) {
        ...
        } else if (HttpRequestMultipart.CONTENT_TYPE.equalsIgnoreCase(str)) {
        ...
        if (multipartTypedOutput == null || multipartTypedOutput.mimeParts.size() != 0) {
            ...
            if (str2 != null) {
                if (typedOutput != null) {
                    ...
                    Header header = new Header(HttpRequestMultipart.CONTENT_TYPE, str2);
                    if (list == null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (annotationType == Path.class) {
                    ...
                    if (obj != null) {
                        ...
                        throw new IllegalArgumentException(AnonymousClass006.A09("Path parameter \"", value, "\" value must not be null."));
                    }
                    ...
                    if (obj != null) {
                        ...
                        throw new IllegalArgumentException(AnonymousClass006.A09("Path parameter \"", value2, "\" value must not be null."));
                    }
                    ...
                    if (obj != null) {
                        ...
                        for (Map.Entry entry : ((Map) obj).entrySet()) {
                            ...
                            if (key != null) {
                                ...
                                throw new IllegalArgumentException(AnonymousClass006.A04("Parameter #", i + 1, " field map contained null key."));
                            }
                        }
                        continue;
                    } else {
                    ...
                    if (obj != null) {
                        ...
                        multipartTypedOutput2.addPart(value6, encoding, body4);
                    }
                            ...
                            if (key2 != null) {
                                ...
                                if (value7 != null) {
                                    if (value7 instanceof TypedOutput) {
                                        ...
                                        body3 = (TypedOutput) value7;
                                    } else if (value7 instanceof String) {
                                        this.multipartBody.addPart(obj6, encoding2, new TypedString((String) value7));
                                    } else {
                                        multipartTypedOutput = this.multipartBody;
                                        body3 = this.converter.toBody(value7);
                                    }
                                    multipartTypedOutput.addPart(obj6, encoding2, body3);
                                }
                            } else {
                                throw new IllegalArgumentException(AnonymousClass006.A04("Parameter #", i + 1, " part map contained null key."));
                            }
                        }
                        continue;
                    } else {
                    ...
                    throw new IllegalArgumentException(AnonymousClass006.A07("Unknown annotation: ", annotationType.getCanonicalName()));
                } else if (obj != null) {
                    if (obj instanceof TypedOutput) {
    ...
    public RequestBuilder(String str, RestMethodInfo restMethodInfo, Converter converter2) {
        ...
        switch (requestType.ordinal()) {
            ...
            case 2:
                ...
                return;
            default:
                StringBuilder sb2 = new StringBuilder("Unknown request type: ");
    ...
    private void addQueryParamMap(int i, Map<?, ?> map, boolean z, boolean z2) {
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            if (key != null) {
                ...
                throw new IllegalArgumentException(AnonymousClass006.A04("Parameter #", i + 1, " query map contained null key."));
            }
        }
    }
    ...
    private void addPathParam(String str, String str2, boolean z) {
        if (str == null) {
            ...
            throw new IllegalArgumentException(AnonymousClass006.A09("Path replacement \"", str, "\" value must not be null."));
        } else if (z) {
            try {
                this.relativeUrl = this.relativeUrl.replace(AnonymousClass006.A09("{", str, "}"), URLEncoder.encode(str2, "UTF-8").replace("+", "%20"));
            } catch (UnsupportedEncodingException e) {
                throw new RuntimeException(AnonymousClass006.A0B("Unable to convert path parameter \"", str, "\" value to UTF-8:", str2), e);
            }
        } else {
            this.relativeUrl = this.relativeUrl.replace(AnonymousClass006.A09("{", str, "}"), str2);
        }
    }
    ...
    private void addQueryParam(String str, String str2, boolean z, boolean z2) {
        if (str == null) {
            ...
            try {
                ...
                throw new RuntimeException(AnonymousClass006.A0B("Unable to convert query parameter \"", str, "\" value to UTF-8: ", str2), e);
            }
        } else {
            throw new IllegalArgumentException(AnonymousClass006.A09("Query param \"", str, "\" value must not be null."));
        }
    }
