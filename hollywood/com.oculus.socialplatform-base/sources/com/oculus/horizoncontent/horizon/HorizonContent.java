...
public class HorizonContent {
    ...
    public static String TAG = LoggingUtil.tag(HorizonContent.class);
    ...
    public static class FriendList {
        ...
        public static void build(String str) {
            ...
            AUTHORITY = A07;
            String A072 = AnonymousClass006.A07("content://", A07);
            PARTY_GET_JOINABLE_PARTIES_URI = Uri.parse(AnonymousClass006.A07(A072, "/party_get_joinable"));
            GET_GROUP_LAUNCH_SUPPORTED_APPLICATIONS_URI = Uri.parse(AnonymousClass006.A07(A072, "/get_group_launch_supported_applications"));
            GET_GROUP_LAUNCH_APPLICATION_DESTINATIONS_URI = Uri.parse(AnonymousClass006.A07(A072, "/get_group_launch_application_destinations"));
            GET_APPS_SCOREBOARDS_INFO_URI = Uri.parse(AnonymousClass006.A07(A072, "/get_apps_scoreboards_info"));
            PARTY_GET_CURRENT = Uri.parse(AnonymousClass006.A07(A072, "/party_get_current"));
            PARTY_GET_CURRENT_V2 = Uri.parse(AnonymousClass006.A07(A072, "/party_get_current_v2"));
            PEOPLE_NEARBY_CONTENT_URI = Uri.parse(AnonymousClass006.A07(A072, "/people_nearby"));
            PYMK_CONTENT_URI = Uri.parse(AnonymousClass006.A07(A072, "/pymks"));
            PYMK_HIDE_USER = Uri.parse(AnonymousClass006.A07(A072, "/pymk_hide_user"));
            MESSAGE_SEND_TO_THREAD = Uri.parse(AnonymousClass006.A07(A072, "/message_send_to_thread"));
            FRIEND_REQUESTS_CONTENT_URI = Uri.parse(AnonymousClass006.A07(A072, "/friend_requests"));
            SOCIAL_FRIENDS_URI = Uri.parse(AnonymousClass006.A07(A072, "/get_friends"));
            USER_SEARCH = Uri.parse(AnonymousClass006.A07(A072, "/user_search"));
            USER_BLOCK = Uri.parse(AnonymousClass006.A07(A072, "/user_block"));
            USER_UNBLOCK = Uri.parse(AnonymousClass006.A07(A072, "/user_unblock"));
            FRIEND_SEND_REQUEST = Uri.parse(AnonymousClass006.A07(A072, "/friend_request_send"));
            FRIEND_ACCEPT_REQUEST = Uri.parse(AnonymousClass006.A07(A072, "/friend_request_accept"));
            FRIEND_REJECT_REQUEST = Uri.parse(AnonymousClass006.A07(A072, "/friend_reject_request"));
            FRIEND_CANCEL_REQUEST = Uri.parse(AnonymousClass006.A07(A072, "/friend_request_cancel"));
            FRIEND_REMOVE = Uri.parse(AnonymousClass006.A07(A072, "/friend_remove"));
            FRIEND_LIST_CONTENT_URI = Uri.parse(AnonymousClass006.A07(A072, "/party_invitable"));
            GET_SOCIAL_ACTIVITY = Uri.parse(AnonymousClass006.A07(A072, "/social_activity"));
            PARTY_INVITE_USERS_CONTENT_URI = Uri.parse(AnonymousClass006.A07(A072, "/party_invite_users"));
            PARTY_CREATE = Uri.parse(AnonymousClass006.A07(A072, "/party_create"));
            PARTY_JOIN = Uri.parse(AnonymousClass006.A07(A072, "/party_join"));
            PARTY_KICK = Uri.parse(AnonymousClass006.A07(A072, "/party_kick"));
            PARTY_LEAVE = Uri.parse(AnonymousClass006.A07(A072, "/party_leave"));
            PARTY_CANCEL_INVITE = Uri.parse(AnonymousClass006.A07(A072, "/party_cancel_invite"));
            PARTY_SET_TYPE = Uri.parse(AnonymousClass006.A07(A072, "/party_set_type"));
            PARTY_ACTIVATE_LINK_INVITE = Uri.parse(AnonymousClass006.A07(A072, "/party_activate_link_invite"));
            PARTY_DEACTIVATE_LINK_INVITE = Uri.parse(AnonymousClass006.A07(A072, "/party_deactivate_link_invite"));
            PARTY_SET_VOLUME = Uri.parse(AnonymousClass006.A07(A072, "/party_set_volume"));
            PARTY_GET_VOLUME = Uri.parse(AnonymousClass006.A07(A072, "/party_get_volume"));
            PARTY_SET_SELF_MUTE = Uri.parse(AnonymousClass006.A07(A072, "/party_set_self_mute"));
            PARTY_GET_SELF_MUTE = Uri.parse(AnonymousClass006.A07(A072, "/party_get_self_mute"));
            PARTY_SET_PER_PERSON_MUTE_STATUS = Uri.parse(AnonymousClass006.A07(A072, "/party_set_per_person_mute_status"));
            PARTY_SEND_MICROPHONE_INPUT_TO_APP = Uri.parse(AnonymousClass006.A07(A072, "/party_send_microphone_input_to_app"));
            PARTY_SEND_MICROPHONE_INPUT_TO_PARTY = Uri.parse(AnonymousClass006.A07(A072, "/party_send_microphone_input_to_party"));
            PARTY_GET_MICROPHONE_INPUT_LOCATION = Uri.parse(AnonymousClass006.A07(A072, "/party_get_microphone_input_location"));
            PARTY_GET_MICROPHONE_STATE = Uri.parse(AnonymousClass006.A07(A072, "/party_get_microphone_state"));
            PARTY_SET_MICROPHONE_STATE = Uri.parse(AnonymousClass006.A07(A072, "/party_set_microphone_state"));
            GET_PARTY_INFO_WITH_ACTIVITY = Uri.parse(AnonymousClass006.A07(A072, "/party_get_info_with_activity"));
            GET_PARTY_INVITES = Uri.parse(AnonymousClass006.A07(A072, "/get_party_invites"));
            GET_PARTY_INVITE_INFO = Uri.parse(AnonymousClass006.A07(A072, "/get_party_invite_info"));
            GET_PARTY_PRIVACY_INFO = Uri.parse(AnonymousClass006.A07(A072, "/get_party_privacy_info"));
            GET_PARTY_INVITE_INFO_WITH_NONCE = Uri.parse(AnonymousClass006.A07(A072, "/get_party_invite_info_with_nonce"));
            GET_LINKED_ACCOUNTS_INFO = Uri.parse(AnonymousClass006.A07(A072, "/get_linked_accounts_info"));
            GET_PARTY_FBID = Uri.parse(AnonymousClass006.A07(A072, "/get_party_fbid"));
            GET_PARTY_HAS_PARTICIPANT_RECENTLY_SPOKEN = Uri.parse(AnonymousClass006.A07(A072, "/get_party_has_participant_recently_spoken"));
            PARTY_PROPOSED_GROUP_LAUNCH_DESTINATION_CREATE = Uri.parse(AnonymousClass006.A07(A072, "/party_proposed_group_launch_destination_create"));
            PARTY_PROPOSED_GROUP_LAUNCH_DESTINATION_REMOVE = Uri.parse(AnonymousClass006.A07(A072, "/party_proposed_group_launch_destination_remove"));
            GROUP_LAUNCH_SET_USER_RESPONSE = Uri.parse(AnonymousClass006.A07(A072, "/group_launch_user_response"));
            GET_PROFILE_CONTENT = Uri.parse(AnonymousClass006.A07(A072, "/get_profile_content"));
            GROUP_LAUNCH_LAUNCH_HANDLE = Uri.parse(AnonymousClass006.A07(A072, "/group_launch_launch_handle"));
            GROUP_LAUNCH_SOLO_LAUNCH_HANDLE = Uri.parse(AnonymousClass006.A07(A072, "/group_launch_solo_launch_handle"));
            PROFILE_SET_BIO = Uri.parse(AnonymousClass006.A07(A072, "/profile_set_bio"));
            GROUP_LAUNCH_SET_STATE = Uri.parse(AnonymousClass006.A07(A072, "/group_launch_set_state"));
            GET_SOCIAL_VIEWER = Uri.parse(AnonymousClass006.A07(A072, "/get_social_viewer"));
            GET_VR_PROFILE_CONTENT = Uri.parse(AnonymousClass006.A07(A072, "/get_vr_profile_content"));
            GET_FB_FRIEND_PRIMARY_PROFILE = Uri.parse(AnonymousClass006.A07(A072, "/get_fb_friend_primary_profile"));
            GET_BLOCKED_USER_ID = Uri.parse(AnonymousClass006.A07(A072, "/get_blocked_id"));
            SET_NUX_FLAG_FOR_USER = Uri.parse(AnonymousClass006.A07(A072, "/set_nux_flag_for_user"));
            GET_ROSTER_SIZE = Uri.parse(AnonymousClass006.A07(A072, "/get_roster_size"));
        }
    }
    ...
    public static void runOncePartyInfraGKFetched(Context context, @Nullable final PartyInfraGKCallback partyInfraGKCallback) {
        if (!sWasPartyInfraGKFetched.get() || partyInfraGKCallback == null) {
            ...
            DeviceConfigHelper.getDeviceBooleanAsync(context, PARTY_INFRA_GK_MC, new DeviceConfigHelper.GetDeviceBooleanCallback() {
                ...
                public void onValue(boolean z) {
                    String str;
                    if (z) {
                        str = "com.oculus.socialplatform";
                    } else {
                        str = "com.oculus.horizon";
                    }
                    HorizonContent.build(str);
