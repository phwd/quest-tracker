...
public class QuickPromotionGraphQL {
    ...
    public static final String PARAM_PROMOTION_LOGGING_DATA = "promotion_logging_data";
    public static final String PARAM_SURFACE_NUX_ID = "surface_nux_id";
    public static final String PARAM_TRIGGER_NAME = "trigger_name";
    public static final String PROMOTION_ACTION_FIELDS = "dismiss_promotion,limit,title_text,url,";
    ...
    public static final String PROMOTION_FILTER_CLAUSE_FIELDS = "clause_type,filters {extra_datas {name,required,bool_value,color_value,float_value,int_value,string_value,uri_value,},filter_type,unknown_action,value {name,required,bool_value,color_value,float_value,int_value,string_value,uri_value,},},";
    public static final String PROMOTION_IMAGE_FIELDS = "dimensionless_cache_key,height,is_silhouette,mime_type,name,scale,uri,width,";
    public static final String PROMOTION_PARAMETER_FIELDS = "name,required,bool_value,color_value,float_value,int_value,string_value,uri_value,";
    public static final String PROMOTION_TEMPLATE_FIELDS = "name,parameters {name,required,bool_value,color_value,float_value,int_value,string_value,uri_value,}";
    ...
    public static JSONObject getParamsForAction(String str, String str2, int i, String str3, String str4) {
        try {
            ...
            jSONObject2.put(PARAM_EVENT, EVENT_ACTION);
    ...
    public static JSONObject getParamsForExposure(String str, String str2, int i, String str3) {
        try {
            ...
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("client_mutation_id", UUID.randomUUID().toString());
            jSONObject2.put(PARAM_EVENT, EVENT_EXPOSURE);
            jSONObject2.put("promotion_id", str);
            jSONObject2.put(PARAM_PROMOTION_LOGGING_DATA, str2);
            jSONObject2.put(PARAM_SURFACE_NUX_ID, i);
            jSONObject2.put(PARAM_TRIGGER_NAME, str3);
    ...
    public static JSONObject getParamsForView(String str, String str2, int i, String str3) {
        try {
            ...
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("client_mutation_id", UUID.randomUUID().toString());
            jSONObject2.put(PARAM_EVENT, EVENT_VIEW);
            jSONObject2.put("promotion_id", str);
            jSONObject2.put(PARAM_PROMOTION_LOGGING_DATA, str2);
            jSONObject2.put(PARAM_SURFACE_NUX_ID, i);
            jSONObject2.put(PARAM_TRIGGER_NAME, str3);
