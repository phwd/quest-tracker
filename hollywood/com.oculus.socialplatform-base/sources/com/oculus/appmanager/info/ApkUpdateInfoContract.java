...
public class ApkUpdateInfoContract {
    ...
    public static final int STATE_QUEUED = 655376;
    ...
    public static class ApkUpdateTable {
        ...
        public static class Columns {
            public static Column ACCESS_TOKEN = new Column("access_token", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column BASE_VERSION = new Column("base_version", LocalMediaContract.ExtrasTable.ColumnsTypes.INTEGER);
            @Deprecated
            public static Column BINARY_ID = new Column("binary_id", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column DEPENDENCIES = new Column("dependencies", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column DISPLAY_TITLE = new Column("display_title", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column DOWNLOAD_CHECKSUM = new Column("checksum_hash", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column DOWNLOAD_CHECKSUM_ALG = new Column("checksum_hash_alg", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column DOWNLOAD_SIZE = new Column(ApkUpdateInfoContract.EXTRA_DOWNLOADED_SIZE, LocalMediaContract.ExtrasTable.ColumnsTypes.INTEGER);
            public static Column DOWNLOAD_URL = new Column("download_url", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column EXTERNAL_SIGNATURES = new Column("external_signatures", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column ID = new Column("_id", "INTEGER PRIMARY KEY AUTOINCREMENT");
            public static Column IDENTIFIER = new Column("package_name", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column IS_UPDATE = new Column("is_update", LocalMediaContract.ExtrasTable.ColumnsTypes.INTEGER);
            public static Column ITEM_ID = new Column("item_id", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column REQUESTING_PACKAGE = new Column(FriendListContentProviderLogger.EXTRA_REQUESTING_PACKAGE, LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column REQUEST_HEADERS = new Column("request_headers", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column REQUEST_ORIGIN = new Column("request_origin", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column SIGNATURE = new Column("signature", LocalMediaContract.ExtrasTable.ColumnsTypes.TEXT);
            public static Column TARGET_VERSION = new Column("version", LocalMediaContract.ExtrasTable.ColumnsTypes.INTEGER);
            public static Column UPDATE_TYPE = new Column("update_type", LocalMediaContract.ExtrasTable.ColumnsTypes.INTEGER);
        }
    }
    ...
    public enum UpdateState implements IntegerBasedEnum, Comparator<UpdateState> {
        ...
        QUEUED(ApkUpdateInfoContract.STATE_QUEUED),
        ...
        public int compare(UpdateState updateState, UpdateState updateState2) {
            return (updateState2.asInt() & Settings.DEFAULT_INITIAL_WINDOW_SIZE) - (updateState.asInt() & Settings.DEFAULT_INITIAL_WINDOW_SIZE);
        }
    }
    ...
    public static <T extends Enum & IntegerBasedEnum> T fromEnumInt(Class<T> cls, int i) {
        ...
        throw new IllegalArgumentException(AnonymousClass006.A08(cls.getSimpleName(), " int : ", i));
    }
}
