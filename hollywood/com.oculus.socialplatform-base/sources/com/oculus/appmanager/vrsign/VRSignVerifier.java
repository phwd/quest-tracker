...
public class VRSignVerifier {
    ...
    public final AnonymousClass1RK mVerifier;

    @AutoGeneratedAccessMethod
    public static final AbstractC03180ld _UL__ULSEP_com_facebook_inject_Lazy_ULLT_com_oculus_appmanager_vrsign_VRSignVerifier_ULGT__ULSEP_ACCESS_METHOD(AnonymousClass0lg r1) {
        return AnonymousClass0Hr.A00(2105, r1);
    }

    @AutoGeneratedAccessMethod
    public static final VRSignVerifier _UL__ULSEP_com_oculus_appmanager_vrsign_VRSignVerifier_ULSEP_ACCESS_METHOD(AnonymousClass0lg r2) {
        return (VRSignVerifier) AnonymousClass1TK.A00(2105, r2, null);
    }

    @AutoGeneratedFactoryMethod
    public static final VRSignVerifier _UL__ULSEP_com_oculus_appmanager_vrsign_VRSignVerifier_ULSEP_FACTORY_METHOD(AnonymousClass0lg r0, Object obj) {
        return new VRSignVerifier();
    }

    @AutoGeneratedAccessMethod
    public static final Provider _UL__ULSEP_javax_inject_Provider_ULLT_com_oculus_appmanager_vrsign_VRSignVerifier_ULGT__ULSEP_ACCESS_METHOD(AnonymousClass0lg r1) {
        return AnonymousClass0VC.A00(2105, r1);
    }
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        sb.append(vRSignVerifier.verifyVRSig(str));
        printStream.println(sb.toString());
    }

    public boolean verifyOculusSig(String str, InputStream inputStream) throws IOException {
        return this.mVerifier.A00(new ByteArrayInputStream(AnonymousClass006.A07("﻿", str).getBytes("UTF-16LE")), inputStream);
    }
    ...
    public boolean verifyVRSig(String str) throws IOException {
        ...
        if (jarEntries.size() == 1) {
            ...
            for (JarEntry jarEntry : getJarEntries(jarFile, ".OSIG")) {
                if (this.mVerifier.A00(inputStream, jarFile.getInputStream(jarEntry))) {
                    return true;
                }
            }
            return false;
        }
        throw new IOException(AnonymousClass006.A03("expected one .SF file, got ", jarEntries.size()));
    }

    @Inject
    public VRSignVerifier() {
        try {
            this.mVerifier = new AnonymousClass1RK((X509Certificate) CertificateFactory.getInstance("X.509").generateCertificate(new ByteArrayInputStream(CERT)));
        } catch (CertificateException e) {
            throw new RuntimeException(e);
        }
    }

    public static List<JarEntry> getJarEntries(JarFile jarFile, String str) {
