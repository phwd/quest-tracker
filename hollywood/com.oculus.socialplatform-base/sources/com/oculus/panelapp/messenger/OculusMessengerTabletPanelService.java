...
public class OculusMessengerTabletPanelService extends PanelService {
    public static final String TAG = LoggingUtil.tag(OculusMessengerTabletPanelService.class);
    @Nullable
    public OculusMessengerTabletPanelApp mApp;
    ...
    public long createNativePanelAppInstance(Surface surface, Map<String, Surface> map, Bundle bundle) {
        this.mApp = new OculusMessengerTabletPanelApp(getApplication(), getApplicationContext(), surface, map, bundle);
