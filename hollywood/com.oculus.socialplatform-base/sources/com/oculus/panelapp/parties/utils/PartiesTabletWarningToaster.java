...
public final class PartiesTabletWarningToaster {
    public static void showErrorToast(Context context, String str, String str2, String str3) {
        showToast(context, str, context.getResources().getString(R.string.parties_tablet_error_toast_title), str2, R.drawable.ic_notif_alert, str3);
    }
