...
public class SocialPartyUtils {
    public static final String TAG = LoggingUtil.tag(SocialPartyUtils.class);

    public static JSONObject buildSocialPartyShareSheetParams(String str) throws JSONException {
