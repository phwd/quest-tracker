...
public class GraphQLVRLifecycleParams {
    ...
    public String toString() {
        ...
        A04.put(ARGUMENT_DEVICE_ID, this.deviceId);
        A04.put(ARGUMENT_LAST_APPS_IN_VR, this.lastAppsInVR);
        A04.put(ARGUMENT_SESSION_LENGTH_MS, Long.valueOf(this.sessionLengthMs));
        A04.put(ARGUMENT_TIME_SINCE_SESSION_MS, Long.valueOf(this.timeSinceSessionMs));
        return GraphQLParamsHelper.encodeMutationParams(A04.build(), ImmutableMap.A04().build());
    }
}
