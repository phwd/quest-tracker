...
public class HasSeenActivityPrivacyUpdateRoadblockResponse implements ValidatableApiResponse {
    ...
    public void validate() throws RuntimeException {
        ...
        if (viewer2 == null) {
            throw new NullPointerException("Received an invalid HasSeenActivityPrivacyUpdateRoadblockResponse. Response didn't have a viewer");
        } else if (viewer2.social_settings_info == null) {
            throw new NullPointerException("Received an invalid HasSeenActivityPrivacyUpdateRoadblockResponse. Viewer didn't have a social_settings_info");
        }
    }
}
