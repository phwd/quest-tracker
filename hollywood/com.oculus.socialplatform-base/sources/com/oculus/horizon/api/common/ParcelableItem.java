...
public class ParcelableItem extends Item implements Parcelable {
    ...
    public ParcelableItem(Parcel parcel) {
        ...
        this.quality_rating_histogram_aggregate = arrayList;
        parcel.readList(arrayList, Item.QualityRatingHistogram.class.getClassLoader());
        ArrayList arrayList2 = new ArrayList();
        this.quality_ratings_by_viewer = arrayList2;
        parcel.readList(arrayList2, Item.QualityRating.class.getClassLoader());
        boolean z = false;
    ...
    public static ParcelableItem from(InAppItem inAppItem) {
        return new ParcelableItem(inAppItem.__typename, inAppItem.id, inAppItem.display_name, inAppItem.display_long_description, null, null, null, null, null, inAppItem.cover_landscape_image, null, null, null, AndroidPanelLayer.Spec.DEFAULT_CYLINDER_POSITION_Z, null, null, false, null, null, false, false, null, Integer.MIN_VALUE, Integer.MIN_VALUE);
    }
