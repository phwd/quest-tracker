...
public class GraphQLNotificationsFeedQuery {
    ...
    public static final String NOTIFICATION_BUCKET_SETTINGS_QUERY = "key,name,description,opt_out_value";
    public static final String NOTIFICATION_DEV_SETTINGS_QUERY = "app_group_id,name,opt_out_value";
    public static final String NOTIFICATION_QUERY_V2 = "id,uuid,is_read,notification_type,notification_preference_type,rendered_notification {title,message,extra_data,},seen_state,send_time,sender {alias,name,},";
    public static final String RENDERED_NOTIFICATION_FIELDS = "title,message,extra_data,";
    public static final String SENDER_FIELDS = "alias,name,";
}
