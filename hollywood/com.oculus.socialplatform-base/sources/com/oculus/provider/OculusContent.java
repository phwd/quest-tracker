...
public class OculusContent {
    ...
    public static final Uri CONTENT_URI = Uri.parse(AnonymousClass006.A07("content://", "com.oculus.horizon"));
    ...
    public static class Gatekeeper {
        ...
        static {
            String A07 = AnonymousClass006.A07("com.oculus.horizon", ".gatekeeper");
            AUTHORITY = A07;
            CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", A07, "/fetch"));
        }
    }
    ...
    public static class PartyCalls {
        ...
        public static final Uri INCOMING_CALLS_CONTENT_URI;

        static {
            String A07 = AnonymousClass006.A07("com.oculus.horizon", ".livestreaming");
            AUTHORITY = A07;
            INCOMING_CALLS_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", A07, "/incoming_calls"));
        }
    }
    ...
    public static class PartyVideoStreams {
        ...
        static {
            String A07 = AnonymousClass006.A07("com.oculus.horizon", ".livestreaming");
            AUTHORITY = A07;
            CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", A07, "/party_video_streams"));
        }
    }
    ...
    public static class Platform {
        ...
        static {
            String A07 = AnonymousClass006.A07("com.oculus.horizon", ".platformsdk");
            AUTHORITY = A07;
            CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", A07, "/query"));
        }
    }

    public static class Profile {
        public static final Uri CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", "com.oculus.horizon", TabletDeepLinkingUriUtil.AUI_PROFILE_URI));
        ...
        public static Uri getUriFromNuxPref(String str) {
            if (!TextUtils.isEmpty(str)) {
                return new Uri.Builder().scheme(LoggingKeys.REFERRER_CONTENT).authority("com.oculus.horizon").path("profile").appendPath(str).build();
            }
    ...
    public static class FriendList {
        ...
        public static Uri GET_ROSTER_SIZE = null;
        ...
        public static Uri PARTY_GET_MICROPHONE_STATE = null;
        ...
        public static final String PARTY_MIC_STATE = "party_mic_state";
        ...
        public static Uri PARTY_SET_MICROPHONE_STATE = null;
        ...
        public static class RosterSizeType {
            public static final int APPLICATION_INVITES = 1;
            public static final int LOBBY_ROSTER = 0;
        }
        ...
        public static void rebuild(String str) {
            String A07 = AnonymousClass006.A07(str, ".friendlist");
            AUTHORITY = A07;
            GET_FRIENDS_URI = Uri.parse(AnonymousClass006.A09("content://", A07, "/get_friends"));
            GET_PARTY_INVITES = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_invites"));
            GET_PARTY_INVITE_INFO = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_invite_info"));
            GET_PARTY_PRIVACY_INFO = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_privacy_info"));
            GET_PARTY_INVITE_INFO_WITH_NONCE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_invite_info_with_nonce"));
            GET_ROSTER_SIZE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_roster_size"));
            PARTY_GET_JOINABLE_PARTIES_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_joinable"));
            GET_PARTY_FBID = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_fbid"));
            GET_GROUP_LAUNCH_SUPPORTED_APPLICATIONS_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_group_launch_supported_applications"));
            GET_GROUP_LAUNCH_APPLICATION_DESTINATIONS_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_group_launch_application_destinations"));
            GET_APP_SCOREBOARDS_INFO_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_app_scoreboards_info"));
            GET_APPS_SCOREBOARDS_INFO_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_apps_scoreboards_info"));
            PARTY_GET_CURRENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_current"));
            PARTY_GET_CURRENT_URI_V2 = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_current_v2"));
            PEOPLE_NEARBY_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/people_nearby"));
            PYMK_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/pymks"));
            PYMK_HIDE_USER = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/pymk_hide_user"));
            MESSAGE_SEND_TO_THREAD = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/message_send_to_thread"));
            FRIEND_REQUESTS_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_requests"));
            FRIEND_LIST_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_invitable"));
            USER_BLOCK = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/user_block"));
            USER_UNBLOCK = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/user_unblock"));
            FRIEND_SEND_REQUEST = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_request_send"));
            FRIEND_ACCEPT_REQUEST = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_request_accept"));
            FRIEND_REJECT_REQUEST = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_reject_request"));
            FRIEND_CANCEL_REQUEST = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_request_cancel"));
            FRIEND_REMOVE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/friend_remove"));
            GET_SOCIAL_ACTIVITY = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/social_activity"));
            PARTY_INVITE_USERS_CONTENT_URI = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_invite_users"));
            PARTY_CREATE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_create"));
            PARTY_JOIN = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_join"));
            PARTY_JOIN_WITH_ERROR_CALLBACK = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_join_with_error_callback"));
            PARTY_LEAVE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_leave"));
            PARTY_CANCEL_INVITE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_cancel_invite"));
            PARTY_SET_TYPE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_set_type"));
            PARTY_ACTIVATE_LINK_INVITE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_activate_link_invite"));
            PARTY_DEACTIVATE_LINK_INVITE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_deactivate_link_invite"));
            PARTY_KICK = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_kick"));
            PARTY_PROPOSED_GROUP_LAUNCH_DESTINATION_CREATE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_proposed_group_launch_destination_create"));
            PARTY_PROPOSED_GROUP_LAUNCH_DESTINATION_REMOVE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_proposed_group_launch_destination_remove"));
            PARTY_SET_VOLUME = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_set_volume"));
            PARTY_GET_VOLUME = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_volume"));
            PARTY_SET_SELF_MUTE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_set_self_mute"));
            PARTY_GET_SELF_MUTE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_self_mute"));
            PARTY_SET_PER_PERSON_MUTE_STATUS = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_set_per_person_mute_status"));
            PARTY_GET_INFO_WITH_ACTIVITY = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_info_with_activity"));
            PARTY_SEND_MICROPHONE_INPUT_TO_APP = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_send_microphone_input_to_app"));
            PARTY_SEND_MICROPHONE_INPUT_TO_PARTY = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_send_microphone_input_to_party"));
            PARTY_GET_MICROPHONE_INPUT_LOCATION = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_microphone_input_location"));
            PARTY_SET_MICROPHONE_STATE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_set_microphone_state"));
            PARTY_GET_MICROPHONE_STATE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_microphone_state"));
            GET_LINKED_ACCOUNTS_INFO = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_linked_accounts_info"));
            GET_PARTY_HAS_PARTICIPANT_RECENTLY_SPOKEN = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_party_has_participant_recently_spoken"));
            PARTY_GET_INFO_WITH_MEMBERS = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/party_get_info_with_members"));
            GROUP_LAUNCH_SET_USER_RESPONSE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/group_launch_user_response"));
            GROUP_LAUNCH_LAUNCH_HANDLE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/group_launch_launch_handle"));
            GROUP_LAUNCH_SOLO_LAUNCH_HANDLE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/group_launch_solo_launch_handle"));
            GET_PROFILE_CONTENT = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_profile_content"));
            PROFILE_SET_BIO = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/profile_set_bio"));
            GET_FB_FRIEND_PRIMARY_PROFILE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_fb_friend_primary_profile"));
            GROUP_LAUNCH_SET_STATE = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/group_launch_set_state"));
            GET_SOCIAL_VIEWER = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_social_viewer"));
            GET_VR_PROFILE_CONTENT = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_vr_profile_content"));
            USER_SEARCH = C02980kg.A00(AnonymousClass006.A09("content://", AUTHORITY, "/user_search"));
            GET_BLOCKED_USER_ID = Uri.parse(AnonymousClass006.A09("content://", AUTHORITY, "/get_blocked_id"));
            SET_NUX_FLAG_FOR_USER = C02980kg.A00(AnonymousClass006.A09("content://", AUTHORITY, "/set_nux_flag_for_user"));
        }
    }
}
