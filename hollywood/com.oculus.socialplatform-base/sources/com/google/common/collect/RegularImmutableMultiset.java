...
public class RegularImmutableMultiset<E> extends ImmutableMultiset<E> {
    public static final RegularImmutableMultiset<Object> A03 = new RegularImmutableMultiset<>(new AnonymousClass0vu());
    @LazyInit
    public transient ImmutableSet<E> A00;
    public final transient AnonymousClass0vu<E> A01;
    ...
    public final class ElementSet extends IndexedImmutableSet<E> {
        ...
        public final E A0L(int i) {
            AnonymousClass0vu<E> r1 = RegularImmutableMultiset.this.A01;
    ...
    public static class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            AnonymousClass0fM r3 = new AnonymousClass0fM(this.elements.length);
            int i = 0;
            while (true) {
        ...
        public SerializedForm(AbstractC05490vp<?> r6) {
            int size = r6.entrySet().size();
            this.elements = new Object[size];
            this.counts = new int[size];
            int i = 0;
            for (AnonymousClass0f2 r2 : r6.entrySet()) {
    ...
    public final ImmutableSet<E> A0K() {
    ...
    @Override // com.google.common.collect.ImmutableMultiset
    public final Multiset.Entry<E> A0L(int i) {
    ...
    public RegularImmutableMultiset(AnonymousClass0vu<E> r6) {
        this.A01 = r6;
        long j = 0;
        int i = 0;
        while (true) {
            ...
            if (i < i2) {
                ...
                this.A02 = AnonymousClass105.A00(j);
                return;
            }
        }
    }
