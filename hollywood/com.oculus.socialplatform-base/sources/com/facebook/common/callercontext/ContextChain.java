...
public final class ContextChain implements Parcelable {
    public static final Parcelable.Creator<ContextChain> CREATOR = new AnonymousClass0HS();
    @Nullable
    public String A00;
    ...
    public final String toString() {
        ...
        String A09 = AnonymousClass006.A09(this.A04, ":", this.A03);
        this.A00 = A09;
        ContextChain contextChain = this.A02;
        if (contextChain == null) {
            return A09;
        }
        String A022 = AnonymousClass006.A02(contextChain.toString(), '/', this.A00);
        this.A00 = A022;
        return A022;
    }
