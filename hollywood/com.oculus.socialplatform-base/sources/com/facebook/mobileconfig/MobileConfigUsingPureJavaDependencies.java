...
public class MobileConfigUsingPureJavaDependencies {
    ...
    public static native HybridData initHybrid(@Nullable AndroidAsyncExecutorFactory androidAsyncExecutorFactory, @Nullable MobileConfigFetcher mobileConfigFetcher, boolean z, @Nullable MobileConfigCxxLogger mobileConfigCxxLogger);
