...
@DoNotOptimize
public final class ErrorReporter implements AnonymousClass0IE {
    ...
    public static class AcraReportHandler implements ReportHandler {
        ...
        public boolean handleReport(ErrorReporter errorReporter, Spool.FileBeingConsumed fileBeingConsumed, String str, boolean z) {
            ...
            try {
                ...
                AnonymousClass0MD.A0C("ACRA", e, "Failed to send crash reports");
                ErrorReporter.deleteFile(file);
                return false;
            } catch (IOException e2) {
                AnonymousClass0MD.A0E("ACRA", e2, "Failed to load crash report for %s", name);
                ErrorReporter.deleteFile(file);
                return false;
            } catch (ReportSenderException e3) {
                AnonymousClass0MD.A0E("ACRA", e3, "Failed to send crash report for %s", name);
                return false;
            }
        }
    ...
    private void buildAttachmentWrapperCrashReport(CrashReportData crashReportData, CrashReportType crashReportType, @Nullable Spool.FileBeingConsumed fileBeingConsumed, @Nullable Writer writer, boolean z) {
        try {
            ...
            put(ReportField.REPORT_LOAD_THROW, AnonymousClass006.A07("retrieve exception: ", th.getMessage()), crashReportData, writer);
        }
    }
    ...
    public static boolean deleteFile(File file) {
        ...
        file.getName();
        if (!delete) {
            AnonymousClass0MD.A0A("ACRA", "Could not delete error report: %s", file.getName());
        }
        return delete;
    }
    ...
    private int maybeSendCrashReport(CrashReportType crashReportType, CrashReportData crashReportData, @Nullable Spool.FileBeingConsumed fileBeingConsumed, @Nullable FileGenerator fileGenerator, boolean z) throws Throwable {
            ...
            try {
                ...
                if (0 != 0) {
                    try {
                        ...
                        AnonymousClass0MD.A0C("ACRA", e, "IO Exception");
        ...
        try {
            ...
            AnonymousClass0MD.A0C("ACRA", e2, "IO Exception");
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private int processCrashAttachmentsLocked(int r14, com.facebook.acra.ErrorReporter.CrashReportType r15, @javax.annotation.Nullable com.facebook.acra.FileGenerator r16, boolean r17) {
        /*
    ...
    private void uncaughtExceptionImpl(Thread thread, Throwable th, boolean z) throws Throwable {
        ...
        int i = 3;
        try {
            AnonymousClass0MD.A09("ACRA", "ACRA caught a %s exception for %s version %s. Building report.", th.getClass().getSimpleName(), this.mContext.getPackageName(), this.mAppVersionCode);
        } catch (Throwable th3) {
        ...
        if (translateException != null) {
            ...
            try {
                synchronized (AnonymousClass0N1.class) {
                    r0 = AnonymousClass0N1.A00;
                    if (r0 == null) {
                        r0 = new AnonymousClass0N1();
                        AnonymousClass0N1.A00 = r0;
                    }
                }
                synchronized (r0) {
                }
                ...
                if (!z) {
                    AnonymousClass0MD.A0C("ACRA", th4, "error during error reporting: will attempt to report error");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001b, code lost:
        r3 = new java.io.FileOutputStream(new java.io.File(X.AnonymousClass006.A07(r1, com.facebook.acra.ErrorReporter.ANR_EXTRA_PROPERTIES_EXTENSION)), true);
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    try {
                        AnonymousClass0MD.A0C("ACRA", e, "GLC getNewLibs IO Exception");
                        safeClose(closeable);
    ...
    private void addCriticalData() {
        ...
        for (Map.Entry<String, String> entry : CriticalAppData.getAdditionalParamValues(this.mContext).entrySet()) {
            ...
            if (!TextUtils.isEmpty(value)) {
                putCustomDataInternal(entry.getKey(), value);
            }
        }
    }
    ...
    private void checkNativeReportsOnApplicationStart() {
        ...
        int roughlyCountPendingReportsOfType = roughlyCountPendingReportsOfType(crashReportType);
        ...
        if (maxPendingMiniDumpReports < Integer.MAX_VALUE && roughlyCountPendingReportsOfType > maxPendingMiniDumpReports) {
            AnonymousClass0MD.A0A(TAG, "Minidump count above threshold %d", Integer.valueOf(roughlyCountPendingReportsOfType));
            removeCrashFiles(crashReportType, roughlyCountPendingReportsOfType - maxPendingMiniDumpReports);
        }
        if (roughlyCountPendingReportsOfType > 5) {
            ReportsSenderWorker reportsSenderWorker = new ReportsSenderWorker(this, crashReportType);
    ...
    private File createBackUpDirectory(CrashReportType crashReportType) {
        ...
        try {
            ...
            try {
                ...
                e = e2;
                AnonymousClass0MD.A0E("ACRA", e, "Failed to create backup directory %s", REPORTED_CRASH_DIR);
                return file;
            }
    ...
    private CrashReportData createCrashReportFromStackTrace(String str, CrashReportType crashReportType) {
        ...
        try {
            ...
            e.printStackTrace();
            crashReportData.put(ReportField.REPORT_LOAD_THROW, AnonymousClass006.A07("throwable: ", e.getMessage()));
            AnonymousClass0MD.A0C("ACRA", e, "Could not load crash report. File will be deleted.");
        }
    ...
    public static String getLogcatFileName(Spool.FileBeingConsumed fileBeingConsumed, CrashReportType crashReportType) {
        ...
        try {
            ...
            AnonymousClass0MD.A0E("ACRA", e, "Failed to find logcat file %s", fileBeingConsumed.fileName);
            return null;
        }
    }

    public static Throwable getMostSignificantCause(Throwable th) {
        if (!(th instanceof AnonymousClass0N2)) {
    ...
    private void maybeRemoveAnrReports() {
        CrashReportType crashReportType = CrashReportType.CACHED_ANR_REPORT;
        int roughlyCountPendingReportsOfType = roughlyCountPendingReportsOfType(crashReportType);
        ...
        if (maxPendingAnrReports < Integer.MAX_VALUE && roughlyCountPendingReportsOfType > maxPendingAnrReports) {
            AnonymousClass0MD.A0A(TAG, "Anr count %d above threshold %d", Integer.valueOf(roughlyCountPendingReportsOfType), Integer.valueOf(maxPendingAnrReports));
            removeCrashFiles(crashReportType, roughlyCountPendingReportsOfType - maxPendingAnrReports);
        }
    }
    ...
    public static void putCustomDataInternal(String str, @Nullable String str2) {
        ...
        if (i > 0) {
            try {
                Spool.Snapshot snapshot = crashReportType.getSpool(this.mContext).snapshot(new FifoSpoolComparator(), new FilenameFilter() {
                    /* class com.facebook.acra.ErrorReporter.AnonymousClass6 */
                ...
                if (snapshot == null) {
                    AnonymousClass0MD.A05(TAG, "removeCrashFiles no snapshot");
                    return;
                }
                    ...
                    if (next.fileName != null) {
                        ...
                        if (strArr != null) {
                            for (String str : strArr) {
                                new File(AnonymousClass006.A07(next.fileName.getCanonicalPath(), str)).delete();
                            }
                        }
                        if (!next.fileName.delete()) {
                            AnonymousClass0MD.A0A(TAG, "removeCrashFiles Crash file not deleted %s", next.fileName.getAbsolutePath());
                        } else {
                            i--;
                        }
                    }
                ...
                AnonymousClass0MD.A0C(TAG, th, "removeCrashFiles");
            }
        }
    }

    public static void removeCustomDataInternal(@Nullable String str) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    if (z) {
                        AnonymousClass0MD.A0F("ACRA", e, "ReportSender of class %s failed but other senders completed their task. ACRA will not send this report again.", reportSender.getClass().getName());
    ...
    private void slurpAttachment(CrashReportData crashReportData, InputStream inputStream, CrashReportType crashReportType, long j) throws IOException {
        if (crashReportType == CrashReportType.NATIVE_CRASH_REPORT) {
            try {
                ...
                AnonymousClass0MD.A0D(TAG, e, "error attaching activity information");
            }
            try {
                attachIabInfo(crashReportData);
            } catch (IOException e2) {
                AnonymousClass0MD.A0D(TAG, e2, "error attaching IAB information");
            }
        }
    ...
    @javax.annotation.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.lang.Throwable translateException(java.lang.Throwable r8, java.util.Map<java.lang.String, java.lang.String> r9) {
        /*
            r7 = this;
            java.util.concurrent.atomic.AtomicReference<com.facebook.acra.ExceptionTranslationHook> r0 = r7.mExceptionTranslationHook
            java.lang.Object r6 = r0.get()
            com.facebook.acra.ExceptionTranslationHook r6 = (com.facebook.acra.ExceptionTranslationHook) r6
            r5 = 0
        L_0x0009:
            r4 = r6
        L_0x000a:
            ...
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ all -> 0x0017 }
        ...
        L_0x0017:
            ...
            X.AnonymousClass0MD.A0F(r2, r3, r0, r1)
    ...
    private boolean writeJsonReport(CrashReportData crashReportData) {
        ...
        File file = new File(this.mContext.getDir(ErrorReportingConstants.TRACE_UPLOAD_DIR, 0), AnonymousClass006.A07(str, ".gz"));
        HashMap hashMap = new HashMap();
        for (Map.Entry<String, InputStreamField> entry : crashReportData.mInputStreamFields.entrySet()) {
    ...
    private void writeToLogBridge(String str, String str2, Throwable th, @Nullable String str3) {
        ...
        for (StackTraceElement stackTraceElement2 : stackTrace) {
            if (stackTraceElement2.getClassName().equals(stackTraceElement.getClassName()) && stackTraceElement2.getMethodName().equals(stackTraceElement.getMethodName())) {
                AnonymousClass0MD.A0C(TAG, th, "Unable to log over log bridge due to exception.");
                return;
            }
        }
        ...
        if (logBridge != null) {
            if (str3 != null) {
                str2 = AnonymousClass006.A09(str2, "\n", str3);
                th = null;
            }
            logBridge.log(str, str2, th);
        } else if (str3 != null) {
            AnonymousClass0MD.A09(str, "%s\n%s", str2, str3);
        } else {
            AnonymousClass0MD.A0E(str, th, "%s", str2);
        }
    }
    ...
    public boolean addToAnrInProgressUpdateFile(Map<String, String> map) throws IOException {
        synchronized (this.mAnrFilesInProgress) {
            ...
            FileOutputStream fileOutputStream = new FileOutputStream(new File(AnonymousClass006.A07(this.mAnrFilesInProgress.iterator().next(), ANR_EXTRA_PROPERTIES_EXTENSION)), true);
    ...
    public String getLogcatOutputIfPidFound(boolean z, @Nullable Integer num) {
        ...
        if (collectLogCat == null || (num != null && !Pattern.compile(AnonymousClass006.A09("^\\d+-\\d+\\s+\\d+:\\d+:\\d+\\.\\d+\\s+", num.toString(), "\\s+\\d+\\s+[A-Z]\\s+(.*?)$"), 8).matcher(collectLogCat).find())) {
            return null;
        }
    ...
    public void handleUncaughtException(Thread thread, Throwable th, @Nullable AnonymousClass0I9 r7) {
        ...
        AnonymousClass0MD.A0E(TAG, th, "Maximum pending Java crash threshold reached, Not storing count=%d", Integer.valueOf(roughlyCountPendingReportsOfType));
    }
    ...
    public void reportErrorAndTerminate(Thread thread, Throwable th) {
        synchronized (AnonymousClass0IC.class) {
            AnonymousClass0IC.A00().uncaughtException(thread, th);
    ...
    public int roughlyCountPendingReportsOfType(CrashReportType... crashReportTypeArr) {
        if (this.mContext == null) {
            AnonymousClass0MD.A04("ACRA", "Trying to get ACRA reports but ACRA is not initialized.");
            return 0;
        }
        int i = 0;
        for (CrashReportType crashReportType : crashReportTypeArr) {
    ...
    public void updateGLCwithSystemLibs(Spool.FileBeingConsumed fileBeingConsumed) {
        ...
        if (!crashDumpSysLibPath.exists()) {
            try {
                ...
                AnonymousClass0MD.A0C("ACRA", e, "Failed to create GLC Lib file");
                return;
            }
        }
        try {
            ...
            AnonymousClass0MD.A0C("ACRA", e2, "Failed to create GLC Lib file");
        }
    }
        ...
        if (hashSet != null && !hashSet.isEmpty()) {
            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        bufferedWriter.write(AnonymousClass006.A07(it.next(), "\n"));
                    }
                    ...
                    try {
                        AnonymousClass0MD.A0C("ACRA", e, "GLC file to write Exception");
                        safeClose(closeable);
    ...
    private String genCrashReportFileName(Class cls, UUID uuid, String str) {
        ...
        if (this.mAppVersionCode != null) {
            str2 = AnonymousClass006.A07(HelpFormatter.DEFAULT_OPT_PREFIX, this.mAppVersionCode);
        } else {
            str2 = "";
        }
        return AnonymousClass006.A0C(obj, HelpFormatter.DEFAULT_OPT_PREFIX, simpleName, str2, str);
    }
    ...
    private void populateConstantFields() {
        ...
        String str3;
        String str4;
        int A00 = AnonymousClass0HJ.A00();
        this.mAppVersionCode = Integer.toString(AnonymousClass0HJ.A01());
        ...
        if (this.mConfig.shouldReportField(ReportField.ANDROID_ID)) {
            try {
                ...
                AnonymousClass0MD.A07(TAG, "Failed to fetch the constant field ANDROID_ID", e);
                str4 = "unknown";
            }
        ...
        if (this.mConfig.shouldReportField(ReportField.IS_RELABELED)) {
            treeMap.put(ReportField.IS_RELABELED, String.valueOf(AnonymousClass0HJ.A02()));
        }
    ...
    public static void init() {
        if (AnonymousClass0Mn.A00 != null) {
            AnonymousClass0MD.A05(TAG, "ErrorReportingDiagnosticData.setInstance already set.");
            return;
        }
        AnonymousClass0Mn.A00 = new Object() {
            /* class com.facebook.acra.ErrorReporter.AnonymousClass2 */

            public void putLazyCustomData(String str, final Provider<String> provider) {
        ...
        AnonymousClass3 r0 = new Object() {
            ...
            public void writeReportToStream(@Nullable Throwable th, OutputStream outputStream) throws Exception {
                ErrorReporter.getInstance().writeReportToStream(th, outputStream);
            }
        };
        synchronized (AnonymousClass0My.class) {
            AnonymousClass0My.A00 = r0;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:69:0x014c A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:75:0x0158  */
    /* JADX WARNING: Removed duplicated region for block: B:78:0x0162  */
    /* JADX WARNING: Removed duplicated region for block: B:79:0x0168 A[SYNTHETIC, Splitter:B:79:0x0168] */
    /* JADX WARNING: Removed duplicated region for block: B:84:0x0176 A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:87:0x0182 A[RETURN] */
    @javax.annotation.Nullable
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void tryLogInternalError(@Nullable String str, Throwable th) {
        ...
        try {
            AnonymousClass0MD.A0E("ACRA", th, "internal ACRA error: %s: ", str);
        } catch (Throwable unused) {
        }
    }
        ...
        if (!this.mInitializationComplete) {
            ...
            if (this.mContext != null) {
                ...
                if (this.mInstallTime == 0) {
                    AnonymousClass0MD.A05("ACRA", "could not retrieve APK mod time");
                }
