...
public class ReflectionCollector {
    public static String collectConstants(Class<?> cls) {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                sb.append(DeviceConfigClient.NOT_AVAILABLE);
            }
            sb.append("\n");
        }
        return sb.toString();
    ...
    public static String getPlayServicesVersion(Context context) {
        try {
            ...
            int intValue = ((Number) cls.getMethod("isGooglePlayServicesAvailable", Context.class).invoke(cls.getMethod("getInstance", new Class[0]).invoke(cls, new Object[0]), context)).intValue();
