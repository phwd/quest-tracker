...
public class SigquitDetectorAcra implements SigquitDetector {
    ...
    public static native void nativeInit(Object obj, boolean z, int i, String str, String str2, @Nullable String str3, @Nullable String str4, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, @Nullable String str5, boolean z7);
    ...
    private void sigquitDetected(String str, String str2, boolean z, boolean z2) {
        AnonymousClass0MD.A0A(TAG, "sigquitDetected inFgV1: %b inFgV2: %b", Boolean.valueOf(z), Boolean.valueOf(z2));
    ...
    public void init(ANRDetectorConfig aNRDetectorConfig, boolean z) {
        ...
        AnonymousClass0MD.A05(TAG, "nativeInit");
