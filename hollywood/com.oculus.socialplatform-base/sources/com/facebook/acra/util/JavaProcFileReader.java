...
public class JavaProcFileReader extends ProcFileReader {
    ...
    public int getOpenFDCount() {
        try {
            ...
            AnonymousClass0MD.A04(TAG, e.getMessage());
            return -2;
        }
    }
    ...
    public ProcFileReader.OpenFDLimits getOpenFDLimits() {
        ...
        try {
            ...
            try {
                ...
                while ((read - 1) - i > bytes.length) {
                    ...
                    if (startsWithOffset(bArr, i, bytes)) {
                        if (AnonymousClass0Jp.A00.A8K(bArr, i, findNewLineOrEnd, PROC_OPEN_FD_LIMITS_FORMAT, strArr, null, null)) {
            ...
            AnonymousClass0MD.A0D(TAG, e, "Failed to read /proc/self/limits");
            return null;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00ad, code lost:
        X.AnonymousClass0MD.A0C(com.facebook.acra.util.JavaProcFileReader.TAG, r2, "Exception caught while reading open file descriptors");
     */
