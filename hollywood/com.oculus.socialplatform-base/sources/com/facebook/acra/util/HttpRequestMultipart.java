...
public class HttpRequestMultipart {
    ...
    public void sendPost(URL url, Map<?, ?> map, Map<?, InputStreamField> map2, ACRAResponse aCRAResponse, String str, boolean z) throws IOException {
        ...
        try {
            ...
            try {
                OutputStream createOutputDecorator = AcraRadioMonitorBridge.createOutputDecorator(outputStream2);
                ...
                for (Map.Entry<?, InputStreamField> entry2 : map2.entrySet()) {
                    ...
                    if (z2) {
                        outputStream = new CompressionOutputStream(createOutputDecorator, 8192, z);
                    } else {
                        outputStream = createOutputDecorator;
                    }
                    copyStream(value.mInputStream, outputStream);
                    if (z2) {
