...
public class TraceDirect {
    public static final boolean sForceJavaImpl = "true".equals(AnonymousClass0GR.A02("debug.fbsystrace.force_java"));
    public static volatile TriState sNativeAvailable = TriState.UNSET;
    public static volatile int sPrevSoLoaderSourcesVersion = -1;
    public static final boolean sTraceLoad = "true".equals(AnonymousClass0GR.A02("debug.fbsystrace.trace_load"));
    ...
    public static boolean checkNative() {
        ...
        if (sNativeAvailable == TriState.UNSET) {
            if (sForceJavaImpl) {
                ...
                if (AnonymousClass0lD.A02()) {
                    synchronized (AnonymousClass0lD.class) {
                        if (AnonymousClass0lD.A00 == null) {
                            throw new IllegalStateException("NativeLoader has not been initialized.  To use standard native library loading, call NativeLoader.init(new SystemDelegate()).");
                        }
                    }
                    i = AnonymousClass0lD.A00.A4x();
                } else {
                    i = -1;
                }
                if (i != sPrevSoLoaderSourcesVersion) {
                    ...
                    try {
                        AnonymousClass0lD.A01("fbsystrace");
                        nativeSetEnabledTags(AnonymousClass0GR.A00("debug.fbsystrace.tags"));
