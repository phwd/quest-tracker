            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        return new JdkWithJettyBootPlatform(cls2, cls3.getMethod("put", SSLSocket.class, Class.forName(AnonymousClass006.A07("org.eclipse.jetty.alpn.ALPN", "$Provider"))), cls3.getMethod("get", SSLSocket.class), cls3.getMethod("remove", SSLSocket.class), Class.forName(AnonymousClass006.A07("org.eclipse.jetty.alpn.ALPN", "$ClientProvider")), Class.forName(AnonymousClass006.A07("org.eclipse.jetty.alpn.ALPN", "$ServerProvider")));
