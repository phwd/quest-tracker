...
public final class Spdy3 implements Variant {
            ...
            try {
                ...
                if (z2) {
                    ...
                    if (i3 == 3) {
                        ...
                        throw new ProtocolException(AnonymousClass006.A03("version != 3: ", i3));
                    }
                } else {
    ...
    public static final class Writer implements FrameWriter {
        ...
        public final BufferedSink headerBlockOut;
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.writeInt((((int) (this.headerBlockBuffer.size + 4)) & 16777215) | 0);
        ...
        public synchronized void settings(Settings settings) throws IOException {
            if (!this.closed) {
                ...
                int i = 0;
                this.sink.writeInt((((bitCount << 3) + 4) & 16777215) | 0);
                this.sink.writeInt(bitCount);
                do {
                    if (settings.isSet(i)) {
                        this.sink.writeInt(((settings.flags(i) & MediaProviderUtils.JPEG_HEADER) << 24) | (i & 16777215));
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.writeInt(((i2 & MediaProviderUtils.JPEG_HEADER) << 24) | (((int) (this.headerBlockBuffer.size + 4)) & 16777215));
                this.sink.writeInt(i & Integer.MAX_VALUE);
                this.sink.writeAll(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.writeInt(((((z ? 1 : 0) | i4) & MediaProviderUtils.JPEG_HEADER) << 24) | (i3 & 16777215));
                this.sink.writeInt(i & Integer.MAX_VALUE);
        ...
        public synchronized void windowUpdate(int i, long j) throws IOException {
            if (this.closed) {
                ...
                throw new IllegalArgumentException(AnonymousClass006.A06("windowSizeIncrement must be between 1 and 0x7fffffff: ", j));
            } else {
        ...
        public void sendDataFrame(int i, int i2, Buffer buffer, int i3) throws IOException {
            if (!this.closed) {
                ...
                if (j <= 16777215) {
                    this.sink.writeInt(i & Integer.MAX_VALUE);
                    this.sink.writeInt(((i2 & MediaProviderUtils.JPEG_HEADER) << 24) | (16777215 & i3));
                    if (i3 > 0) {
                ...
                throw new IllegalArgumentException(AnonymousClass006.A03("FRAME_TOO_LARGE max size is 16Mib: ", i3));
            }
            throw new IOException("closed");
        }
        ...
        public Writer(BufferedSink bufferedSink, boolean z) {
            ...
            this.headerBlockOut = new RealBufferedSink(new DeflaterSink((Sink) buffer, deflater));
        }
    }
