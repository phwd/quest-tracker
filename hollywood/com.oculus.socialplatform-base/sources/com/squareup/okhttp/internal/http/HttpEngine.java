...
public final class HttpEngine {
    ...
    public class NetworkInterceptorChain implements Interceptor.Chain {
        ...
        public Response proceed(Request request2) throws IOException {
            ...
            if (i > 0) {
                ...
                if (!str.equals(httpUrl2.host) || httpUrl.port != httpUrl2.port) {
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors.size()) {
                ...
                if (HttpMethod.permitsRequestBody(request2.method) && (requestBody = request2.body) != null) {
                    RealBufferedSink realBufferedSink = new RealBufferedSink(httpEngine.httpStream.createRequestBody(request2, requestBody.contentLength()));
                    request2.body.writeTo(realBufferedSink);
                ...
                if (i2 == 204 || i2 == 205) {
                    ...
                    if (responseBody.contentLength() > 0) {
                        ...
                        sb5.append(responseBody.contentLength());
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        builder.body = new RealResponseBody(response.headers, Okio.buffer(r0));
    ...
    public static Headers combine(Headers headers, Headers headers2) throws IOException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if ((!"Warning".equalsIgnoreCase(name) || !value.startsWith("1")) && (!OkHeaders.isEndToEnd(name) || Headers.get(headers2.namesAndValues, name) == null)) {
    ...
    private Response readNetworkResponse() throws IOException {
        ...
        if (CommonSystemDialogActions.CLOSE.equalsIgnoreCase(build.request.header("Connection")) || CommonSystemDialogActions.CLOSE.equalsIgnoreCase(build.header("Connection", null))) {
    ...
    private Response unzip(Response response) throws IOException {
        ...
        builder.body = new RealResponseBody(headers, Okio.buffer(gzipSource));
        return builder.build();
    }
    ...
    public BufferedSink getBufferedRequestBody() {
        ...
        RealBufferedSink realBufferedSink = new RealBufferedSink(requestBody);
        this.bufferedRequestBody = realBufferedSink;
