...
public final class OkHeaders {
    ...
    public static final String RECEIVED_MILLIS = AnonymousClass006.A07("OkHttp", "-Received-Millis");
    public static final String RESPONSE_SOURCE = AnonymousClass006.A07("OkHttp", "-Response-Source");
    public static final String SELECTED_PROTOCOL = AnonymousClass006.A07("OkHttp", "-Selected-Protocol");
    public static final String SENT_MILLIS = AnonymousClass006.A07("OkHttp", "-Sent-Millis");
        ...
        for (int i = 0; i < length; i++) {
            if (str.equalsIgnoreCase(headers.name(i))) {
                ...
                while (i2 < value.length()) {
                    int skipUntil = HeaderParser.skipUntil(value, i2, HelpFormatter.DEFAULT_LONG_OPT_SEPARATOR);
