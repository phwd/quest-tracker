...
public final class StdArraySerializers$BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
    public static final AbstractC02190iF A00 = new AnonymousClass0C7(Boolean.class);
    ...
    public StdArraySerializers$BooleanArraySerializer() {
        super(boolean[].class, (AbstractC02220iI) null);
    }
    ...
    public final void A05(boolean[] zArr, AbstractC02300iS r5, AbstractC02120i3 r6) throws IOException, C02310iT {
        for (boolean z : zArr) {
            r5.A0Y(z);
        }
    }
