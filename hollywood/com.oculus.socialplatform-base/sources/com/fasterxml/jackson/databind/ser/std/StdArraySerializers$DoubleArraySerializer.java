...
public final class StdArraySerializers$DoubleArraySerializer extends ArraySerializerBase<double[]> {
    public static final AbstractC02190iF A00 = new AnonymousClass0C7(Double.TYPE);
    ...
    public StdArraySerializers$DoubleArraySerializer() {
        super(double[].class, (AbstractC02220iI) null);
    }
    ...
    public final void A05(double[] dArr, AbstractC02300iS r6, AbstractC02120i3 r7) throws IOException, C02310iT {
        for (double d : dArr) {
            r6.A0K(d);
        }
    }
