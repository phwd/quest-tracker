...
public final class NotificationCompat$CarExtender implements AbstractC001103p {
    ...
    public AnonymousClass03o mUnreadConversation;

    @RequiresApi(21)
    public static AnonymousClass03o getUnreadConversationFromBundle(@Nullable Bundle bundle) {
        String[] strArr;
        int i;
        AnonymousClass04A r7 = null;
        if (bundle != null) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ...
                    r7 = new AnonymousClass04A(resultKey, label, choices, allowFreeFormInput, i, remoteInput.getExtras());
                }
                return new AnonymousClass03o(strArr, r7, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
            }
        }
        return null;
    }
    ...
    @RequiresApi(21)
    public static Bundle getBundleForUnreadConversation(@NonNull AnonymousClass03o r10) {
        String str;
        ...
        for (int i = 0; i < length; i++) {
            ...
            bundle2.putString("text", strArr2[i]);
            bundle2.putString(KEY_AUTHOR, str);
            parcelableArr[i] = bundle2;
        }
        bundle.putParcelableArray(KEY_MESSAGES, parcelableArr);
        AnonymousClass04A r4 = r10.A03;
        if (r4 != null) {
    ...
    public AnonymousClass03m extend(AnonymousClass03m r4) {
        Bundle bundle = new Bundle();
        ...
        AnonymousClass03o r0 = this.mUnreadConversation;
        if (r0 != null) {
    ...
    @Deprecated
    public AnonymousClass03o getUnreadConversation() {
    ...
    @Deprecated
    public NotificationCompat$CarExtender setUnreadConversation(AnonymousClass03o r1) {
