...
public class FileProvider extends ContentProvider {
    ...
    @GuardedBy("sCache")
    public static HashMap<String, AnonymousClass04P> sCache = new HashMap<>();
    public AnonymousClass04P mStrategy;
    ...
    public static AnonymousClass04P getPathStrategy(Context context, String str) {
        AnonymousClass04P r1;
        synchronized (sCache) {
            r1 = sCache.get(str);
            if (r1 == null) {
                try {
    ...
    public static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(AnonymousClass006.A07("Invalid mode: ", str));
    }

    public static AnonymousClass04P parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        File[] externalMediaDirs;
        File file;
        C05640wI r3 = new C05640wI(str);
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(AnonymousClass006.A07("Couldn't find meta-data for provider with authority ", str));
        }
    }

    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        return this.mStrategy.A3x(uri).delete() ? 1 : 0;
    }

    public String getType(@NonNull Uri uri) {
        String mimeTypeFromExtension;
        File A3x = this.mStrategy.A3x(uri);
        int lastIndexOf = A3x.getName().lastIndexOf(46);
        if (lastIndexOf < 0 || (mimeTypeFromExtension = MimeTypeMap.getSingleton().getMimeTypeFromExtension(A3x.getName().substring(lastIndexOf + 1))) == null) {
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.mStrategy.A3x(uri), modeToMode(str));
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        for (String str3 : strArr) {
            if ("_display_name".equals(str3)) {
                ...
                i = i2 + 1;
                objArr[i2] = A3x.getName();
            } else if ("_size".equals(str3)) {
                strArr3[i2] = "_size";
                i = i2 + 1;
                objArr[i2] = Long.valueOf(A3x.length());
            }
            i2 = i;
        }
    ...
    public static Uri getUriForFile(@NonNull Context context, @NonNull String str, @NonNull File file) {
        return getPathStrategy(context, str).A5C(file);
    }
