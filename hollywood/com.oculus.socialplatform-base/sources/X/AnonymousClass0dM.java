...
public class AnonymousClass0dM extends AnonymousClass13Y<Calendar> {
    ...
    public final void A03(AnonymousClass14L r3, Calendar calendar) throws IOException {
    ...
    @Override // X.AnonymousClass13Y
    public final Calendar A02(AnonymousClass14I r10) throws IOException {
        if (r10.A0G() == AnonymousClass007.A09) {
            r10.A0P();
            return null;
        }
        r10.A0M();
        ...
        int i5 = 0;
        int i6 = 0;
        while (r10.A0G() != AnonymousClass007.A04) {
            String A0I = r10.A0I();
            int A0D = r10.A0D();
            if ("year".equals(A0I)) {
                i = A0D;
