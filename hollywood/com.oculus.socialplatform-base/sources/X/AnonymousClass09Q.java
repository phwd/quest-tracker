...
public final class AnonymousClass09Q extends FrameLayout {
    ...
    public AnonymousClass09Q(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull AnonymousClass09b r8) {
        super(context, attributeSet);
        String str;
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AnonymousClass2gL.A01);
        ...
        if (classAttribute != null && A0F == null) {
            if (id <= 0) {
                if (string != null) {
                    str = AnonymousClass006.A07(" with tag ", string);
                } else {
                    str = "";
                }
                throw new IllegalStateException(AnonymousClass006.A09("FragmentContainerView must have an android:id to add Fragment ", classAttribute, str));
            }
            Fragment A012 = r8.A0J().A01(context.getClassLoader(), classAttribute);
            A012.A05();
            AnonymousClass0vO r1 = new AnonymousClass0vO(r8);
            r1.A0E = true;
            A012.A0B = this;
            r1.A02(getId(), A012, string, 1);
            r1.A01();
        }
    }
