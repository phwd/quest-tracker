...
public abstract class AnonymousClass1PR implements AnonymousClass1PS {
    ...
    public final AnonymousClass1PJ A06;
    ...
    private synchronized void A01() {
        if (this.A02 == null) {
            this.A02 = this.A04.getSharedPreferences(new AnonymousClass1PO(AnonymousClass006.A0B("rti.mqtt.counter.", this.A07, ".", this.A03)).A00, 0);
        }
    }
    ...
    public AnonymousClass1PR(Context context, String str, AnonymousClass1PJ r7, RealtimeSinceBootClock realtimeSinceBootClock, String str2, boolean z) {
        this.A04 = context;
        this.A07 = str;
        this.A06 = r7;
