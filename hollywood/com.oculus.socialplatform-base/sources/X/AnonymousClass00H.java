...
public abstract class AnonymousClass00H<V, X extends Throwable, F, T> extends AnonymousClass02i<V> implements Runnable {
    ...
    public final String pendingToString() {
        ...
        if (cls != null && f != null) {
            ...
            return AnonymousClass006.A07(str, pendingToString);
        } else {
            return null;
        }
    }

    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: X.00H<V, X extends java.lang.Throwable, F, T> */
    ...
    public final void run() {
        ...
        L_0x0013:
            ...
            java.lang.Object r0 = X.AnonymousClass12r.A00(r5)     // Catch:{ ExecutionException -> 0x002f, all -> 0x0037 }
            r6.set(r0)
            return
        L_0x002f:
            r0 = move-exception
        ...
        L_0x005d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass00H.run():void");
    }

    public AnonymousClass00H(ListenableFuture<? extends V> listenableFuture, Class<X> cls, F f) {
