...
public final class AnonymousClass13j {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass13j.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }
    ...
    public static Class<?> A00(Type type) {
        ...
        if (!(type instanceof Class)) {
            if (type instanceof ParameterizedType) {
                ...
                AnonymousClass13f.A00(type instanceof Class);
    ...
    public static Type A02(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new AnonymousClass13g(A02(cls.getComponentType()));
            }
            return type2;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new AnonymousClass13h(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new AnonymousClass13g(((GenericArrayType) type).getGenericComponentType());
        } else {
            if (!(type instanceof WildcardType)) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new AnonymousClass13i(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        }
    }
    ...
    public static Type A03(Type type, Class<?> cls, Class<?> cls2) {
        ...
        AnonymousClass13f.A00(cls2.isAssignableFrom(cls));
    ...
    public static java.lang.reflect.Type A05(java.lang.reflect.Type r7, java.lang.Class<?> r8, java.lang.reflect.Type r9, java.util.Collection<java.lang.reflect.TypeVariable> r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass13j.A05(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static void A06(java.lang.reflect.Type r1) {
        ...
        L_0x000d:
            r0 = 1
        L_0x000e:
            X.AnonymousClass13f.A00(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass13j.A06(java.lang.reflect.Type):void");
    }
}
