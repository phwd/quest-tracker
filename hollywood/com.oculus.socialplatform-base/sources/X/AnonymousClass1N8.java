...
public class AnonymousClass1N8 extends SparseArray<String> {
    public AnonymousClass1N8() {
        put(0, "/buddy_list");
        put(1, "/create_thread");
        ...
        put(178, "/ls_req");
        put(179, VrMsysMqttClientCallbacks.MQTT_TOPIC_LS_RESP);
        ...
        put(MediaProviderUtils.JPEG_HEADER, "/workplace_desks");
        put(257, "/t_portal_comms_req");
        put(258, "/voodoo_json");
        put(259, "/ixt_trigger");
        put(261, "/t_presence_on_bladerunner");
        put(262, "/t_send_contextual_presence");
        put(263, "/universal_search_generative_ranking_publish_to_server");
        put(264, "/universal_search_generative_ranking_publish_to_client");
    }
}
