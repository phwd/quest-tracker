...
public final class C05570w9 extends AnonymousClass05G {
    ...
    @Override // X.AnonymousClass05G
    public final AnonymousClass06C A04(AnonymousClass06C[] r3, int i) {
        throw new RuntimeException("Do not use this function in API 29 or later.");
    }

    @Override // X.AnonymousClass05G
    @Nullable
    public final Typeface A06(Context context, C05630wH r12, Resources resources, int i) {
        AnonymousClass04m[] r6 = r12.A00;
    ...
    @Override // X.AnonymousClass05G
    @Nullable
    public final Typeface A05(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull AnonymousClass06C[] r14, int i) {
