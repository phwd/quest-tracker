...
public final class AnonymousClass07C {
    public static Field A00;
    public static Method A01;
    public static boolean A02;
    public static boolean A03;

    public static boolean A00(@NonNull AnonymousClass07B r4, @Nullable View view, @Nullable Window.Callback callback, @NonNull KeyEvent keyEvent) {
        ...
        if (callback instanceof Activity) {
            ...
            if (AnonymousClass07f.A08(decorView, keyEvent)) {
                return true;
            }
            if (decorView != null) {
            ...
            return (view != null && AnonymousClass07f.A08(view, keyEvent)) || r4.superDispatchKeyEvent(keyEvent);
        } else {
            ...
            if (AnonymousClass07f.A08(decorView2, keyEvent)) {
                return true;
            }
            if (decorView2 != null) {
