...
public final class AnonymousClass04A {
    ...
    @RequiresApi(20)
    public static RemoteInput[] A00(AnonymousClass04A[] r7) {
        int length = r7.length;
        RemoteInput[] remoteInputArr = new RemoteInput[length];
        for (int i = 0; i < length; i++) {
            AnonymousClass04A r6 = r7[i];
    ...
    public AnonymousClass04A(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z, int i, Bundle bundle) {
        this.A03 = str;
