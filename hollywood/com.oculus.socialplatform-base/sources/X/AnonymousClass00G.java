...
public abstract class AnonymousClass00G<I, O, F, T> extends AnonymousClass02i<O> implements Runnable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: X.00G<I, O, F, T> */
    ...
    public final void run() {
        ...
        if (!z3 && !z) {
            ...
            try {
                ...
                try {
                    Object A002 = A00(f, AnonymousClass12r.A00(listenableFuture));
                    this.A01 = null;
                    A01(A002);
                } catch (Throwable th) {
                    this.A01 = null;
    ...
    public AnonymousClass00G(ListenableFuture<? extends I> listenableFuture, F f) {
