...
public abstract class AnonymousClass0A7 {
    ...
    public void A05(@NonNull Fragment fragment, @NonNull Object obj, @NonNull AnonymousClass05j r3, @NonNull Runnable runnable) {
        runnable.run();
    }
}
