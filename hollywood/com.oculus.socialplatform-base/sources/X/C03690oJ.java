...
public final class C03690oJ implements Comparable<C03690oJ>, Serializable {
    public static final C03690oJ A00 = new C03690oJ(0, 0, 0, null, null, null);
    ...
    public final int compareTo(C03690oJ r3) {
        C03690oJ r32 = r3;
        if (r32 == this) {
            return 0;
        }
    ...
    public C03690oJ(int i, int i2, int i3, String str, String str2, String str3) {
