...
public abstract class AnonymousClass0VG<T> implements ProviderWithInjector<T>, AnonymousClass0lg, AbstractC01140Ri {
    ...
    @Override // X.AnonymousClass0RF
    public <T> Set<T> getSet(AnonymousClass14P<T> r2, Context context) {
    ...
    public Object getObjectForBindingId(int i) {
        ...
        throw new RuntimeException(AnonymousClass006.A07("Not Implemented. This should only be called from the test frameworks, and must be explicitly overridden\nName of injector: ", getClass().getCanonicalName()));
    }
