...
public final class AnonymousClass07M implements View.OnAttachStateChangeListener, ViewTreeObserver.OnPreDrawListener {
    ...
    public static void A00(@NonNull View view, @NonNull Runnable runnable) {
        if (view != null) {
            AnonymousClass07M r1 = new AnonymousClass07M(view, runnable);
    ...
    public AnonymousClass07M(View view, Runnable runnable) {
        this.A01 = view;
