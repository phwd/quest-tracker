...
public final class AnonymousClass0IC implements Thread.UncaughtExceptionHandler {
    @Nullable
    public static AnonymousClass0IC A04;
    public final boolean A00 = true;
    public final Object A01 = new Object();
    public final Thread.UncaughtExceptionHandler A02;
    public volatile List<AnonymousClass0IB> A03 = Collections.unmodifiableList(new ArrayList());
    @DoNotStrip
    @Nullable
    public byte[] mOomReservation = null;

    public AnonymousClass0IC(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
        this.A02 = uncaughtExceptionHandler;
        this.mOomReservation = new byte[4096];
    }

    public static synchronized AnonymousClass0IC A00() {
        AnonymousClass0IC r0;
        synchronized (AnonymousClass0IC.class) {
            r0 = A04;
            if (r0 == null) {
                AnonymousClass0IC r02 = new AnonymousClass0IC(Thread.getDefaultUncaughtExceptionHandler());
                A04 = r02;
    ...
    public static synchronized void A02(AnonymousClass0IE r4, int i) {
        synchronized (AnonymousClass0IC.class) {
            AnonymousClass0IC A002 = A00();
            synchronized (A002) {
                ArrayList arrayList = new ArrayList(A002.A03);
                AnonymousClass0IB r0 = new AnonymousClass0IB();
                r0.A01 = r4;
                r0.A00 = i;
                arrayList.add(r0);
                if (A002.A00) {
    ...
    public final void uncaughtException(Thread thread, Throwable th) {
        synchronized (this.A01) {
            ...
            List<AnonymousClass0IB> list = this.A03;
            try {
                ...
                try {
                    A03(th);
                    if (!(th instanceof AnonymousClass0ID)) {
                        this.A02.uncaughtException(thread, th);
                    } else {
                        Log.w("ExceptionHandlerManager", AnonymousClass006.A07("Exit: ", th.getMessage()));
                    }
                } catch (Throwable th3) {
                    A01();
                    throw th3;
    ...
    public static void A01() {
        ...
        L_0x001e:
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0IC.A01():void");
    }
