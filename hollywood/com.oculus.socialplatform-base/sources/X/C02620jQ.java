...
public final class C02620jQ {
    @Nullable
    public static C02610jP A00(@Nullable Intent intent) throws JSONException {
        Object obj;
        Uri uri;
        ...
        if (data != null) {
            arrayList.add(data);
            jSONObject.put("data", C02730jk.A00(data).A00());
        }
        ClipData A00 = C02600jO.A00(intent);
        if (A00 != null) {
            ...
            for (int i = 0; i < A00.getItemCount(); i++) {
                ...
                if (!(itemAt == null || (uri = itemAt.getUri()) == null)) {
                    arrayList.add(uri);
                    jSONArray.put(C02730jk.A00(uri).A00());
                }
            }
        ...
        return new C02610jP(jSONObject, arrayList);
    }
}
