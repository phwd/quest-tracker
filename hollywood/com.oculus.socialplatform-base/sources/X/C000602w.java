...
public final class C000602w<E> implements Cloneable {
    ...
    public final E A02(int i) {
        E e;
        int A002 = AnonymousClass02m.A00(this.A02, this.A00, i);
    ...
    public static void A00(C000602w r8) {
        int i = r8.A00;
        int[] iArr = r8.A02;
    ...
    public final void A04(int i, E e) {
        int[] iArr = this.A02;
        int i2 = this.A00;
        int A002 = AnonymousClass02m.A00(iArr, i2, i);
        if (A002 >= 0) {
            this.A03[A002] = e;
            return;
        }
        ...
        if (this.A01 && i2 >= iArr.length) {
            A00(this);
            i2 = this.A00;
            i3 = AnonymousClass02m.A00(iArr, i2, i) ^ -1;
        }
        int length = iArr.length;
        if (i2 >= length) {
            int i4 = (i2 + 1) << 2;
    ...
    public final /* bridge */ /* synthetic */ Object clone() throws CloneNotSupportedException {
        try {
            C000602w r1 = (C000602w) super.clone();
    ...
    public C000602w(int i) {
        Object[] objArr;
        this.A01 = false;
        if (i == 0) {
            this.A02 = AnonymousClass02m.A00;
            objArr = AnonymousClass02m.A01;
        } else {
            int i2 = i << 2;
            int i3 = 4;
            while (true) {
