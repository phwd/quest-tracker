...
public abstract class AnonymousClass0Uo extends AbstractC03020km {
    ...
    private Intent A00(Intent intent, Context context, List<? extends ComponentInfo> list) {
        ...
        for (ComponentInfo componentInfo : list) {
            if (A09(context, componentInfo)) {
                ...
                } else if (A07() || AbstractC03020km.A02(this) == AnonymousClass007.A01) {
                    arrayList.add(componentInfo);
            ...
            this.A00.report("DifferentKeyIntentScope", AnonymousClass006.A07(str2, AbstractC03020km.A03(intent)), null);
        }
        if (!arrayList.isEmpty()) {
            ...
            r6 = this.A00;
            intent2 = intent3;
        } else if (context.getApplicationInfo().targetSdkVersion < 30 || !list.isEmpty()) {
            this.A00.report("DifferentKeyIntentScope", AnonymousClass006.A07("No matching different-signature components for: ", AbstractC03020km.A03(intent)), null);
            return null;
        } else {
            r6 = this.A00;
            r6.report("DifferentKeyIntentScope", AnonymousClass006.A09("No matching different-signature components for: ", AbstractC03020km.A03(intent), " on API 30+ device. Intent target is not in any PackageFinder aware app, so it's probably a non-FB app. Attempting to proceed."), null);
            intent2 = intent;
        }
        boolean A07 = A07();
        if (intent2.getExtras() != null) {
            ...
            for (String str3 : keySet) {
                ...
                if (obj != null && AnonymousClass0Hk.class.getClassLoader().equals(obj.getClass().getClassLoader())) {
                    arrayList3.add(str3);
                }
            }
            ...
            while (it.hasNext()) {
                ...
                r6.report("ExternalIntentSanitization", String.format(str, objArr), null);
            }
        }
        return intent2;
    }
    ...
    public final Intent A2n(Intent intent, Context context, @Nullable String str) {
        ...
        List<ActivityInfo> A04 = AbstractC03020km.A04(intent, context, 65600);
        if (A04.isEmpty()) {
            A04 = AbstractC03020km.A04(intent, context, 0);
        }
    ...
    public final Intent A2r(Intent intent, Context context, @Nullable String str) {
        ...
        List<ServiceInfo> A05 = AbstractC03020km.A05(intent, context, 65600);
        if (A05.isEmpty()) {
            A05 = AbstractC03020km.A05(intent, context, 0);
        }
        return A00(intent, context, A05);
    }

    public AnonymousClass0Uo(C02580jL r1, AbstractC02660jW r2, C02650jV r3) {
        super(r1, r2, r3);
    }
}
