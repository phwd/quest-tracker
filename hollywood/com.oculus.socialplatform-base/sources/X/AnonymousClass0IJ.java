...
public final class AnonymousClass0IJ<V> implements RunnableFuture<V>, ScheduledFuture<V> {
    ...
    public AnonymousClass0IJ(Handler handler, Runnable runnable, @Nullable V v) {
        this.A00 = handler;
        this.A01 = new FutureTask<>(runnable, v);
    }

    public AnonymousClass0IJ(Handler handler, Callable<V> callable) {
        this.A00 = handler;
