...
public class AnonymousClass0WG extends C05610wD {
    ...
    @Override // X.AnonymousClass05G, X.C05610wD
    @Nullable
    public final Typeface A05(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull AnonymousClass06C[] r13, int i) {
        ...
        if (length >= 1) {
            ...
            if (!z3) {
                AnonymousClass06C A042 = A04(r13, i);
                ...
                for (AnonymousClass06C r1 : r13) {
                    if (r1.A00 == 0) {
                        Uri uri = r1.A03;
                        if (!hashMap.containsKey(uri)) {
                            hashMap.put(uri, AnonymousClass05H.A01(context, cancellationSignal, uri));
                        }
                    }
                }
    ...
    @Override // X.AnonymousClass05G, X.C05610wD
    @Nullable
    public final Typeface A06(Context context, C05630wH r15, Resources resources, int i) {
        Object obj;
        boolean z;
        Method method = this.A02;
        if (method == null) {
        ...
        if (obj != null) {
            AnonymousClass04m[] r3 = r15.A00;
            for (AnonymousClass04m r0 : r3) {
    ...
    public AnonymousClass0WG() {
        ...
        try {
            ...
            Log.e("TypefaceCompatApi26Impl", AnonymousClass006.A07("Unable to collect necessary methods for class ", e.getClass().getName()), e);
            method5 = cls;
            constructor = cls;
            method2 = cls;
            method = cls;
