...
public enum AnonymousClass0Lz {
    ...
    public static AnonymousClass0Lz decode(String str) {
        if (str.startsWith("$")) {
    ...
    public String encode() {
        return AnonymousClass006.A07("$", super.toString());
    }
    ...
    public String getBuildConstant() {
        ...
        if (str != null) {
            try {
                return (String) AnonymousClass0HJ.class.getField(str).get(this);
            } catch (Exception e) {
    ...
    AnonymousClass0Lz(@Nullable String str) {
