...
public final class C06891bH implements AbstractC07011bT<Uri, InputStream> {
    ...
    public final C07091bb<InputStream> A1r(@NonNull Uri uri, int i, int i2, @NonNull AnonymousClass1cO r10) {
        ...
        return new C07091bb(r5, new C06531aV(uri2, new C06541aW(ComponentCallbacks2C07631cl.A01(context).A01.A00(), new C06571aZ(context.getContentResolver()), ComponentCallbacks2C07631cl.A01(context).A03, context.getContentResolver())));
    }
    ...
    public C06891bH(Context context) {
