...
public class AnonymousClass08H {
    public float A00;
    public float A01;
    public float A02;
    public int A03;
    ...
    public static float A00(AnonymousClass08H r9, long j) {
        long j2 = r9.A07;
        if (j < j2) {
        ...
        if (j3 < 0 || j < j3) {
            ...
            if (f > 1.0f) {
                f = 1.0f;
            } else if (f < AndroidPanelLayer.Spec.DEFAULT_CYLINDER_POSITION_Z) {
        ...
        if (f4 > 1.0f) {
            f4 = 1.0f;
        } else if (f4 < AndroidPanelLayer.Spec.DEFAULT_CYLINDER_POSITION_Z) {
