...
public final class AnonymousClass0Jd<T> {
    public int A00;
    public long A01;
    public T[] A02;
    ...
    public final AnonymousClass0K8 A08;
    public final Class<T> A09;

    public static void A00(AnonymousClass0Jd r4, int i) {
    ...
    public AnonymousClass0Jd(Class<T> cls, int i, int i2, int i3, long j, ObjectPool.Allocator<T> allocator, AnonymousClass0K8 r10) {
        this.A09 = cls;
