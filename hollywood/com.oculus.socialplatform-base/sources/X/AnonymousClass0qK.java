...
public final class AnonymousClass0qK {
    ...
    public LinkedHashMap<Object, AbstractC01990hm> A01;
    public LinkedList<AbstractC01990hm> A02;
    public LinkedList<AnonymousClass0Cr> A03;
    public LinkedList<AnonymousClass0Ot> A04;
    public LinkedList<AnonymousClass0Cr> A05;
    public final AbstractC02230iJ A06;
    public final AbstractC02190iF A07;
    public final AbstractC02110i2<?> A08;
    public final C02000hn A09;
    public final AnonymousClass0qO<?> A0A;
    public final String A0B;
    public final LinkedHashMap<String, AnonymousClass0Ot> A0C = new LinkedHashMap<>();
    public final boolean A0D;

    private final AnonymousClass0Ot A00(String str) {
        LinkedHashMap<String, AnonymousClass0Ot> linkedHashMap = this.A0C;
        AnonymousClass0Ot r2 = linkedHashMap.get(str);
        if (r2 != null) {
            return r2;
        }
        AnonymousClass0Ot r22 = new AnonymousClass0Ot(str, this.A06, this.A0D);
        linkedHashMap.put(str, r22);
        return r22;
    }

    public static String A01(AnonymousClass0Cr r3, String str) {
        Class<?> A0K;
    ...
    public static java.lang.String A02(X.AnonymousClass0Cr r3, java.lang.String r4) {
        /*
        // Method dump skipped, instructions count: 103
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0qK.A02(X.0Cr, java.lang.String):java.lang.String");
    }

    public static final void A04(AnonymousClass0qK r2, String str) {
    ...
    private final void A05(Object obj, AbstractC01990hm r7) {
        if (obj != null) {
            LinkedHashMap<Object, AbstractC01990hm> linkedHashMap = this.A01;
            if (linkedHashMap == null) {
                linkedHashMap = new LinkedHashMap<>();
                this.A01 = linkedHashMap;
            }
            if (linkedHashMap.put(obj, r7) != null) {
                throw new IllegalArgumentException(AnonymousClass006.A0C("Duplicate injectable value with id '", String.valueOf(obj), "' (of type ", obj.getClass().getName(), ")"));
            }
        }
    }

    public final AnonymousClass0Cr A06() {
        LinkedList<AnonymousClass0Cr> linkedList = this.A05;
        if (linkedList == null) {
            return null;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0016, code lost:
        if (r17.A08.A05(X.EnumC02160i9.ALLOW_FINAL_FIELDS_AS_MUTATORS) != false) goto L_0x0018;
     */
    ...
    public final void A07() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0qK.A07():void");
    }

    public AnonymousClass0qK(AbstractC02110i2<?> r3, boolean z, AbstractC02190iF r5, C02000hn r6, String str) {
        AnonymousClass0qO<?> A0C2;
        ...
        r1 = r3.A05(EnumC02160i9.USE_ANNOTATIONS) ? r3.A01() : r1;
        this.A06 = r1;
        if (r1 == null) {
            A0C2 = this.A08.A04();
        } else {
