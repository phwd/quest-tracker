...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private void resolvePath(java.lang.String r10, int r11, int r12) {
            ...
            L_0x001e:
                ...
                java.lang.String r0 = "/\\"
                int r6 = okhttp3.internal.Util.delimiterOffset(r10, r6, r12, r0)
                r7 = 0
        ...
        public Builder addEncodedQueryParameter(String str, String str2) {
            ...
            if (str != null) {
                ...
                list.add(HttpUrl.canonicalize(str, " \"'<>#&=", true, false, true, true));
        ...
        public Builder addQueryParameter(String str, String str2) {
            ...
            if (str != null) {
                ...
                list.add(HttpUrl.canonicalize(str, " \"'<>#&=", false, false, true, true));
                List<String> list2 = this.encodedQueryNamesAndValues;
                if (str2 != null) {
        ...
        public Builder setEncodedPathSegment(int i, String str) {
            if (str != null) {
                String canonicalize = HttpUrl.canonicalize(str, 0, str.length(), " \"<>^`{}|/\\?#", true, false, false, true);
        ...
        public Builder setPathSegment(int i, String str) {
            if (str != null) {
                String canonicalize = HttpUrl.canonicalize(str, 0, str.length(), " \"<>^`{}|/\\?#", false, false, false, true);
                if (isDot(canonicalize) || isDotDot(canonicalize)) {
                    throw new IllegalArgumentException(AnonymousClass006.A07("unexpected path segment: ", str));
                }
                this.encodedPathSegments.set(i, canonicalize);
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            int skipLeadingAsciiWhitespace = Util.skipLeadingAsciiWhitespace(str, 0, length);
            int skipTrailingAsciiWhitespace = Util.skipTrailingAsciiWhitespace(str, skipLeadingAsciiWhitespace, length);
                ...
                while (true) {
                    ...
                    if (delimiterOffset == skipTrailingAsciiWhitespace || (charAt = str.charAt(delimiterOffset)) == 65535 || charAt == '#' || charAt == '/' || charAt == '\\' || charAt == '?') {
                        ...
                        if (!z) {
                            ...
                            String canonicalize = HttpUrl.canonicalize(str, i, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                            if (z2) {
                            ...
                            this.encodedPassword = AnonymousClass006.A09(this.encodedPassword, "%40", HttpUrl.canonicalize(str, i, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true));
                        }
                        i = delimiterOffset + 1;
                    }
                }
            ...
            resolvePath(str, delimiterOffset, delimiterOffset3);
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r2 = new int[r0]
                okhttp3.HttpUrl.AnonymousClass1.$SwitchMap$okhttp3$HttpUrl$Builder$ParseResult = r2
                okhttp3.HttpUrl$Builder$ParseResult r0 = okhttp3.HttpUrl.Builder.ParseResult.SUCCESS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0 = 1
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                okhttp3.HttpUrl$Builder$ParseResult r0 = okhttp3.HttpUrl.Builder.ParseResult.INVALID_HOST     // Catch:{ NoSuchFieldError -> 0x001b }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x001b }
                r0 = 2
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x001b }
            L_0x001b:
                okhttp3.HttpUrl$Builder$ParseResult r0 = okhttp3.HttpUrl.Builder.ParseResult.UNSUPPORTED_SCHEME     // Catch:{ NoSuchFieldError -> 0x0024 }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0024 }
                r0 = 3
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0024 }
            L_0x0024:
                okhttp3.HttpUrl$Builder$ParseResult r0 = okhttp3.HttpUrl.Builder.ParseResult.MISSING_SCHEME     // Catch:{ NoSuchFieldError -> 0x002d }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x002d }
                r0 = 4
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x002d }
            L_0x002d:
                okhttp3.HttpUrl$Builder$ParseResult r0 = okhttp3.HttpUrl.Builder.ParseResult.INVALID_PORT     // Catch:{ NoSuchFieldError -> 0x0036 }
    ...
    public URI uri() {
        ...
        String obj = newBuilder.toString();
        try {
            return new URI(obj);
    ...
    public static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            ...
            if (codePointAt >= 32 && codePointAt != 127 && ((codePointAt < 128 || !z4) && str2.indexOf(codePointAt) == -1)) {
                if (codePointAt == 37) {
                    if (z) {
                        if (z2 && !percentEncoded(str, i3, i2)) {
                        }
                    }
