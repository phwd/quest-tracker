            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 4:
                        ...
                        onBufferingStateChanged(_arg02, data.readInt(), data.readLong());
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onPlaylistChanged(_arg08, _arg1);
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        onPlaylistMetadataChanged(_arg03);
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                    ...
                    case 13:
                        ...
                        onConnected(_arg010, _arg13, _arg25, _arg3, _arg43, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, _arg11, _arg122);
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                        onDisconnected();
                    ...
                    case 16:
                        ...
                        onAllowedCommandsChanged(_arg05);
                        return true;
                    case 17:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        onCustomCommand(_arg06, _arg14, _arg2);
                        return true;
                    case 18:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        onGetLibraryRootDone(_arg07, _arg16, _arg22);
                        return true;
                    case 19:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 20:
                        ...
                        onChildrenChanged(_arg012, _arg17, _arg23);
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onGetChildrenDone(_arg013, _arg18, _arg26, _arg32, _arg4);
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onSearchResultChanged(_arg014, _arg19, _arg24);
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        onGetSearchResultDone(_arg015, _arg110, _arg27, _arg33, _arg42);
                        return true;
                    default:
