...
public class DefaultAcraConfig implements AcraReportingConfig {
    ...
    public DefaultAcraConfig(Context applicationContext, String crashReportUrl, boolean isInternalBuild, boolean shouldStartANRDetector, boolean isZeroCrashlogBlocked, String sessionId) {
