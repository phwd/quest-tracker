...
public abstract class DeviceConfigModule extends RCTBaseJavaModule {
    ...
    /* access modifiers changed from: protected */
    public abstract void prefetchImpl(ConfigParamList configParamList, Resolver<Void> resolver);
    ...
    protected static final List<Pair<String, String>> describe() {
        ...
        list.add(new Pair<>("prefetch", "+jii"));
        list.add(new Pair<>("subscribe", "bb"));
        return list;
    }
    ...
    /* access modifiers changed from: protected */
    public final void prefetch(JSONObject paramNames, int resolveID, int rejectID) {
        prefetchImpl(ConfigParamList.makeFromJSONObject(paramNames), ResolverFactory.createVoidResolver(this, resolveID, rejectID));
    }

    /* access modifiers changed from: protected */
    public final void subscribe(boolean supportUpdates, boolean enableAutoPrefetch) {
        subscribeImpl(supportUpdates, enableAutoPrefetch);
    }
