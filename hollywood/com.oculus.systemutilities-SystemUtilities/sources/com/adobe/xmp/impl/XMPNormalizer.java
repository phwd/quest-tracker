    ...
    private static void migrateAudioCopyright(XMPMeta xmp, XMPNode dmCopyright) {
        try {
            ...
            if (dcRightsArray == null || !dcRightsArray.hasChildren()) {
                xmp.setLocalizedText("http://purl.org/dc/elements/1.1/", "rights", "", "x-default", "\n\n" + dmValue, null);
            } else {
                int xdIndex = XMPNodeUtils.lookupLanguageItem(dcRightsArray, "x-default");
                if (xdIndex < 0) {
                    xmp.setLocalizedText("http://purl.org/dc/elements/1.1/", "rights", "", "x-default", dcRightsArray.getChild(1).getValue(), null);
