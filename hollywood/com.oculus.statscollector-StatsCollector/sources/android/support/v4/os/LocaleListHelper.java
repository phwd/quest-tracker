...
public final class LocaleListHelper {
    ...
    private int findFirstMatchIndex(Locale supportedLocale) {
        ...
        while (true) {
            ...
            if (idx >= localeArr.length) {
                return DataConnectionPowerStateEnum.DATA_CONNECTION_POWER_STATE_UNKNOWN_VALUE;
            }
    ...
    private int computeFirstMatchIndex(Collection<String> supportedLocales, boolean assumeEnglishIsSupported) {
        ...
        int bestIndex = DataConnectionPowerStateEnum.DATA_CONNECTION_POWER_STATE_UNKNOWN_VALUE;
