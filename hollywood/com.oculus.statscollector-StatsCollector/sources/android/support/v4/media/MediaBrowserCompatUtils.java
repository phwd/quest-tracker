...
public class MediaBrowserCompatUtils {
    ...
    public static boolean hasDuplicatedItems(Bundle options1, Bundle options2) {
        ...
        if (page1 == -1 || pageSize1 == -1) {
            startIndex1 = 0;
            endIndex1 = DataConnectionPowerStateEnum.DATA_CONNECTION_POWER_STATE_UNKNOWN_VALUE;
        } else {
        ...
        if (page2 == -1 || pageSize2 == -1) {
            startIndex2 = 0;
            endIndex2 = DataConnectionPowerStateEnum.DATA_CONNECTION_POWER_STATE_UNKNOWN_VALUE;
        } else {
