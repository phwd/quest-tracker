...
public final class CodedInputStream {
    ...
    private int currentLimit = DataConnectionPowerStateEnum.DATA_CONNECTION_POWER_STATE_UNKNOWN_VALUE;
    ...
    /* JADX INFO: Multiple debug info for r3v5 byte[]: [D('bytes' byte[]), D('chunks' java.util.List<byte[]>)] */
