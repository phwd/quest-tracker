...
public final class NotificationCompat$WearableExtender implements AbstractC001003k {
    ...
    public ArrayList<AnonymousClass03d> mActions = new ArrayList<>();
    ...
    @RequiresApi(20)
    public static Notification.Action getActionFromActionCompat(AnonymousClass03d r5) {
        int i;
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            builder = new Notification.Action.Builder(A0G, r5.A02, r5.A01);
        } else {
            IconCompat A002 = r5.A00();
            if (A002 == null || A002.A0E() != 2) {
                i = 0;
            } else {
                i = A002.A0D();
            }
            builder = new Notification.Action.Builder(i, r5.A02, r5.A01);
        }
    ...
    public NotificationCompat$WearableExtender addAction(AnonymousClass03d r2) {
        this.mActions.add(r2);
        return this;
    }

    public NotificationCompat$WearableExtender addActions(List<AnonymousClass03d> list) {
    ...
    public AnonymousClass03h extend(AnonymousClass03h r6) {
        Bundle bundle = new Bundle();
        ArrayList<AnonymousClass03d> arrayList = this.mActions;
        if (!arrayList.isEmpty()) {
            ArrayList<? extends Parcelable> arrayList2 = new ArrayList<>(arrayList.size());
            Iterator<AnonymousClass03d> it = arrayList.iterator();
            while (it.hasNext()) {
    ...
    public List<AnonymousClass03d> getActions() {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0074, code lost:
        if (r4.getAllowGeneratedReplies() != false) goto L_0x0076;
     */
