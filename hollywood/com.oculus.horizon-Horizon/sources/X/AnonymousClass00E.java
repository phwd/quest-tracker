...
public abstract class AnonymousClass00E<V, X extends Throwable, F, T> extends AbstractC000300p<V> implements Runnable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: X.00E<V, X extends java.lang.Throwable, F, T> */
    ...
    public final void run() {
        ...
        L_0x0013:
            ...
            java.lang.Object r0 = X.C08740y3.A00(r5)     // Catch:{ ExecutionException -> 0x002f, all -> 0x0037 }
            r6.set(r0)
            return
        L_0x002f:
            r0 = move-exception
        ...
        L_0x005d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass00E.run():void");
    }

    public AnonymousClass00E(ListenableFuture<? extends V> listenableFuture, Class<X> cls, F f) {
