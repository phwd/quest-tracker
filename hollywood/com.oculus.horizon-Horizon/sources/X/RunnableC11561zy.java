...
public class RunnableC11561zy implements Runnable {
    ...
    public RunnableC11561zy(AnonymousClass1zr r1, AnonymousClass1zF r2, Handler handler) {
        this.A02 = r1;
        this.A01 = r2;
        this.A00 = handler;
    }
    ...
    public final void run() {
        String str;
        AnonymousClass1zr r3 = this.A02;
        AnonymousClass1zF r4 = this.A01;
        Handler handler = this.A00;
        synchronized (r3) {
            r3.A03.append("asyncStart, ");
            if (r3.A09 != AnonymousClass007.A00) {
                Integer num = r3.A09;
                if (num != null) {
