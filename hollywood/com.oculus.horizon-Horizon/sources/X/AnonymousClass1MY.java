...
public final class AnonymousClass1MY implements AnonymousClass0TF {
    ...
    public final String A2w(int i) {
        ...
        switch (i) {
            ...
            case FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE /*{ENCODED_INT: 128}*/:
            ...
            case MountStatusPoller.POLL_INTERVAL_MS /*{ENCODED_INT: 250}*/:
                return "RETURN_EXCEPTION_TO_CALLER";
            case NotificationsContract.GENERIC_NOTIFICATION_ID /*{ENCODED_INT: 251}*/:
                return "SURFACE_TEXTURE_AVAILABLE";
            case NotificationsContract.EVENT_NOTIFICATION_ID /*{ENCODED_INT: 252}*/:
                return "NEWS_FEED_FRAGMENT";
            case NotificationsContract.VIDEO_UPLOADER_ID /*{ENCODED_INT: 253}*/:
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            case 299:
                                return "SAVE_AD";
                            case AudioCapture.AUDIO_RECORDER_INTERVAL_MS /*{ENCODED_INT: 300}*/:
                                return "UNSAVE_AD";
                            case 301:
                                return "SAVE_MODE";
                            case 302:
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case FacebookRequestErrorClassification.EC_TOO_MANY_USER_ACTION_CALLS /*{ENCODED_INT: 341}*/:
                                    ...
                                    default:
                                        switch (i) {
                                            ...
                                            case 399:
                                                return "TOTAL";
                                            case ViewPager.MIN_FLING_VELOCITY /*{ENCODED_INT: 400}*/:
                                                return TigonRequest.HEAD;
                                            case AuthorizationInterceptor.HTTP_STATUS_UNAUTHORIZED /*{ENCODED_INT: 401}*/:
                                                return "TAIL";
                                            case 402:
                                                return "INITIAL";
                                            case 403:
                                            ...
                                            case ApiErrorCodes.ERROR_CODE_FAILED_AUTHENTICATION_WRONG_PASSWORD /*{ENCODED_INT: 413}*/:
                                            ...
                                            default:
                                                switch (i) {
                                                    ...
                                                    case SqlExpression.SQLITE_MAXIMUM_PARAMETER_COUNT /*{ENCODED_INT: 450}*/:
                                                    ...
                                                    case WebDialog.NO_PADDING_SCREEN_WIDTH /*{ENCODED_INT: 480}*/:
                                                        ...
                                                        switch (i) {
                                                            ...
                                                            default:
                                                                switch (i) {
                                                                    ...
                                                                    case ViewPager.MAX_SETTLE_DURATION /*{ENCODED_INT: 600}*/:
    ...
    /*  JADX ERROR: Type inference failed with exception
        ...
        */
    @Override // X.AnonymousClass0TF
    public final java.lang.String A3o(int r4) {
        /*
        // Method dump skipped, instructions count: 34498
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass1MY.A3o(int):java.lang.String");
    }
}
