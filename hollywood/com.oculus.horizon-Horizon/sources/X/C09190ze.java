...
public final class C09190ze {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C09190ze.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }

    public static <T> C09170za<T> A00(C09170za<T> r5) {
        Type type = r5.type;
        if (!A06(type)) {
            StringBuilder sb = new StringBuilder("Key not fully specified ");
            sb.append(r5);
            throw new RuntimeException(sb.toString());
        } else if (r5.rawType != Provider.class) {
            return r5;
        } else {
            return new C09170za<>(new AnonymousClass0UP(null, Provider.class, ((ParameterizedType) type).getActualTypeArguments()[0]));
        }
    }
    ...
    public static Type A03(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new AnonymousClass0UQ(A03(cls.getComponentType()));
            }
            return type2;
        }
        if (!(type instanceof AbstractC09180zd)) {
            if (type instanceof ParameterizedType) {
                ParameterizedType parameterizedType = (ParameterizedType) type;
                return new AnonymousClass0UP(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
            } else if (type instanceof GenericArrayType) {
                return new AnonymousClass0UQ(((GenericArrayType) type).getGenericComponentType());
            } else {
                if (type instanceof WildcardType) {
                    WildcardType wildcardType = (WildcardType) type;
                    return new AnonymousClass0UO(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
                }
            }
        }
        return type;
    ...
    public static void A05(java.lang.reflect.Type r2, java.lang.String r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C09190ze.A05(java.lang.reflect.Type, java.lang.String):void");
    }
    ...
    public static boolean A06(Type type) {
        ...
        return ((AbstractC09180zd) type).A50();
    }
}
