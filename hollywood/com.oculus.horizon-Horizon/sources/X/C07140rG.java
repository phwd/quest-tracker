...
public class C07140rG implements AnonymousClass0D4<TResult, Void> {
    ...
    public C07140rG(AnonymousClass0DC r1, AnonymousClass0DD r2, AnonymousClass0D4 r3, Executor executor) {
        this.A01 = r1;
        this.A02 = r2;
        this.A00 = r3;
        this.A03 = executor;
    ...
    public final Void then(AnonymousClass0DC r5) throws Exception {
        ...
        try {
            this.A03.execute(new AnonymousClass0D6(r3, r2, r5));
            return null;
        } catch (Exception e) {
