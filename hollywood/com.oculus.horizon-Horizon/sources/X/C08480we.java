...
public final class C08480we {
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C08480we)) {
            return false;
        }
        C08480we r7 = (C08480we) obj;
        if (r7.A02.equals(this.A02) && r7.A04.equals(this.A04) && r7.A01.equals(this.A01) && r7.A03.equals(this.A03) && r7.A00 == this.A00 && r7.A08 == this.A08 && r7.A06 == this.A06 && r7.A07 == this.A07 && r7.A05 == this.A05) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        if (this.A07) {
            ...
            if (j == Long.MIN_VALUE) {
                ...
                sb.append("; expires=");
                format = C08060vp.A00.get().format(new Date(j));
            }
            sb.append(format);
        }
        if (!this.A05) {
    ...
    public C08480we(String str, String str2, long j, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4) {
        this.A02 = str;
        this.A04 = str2;
        this.A00 = j;
        this.A01 = str3;
