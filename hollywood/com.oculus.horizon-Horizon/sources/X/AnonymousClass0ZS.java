...
public final class AnonymousClass0ZS {
    public int A00;
    public int A01;
    public String A02;
    @Nullable
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            ...
            AnonymousClass0ZS r5 = (AnonymousClass0ZS) obj;
    ...
    public AnonymousClass0ZS() {
        this("", null, 0, 0);
    }

    public AnonymousClass0ZS(String str, @Nullable List<InetAddress> list, int i, int i2) {
        this.A02 = str;
        this.A03 = list;
        if (list != null) {
