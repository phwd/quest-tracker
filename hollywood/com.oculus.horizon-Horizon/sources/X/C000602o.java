...
public class C000602o<K, V> {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C000602o) {
                C000602o r7 = (C000602o) obj;
                if (size() == r7.size()) {
    ...
    private final int A01(Object obj, int i) {
        ...
        try {
            int A002 = AnonymousClass02f.A00(this.A01, i2, i);
    ...
    public static void A02(C000602o r6, int i) {
        if (i == 8) {
            synchronized (C000602o.class) {
                Object[] objArr = A06;
                if (objArr != null) {
                    r6.A02 = objArr;
                    A06 = (Object[]) objArr[0];
    ...
    public final V A06(int i) {
        ...
        if (i4 <= 1) {
            ...
            this.A01 = AnonymousClass02f.A00;
            this.A02 = AnonymousClass02f.A01;
            i2 = 0;
        } else {
            i2 = i4 - 1;
            int[] iArr = this.A01;
