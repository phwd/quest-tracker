...
public final class C000702p<E> implements Cloneable {
    ...
    public static void A00(C000702p r8) {
        int i = r8.A00;
        int[] iArr = r8.A02;
    ...
    public final void A02(int i, E e) {
        ...
        int i2 = this.A00;
        int i3 = i2;
        int A002 = AnonymousClass02f.A00(iArr, i2, i);
        if (A002 >= 0) {
            this.A03[A002] = e;
            return;
        }
        ...
        if (this.A01 && i2 >= iArr.length) {
            A00(this);
            i3 = this.A00;
            i4 = AnonymousClass02f.A00(iArr, i3, i) ^ -1;
        }
    ...
    public final Object clone() throws CloneNotSupportedException {
        try {
            C000702p r1 = (C000702p) super.clone();
    ...
    public C000702p(int i) {
        Object[] objArr;
        this.A01 = false;
        if (i == 0) {
            this.A02 = AnonymousClass02f.A00;
            objArr = AnonymousClass02f.A01;
        } else {
            int i2 = i << 2;
            int i3 = 4;
            while (true) {
