...
public final class AnonymousClass040 {
    ...
    public static AnonymousClass040 A00(@NonNull Person person) {
        IconCompat iconCompat;
        AnonymousClass03z r1 = new AnonymousClass03z();
        r1.A01 = person.getName();
        if (person.getIcon() != null) {
            iconCompat = IconCompat.A08(person.getIcon());
        } else {
            iconCompat = null;
        }
        r1.A00 = iconCompat;
        ...
        return new AnonymousClass040(r1);
    }

    @NonNull
    public static AnonymousClass040 A01(@NonNull Bundle bundle) {
        IconCompat iconCompat;
        Bundle bundle2 = bundle.getBundle("icon");
        AnonymousClass03z r2 = new AnonymousClass03z();
        ...
        return new AnonymousClass040(r2);
    }
    ...
    public final Person A02() {
        ...
        if (iconCompat != null) {
            icon = IconCompat.A04(iconCompat, null);
        } else {
            icon = null;
        }
    ...
    public AnonymousClass040(AnonymousClass03z r2) {
        this.A01 = r2.A01;
        this.A00 = r2.A00;
        this.A03 = r2.A03;
        this.A02 = r2.A02;
