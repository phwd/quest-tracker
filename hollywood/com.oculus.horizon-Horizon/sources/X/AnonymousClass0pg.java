...
public final class AnonymousClass0pg implements AnonymousClass0Kz {
    @Nullable
    ...
    @Nullable
    public static AnonymousClass0pg A00() {
        ...
        if (method != null) {
            try {
                ...
                if (Log.isLoggable("OldProcReader", 6)) {
                    Log.e("OldProcReader", AnonymousClass006.A07("Error (IllegalAccessException - ", e.getLocalizedMessage(), ")"), e);
                }
            } catch (InvocationTargetException e2) {
                if (Log.isLoggable("OldProcReader", 6)) {
                    Log.e("OldProcReader", AnonymousClass006.A07("Error (InvocationTargetException - ", e2.getLocalizedMessage(), ")"), e2);
                }
            }
        }
    ...
    public final boolean A7H(byte[] bArr, int i, int i2, int[] iArr, @Nullable String[] strArr, @Nullable long[] jArr, @Nullable float[] fArr) {
    ...
    @Override // X.AnonymousClass0Kz
    public final boolean A7x(String str, int[] iArr, @Nullable String[] strArr, @Nullable long[] jArr, @Nullable float[] fArr) {
