...
public final class AnonymousClass0WN {
    ...
    public static void A00(AnonymousClass0WN r2, byte b, short s, byte b2) throws IOException {
        int i;
        if (b2 == -1) {
            b2 = A06[b];
        }
    ...
    public static void A01(AnonymousClass0WN r5, int i) throws IOException {
        int i2 = 0;
        while ((i & -128) != 0) {
            r5.A05[i2] = (byte) ((i & Hpack.PREFIX_7_BITS) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE);
            i >>>= 7;
            i2++;
        }
        byte[] bArr = r5.A05;
    ...
    public AnonymousClass0WN(OutputStream outputStream) {
