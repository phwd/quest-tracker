...
public final class C06460nB extends DateFormat {
    public static final C06460nB A05 = new C06460nB();
    ...
    public C06460nB(TimeZone timeZone) {
        this.A04 = timeZone;
    }
    ...
    public final java.util.Date parse(java.lang.String r9, java.text.ParsePosition r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C06460nB.parse(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
}
