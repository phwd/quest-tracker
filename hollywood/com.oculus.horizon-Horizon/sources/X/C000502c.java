...
public final class C000502c<E> implements Collection<E>, Set<E> {
    ...
    public int A00 = 0;
    public AnonymousClass02n<E, E> A01;
    public int[] A02 = A08;
    ...
    public static int A00(C000502c r6) {
        int i = r6.A00;
        if (i == 0) {
            return -1;
        }
        int[] iArr = r6.A02;
        try {
            int A002 = AnonymousClass02f.A00(iArr, i, 0);
            if (A002 >= 0) {
    ...
    public static int A01(C000502c r4, Object obj, int i) {
        int i2 = r4.A00;
        if (i2 == 0) {
            return -1;
        }
        try {
            int A002 = AnonymousClass02f.A00(r4.A02, i2, i);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: X.02c<E> */
    ...
    public final Iterator<E> iterator() {
        AnonymousClass02n r1 = this.A01;
        if (r1 == null) {
            r1 = new C07480sr(this);
            this.A01 = r1;
        }
        AnonymousClass02k r0 = r1.A01;
        if (r0 == null) {
            r0 = new AnonymousClass02k(r1);
            r1.A01 = r0;
        }
        return r0.iterator();
    }
