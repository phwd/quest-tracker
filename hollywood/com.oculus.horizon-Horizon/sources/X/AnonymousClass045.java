...
public final class AnonymousClass045 {
    ...
    @RequiresApi(20)
    public static RemoteInput[] A00(AnonymousClass045[] r7) {
        int length = r7.length;
        RemoteInput[] remoteInputArr = new RemoteInput[length];
        for (int i = 0; i < length; i++) {
            AnonymousClass045 r6 = r7[i];
    ...
    public AnonymousClass045(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z, int i, Bundle bundle) {
        this.A03 = str;
