...
public final class AnonymousClass0YF {
    @VisibleForTesting
    public static final String A0O = AnonymousClass006.A05("KeepaliveManager", ".ACTION_INEXACT_ALARM.");
    public static final List<Long> A0P = Collections.unmodifiableList(new AnonymousClass0YB());
    public static final String A0Q = AnonymousClass006.A05("KeepaliveManager", ".ACTION_BACKUP_ALARM.");
    public static final String A0R = AnonymousClass006.A05("KeepaliveManager", ".ACTION_EXACT_ALARM.");
    @GuardedBy("this")
    public long A00;
    @GuardedBy("this")
    public long A01;
    ...
    public final AnonymousClass0Wc A0F;
    @VisibleForTesting
    ...
    public final AnonymousClass0b1 A0K = new C06150ma(this);
    ...
    public final synchronized void A03() {
        if (this.A03) {
            this.A03 = false;
            AnonymousClass0Wc r2 = this.A0F;
            AlarmManager alarmManager = this.A05;
            r2.A04(alarmManager, this.A08);
            if (!this.A0J) {
                r2.A04(alarmManager, this.A06);
            }
            r2.A04(alarmManager, this.A07);
        }
        this.A00 = 900000;
        this.A02 = -1;
    }
    ...
    @GuardedBy("this")
    public static void A01(AnonymousClass0YF r3, long j) {
        int i = r3.A04;
        if (i >= 23 && r3.A0J) {
    ...
    public static void A02(AnonymousClass0YF r5, long j, long j2) {
        if (r5.A04 < 23 || !r5.A0J) {
    ...
    public AnonymousClass0YF(Context context, C01630Wg r9, String str, AtomicInteger atomicInteger, RealtimeSinceBootClock realtimeSinceBootClock, Handler handler, AnonymousClass0Wc r14) {
        this.A0C = context;
        this.A0L = str;
        this.A0J = C01880Xv.A00(context.getPackageName());
        this.A0M = atomicInteger;
        AnonymousClass0W8 A002 = r9.A00("alarm", AlarmManager.class);
        if (A002.A02()) {
            ...
            this.A0D = handler;
            this.A0F = r14;
            this.A0A = new AnonymousClass0YC(this);
