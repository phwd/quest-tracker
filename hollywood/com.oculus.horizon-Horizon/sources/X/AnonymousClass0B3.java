...
public final class AnonymousClass0B3 implements AnonymousClass0Lx, AnonymousClass0Lw, Cloneable, ByteChannel {
    ...
    public final C07660v9 A07(int i) {
        if (i < 1 || i > 8192) {
            throw new IllegalArgumentException();
        }
        C07660v9 r0 = this.A01;
        if (r0 == null) {
            C07660v9 A002 = C07650v8.A00();
            this.A01 = A002;
            A002.A03 = A002;
            A002.A00 = A002;
            return A002;
    ...
    public final void A0H(AnonymousClass0B3 r12, long j, long j2) {
        long j3 = j2;
        long j4 = j;
        if (r12 != null) {
            C07610v4.A00(this.A00, j4, j3);
            if (j2 != 0) {
                r12.A00 += j2;
                C07660v9 r2 = this.A01;
                while (j4 >= ((long) (r2.A01 - r2.A02))) {
                    j4 -= (long) (r2.A01 - r2.A02);
                    r2 = r2.A00;
                }
                while (j3 > 0) {
                    C07660v9 A012 = r2.A01();
    ...
    @Override // X.AnonymousClass0Lw, X.AnonymousClass0Lx
    public final AnonymousClass0B3 A1V() {
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final AnonymousClass0Lx A2O() {
        return this;
    }

    @Override // java.lang.AutoCloseable, X.AbstractC07640v7, java.io.Closeable, X.AbstractC07630v6, java.nio.channels.Channel
    public final void close() {
    }

    @Override // X.AnonymousClass0Lx, X.AbstractC07640v7, java.io.Flushable
    ...
    private final String A00(long j, Charset charset) throws EOFException {
        ...
        if (charset == null) {
            ...
            C07660v9 r4 = this.A01;
            int i = r4.A02;
            if (((long) i) + j > ((long) r4.A01)) {
                return new String(A7s(j), charset);
            }
    ...
    public final String A04() {
        try {
            return A00(this.A00, C07610v4.A00);
    ...
    public final String A05(long j) throws EOFException {
        ...
        if (j > 0) {
            long j3 = j - 1;
            if (A01(j3) == 13) {
                A002 = A00(j3, C07610v4.A00);
                j2 = 2;
                A94(j2);
                return A002;
            }
        }
        A002 = A00(j, C07610v4.A00);
        A94(j2);
        return A002;
    }

    public final C07700vD A06() {
        long j = this.A00;
        if (j <= 2147483647L) {
            int i = (int) j;
            if (i == 0) {
            ...
            return new AnonymousClass0Ln(this, i);
        }
        ...
        if (i >= 128) {
            ...
            if (i >= 2048) {
                if (i < 65536) {
                    ...
                    A09((i >> 18) | 240);
                    i2 = ((i >> 12) & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE;
                } else {
                    throw new IllegalArgumentException(AnonymousClass006.A05("Unexpected code point: ", Integer.toHexString(i)));
                }
                A09(i2);
                i4 = (i3 & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE;
            }
            A09(i4);
            i = (i & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE;
        }
        A09(i);
    }
    ...
    public final void A0E(long j) {
        ...
        C07660v9 A07 = A07(numberOfTrailingZeros);
        byte[] bArr = A07.A06;
        int i = A07.A01;
                    ...
                    if (charAt < 128) {
                        ...
                        if (charAt >= 2048) {
                            if (charAt < 55296 || charAt > 57343) {
                                A09((charAt >> '\f') | 224);
                                i7 = ((charAt >> 6) & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE;
                            } else {
                                int i8 = i + 1;
                                if (i8 < i2) {
                                    c = str.charAt(i8);
                                ...
                                if (charAt > 56319 || c < 56320 || c > 57343) {
                                    ...
                                    A09((i9 >> 18) | 240);
                                    A09(((i9 >> 12) & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE);
                                    A09(((i9 >> 6) & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE);
                                    A09((i9 & 63) | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE);
                                    i += 2;
                                }
                            }
                        }
                        A09(i7);
                        A09((charAt & '?') | FacebookSdk.DEFAULT_MAXIMUM_POOL_SIZE);
                        i++;
                    }
                }
                return;
    ...
    public final void A0J(byte[] bArr, int i, int i2) {
        if (bArr != null) {
            long j = (long) i2;
            C07610v4.A00((long) bArr.length, (long) i, j);
            int i3 = i2 + i;
            while (i < i3) {
                C07660v9 A07 = A07(1);
                int i4 = A07.A01;
    ...
    @Override // X.AnonymousClass0Lw
    public final long A4n(byte b) {
        return A03(b, 0);
    }

    @Override // X.AnonymousClass0Lw
    public final InputStream A4q() {
        return new C07710vE(this);
    }

    @Override // X.AnonymousClass0Lx
    public final OutputStream A7F() {
        return new C07720vF(this);
    }

    @Override // X.AnonymousClass0Lw
    public final byte[] A7r() {
        try {
            return A7s(this.A00);
        } catch (EOFException e) {
            throw new AssertionError(e);
    ...
    @Override // X.AnonymousClass0Lw
    public final byte[] A7s(long j) throws EOFException {
        C07610v4.A00(this.A00, 0, j);
        if (j <= 2147483647L) {
            int i = (int) j;
    ...
    public final long A7u() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0B3.A7u():long");
    }
    ...
    public final long A7v() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0B3.A7v():long");
    }

    @Override // X.AnonymousClass0Lw
    public final String A80(Charset charset) {
        try {
    ...
    @Override // X.AnonymousClass0Lw
    public final void A8I(long j) throws EOFException {
        if (this.A00 < j) {
            throw new EOFException();
        }
    }
    ...
    @Override // X.AnonymousClass0Lw
    public final void A94(long j) throws EOFException {
        while (j > 0) {
            C07660v9 r6 = this.A01;
            if (r6 != null) {
                int i = r6.A01;
    ...
    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AA6(C07700vD r3) throws IOException {
        if (r3 != null) {
            r3.A0F(this);
            return this;
        }
    ...
    public final Object clone() throws CloneNotSupportedException {
        ...
        long j = this.A00;
        if (j != 0) {
            C07660v9 A012 = this.A01.A01();
            r7.A01 = A012;
            A012.A03 = A012;
            A012.A00 = A012;
            C07660v9 r3 = this.A01;
            while (true) {
                r3 = r3.A00;
                if (r3 == r3) {
                    break;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass0B3) {
                AnonymousClass0B3 r3 = (AnonymousClass0B3) obj;
                long j = this.A00;
                if (j == r3.A00) {
                    long j2 = 0;
                    if (j != 0) {
                        C07660v9 r9 = this.A01;
                        C07660v9 r8 = r3.A01;
                        int i = r9.A02;
                        int i2 = r8.A02;
                        while (j2 < j) {
    ...
    @Override // X.AnonymousClass0Lw
    public final boolean A7n(long j, C07700vD r10) {
        int A07 = r10.A07();
        if (j < 0 || A07 < 0 || this.A00 - j < ((long) A07) || A07 - 0 < A07) {
            return false;
        }
        for (int i = 0; i < A07; i++) {
            if (A01(((long) i) + j) != r10.A06(0 + i)) {
                return false;
            }
        }
        return true;
    ...
    @Override // X.AnonymousClass0Lw
    public final C07700vD A7t(long j) throws EOFException {
        return new C07700vD(A7s(j));
    }
    ...
    @Override // X.AnonymousClass0Lw
    public final short A7z() {
        int readShort = readShort() & 65535;
        return (short) (((readShort & 255) << 8) | ((65280 & readShort) >>> 8));
    }

    @Override // X.AbstractC07640v7, X.AbstractC07630v6
    ...
    @Override // X.AnonymousClass0Lw
    public final String A81() throws EOFException {
        ...
        AnonymousClass0B3 r8 = new AnonymousClass0B3();
        A0H(r8, 0, Math.min(32L, this.A00));
        StringBuilder sb = new StringBuilder("\\n not found: limit=");
        sb.append(Math.min(this.A00, Long.MAX_VALUE));
        sb.append(" content=");
        sb.append(new C07700vD(r8.A7r()).A09());
        sb.append((char) 8230);
        throw new EOFException(sb.toString());
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AA7(byte[] bArr) throws IOException {
        A0I(bArr);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAC(int i) throws IOException {
        A09(i);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAD(long j) throws IOException {
        A0D(j);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAE(long j) throws IOException {
        A0E(j);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAF(int i) throws IOException {
        A0A(i);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAH(int i) throws IOException {
        A0B(i);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AAI(String str) throws IOException {
        A0F(str);
        return this;
    }

    @Override // X.AnonymousClass0Lx
    public final /* bridge */ /* synthetic */ AnonymousClass0Lx AA8(byte[] bArr, int i, int i2) throws IOException {
        A0J(bArr, i, i2);
        return this;
    }
    ...
    public final long read(AnonymousClass0B3 r6, long j) {
        String str;
        if (r6 == null) {
            str = "sink == null";
        } else if (j >= 0) {
    ...
    public final void write(AnonymousClass0B3 r11, long j) {
        String str;
        int i;
        C07660v9 r5;
        int i2;
