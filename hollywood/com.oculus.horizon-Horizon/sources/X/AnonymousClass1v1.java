...
public abstract class AnonymousClass1v1 {
    public final synchronized void A01(byte b, byte[] bArr, int i, int i2) throws AnonymousClass1v5 {
        if (bArr == null) {
            throw new AnonymousClass1v5((byte) 80, new SSLException("Data cannot be null"));
        } else if (AnonymousClass1uw.A00.contains(Byte.valueOf(b))) {
            while (i2 > 16384) {
            ...
            throw new AnonymousClass1v5((byte) 80, new SSLException("Invalid content type"));
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0116, code lost:
        throw new X.AnonymousClass1v5(r3, new javax.net.ssl.SSLException(r1));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0122, code lost:
        throw new X.AnonymousClass1v5((byte) 80, new javax.net.ssl.SSLException(r1), true);
     */
    ...
    private final void A00(byte r15, byte[] r16, int r17, int r18) throws X.AnonymousClass1v5 {
        /*
        // Method dump skipped, instructions count: 310
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass1v1.A00(byte, byte[], int, int):void");
    }
}
