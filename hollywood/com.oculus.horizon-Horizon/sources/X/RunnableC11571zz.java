...
public class RunnableC11571zz implements Runnable {
    ...
    public RunnableC11571zz(AnonymousClass1zs r1, AnonymousClass1zF r2, Handler handler) {
        this.A02 = r1;
        this.A01 = r2;
        this.A00 = handler;
    }
    ...
    public final void run() {
        String str;
        AnonymousClass1zs r3 = this.A02;
        AnonymousClass1zF r4 = this.A01;
        Handler handler = this.A00;
        synchronized (r3) {
            r3.A03.append("asyncStart, ");
            if (r3.A08 != AnonymousClass007.A00) {
                Integer num = r3.A08;
                if (num != null) {
                ...
                r5.A00("current_state", AnonymousClass1z2.A00(r3.A08));
                r5.A00("method_invocation", r3.A03.toString());
                AnonymousClass1z7.A01(r4, handler, r5);
            } else {
                try {
                    r3.A00.start();
                    r3.A08 = AnonymousClass007.A01;
                    r3.A04.post(new AnonymousClass20A(r3));
                    r3.A03.append("asyncStart end, ");
                    AnonymousClass1z7.A00(r4, handler);
                } catch (Exception e) {
                    AnonymousClass205 r0 = new AnonymousClass205(e);
                    AnonymousClass1zs.A01(r3, r0, e);
