...
public final class AnonymousClass1mE extends InputStream implements AnonymousClass1mH {
    public int A00 = -1;
    public int A01 = 0;
    public int A02 = 0;
    ...
    @Override // X.AnonymousClass1mH
    public final void A1F(byte[] bArr, int i, int i2) throws IOException {
        String str;
        byte[] bArr2;
        int i3;
        byte[] bArr3 = this.A03;
        if (bArr3 == null) {
            ...
            if (i + i2 <= bArr.length) {
                ...
                if (i7 > length) {
                    ...
                    if (i10 < i2) {
                        ...
                        if (i8 == -1) {
                            int i11 = i5 - i4;
                            System.arraycopy(bArr3, i4, bArr2, 0, i11);
                            this.A02 = 0;
                            this.A01 = i11;
                            i6 = i11;
                            this.A00 = -1;
                        }
                        System.arraycopy(bArr3, i8, bArr2, i3, i9);
                        int i12 = this.A02;
                        int i13 = this.A00;
                        this.A02 = i12 - i13;
                        i6 = this.A01 - i13;
                        ...
                        if (i8 == -1) {
                            int i14 = i5 - i4;
                            System.arraycopy(bArr3, i4, bArr2, 0, i14);
                            this.A02 = 0;
                            this.A01 = i14;
                            i6 = i14;
                            this.A00 = -1;
            ...
            str = AnonymousClass006.A02("Len ", i2, " exceeds supplied buffer limits.");
        } else {
            return;
        }
