...
public abstract class AbstractRunnableC08660xD<T> extends AtomicReference<Runnable> implements Runnable {
    public static final Runnable A00 = new RunnableC08650xC();
    public static final Runnable A01 = new RunnableC08650xC();
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: X.0xD<T> */
