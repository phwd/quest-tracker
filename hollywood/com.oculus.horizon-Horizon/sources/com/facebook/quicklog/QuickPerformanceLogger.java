...
public interface QuickPerformanceLogger {
    ...
    @Deprecated
    void markerPoint(int i, int i2, @EventLevel int i3, String str, @Nullable AnonymousClass0T7 v, long j, int i4);

    void markerPoint(int i, int i2, @EventLevel int i3, String str, @Nullable AnonymousClass0T7 v, long j, TimeUnit timeUnit, int i4);
