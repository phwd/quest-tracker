...
public interface IFbnsAIDLService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFbnsAIDLService {
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                FbnsAIDLResult A7l = A7l(fbnsAIDLRequest);
                parcel2.writeNoException();
                if (A7l != null) {
                    parcel2.writeInt(1);
                    A7l.writeToParcel(parcel2, 1);
                    return true;
                }
                parcel2.writeInt(0);
                return true;
        ...
        public static class Proxy implements IFbnsAIDLService {
            ...
            public final FbnsAIDLResult A7l(FbnsAIDLRequest fbnsAIDLRequest) throws RemoteException {
            ...
            @Override // com.facebook.push.fbns.ipc.IFbnsAIDLService
            public final void A9i(FbnsAIDLRequest fbnsAIDLRequest) throws RemoteException {
                IFbnsAIDLService iFbnsAIDLService;
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.facebook.push.fbns.ipc.IFbnsAIDLService");
    ...
    FbnsAIDLResult A7l(FbnsAIDLRequest fbnsAIDLRequest) throws RemoteException;

    void A9i(FbnsAIDLRequest fbnsAIDLRequest) throws RemoteException;
}
