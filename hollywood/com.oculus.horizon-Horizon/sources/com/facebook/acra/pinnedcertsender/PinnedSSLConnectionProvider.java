...
public class PinnedSSLConnectionProvider implements HttpConnectionProvider {
    ...
    @Nullable
    public C01350Rz sFbPinningSSLContextFactory;

    public void configureSocketFactory(HttpsURLConnection httpsURLConnection) {
        C01350Rz r3 = this.sFbPinningSSLContextFactory;
        if (r3 == null) {
            r3 = new C01350Rz(this.mBuildTimeMs);
        ...
        try {
            ...
            AnonymousClass0NO.A0C(TAG, "Pinning failed", e);
        }
    }
