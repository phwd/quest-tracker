...
public class ANRReport implements IANRReport {
    ...
    public static class UUIDFileGenerator implements FileGenerator {
        ...
        public File generate() {
            return new File(this.mContext.getDir(this.mDirectory, 0), AnonymousClass006.A05(UUID.randomUUID().toString(), this.mExtension));
        }
    ...
    public static boolean deleteFile(File file) {
        ...
        AnonymousClass0NO.A0F(LOG_TAG, "Could not delete error report: %s", file.getName());
        return delete;
    }
    ...
    private void initializeProcessErrorPropertiesOnErrorReport() {
        synchronized (this.mANRProcessErrorProperties) {
            ...
            for (int i = 1; i <= this.mMaxUsedAnrProcessStateIndex; i++) {
                ErrorReporter.putCustomData(AnonymousClass006.A01(ErrorReportingConstants.ANR_OTHER_PROCESS_ERROR_PREFIX, i), this.mANRProcessErrorProperties.get(AnonymousClass006.A01(ErrorReportingConstants.ANR_OTHER_PROCESS_ERROR_PREFIX, i)));
            }
            this.mANRProcessErrorProperties.clear();
        }
    }
    ...
    public void logOtherProcessAnr(String str, @Nullable String str2, @Nullable String str3, long j) {
        synchronized (this.mANRProcessErrorProperties) {
            ...
            if (i < 5) {
                ...
                sb.append(',');
                sb.append(str3);
                this.mANRProcessErrorProperties.put(AnonymousClass006.A01(ErrorReportingConstants.ANR_OTHER_PROCESS_ERROR_PREFIX, i), sb.toString());
                addProcessErrorPropertiesToErrorReport();
        ...
        synchronized (this.mANRProcessErrorProperties) {
            ...
            if (!(str == null && str2 == null)) {
                try {
                    ...
                    AnonymousClass0NO.A0B(LOG_TAG, "Failed to save SIGQUIT", e);
                }
            }
            addProcessErrorPropertiesToErrorReport();
        }
