...
public class SigquitBasedANRDetector extends AbstractANRDetector implements SigquitDetectorListener {
    ...
    public class ProcessAnrErrorMonitorListener extends DefaultProcessErrorStateListener {
        ...
        public void onCheckFailed() {
            AnonymousClass0NO.A08(SigquitBasedANRDetector.LOG_TAG, "Failed when checking process error state");
        ...
        public void onMaxChecksReachedAfterError() {
            AnonymousClass0NO.A09(SigquitBasedANRDetector.LOG_TAG, "Reached max number of checks after error was detected");
            SigquitBasedANRDetector.this.processMonitorStopped(2);
        }

        @Override // com.facebook.acra.anr.processmonitor.ProcessErrorStateListener, com.facebook.acra.anr.processmonitor.DefaultProcessErrorStateListener
        public void onMaxChecksReachedBeforeError() {
            AnonymousClass0NO.A09(SigquitBasedANRDetector.LOG_TAG, "Reached max number of checks before error was detected");
    ...
    public void anrErrorClearedOnProcessMonitor() {
        setInAnrState(false);
        notifyStateListeners(AnonymousClass0VV.NO_ANR_DETECTED);
    ...
    private void installSignalHandlerAndMaybeStart(boolean z) {
        synchronized (this.mStateLock) {
            if (!sNativeInited) {
                ...
                aNRDetectorConfig.mAppStateUpdater = new AppStateUpdater() {
                    ...
                    public void updateAnrState(AnonymousClass0VV r3, @Nullable Runnable runnable) {
                        AnonymousClass1 r1;
                        if (r3 != AnonymousClass0VV.DURING_ANR) {
                            r1 = new Runnable() {
            ...
            if (handler == null) {
                AnonymousClass0NO.A09(LOG_TAG, "nativeLibraryLoaded has not been called yet");
            } else {
    ...
    private void maybeStartACRAReport(String str, String str2, long j) {
        if ((this.mInForegroundV1 || this.mInForegroundV2) && shouldCollectAndUploadANRReports()) {
            ...
            try {
                ...
                AnonymousClass0NO.A0H(LOG_TAG, e, "Error saving ANR report");
            }
        } else if (str2 != null) {
    ...
    public void sigquitDetected(final String str, final String str2, final boolean z, final boolean z2) {
        final boolean z3;
        AnonymousClass0NO.A09(LOG_TAG, "On sigquitDetected call");
        ...
        if (!isDebuggerConnected() && this.mRunning) {
            ...
            if (inAnrState()) {
                AnonymousClass0NO.A09(LOG_TAG, "Detected a new ANR before the end of the previous one");
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            synchronized (this.mProcessingThreadLock) {
                ...
                if (handler2 != null) {
                    handler2.post(new Runnable() {
                        ...
                        public void run() {
                            if (z3) {
                                AnonymousClass0NO.A09(SigquitBasedANRDetector.LOG_TAG, "Clearing current ANR");
                                SigquitBasedANRDetector.this.anrErrorClearedOnProcessMonitor();
                            }
                            AnonymousClass0NO.A09(SigquitBasedANRDetector.LOG_TAG, "On processing thread handling ANR start");
                            SigquitBasedANRDetector.this.updateForegroundState(z, z2);
                            SigquitBasedANRDetector.this.notifyStateListeners(AnonymousClass0VV.DURING_ANR);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            if (SigquitBasedANRDetector.this.inAnrState()) {
                                ...
                                SigquitBasedANRDetector.this.notifyStateListeners(AnonymousClass0VV.ANR_RECOVERED);
                            }
                        }
                    });
                }
            ...
            public void run() {
                synchronized (SigquitBasedANRDetector.this.mWaitingToClearANRLock) {
                    ...
                    if (sigquitBasedANRDetector.mWaitingForANRClearTimeout) {
                        sigquitBasedANRDetector.notifyStateListeners(AnonymousClass0VV.NO_ANR_DETECTED);
    ...
    private void notifyStateListeners(AnonymousClass0VV r4, boolean z) {
        AnonymousClass0VV r0;
        AppStateUpdater appStateUpdater = this.mANRConfig.mAppStateUpdater;
        AnonymousClass0VV r02 = AnonymousClass0VV.DURING_ANR;
        if (r4 == r02) {
            if (appStateUpdater != null) {
            ...
            if (isProcessErrorMonitorMonitoring() || r4 == AnonymousClass0VV.ANR_RECOVERED) {
                r0 = AnonymousClass0VV.ANR_RECOVERED;
            } else {
                r0 = AnonymousClass0VV.NO_ANR_DETECTED;
            }
    ...
    public void notifyStateListeners(X.AnonymousClass0VV r3) {
        /*
            r2 = this;
        ...
        L_0x000a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.acra.anr.sigquit.detector.SigquitBasedANRDetector.notifyStateListeners(X.0VV):void");
    }
}
