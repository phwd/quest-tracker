...
public class ACRA {
        ...
        if (context != null) {
            ...
            if (file.exists()) {
                try {
                    ...
                    AnonymousClass0NO.A0C("ACRA", "Failed to read fury traces file", e);
                    return null;
                }
            }
        }
    ...
    public static void writeSenderHost(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    AnonymousClass0NO.A0H("ACRA", e, "could not write to host file: ");
    ...
    public static void addFuryTracesToReportSourceRef(JSONObject jSONObject, String str) {
        ...
        if (furyTraces != null && !furyTraces.equals("")) {
            try {
                ...
                AnonymousClass0NO.A0F("ACRA", "Invalid fury file contents: %s", furyTraces, e);
            }
        }
    }
    ...
    public static void closeStreamNoException(@Nullable Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                AnonymousClass0NO.A0H("ACRA", e, "Error while closing stream: ");
            }
        }
    }
    ...
    public static void deleteHostsFileIfEmpty(Context context) {
        try {
            ...
            if (!fileStreamPath.canRead() || !fileStreamPath.canWrite()) {
                AnonymousClass0NO.A08("ACRA", "cannot read or write host file");
            } else if (fileStreamPath.length() == 0 && !context.deleteFile(REPORT_HOST_FILE_NAME)) {
                AnonymousClass0NO.A08("ACRA", "could not delete empty host file");
            }
        } catch (SecurityException e) {
            AnonymousClass0NO.A0H("ACRA", e, "could not delete empty host file: ");
        }
    }
            ...
            if (file.exists()) {
                ...
                if (file2.exists()) {
                    try {
                        ...
                        AnonymousClass0NO.A0C("ACRA", "Failed to read report source ref override file", e);
                        return null;
                    }
                }
            }
    ...
    public static void installPeriodicReporter(Context context, final ErrorReporter errorReporter) {
        int A00 = AnonymousClass0OS.A00(context, "acraconfig_logcat_native_crash_periodic_interval_mins", 0);
        if (A00 > 0) {
            long j = (long) A00;
    ...
    public static JSONObject jsonifyReportSourceRef(String str) {
        ...
        try {
            ...
            AnonymousClass0NO.A0F("ACRA", "Invalid report source ref override file contents: %s", str, e);
            return null;
        }
    }
    ...
    public static void nativeLibrarySuccessfullyLoaded(Context context) {
        ...
        String A08;
        File dir;
        boolean A01 = AnonymousClass0OS.A01(context, "acraconfig_enable_nightwatch");
        boolean A012 = AnonymousClass0OS.A01(context, "nightwatch_monitor_resources");
        int A00 = AnonymousClass0OS.A00(context, "nightwatch_tick_info_count", 0);
        if (A01 || A012 || A00 > 0) {
            String processName = getProcessName();
            if (!processName.contains(":")) {
                boolean A013 = AnonymousClass0OS.A01(context, "acraconfig_nightwatch_use_setsid");
                boolean A014 = AnonymousClass0OS.A01(context, "acraconfig_nightwatch_use_lss_on_exec");
                boolean A015 = AnonymousClass0OS.A01(context, "nightwatch_use_mmap");
                int A002 = AnonymousClass0OS.A00(context, "nightwatch_monitor_resources_interval_ms", 500);
                boolean z = true;
                if (AnonymousClass0OS.A00(context, "nightwatch_split_mmap", 0) != 1) {
                    z = false;
                }
                int A003 = AnonymousClass0OS.A00(context, "nightwatch_mmap_update_min_interval_ms", 0);
                boolean z2 = true;
                if (AnonymousClass0OS.A00(context, "acra_nightwatch_turn_off_fast_jni_methods", 0) != 1) {
                    z2 = false;
                }
                AnonymousClass0O0 r8 = new AnonymousClass0O0(A01, A013, A014, A015, A012, A002, A00, z, A003, !z2);
                if (AnonymousClass0OS.A01(context, "acraconfig_nightwatch_use_asl_session_id")) {
                    A08 = AnonymousClass006.A08(processName.replace(':', '_'), "_", mConfig.getSessionId(), ".txt");
                    dir = context.getDir("watcher", 0);
                } else {
                    Random random = new Random();
                    A08 = AnonymousClass006.A08(processName.replace(':', '_'), "_", new UUID(random.nextLong(), random.nextLong()).toString(), ".txt");
                    dir = context.getDir("watcher", 0);
                }
                AnonymousClass0O3.A00(new File(dir, A08), r8);
            }
        }
        synchronized (sANRDetectorLock) {
            IANRDetector iANRDetector = mANRDetector;
        ...
        if (AnonymousClass0OS.A01(context, "acraconfig_disable_fs_sync_syscalls")) {
            NoSync.disableFSSync(AnonymousClass0OS.A01(context, "acraconfig_use_fast_fs_sync_hooks"));
        }
        AnonymousClass0Kv r0 = C01160Kw.A00().A00;
        if (r0 != null) {
            str = r0.A00;
        } else {
            str = null;
        }
        if ("videoplayer".equalsIgnoreCase(str) && AnonymousClass0OS.A01(context, "acraconfig_disable_fs_sync_syscalls_vps")) {
            NoSync.disableFSSync(AnonymousClass0OS.A01(context, "acraconfig_use_fast_fs_sync_hooks"));
        }
    ...
    public static boolean shouldRunNightwatch(Context context) {
        return AnonymousClass0OS.A01(context, "acraconfig_enable_nightwatch");
    }
    ...
    public static void writeSkipCertChecksFile(boolean z) {
        ...
        try {
            ...
            AnonymousClass0NO.A0H("ACRA", e, "could not create ssl cert checks file.");
        }
    }
    ...
    public static ErrorReporter init(AcraReportingConfig acraReportingConfig, long j, @Nullable AppStateUpdater appStateUpdater, @Nullable ErrorReporter.ExcludedReportObserver excludedReportObserver) {
        ...
        if (mConfig == null) {
            ...
            if (mConfig.shouldStopAnrDetectorOnErrorReporting()) {
                AnonymousClass0K4.A02(new AnonymousClass0K5() {
                    /* class com.facebook.acra.ACRA.AnonymousClass1 */

                    @Override // X.AnonymousClass0K5
                    public void handleUncaughtException(Thread thread, Throwable th, @Nullable AnonymousClass0K1 r3) {
                        ACRA.stopANRDetector();
                    }
                }, 100);
            }
            AnonymousClass0K4.A02(instance, 0);
            if (th != null) {
