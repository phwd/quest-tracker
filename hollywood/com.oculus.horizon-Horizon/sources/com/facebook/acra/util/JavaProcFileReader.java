...
public class JavaProcFileReader extends ProcFileReader {
    ...
    public int getOpenFDCount() {
        try {
            ...
            AnonymousClass0NO.A08(TAG, e.getMessage());
            return -2;
        }
    }
    ...
    public ProcFileReader.OpenFDLimits getOpenFDLimits() {
        ...
        try {
            ...
            try {
                ...
                while ((read - 1) - i > bytes.length) {
                    ...
                    if (startsWithOffset(bArr, i, bytes)) {
                        if (AnonymousClass0L0.A00.A7H(bArr, i, findNewLineOrEnd, PROC_OPEN_FD_LIMITS_FORMAT, strArr, null, null)) {
            ...
            AnonymousClass0NO.A0I(TAG, e, "Failed to read /proc/self/limits");
            return null;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00b3, code lost:
        X.AnonymousClass0NO.A0H(com.facebook.acra.util.JavaProcFileReader.TAG, r2, "Exception caught while reading open file descriptors");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x00be, code lost:
        return r2.getMessage();
     */
    /* JADX WARNING: Removed duplicated region for block: B:27:0x00b2 A[ExcHandler: IOException | IndexOutOfBoundsException | SecurityException (r2v4 'e' java.lang.Throwable A[CUSTOM_DECLARE]), Splitter:B:12:0x005d] */
    @Override // com.facebook.acra.util.ProcFileReader
