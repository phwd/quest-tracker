...
public class CrashTimeDataCollectorHelper {
    ...
    public static String getJailStatus() {
        ...
        try {
            ...
            AnonymousClass0NO.A0H("ACRA", e, "Failed to find Superuser.pak");
        }
        ...
        for (String str2 : map.get("PATH").split(":")) {
            try {
                if (new File(AnonymousClass006.A05(str2, "/su")).exists()) {
                    return "yes";
                }
            } catch (Exception e2) {
                AnonymousClass0NO.A0H("ACRA", e2, "Failed to find su binary in the PATH");
            }
        }
        return "no";
    }
