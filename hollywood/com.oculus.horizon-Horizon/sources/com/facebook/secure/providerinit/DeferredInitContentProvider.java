...
public abstract class DeferredInitContentProvider extends ContentProvider {
    ...
    public AnonymousClass1bn mDelegate;
    public volatile ProviderInfo mProviderInfo;

    /* access modifiers changed from: private */
    public synchronized AnonymousClass1bn getDelegate() {
        AnonymousClass1bn r0;
        r0 = this.mDelegate;
        if (r0 == null) {
            AnonymousClass0b7.A00.block();
    ...
    public final void onLowMemory() {
        if (AnonymousClass0b7.A00.block(-1)) {
            getDelegate().A08();
        }
    }
    ...
    private String getDelegateClassName() {
        return AnonymousClass006.A05(getClass().getName(), "$Impl");
    }
    ...
    public final Bundle call(String str, @Nullable String str2, @Nullable Bundle bundle) {
        AnonymousClass1bn delegate = getDelegate();
    ...
    public final int delete(Uri uri, @Nullable String str, @Nullable String[] strArr) {
        ...
        DeferredInitAbstractContentProviderNoDIDelegate.A04(deferredInitAbstractContentProviderNoDIDelegate, LinkedAccountsDumperPlugin.COMMAND_DELETE);
        try {
            DeferredInitAbstractContentProviderNoDIDelegate.A02(deferredInitAbstractContentProviderNoDIDelegate);
            throw null;
        } catch (Throwable th) {
    ...
    public AnonymousClass1bn getDelegateInstance() {
        try {
            return (AnonymousClass1bn) Class.forName(getDelegateClassName()).getDeclaredConstructor(DeferredInitContentProvider.class).newInstance(this);
    ...
    public final Uri insert(Uri uri, @Nullable ContentValues contentValues) {
        DeferredInitAbstractContentProviderNoDIDelegate deferredInitAbstractContentProviderNoDIDelegate = (DeferredInitAbstractContentProviderNoDIDelegate) getDelegate();
        DeferredInitAbstractContentProviderNoDIDelegate.A04(deferredInitAbstractContentProviderNoDIDelegate, LinkedAccountsDumperPlugin.COMMAND_INSERT);
        try {
            DeferredInitAbstractContentProviderNoDIDelegate.A02(deferredInitAbstractContentProviderNoDIDelegate);
            throw null;
        } catch (Throwable th) {
    ...
    public final int update(Uri uri, @Nullable ContentValues contentValues, @Nullable String str, @Nullable String[] strArr) {
        DeferredInitAbstractContentProviderNoDIDelegate deferredInitAbstractContentProviderNoDIDelegate = (DeferredInitAbstractContentProviderNoDIDelegate) getDelegate();
        DeferredInitAbstractContentProviderNoDIDelegate.A04(deferredInitAbstractContentProviderNoDIDelegate, ConfigUpdaterDumperPlugin.COMMAND_UPDATE);
        try {
            DeferredInitAbstractContentProviderNoDIDelegate.A02(deferredInitAbstractContentProviderNoDIDelegate);
            throw null;
        } catch (Throwable th) {
    ...
    public Cursor query(Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        DeferredInitAbstractContentProviderNoDIDelegate deferredInitAbstractContentProviderNoDIDelegate = (DeferredInitAbstractContentProviderNoDIDelegate) getDelegate();
        DeferredInitAbstractContentProviderNoDIDelegate.A04(deferredInitAbstractContentProviderNoDIDelegate, LinkedAccountsDumperPlugin.COMMAND_QUERY);
        try {
            DeferredInitAbstractContentProviderNoDIDelegate.A03(deferredInitAbstractContentProviderNoDIDelegate);
            throw null;
        } catch (Throwable th) {
