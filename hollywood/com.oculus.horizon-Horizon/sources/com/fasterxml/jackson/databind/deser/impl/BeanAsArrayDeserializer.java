...
public final class BeanAsArrayDeserializer extends BeanDeserializerBase {
    ...
    public BeanAsArrayDeserializer(BeanDeserializerBase beanDeserializerBase, AnonymousClass0HD[] r3) {
        super(beanDeserializerBase, beanDeserializerBase._ignoreAllUnknown);
        this._delegate = beanDeserializerBase;
        this._orderedProperties = r3;
    }

    private final void A00(AbstractC04100gp r3) throws IOException, AnonymousClass0jg {
    ...
    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    public final BeanDeserializerBase A0Q(C05530lQ r4) {
