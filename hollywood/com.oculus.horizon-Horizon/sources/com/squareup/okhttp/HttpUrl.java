...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i < length) {
                if (i == i3) {
                    ...
                    r2.A0E((long) (((bArr[i] & 255) << 8) | (bArr[i + 1] & 255)));
                    i += 2;
                }
            }
            return r2.A04();
        ...
        public Builder setEncodedPathSegment(int i, String str) {
            ...
            if (str != null) {
                ...
                str2 = AnonymousClass006.A05("unexpected path segment: ", str);
            } else {
                str2 = "encodedPathSegment == null";
            }
        ...
        public Builder addEncodedQueryParameter(String str, String str2) {
            ...
            if (str != null) {
                ...
                list.add(HttpUrl.canonicalize(str, HttpUrl.QUERY_COMPONENT_ENCODE_SET, true, true, true));
                List<String> list2 = this.encodedQueryNamesAndValues;
                if (str2 != null) {
                    str3 = HttpUrl.canonicalize(str2, HttpUrl.QUERY_COMPONENT_ENCODE_SET, true, true, true);
                } else {
                    str3 = null;
                }
                list2.add(str3);
        ...
        public Builder addQueryParameter(String str, String str2) {
            ...
            if (str != null) {
                ...
                list.add(HttpUrl.canonicalize(str, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, true, true));
                List<String> list2 = this.encodedQueryNamesAndValues;
                if (str2 != null) {
                    str3 = HttpUrl.canonicalize(str2, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, true, true);
                } else {
                    str3 = null;
                }
                list2.add(str3);
        ...
        public Builder encodedPath(String str) {
            String str2;
            if (str == null) {
                str2 = "encodedPath == null";
            } else if (str.startsWith("/")) {
                resolvePath(str, 0, str.length());
                return this;
            } else {
                str2 = AnonymousClass006.A05("unexpected encodedPath: ", str);
            }
            throw new IllegalArgumentException(str2);
        }
        ...
        public Builder encodedQuery(String str) {
            List<String> list;
            if (str != null) {
                list = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, HttpUrl.QUERY_ENCODE_SET, true, true, true));
            } else {
                list = null;
            }
            this.encodedQueryNamesAndValues = list;
        ...
        public Builder host(String str) {
            ...
            if (str != null) {
                ...
                str2 = AnonymousClass006.A05("unexpected host: ", str);
            } else {
                str2 = "host == null";
            }
            throw new IllegalArgumentException(str2);
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
                ...
                while (true) {
                    ...
                    if (delimiterOffset == skipTrailingAsciiWhitespace || (charAt = str.charAt(delimiterOffset)) == 65535 || charAt == '#' || charAt == '/' || charAt == '\\' || charAt == '?') {
                        ...
                        if (!z) {
                            ...
                            if (z2) {
                                canonicalize = AnonymousClass006.A07(this.encodedUsername, "%40", canonicalize);
                            }
                            ...
                            this.encodedPassword = AnonymousClass006.A07(this.encodedPassword, "%40", HttpUrl.canonicalize(str, i, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, true));
                        }
                        i = delimiterOffset + 1;
                    }
                }
            ...
            if (delimiterOffset3 < skipTrailingAsciiWhitespace && str.charAt(delimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, delimiterOffset3 + 1, delimiterOffset3, HttpUrl.QUERY_ENCODE_SET, true, true, true));
            }
            if (delimiterOffset3 < skipTrailingAsciiWhitespace && str.charAt(delimiterOffset3) == '#') {
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(AnonymousClass006.A01("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
        ...
        public Builder query(String str) {
            List<String> list;
            if (str != null) {
                list = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, HttpUrl.QUERY_ENCODE_SET, false, true, true));
            } else {
                list = null;
            }
            this.encodedQueryNamesAndValues = list;
        ...
        public Builder scheme(String str) {
            ...
            if (str != null) {
                ...
                if (!str.equalsIgnoreCase(str3)) {
                    str3 = "https";
                    if (!str.equalsIgnoreCase(str3)) {
                        str2 = AnonymousClass006.A05("unexpected scheme: ", str);
                    }
                }
                this.scheme = str3;
                return this;
    ...
    public static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        switch (parse.ordinal()) {
            ...
            case 4:
                throw new UnknownHostException(AnonymousClass006.A05("Invalid host: ", str));
        }
    }
    ...
    public URI uri() {
        try {
            ...
            throw new IllegalStateException(AnonymousClass006.A05("not valid as a java.net.URI: ", this.url));
        }
    }
    ...
    public static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        ...
        while (i3 < i2) {
            ...
            AnonymousClass0B3 r2 = new AnonymousClass0B3();
            r2.A0G(str, i, i3);
            canonicalize(r2, str, i3, i2, str2, z, z2, z3);
            return r2.A04();
        }
    ...
    public static void canonicalize(AnonymousClass0B3 r6, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        String str3;
        AnonymousClass0B3 r4 = null;
        while (i < i2) {
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z2) {
                    ...
                    while (!r4.A2a()) {
                        ...
                        r6.A09(cArr[(readByte >> 4) & 15]);
                        r6.A09(cArr[readByte & 15]);
                    }
                } else {
                    r6.A0C(codePointAt);
                }
    ...
    public static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                AnonymousClass0B3 r0 = new AnonymousClass0B3();
                r0.A0G(str, i, i3);
                percentDecode(r0, str, i3, i2, z);
                return r0.A04();
            }
        }
        return str.substring(i, i2);
    ...
    public static void percentDecode(AnonymousClass0B3 r5, String str, int i, int i2, boolean z) {
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37) {
                int i3 = i + 2;
                if (i3 < i2) {
                    ...
                    if (!(decodeHexDigit == -1 || decodeHexDigit2 == -1)) {
                        r5.A09((decodeHexDigit << 4) + decodeHexDigit2);
                        i = i3;
                    }
                }
                r5.A0C(codePointAt);
