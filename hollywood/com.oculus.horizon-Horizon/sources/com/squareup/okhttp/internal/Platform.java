            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        Class<?> cls4 = Class.forName(AnonymousClass006.A05("org.eclipse.jetty.alpn.ALPN", "$Provider"));
                        return new JdkWithJettyBootPlatform(cls2, cls3.getMethod("put", SSLSocket.class, cls4), cls3.getMethod("get", SSLSocket.class), cls3.getMethod(ConfigUpdaterDumperPlugin.COMMAND_REMOVE, SSLSocket.class), Class.forName(AnonymousClass006.A05("org.eclipse.jetty.alpn.ALPN", "$ClientProvider")), Class.forName(AnonymousClass006.A05("org.eclipse.jetty.alpn.ALPN", "$ServerProvider")));
