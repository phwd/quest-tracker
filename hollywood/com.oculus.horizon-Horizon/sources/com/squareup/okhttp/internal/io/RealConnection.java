...
public final class RealConnection implements Connection {
    ...
    private void connectSocket(int i, int i2, int i3, ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            this.source = new C00560Au(C07690vC.A01(this.rawSocket));
            this.sink = new C00570Av(C07690vC.A00(this.rawSocket));
    ...
    private void createTunnel(int i, int i2) throws IOException {
        ...
        while (true) {
            AnonymousClass0Lw r1 = this.source;
            ...
            AbstractC07630v6 newFixedLengthSource = http1xStream.newFixedLengthSource(contentLength);
            ...
            } else if (!this.source.A1V().A2a() || !this.sink.A1V().A2a()) {
