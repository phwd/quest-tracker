...
public final class Http2 implements Variant {
    public static final C07700vD CONNECTION_PREFACE = C07700vD.A04("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    public static final class ContinuationSource implements AbstractC07630v6 {
        public byte flags;
        public int left;
        public int length;
        ...
        public long read(AnonymousClass0B3 r8, long j) throws IOException {
            while (true) {
                int i = this.left;
                if (i == 0) {
                    this.source.A94((long) this.padding);
                    this.padding = 0;
                    if ((this.flags & 4) != 0) {
                        break;
                    }
        ...
        public ContinuationSource(AnonymousClass0Lw r1) {
            this.source = r1;
        }
    }
    ...
    public static final class Reader implements FrameReader {
        ...
        private void readGoAway(FrameReader.Handler handler, int i, byte b, int i2) throws IOException {
            ...
            if (i < 8) {
                ...
                if (fromHttp2 != null) {
                    C07700vD r0 = C07700vD.A03;
                    if (i3 > 0) {
                        r0 = this.source.A7t((long) i3);
                    }
            ...
            try {
                ...
                switch (readByte) {
                    ...
                    case 8:
                        ...
                        return true;
                    default:
                        this.source.A94((long) readMedium);
                        return true;
                }
        ...
        public void readConnectionPreface() throws IOException {
            if (!this.client) {
                C07700vD A7t = this.source.A7t((long) Http2.CONNECTION_PREFACE.A07());
                if (Http2.logger.isLoggable(Level.FINE)) {
                    Http2.logger.fine(String.format("<< CONNECTION %s", A7t.A09()));
                }
                if (!Http2.CONNECTION_PREFACE.equals(A7t)) {
                    Http2.access$200("Expected a connection header but was %s", new Object[]{A7t.A0A()});
                    throw new RuntimeException("Redex: Unreachable code after no-return invoke");
                }
            }
        }

        public Reader(AnonymousClass0Lw r3, int i, boolean z) {
            this.source = r3;
            this.client = z;
    ...
    public static final class Writer implements FrameWriter {
        ...
        public final AnonymousClass0B3 hpackBuffer;
        ...
        public synchronized void connectionPreface() throws IOException {
            if (this.closed) {
                ...
                this.sink.AA7(Http2.CONNECTION_PREFACE.A0I());
                this.sink.flush();
            }
        }

        @Override // com.squareup.okhttp.internal.framed.FrameWriter
        public synchronized void data(boolean z, int i, AnonymousClass0B3 r5, int i2) throws IOException {
            if (!this.closed) {
                byte b = 0;
                if (z) {
                    b = (byte) 1;
        ...
        public void dataFrame(int i, byte b, AnonymousClass0B3 r6, int i2) throws IOException {
        ...
        public synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
            if (this.closed) {
                ...
                this.sink.AAF(i);
                this.sink.AAF(errorCode.httpCode);
                if (length > 0) {
                    this.sink.AA7(bArr);
                }
                this.sink.flush();
        ...
        public synchronized void pushPromise(int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.AAF(i2 & Integer.MAX_VALUE);
        ...
        public Writer(AnonymousClass0Lx r3, boolean z) {
            this.sink = r3;
            this.client = z;
    ...
    public static void writeMedium(AnonymousClass0Lx r1, int i) throws IOException {
        r1.AAC((i >>> 16) & 255);
        r1.AAC((i >>> 8) & 255);
        r1.AAC(i & 255);
    }
    ...
    public FrameReader newReader(AnonymousClass0Lw r3, boolean z) {
    ...
    public static int readMedium(AnonymousClass0Lw r2) throws IOException {
