...
public final class Spdy3 implements Variant {
    ...
    public static final class Reader implements FrameReader {
        ...
        private void readGoAway(FrameReader.Handler handler, int i, int i2) throws IOException {
            ...
            if (i2 == 8) {
                ...
                if (fromSpdyGoAway != null) {
                    handler.goAway(readInt, fromSpdyGoAway, C07700vD.A03);
                    return;
                } else {
        ...
        public Reader(AnonymousClass0Lw r2, boolean z) {
            this.source = r2;
    ...
    public static final class Writer implements FrameWriter {
        ...
        public final AnonymousClass0B3 headerBlockBuffer;
        public final AnonymousClass0Lx headerBlockOut;
        ...
        @Override // com.squareup.okhttp.internal.framed.FrameWriter
        public synchronized void data(boolean z, int i, AnonymousClass0B3 r4, int i2) throws IOException {
            int i3 = 0;
            if (z) {
                i3 = 1;
            }
        ...
        public synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
            if (this.closed) {
                ...
                this.sink.AAF(-2147287033);
                this.sink.AAF(8);
                this.sink.AAF(i);
                this.sink.AAF(errorCode.spdyGoAwayCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.AAF(-2147287032);
                this.sink.AAF((((int) (this.headerBlockBuffer.A00 + 4)) & 16777215) | 0);
                this.sink.AAF(i & Integer.MAX_VALUE);
                this.sink.AA9(this.headerBlockBuffer);
            } else {
                throw new IOException("closed");
            }
        }
        ...
        public synchronized void rstStream(int i, ErrorCode errorCode) throws IOException {
            if (this.closed) {
                ...
                this.sink.AAF(-2147287037);
                this.sink.AAF(8);
                this.sink.AAF(i & Integer.MAX_VALUE);
                this.sink.AAF(errorCode.spdyRstCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void settings(Settings settings) throws IOException {
            if (!this.closed) {
                ...
                this.sink.AAF(-2147287036);
                int i = 0;
                this.sink.AAF((((bitCount << 3) + 4) & 16777215) | 0);
                this.sink.AAF(bitCount);
                do {
                    if (settings.isSet(i)) {
                        this.sink.AAF(((settings.flags(i) & 255) << 24) | (i & 16777215));
                        this.sink.AAF(settings.values[i]);
                    }
                    i++;
                } while (i <= 10);
                this.sink.flush();
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.AAF(-2147287038);
                this.sink.AAF(((i2 & 255) << 24) | (((int) (this.headerBlockBuffer.A00 + 4)) & 16777215));
                this.sink.AAF(i & Integer.MAX_VALUE);
                this.sink.AA9(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.AAF(-2147287039);
                this.sink.AAF(((((z ? 1 : 0) | i4) & 255) << 24) | (i3 & 16777215));
                this.sink.AAF(i & Integer.MAX_VALUE);
                this.sink.AAF(Integer.MAX_VALUE & i2);
                this.sink.AAH(0);
                this.sink.AA9(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        private void writeNameValueBlockToBuffer(List<Header> list) throws IOException {
            this.headerBlockOut.AAF(list.size());
            int size = list.size();
            for (int i = 0; i < size; i++) {
                C07700vD r2 = list.get(i).name;
                this.headerBlockOut.AAF(r2.A07());
                this.headerBlockOut.AA6(r2);
                C07700vD r22 = list.get(i).value;
                this.headerBlockOut.AAF(r22.A07());
                this.headerBlockOut.AA6(r22);
            }
            this.headerBlockOut.flush();
        }

        public void sendDataFrame(int i, int i2, AnonymousClass0B3 r8, int i3) throws IOException {
            if (!this.closed) {
                long j = (long) i3;
                if (j <= 16777215) {
                    this.sink.AAF(i & Integer.MAX_VALUE);
                    this.sink.AAF(((i2 & 255) << 24) | (16777215 & i3));
                    if (i3 > 0) {
        ...
        public Writer(AnonymousClass0Lx r4, boolean z) {
            this.sink = r4;
            this.client = z;
            ...
            this.headerBlockOut = new C00570Av(new AnonymousClass0Lv(r0, deflater));
        }
    }
    ...
    public FrameReader newReader(AnonymousClass0Lw r2, boolean z) {
        return new Reader(r2, z);
    }

    @Override // com.squareup.okhttp.internal.framed.Variant
    public FrameWriter newWriter(AnonymousClass0Lx r2, boolean z) {
