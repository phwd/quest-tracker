...
public final class FramedStream {
    ...
    public final class FramedDataSink implements AbstractC07640v7 {
        public static final /* synthetic */ boolean $assertionsDisabled = false;
        public static final long EMIT_BUFFER_SIZE = 16384;
        public boolean closed;
        public boolean finished;
        public final AnonymousClass0B3 sendBuffer = new AnonymousClass0B3();
        ...
        @Override // X.AbstractC07640v7
        public void write(AnonymousClass0B3 r6, long j) throws IOException {
    ...
    public final class FramedDataSource implements AbstractC07630v6 {
        public static final /* synthetic */ boolean $assertionsDisabled = false;
        public boolean closed;
        public boolean finished;
        public final long maxByteCount;
        public final AnonymousClass0B3 readBuffer;
        public final AnonymousClass0B3 receiveBuffer;
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public long read(X.AnonymousClass0B3 r14, long r15) throws java.io.IOException {
            /*
            // Method dump skipped, instructions count: 127
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.internal.framed.FramedStream.FramedDataSource.read(X.0B3, long):long");
        }

        public void receive(AnonymousClass0Lw r12, long j) throws IOException {
            boolean z;
            boolean z2;
            boolean z3;
            while (j > 0) {
                ...
                if (z3) {
                    ...
                    if (read != -1) {
                        j -= read;
                        synchronized (FramedStream.this) {
                            AnonymousClass0B3 r3 = this.readBuffer;
                            if (r3.A00 != 0) {
                                z2 = false;
                            }
                            r3.AA9(this.receiveBuffer);
                            if (z2) {
                                FramedStream.this.notifyAll();
                            }
                        }
        ...
        public FramedDataSource(long j) {
            this.receiveBuffer = new AnonymousClass0B3();
            this.readBuffer = new AnonymousClass0B3();
            this.maxByteCount = j;
        }
    }

    public class StreamTimeout extends AnonymousClass0Ly {
    ...
    public AbstractC07640v7 getSink() {
        synchronized (this) {
    ...
    public void receiveData(AnonymousClass0Lw r4, int i) throws IOException {
    ...
    public AbstractC07630v6 getSource() {
        return this.source;
    }

    public C07620v5 readTimeout() {
        return this.readTimeout;
    }

    public C07620v5 writeTimeout() {
