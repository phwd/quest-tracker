...
public final class DistinguishedNameParser {
    ...
    public String findMostSpecific(String str) {
        ...
        if (nextAT != null) {
            ...
            throw new IllegalStateException(AnonymousClass006.A05("Malformed DN: ", this.dn));
        }
        return null;
    }
    ...
    private char getEscaped() {
        ...
        if (i != this.length) {
            ...
            switch (c) {
                case OVRServiceInterface.Stub.TRANSACTION_setRichPresence:
                case OVRServiceInterface.Stub.TRANSACTION_registerProcessToken:
                case OVRServiceInterface.Stub.TRANSACTION_getViewerPurchasesDurableCacheJSON:
                    return c;
                default:
                    switch (c) {
                        case ';':
                        case CastHTTPServerForWeb.WWW_ANSWER_TIMEOUT:
                        case '=':
                        case '>':
                            return c;
                        default:
            ...
            throw new IllegalStateException(AnonymousClass006.A05("Unexpected end of DN: ", this.dn));
        }
    }
