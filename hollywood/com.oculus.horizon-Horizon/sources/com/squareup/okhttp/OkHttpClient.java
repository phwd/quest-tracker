...
public class OkHttpClient implements Cloneable {
    ...
    public void setConnectTimeout(long j, TimeUnit timeUnit) {
        ...
        if (j < 0) {
            ...
            if (millis > 2147483647L) {
                str = "Timeout too large.";
            } else if (millis != 0 || j <= 0) {
                this.connectTimeout = (int) millis;
                return;
            } else {
                str = "Timeout too small.";
            }
        } else {
            str = "unit == null";
        }
    ...
    public OkHttpClient() {
        ...
        this.connectTimeout = NotificationBuilder.CANCELLABLE_NOTIFICATION_FIRST_ID;
        this.readTimeout = NotificationBuilder.CANCELLABLE_NOTIFICATION_FIRST_ID;
        this.writeTimeout = NotificationBuilder.CANCELLABLE_NOTIFICATION_FIRST_ID;
