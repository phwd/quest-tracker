...
public final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public final boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r8) {
        /*
            ...
            X.0s1 r2 = r7.iterator()     // Catch:{ ClassCastException | NoSuchElementException -> 0x0041 }
        L_0x002a:
    ...
    public static boolean A03(Comparator<?> comparator, Iterable<?> iterable) {
        ...
        if (comparator == null) {
            ...
            } else if (!(iterable instanceof AbstractC07200rb)) {
                return false;
            } else {
                comparator2 = ((AbstractC07200rb) iterable).comparator();
            }
    ...
    public final ImmutableSortedSet<E> A0N() {
        Comparator reverseOrder = Collections.reverseOrder(this.A01);
        if (isEmpty()) {
            return ImmutableSortedSet.A04(reverseOrder);
        }
        return new RegularImmutableSortedSet(this.A00.A0L(), reverseOrder);
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    @GwtIncompatible
    public final AbstractC07380s1<E> A0R() {
        return this.A00.A0L().iterator();
    }
    ...
    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0O(E e, boolean z) {
        return A02(0, A00(e, z));
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0P(E e, boolean z) {
        return A02(A01(e, z), size());
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0Q(E e, boolean z, E e2, boolean z2) {
        return A0P(e, z).A0O(e2, z2);
    }
