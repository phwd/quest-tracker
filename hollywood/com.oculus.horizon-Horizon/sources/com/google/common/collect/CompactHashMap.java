...
public class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
        ...
        if (i2 != -1) {
            ...
            while (true) {
                if (((int) (compactHashMap.A05[i2] >>> 32)) != i || !Objects.equal(obj, compactHashMap.A06[i2])) {
                    ...
                    if (i2 < size) {
                        Object[] objArr = compactHashMap.A06;
                        objArr[i2] = objArr[size];
                        Object[] objArr2 = compactHashMap.A07;
                        objArr2[i2] = objArr2[size];
                        objArr[size] = null;
                        objArr2[size] = null;
                        long[] jArr2 = compactHashMap.A05;
                        long j2 = jArr2[size];
                        jArr2[i2] = j2;
                        jArr2[size] = -1;
                        ...
                        compactHashMap.A07[i2] = null;
                        compactHashMap.A05[i2] = -1;
                    }
                    compactHashMap.A02--;
                    compactHashMap.A01++;
                    return obj2;
    ...
    private final void A02(int i) {
        int A012 = C06710pf.A01(i, (double) 1.0f);
    ...
    public final Set<Map.Entry<K, V>> entrySet() {
        ...
        AnonymousClass0pC r0 = new AnonymousClass0pC(this);
        this.A09 = r0;
        return r0;
    }
    ...
    public final Set<K> keySet() {
        ...
        AnonymousClass0pE r0 = new AnonymousClass0pE(this);
        this.A0A = r0;
        return r0;
    }
    ...
    public final Collection<V> values() {
        ...
        AnonymousClass0pF r0 = new AnonymousClass0pF(this);
        this.A08 = r0;
        return r0;
    }
    ...
    public final V remove(@NullableDecl Object obj) {
        return (V) A01(this, obj, C06710pf.A02(obj));
    }
