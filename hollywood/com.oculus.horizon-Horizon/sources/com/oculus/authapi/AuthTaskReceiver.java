...
public abstract class AuthTaskReceiver<T, E extends AuthError> extends ResultReceiver {
    ...
    public E A01(Bundle bundle) {
        return null;
    }

    @Nullable
    public abstract T A02(Bundle bundle) throws AuthError;
    ...
    public final void onReceiveResult(int i, Bundle bundle) {
        if (i == -1) {
            try {
                this.mAuthResultCallback.onResult(A02(bundle));
            } catch (AuthError e) {
                A00(e);
            }
        } else {
            AuthError A01 = A01(bundle);
            if (A01 == null) {
                A01 = new AuthError(bundle);
            }
            A00(A01);
        }
    }
