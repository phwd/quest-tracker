...
public enum SystemUXRoute {
    ...
    SystemUXRoute(String str) {
        if (!str.startsWith(PREFIX)) {
            AnonymousClass0NO.A0E("SystemUXRoute", "Incorrect prefix for path: %s", str);
        }
        this.mPath = str;
    }
    ...
    public String toString() {
        return AnonymousClass006.A08(name(), "(", path(), ")");
    }

    public boolean isSamePath(Uri uri) {
        Uri A00 = C03030bw.A00(this.mPath);
    ...
    public boolean isSamePath(String str) {
        ...
        return isSamePath(C03030bw.A00(str));
    }
}
