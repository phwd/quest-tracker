...
public interface OVRMediaServiceInterface extends IInterface {
    ...
    public static abstract class Stub extends Binder implements OVRMediaServiceInterface {
        ...
        public static class Proxy implements OVRMediaServiceInterface {
            ...
            public Bundle sendCommandToMediaService(Bundle bundle) throws RemoteException {
                Bundle bundle2;
            ...
            @Override // com.oculus.aidl.OVRMediaServiceInterface
            public Bundle sendLivestreamingRawPCMData(Bundle bundle) throws RemoteException {
                Bundle bundle2;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
