...
public class HasSeenNuxResponse implements ValidatableApiResponse {
    ...
    public void validate() throws RuntimeException {
        ...
        if (viewer2 == null) {
            str = "Received an invalid HasSeenNuxResponse. Response didn't have a viewer";
        } else if (viewer2.social_settings_info == null) {
            str = "Received an invalid HasSeenNuxResponse. Viewer didn't have a social_settings_info";
        } else {
            return;
        }
