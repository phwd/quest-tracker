...
public class InstalledVRApplicationsResultBuilder extends ResultBuilder {
    @Inject
    @Eager
    public final ExternalPlatformLocal mExternalPlatformLocal;

    @Inject
    public InstalledVRApplicationsResultBuilder(AbstractC06640p5 r2, @Assisted OVRService oVRService) {
        super(oVRService);
