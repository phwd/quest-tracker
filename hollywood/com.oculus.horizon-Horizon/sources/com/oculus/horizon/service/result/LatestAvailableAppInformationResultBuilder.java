...
public class LatestAvailableAppInformationResultBuilder extends ResultBuilder {
    @Inject
    @Eager
    public final ExternalPlatformLocal mExternalPlatformLocal;

    @Inject
    public LatestAvailableAppInformationResultBuilder(AbstractC06640p5 r2, @Assisted OVRService oVRService) {
        super(oVRService);
