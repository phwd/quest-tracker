...
public class GraphQLFeedQuery {
    public static final String ACTOR_FIELDS = "id,name,deeplink,icon {id,deeplink,thumbnail_image {name,width,height,uri,scale,},content_media {name,width,height,uri,},},";
    public static final String ATTACHMENT_ATTRIBUTES = "id,title,actor {  nodes {id,name,deeplink,icon {id,deeplink,thumbnail_image {name,width,height,uri,scale,},content_media {name,width,height,uri,},},  },},media {  nodes {id,deeplink,thumbnail_image {name,width,height,uri,scale,},content_media {name,width,height,uri,},  },},";
    ...
    public static final String IMAGE_FIELDS = "name,width,height,uri,scale,";
    public static final String MEDIA_FIELDS = "name,width,height,uri,";
    public static final String STORY_MEDIA_FIELDS = "id,deeplink,thumbnail_image {name,width,height,uri,scale,},content_media {name,width,height,uri,},";
