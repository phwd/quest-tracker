...
public class DurableIAPJobScheduler extends OculusJobHelper {
    public static final long PERIODIC_REFRESH_TIMER = TimeUnit.MINUTES.toMillis(15);
    public static final String TAG = "DurableIAPJobScheduler";
    public AnonymousClass0QC _UL_mInjectionContext;

    @Inject
    public DurableIAPJobScheduler(AbstractC06640p5 r3, @ForAppContext Context context) {
        super(context, DurableIAPJobService.class, JobSchedulerIds.DURABLE_IAP_UPDATE);
