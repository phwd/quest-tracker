    ...
    public MediaSessionCompat(@NonNull Context context, @NonNull String str, @Nullable ComponentName componentName, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable VersionedParcelable versionedParcelable) {
        ...
        if (context == null) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                this.mImpl = new MediaSessionImplApi19(context, str, componentName, pendingIntent, bundle);
            } else if (Build.VERSION.SDK_INT >= 18) {
                this.mImpl = new MediaSessionImplApi18(context, str, componentName, pendingIntent, bundle);
            } else {
                this.mImpl = new MediaSessionImplBase(context, str, componentName, pendingIntent, bundle);
            }
