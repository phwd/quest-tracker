...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    private static final byte[] DIGITS = {48, Framer.STDOUT_FRAME_PREFIX, Framer.STDERR_FRAME_PREFIX, 51, SmileConstants.TOKEN_KEY_LONG_STRING, 53, 54, 55, 56, 57, 97, 98, 99, Types.TYPE_STRING, Types.TYPE_BOOL, Types.TYPE_INT};
    ...
    public Buffer writeDecimalLong(long j) {
        ...
        if (j >= 100000000) {
            i = j < 1000000000000L ? j < 10000000000L ? j < TimeConstants.NS_PER_SECOND ? 9 : 10 : j < 100000000000L ? 11 : 12 : j < 1000000000000000L ? j < 10000000000000L ? 13 : j < 100000000000000L ? 14 : 15 : j < 100000000000000000L ? j < 10000000000000000L ? 16 : 17 : j < 1000000000000000000L ? 18 : 19;
        } else if (j >= StartupBlockingConfig.BLOCKING_UPLOAD_MAX_WAIT_MILLIS) {
