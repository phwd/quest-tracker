...
public class WebViewAppLinkResolver implements AppLinkResolver {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x011b, code lost:
        if (java.util.Arrays.asList("no", "false", com.oculus.util.constants.OculusConstants.DEFAULT_ENTERPRISE_USER_ID).contains(((java.lang.String) ((java.util.Map) r0.get(0)).get("value")).toLowerCase()) != false) goto L_0x0120;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public static String readFromConnection(URLConnection uRLConnection) throws IOException {
        ...
        try {
            ...
            if (contentEncoding == null) {
                ...
                if (contentEncoding == null) {
                    contentEncoding = Utf8Charset.NAME;
                }
            }
