...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        public int hashCode() {
            return ((((FragmentConstants.ContentFragmentType.NEW_APPOINTMENT_DETAIL_FRAGMENT + this.pattern.hashCode()) * 31) + this.hashAlgorithm.hashCode()) * 31) + this.hash.hashCode();
        }
