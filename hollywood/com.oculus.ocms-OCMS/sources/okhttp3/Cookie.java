...
public final class Cookie {
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((FragmentConstants.ContentFragmentType.NEW_APPOINTMENT_DETAIL_FRAGMENT + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
}
