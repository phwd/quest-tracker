        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (body != null) {
                ...
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    this.log.log(new String(((TypedByteArray) body).getBytes(), MimeUtil.parseCharset(body.mimeType(), Utf8Charset.NAME)));
        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (body != null) {
                ...
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    this.log.log(new String(bytes, MimeUtil.parseCharset(body.mimeType(), Utf8Charset.NAME)));
                    j2 = length;
                }
            }
