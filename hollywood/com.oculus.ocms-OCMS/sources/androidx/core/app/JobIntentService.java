...
public abstract class JobIntentService extends Service {
        ...
        public void serviceProcessingStarted() {
            synchronized (this) {
                if (!this.mServiceProcessing) {
                    ...
                    this.mRunWakeLock.acquire(WifiScanConfig.DEFAULT_TIMESTAMP_FIX_WINDOW_MS);
    ...
    public final class CommandProcessor extends AsyncTask<Void, Void, Void> {
        private static final String NO_LONGER_RUNNING_MESSAGE = "Caller no longer running";
        ...
        public Void doInBackground(Void... voidArr) {
            while (true) {
                ...
                try {
                    ...
                    if (e.getMessage().contains(NO_LONGER_RUNNING_MESSAGE)) {
                        Log.e(JobIntentService.TAG, "Captured a \"Caller no longer running\"", e);
                    } else {
                        throw e;
                    }
                }
