    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                SERVICES.put(PrintManager.class, InstallerServiceDumper.CMD_PRINT);
            }
            ...
            SERVICES.put(LocationManager.class, LoggingKeys.NOTIFICATION_PREFERENCE_CHANGE_LOCATION);
