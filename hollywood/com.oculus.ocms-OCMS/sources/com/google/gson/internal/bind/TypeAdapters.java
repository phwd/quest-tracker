...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() {
        ...
        public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
            jsonWriter.value(bool == null ? LoggingUtil.NO_HASHCODE : bool.toString());
        }
    };
    ...
    public static final TypeAdapter<Locale> LOCALE = new TypeAdapter<Locale>() {
        ...
        public Locale read(JsonReader jsonReader) throws IOException {
            ...
            StringTokenizer stringTokenizer = new StringTokenizer(jsonReader.nextString(), UltralightNames.FQN_SEPARATOR);
    ...
    public static final TypeAdapter<URI> URI = new TypeAdapter<URI>() {
        ...
        public URI read(JsonReader jsonReader) throws IOException {
            ...
            try {
                String nextString = jsonReader.nextString();
                if (LoggingUtil.NO_HASHCODE.equals(nextString)) {
                    return null;
                }
