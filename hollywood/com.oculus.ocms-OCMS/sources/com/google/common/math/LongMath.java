...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, FragmentConstants.ContentFragmentType.APP_LOCK_SETTINGS_FRAGMENT, FragmentConstants.ContentFragmentType.TIMELINE_OBSESSION_EDIT_FRAGMENT, FragmentConstants.ContentFragmentType.GAMES_TAB_FRAGMENT, FragmentConstants.ContentFragmentType.REACT_FRAGMENT_WITH_MARKETPLACE_SEARCH, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    @VisibleForTesting
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, FragmentConstants.ContentFragmentType.PAGE_CONTENT_LIST_VIEW_STANDALONE_FRAGMENT, FragmentConstants.ContentFragmentType.SEEN_CONTENT_FEED_FRAGMENT, FragmentConstants.ContentFragmentType.FUNDRAISER_CREATION_SUGGESTED_COVER_PHOTO_FRAGMENT, 214, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
