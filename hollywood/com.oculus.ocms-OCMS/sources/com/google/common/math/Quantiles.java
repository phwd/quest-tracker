    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i5 = (int) (length2 - (((long) divide) * ((long) this.scale)));
                iArr3[i3] = divide;
                iArr4[i3] = i5;
                iArr5[i4] = divide;
                i4++;
            ...
            while (true) {
                ...
                if (i7 == 0) {
                    ...
                    hashMap2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i6], dArr[i6 + 1], (double) i7, (double) this.scale)));
                }
                i++;
            }
        }
