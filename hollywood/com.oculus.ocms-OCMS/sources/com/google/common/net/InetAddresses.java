...
public final class InetAddresses {
    ...
    private static byte parseOctet(String str) {
        ...
        if (parseInt <= 255 && (!str.startsWith(OculusConstants.DEFAULT_ENTERPRISE_USER_ID) || str.length() <= 1)) {
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address inet6Address) {
        ...
        int readShort = ByteStreams.newDataInput(address, 8).readShort() & Flattenable.VirtualFlattenableResolver.INVALID_FLATTENABLE_TYPE;
