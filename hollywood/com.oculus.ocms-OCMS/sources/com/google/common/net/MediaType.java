...
public final class MediaType {
    ...
    public MediaType withParameters(String str, Iterable<String> iterable) {
        ...
        while (it.hasNext()) {
            ...
            if (!normalizeToken.equals(key)) {
                builder.put((Object) key, (Object) next.getValue());
            }
        }
        for (String str2 : iterable) {
            builder.put((Object) normalizeToken, (Object) normalizeParameterValue(normalizeToken, str2));
        }
    ...
    private static MediaType create(String str, String str2, Multimap<String, String> multimap) {
        ...
        for (Map.Entry<String, String> entry : multimap.entries()) {
            ...
            builder.put((Object) normalizeToken3, (Object) normalizeParameterValue(normalizeToken3, entry.getValue()));
        }
