    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable th) {
        ...
        return new AbstractList<StackTraceElement>() {
            ...
            public StackTraceElement get(int i) {
                return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod(Throwables.getStackTraceElementMethod, Throwables.jla, new Object[]{th, Integer.valueOf(i)});
            }

            public int size() {
                return ((Integer) Throwables.invokeAccessibleNonThrowingMethod(Throwables.getStackTraceDepthMethod, Throwables.jla, new Object[]{th})).intValue();
            }
        };
    }
