...
public enum SystemUXRoute {
    ...
    private SystemUXRoute(String str) {
        if (!str.startsWith(PREFIX)) {
            BLog.e(SystemUXRoute.class.getSimpleName(), "Incorrect prefix for path: %s", str);
        }
        this.mPath = str;
    }
    ...
    public boolean isSamePath(String str) {
        ...
        return isSamePath(SecureUriParser.parseStrict(str));
    }

    public boolean isSamePath(Uri uri) {
        Uri parseStrict = SecureUriParser.parseStrict(this.mPath);
        return TextUtils.equals(parseStrict.getScheme(), uri.getScheme()) && TextUtils.equals(parseStrict.getAuthority(), uri.getAuthority()) && TextUtils.equals(parseStrict.getPath(), uri.getPath());
    }
