...
public class DsatFetcher {
    ...
    public static final Provider _UL__ULSEP_javax_inject_Provider_ULLT_com_oculus_dsatauth_DsatFetcher_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightSingletonProvider.get(DsatauthModule.UL_id._UL__ULSEP_com_oculus_dsatauth_DsatFetcher_ULSEP_BINDING_ID, injectorLike);
    }

    @AutoGeneratedAccessMethod
    public static final Lazy _UL__ULSEP_com_facebook_inject_Lazy_ULLT_com_oculus_dsatauth_DsatFetcher_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightSingletonProvider.get(DsatauthModule.UL_id._UL__ULSEP_com_oculus_dsatauth_DsatFetcher_ULSEP_BINDING_ID, injectorLike);
    }

    @AutoGeneratedAccessMethod
    public static final DsatFetcher _UL__ULSEP_com_oculus_dsatauth_DsatFetcher_ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return (DsatFetcher) UL.factorymap.get(DsatauthModule.UL_id._UL__ULSEP_com_oculus_dsatauth_DsatFetcher_ULSEP_BINDING_ID, injectorLike);
    }
