...
public class MobileConfigUpdaterJobService extends JobService {
    private static final String EVENT_MOBILE_CONFIG_REFRESH = "oc_mobileconfig_refresh_started";
    private static String TAG = null;
    private static final int WIFI_CHECK_LATCH_TIMEOUT = 30;
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        ((EventManager) FbInjector.lazyInstance(1, UtilsModule.UL_id._UL__ULSEP_com_oculus_logging_utils_EventManager_ULSEP_BINDING_ID, this._UL_mInjectionContext)).createEvent(EVENT_MOBILE_CONFIG_REFRESH).logAndRelease();
