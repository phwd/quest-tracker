...
public class MobileConfigInit implements INeedInit {
    ...
    @AutoGeneratedAccessMethod
    public static final Provider _UL__ULSEP_javax_inject_Provider_ULLT_com_oculus_mobileconfig_init_MobileConfigInit_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightSingletonProvider.get(MobileConfigInitModule.UL_id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigInit_ULSEP_BINDING_ID, injectorLike);
    }

    @AutoGeneratedAccessMethod
    public static final MobileConfigInit _UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigInit_ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return (MobileConfigInit) UL.factorymap.get(MobileConfigInitModule.UL_id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigInit_ULSEP_BINDING_ID, injectorLike);
    }
    ...
    @Nullable
    private MobileConfigManagerHolder createLightweightJavaManager() {
        return MobileConfigJavaManager.createJavaManager(this.mContextLazy.get().getFilesDir(), this.mCredentialsProvider.get() == null ? null : this.mCredentialsProvider.get().getUserId(), this.mContextLazy.get().getAssets(), false);
    }
    ...
    private synchronized MobileConfigManagerHolderImpl createMobileConfigManagerHolder(Credentials credentials) {
        ...
        mobileConfigManagerParamsHolder.setConsistencyLoggingEveryNSec(TimeConstants.SECONDS_PER_MONTH);
        ...
        return new MobileConfigDependenciesInFBApps(null, null, false, this.mXAnalyticsProvider.get().getXAnalyticsNative()).createManager(this.mContextLazy.get().getFilesDir(), this.mPackageInfoProvider.get().versionName, DeviceUtils.getDeviceId(this.mContextLazy.get()), credentials.getUserId(), "", this.mContextLazy.get().getAssets(), false, mobileConfigManagerParamsHolder, MobileConfigManagerUtil.createExtraURLParams(this.mLocaleProvider.get()));
    }
    ...
    public synchronized void logout() {
        BLog.d(TAG, "Switching to MobileConfigManagerHolderNoop");
        MobileConfigFactoryImpl mobileConfigFactoryImpl = (MobileConfigFactoryImpl) this.mMobileConfigFactoryProvider.get();
        if (mobileConfigFactoryImpl.getManagerHolder() instanceof MobileConfigManagerSingletonHolder) {
            ((MobileConfigManagerSingletonHolder) mobileConfigFactoryImpl.getManagerHolder()).setManagerHolderInstance(new MobileConfigManagerHolderNoop(), mobileConfigFactoryImpl);
        }
    }
}
