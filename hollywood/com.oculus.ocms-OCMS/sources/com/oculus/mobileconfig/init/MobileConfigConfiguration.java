...
public class MobileConfigConfiguration implements Configuration {
    private static final String EVENT_MOBILE_CONFIG_FETCH_RESULT = "oculus_mobile_config_fetch";
    private static final String EXTRA_FETCH_RESULT = "fetch_result";
    ...
    public static final MobileConfigConfiguration _UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return (MobileConfigConfiguration) UL.factorymap.get(MobileConfigInitModule.UL_id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULSEP_BINDING_ID, injectorLike);
    }
    ...
    @AutoGeneratedAccessMethod
    public static final Provider _UL__ULSEP_javax_inject_Provider_ULLT_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightProvider.get(MobileConfigInitModule.UL_id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULSEP_BINDING_ID, injectorLike);
    }

    @AutoGeneratedAccessMethod
    public static final Lazy _UL__ULSEP_com_facebook_inject_Lazy_ULLT_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightLazy.get(MobileConfigInitModule.UL_id._UL__ULSEP_com_oculus_mobileconfig_init_MobileConfigConfiguration_ULSEP_BINDING_ID, injectorLike);
    }
    ...
    public boolean updateConfigs(MobileConfigManagerHolder mobileConfigManagerHolder) {
        ...
        ((EventManager) FbInjector.lazyInstance(1, UtilsModule.UL_id._UL__ULSEP_com_oculus_logging_utils_EventManager_ULSEP_BINDING_ID, this._UL_mInjectionContext)).createEvent(EVENT_MOBILE_CONFIG_FETCH_RESULT).addExtra(EXTRA_FETCH_RESULT, updateConfigs).logAndRelease();
