...
public class OculusUserManager implements AutoCloseable {
    ...
    private static final String TAG = "OculusUserManager";
    ...
    public class BlockingServiceConnection implements ServiceConnection {
        ...
        private void connect() {
            boolean z = true;
            Utils.assertState(this.mService == null, "Service is already connected.");
            if (this.mLatch.getCount() != 1) {
                z = false;
            }
            Utils.assertState(z, "Does not support reconnecting to service.");
    ...
    /* access modifiers changed from: private */
    public static void onRemoteServiceDied(@Nullable RemoteException remoteException) {
        Log.e(TAG, "Remote service died", remoteException);
    }
    ...
    private IOculusUserManager getService() throws RemoteException {
        IOculusUserManager awaitService = this.mConnection.awaitService();
    ...
    public void registerUserLogin(String str, String str2) throws AccountConflictException, AccountAlreadyOnDeviceException, RemoteException {
        try {
            getService().registerUserLogin(str, str2);
        } catch (IllegalStateException e) {
            ExceptionUtils.unwrapAndMaybeThrow(e, AccountConflictException.class);
            ExceptionUtils.unwrapAndMaybeThrow(e, AccountAlreadyOnDeviceException.class);
            throw e;
        }
    }

    public void updateUser(SparseOculusUser sparseOculusUser) throws RemoteException {
        getService().updateUser(OculusUserBundler.bundleSparseUser(sparseOculusUser));
    }
    ...
    public void removeUnclaimedUser() throws RemoteException {
        getService().removeUnclaimedUser();
    }
    ...
    private boolean bindService(String str) {
        return this.mContext.bindService(createServiceIntent(str), this.mConnection, 1);
    }

    private static Intent createServiceIntent(String str) {
        ComponentName componentName = new ComponentName(str, SERVICE_IMPL_CLS);
