...
public class ApkUpdateInfoContract {
    ...
    public static class ApkUpdateTable {
        ...
        public static class Columns {
            ...
            public static Column BASE_VERSION = new Column(InstallerAnalytics.Extras.BASE_VERSION, "INTEGER");
            @Deprecated
            ...
            public static Column REQUESTING_PACKAGE = new Column(InstallerAnalytics.Extras.REQUESTING_PKG, "TEXT");
            public static Column REQUEST_HEADERS = new Column("request_headers", "TEXT");
            public static Column REQUEST_ORIGIN = new Column(InstallerAnalytics.Extras.REQUEST_ORIGIN, "TEXT");
            public static Column SIGNATURE = new Column("signature", "TEXT");
            public static Column TARGET_VERSION = new Column("version", "INTEGER");
            public static Column UPDATE_TYPE = new Column(InstallerAnalytics.Extras.UPDATE_TYPE, "INTEGER");
        }
    }
