...
public class UserAgentFactory {
    ...
    @AutoGeneratedAccessMethod
    public static final Provider _UL__ULSEP_javax_inject_Provider_ULLT_com_oculus_http_useragent_UserAgentFactory_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightProvider.get(UserAgentModule.UL_id._UL__ULSEP_com_oculus_http_useragent_UserAgentFactory_ULSEP_BINDING_ID, injectorLike);
    }

    @AutoGeneratedAccessMethod
    public static final Lazy _UL__ULSEP_com_facebook_inject_Lazy_ULLT_com_oculus_http_useragent_UserAgentFactory_ULGT__ULSEP_ACCESS_METHOD(InjectorLike injectorLike) {
        return UltralightLazy.get(UserAgentModule.UL_id._UL__ULSEP_com_oculus_http_useragent_UserAgentFactory_ULSEP_BINDING_ID, injectorLike);
    }
