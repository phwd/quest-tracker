...
public class ApiInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        Request.Builder addHeader = request.newBuilder().addHeader(HttpHeaders.ACCEPT_LANGUAGE, getAcceptLanguage()).addHeader("X-ANDROID-ID", this.mDeviceId).addHeader("X-Build-Model", this.mBuildModel).addHeader("X-Build-Number", String.valueOf(this.mBuildNumber)).addHeader("X-Oculus-Feature", ActivityConstants.Extras.WATCH_FEED_INJECTION).addHeader(ApiUUID.HEADER_NAME, ApiUUID.gen());
