...
public class CustomApiEndpointValidator {
    private static final String DISABLE_CERT_CHECK_EXPRESSION = "[.]((\\w+[.]sb)|((svcscm[.])?\\d+[.]od)|dev)";
    private static final String DISABLE_CERT_CHECK_HOSTNAME = "^graph[.]((\\w+[.]sb)|((svcscm[.])?\\d+[.]od)|dev)[.]oculus[.]com$";
    private static final Pattern DISABLE_CERT_CHECK_HOSTNAME_PATTERN = Pattern.compile(DISABLE_CERT_CHECK_HOSTNAME);
    private static final String DISABLE_CERT_CHECK_URI = "^https://graph[.]((\\w+[.]sb)|((svcscm[.])?\\d+[.]od)|dev)[.]oculus[.]com$";
    private static final Pattern DISABLE_CERT_CHECK_URI_PATTERN = Pattern.compile(DISABLE_CERT_CHECK_URI);
    private static final String GRAPH_SUBDOMAIN = "^graph";
    private static final String OCULUS_DOMAIN_NAME = "[.]oculus[.]com$";
    private static final String SAFE_URI = "^https://graph.*[.]oculus[.]com$";
    private static final Pattern SAFE_URI_PATTERN = Pattern.compile(SAFE_URI);
    private static final String SECURED_GRAPH_SCHEME = "^https://graph";
