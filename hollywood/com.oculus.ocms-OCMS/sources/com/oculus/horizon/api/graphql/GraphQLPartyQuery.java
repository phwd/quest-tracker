...
public class GraphQLPartyQuery {
    ...
    private static final String PARTY_DATA = "id,party_room {  id,},party_users {  nodes {    id,    name,    alias,    display_name,    profile_photo.size(64x64) {      uri,    },    avatar_image.size(64x64) {      uri,    },  }}";
