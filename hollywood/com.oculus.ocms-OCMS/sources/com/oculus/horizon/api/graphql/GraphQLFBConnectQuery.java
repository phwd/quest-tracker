...
public class GraphQLFBConnectQuery {
    private static final String CORE_FB_ACCOUNT = "  facebook_account {    facebook_id,    friend_policy,    needs_password_to_unlink,  },";
    private static final String CORE_FB_ACCOUNT_WITH_TOKEN = "  facebook_account {    access_token,    facebook_id,    friend_policy,    needs_password_to_unlink,  },";
