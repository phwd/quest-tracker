...
public class FBConnectContent {
    ...
    public static class Account {
        ...
        public static final Uri CONTENT_URI = SecureUriParser.parseStrict("content://" + FBConnectContent.AUTHORITY + "/account");
    ...
    public static class AppScopedAccessToken {
        ...
        public static final Uri URI = SecureUriParser.parseStrict("content://" + FBConnectContent.AUTHORITY + "/app_scoped_access_token");
    }
}
