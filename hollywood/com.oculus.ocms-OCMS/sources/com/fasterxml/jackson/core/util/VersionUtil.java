...
public class VersionUtil {
    ...
    public static com.fasterxml.jackson.core.Version mavenVersionFor(java.lang.ClassLoader r3, java.lang.String r4, java.lang.String r5) {
        /*
            ...
            java.util.Properties r4 = new java.util.Properties     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            r4.<init>()     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            r4.load(r3)     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            java.lang.String r5 = "version"
            java.lang.String r5 = r4.getProperty(r5)     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            java.lang.String r0 = "artifactId"
            java.lang.String r0 = r4.getProperty(r0)     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            java.lang.String r1 = "groupId"
            java.lang.String r4 = r4.getProperty(r1)     // Catch:{ IOException -> 0x0052, all -> 0x004d }
            com.fasterxml.jackson.core.Version r4 = parseVersion(r5, r4, r0)     // Catch:{ IOException -> 0x0052, all -> 0x004d }
