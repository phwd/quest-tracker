...
public class BlackBoxState {
    ...
    public synchronized void setBlackBoxRecorderControl(BlackBoxRecorderControl blackBoxRecorderControl) {
    ...
    public synchronized void setContext(@Nullable Object obj) {
        this.mContext = obj;
    }
    ...
    public synchronized void setPreviousExtra(Map<String, String> map) {
        this.mPreviousExtra = map;
    }
}
