...
public class MobileConfigJavaOverridesTable implements MobileConfigOverridesTable {
    private static final String NULL_OVERRIDES_STRING = "__NULL_VALUE__";
        ...
        try {
            ...
            while (i3 < jSONArray.length()) {
                ...
                while (i4 < jSONArray2.length()) {
                    ...
                    if (str4.equals(NULL_OVERRIDES_STRING)) {
    ...
    @Override // com.facebook.mobileconfig.factory.MobileConfigOverridesTable
    public boolean hasNullOverrideForParam(long j) {
        return this.mNullOverrides.get(getNullOverrideKey(translateSpecifierIfNeeded(j)));
    }
