...
public class FBMobileConfigTableOptimized extends FBMobileConfigTable {
    ...
    private static final int MAX_EP_CONFIG_SIZE = 50;
    private static final String TAG = "FBMobileConfigTableOptimized";
    ...
    public static FBMobileConfigTableOptimized getRootAsFBMobileConfigTableOptimized(ByteBuffer byteBuffer) {
        ...
        try {
            ...
            BLog.i(TAG, "Magic number does not match!  Got magic:%s magic2:%s", Integer.valueOf(fBMobileConfigTableOptimized.magic()), Integer.valueOf(fBMobileConfigTableOptimized.magic2()));
            return null;
        } catch (IndexOutOfBoundsException e) {
            BLog.w(TAG, "Corrupted file, unexpected fbs offset", e);
            return null;
        }
    }
    ...
    private boolean initilizeOffsets() {
        ...
        if (emergencyPushInfoLength > 50) {
            BLog.i(TAG, "Probably corrupted mctable data, epInfoLen:%s", Integer.valueOf(emergencyPushInfoLength));
            return false;
        }
