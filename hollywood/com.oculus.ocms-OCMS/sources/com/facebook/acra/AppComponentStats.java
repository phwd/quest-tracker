        ...
        while (true) {
            ...
            if (next != 3 || xmlPullParser.getDepth() != depth) {
                if (next == 2) {
                    ...
                    if (name.equals(TAG_ACTIVITY) || name.equals(TAG_ACTIVITY_ALIAS) || name.equals("receiver") || name.equals("service") || name.equals("provider")) {
                        list.add(xmlPullParser.getAttributeValue(ANDROID_XML_NS, "name"));
                    }
                }
            } else {
                return;
