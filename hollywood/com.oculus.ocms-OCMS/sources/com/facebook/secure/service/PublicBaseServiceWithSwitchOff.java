...
public abstract class PublicBaseServiceWithSwitchOff extends Service {
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        if (this.mCalledOnStartCommand) {
            ...
            getIntentLogger().logIntent(this.mEndpointName, SUB_ENDPOINT_ON_START_COMMAND, IntentLogger.Status.DENY, intent);
            ...
            try {
                ...
                getIntentLogger().logIntent(this.mEndpointName, SUB_ENDPOINT_ON_START_COMMAND, IntentLogger.Status.ALLOW, intent);
