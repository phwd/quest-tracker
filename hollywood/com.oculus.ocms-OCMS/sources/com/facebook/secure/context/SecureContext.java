...
public class SecureContext {
    ...
    public static boolean launchInternalActivityForResult(Intent intent, int i, @Nullable Bundle bundle, Activity activity) {
        return internal().launchActivityForResult(intent, i, bundle, activity);
    }
