...
public class BuildConstants {
    ...
    public static final String TALK_APP_PACKAGE_NAME = (IS_INTERNAL_BUILD ? AllFamilyPackageNames.MESSENGER_KIDS_DEV : AllFamilyPackageNames.MESSENGER_KIDS);
    ...
    static {
        ...
        if (IS_WORK_BUILD) {
            ...
            str = IS_ALOHA_WORK_VC_BUILD ? AllFamilyPackageNames.PORTAL_FOR_WORK : AllFamilyPackageNames.MESSENGER;
        }
    ...
    public static final String getUpgradeURL() {
        return isInternalBuild() ? "https://m.intern.facebook.com/intern/mobile_builds/" : "https://market.android.com/details?id=com.facebook.katana";
    }
