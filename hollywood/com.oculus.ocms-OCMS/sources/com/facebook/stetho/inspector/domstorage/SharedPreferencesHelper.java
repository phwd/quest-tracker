...
public class SharedPreferencesHelper {
    ...
    private static Boolean parseBoolean(String str) throws IllegalArgumentException {
        if (ActivityConstants.Extras.WATCH_FEED_INJECTION.equals(str) || "true".equalsIgnoreCase(str)) {
            return Boolean.TRUE;
        }
        if (OculusConstants.DEFAULT_ENTERPRISE_USER_ID.equals(str) || "false".equalsIgnoreCase(str)) {
