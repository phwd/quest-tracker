...
public class NetworkEventReporterImpl implements NetworkEventReporter {
    ...
    public void requestWillBeSent(NetworkEventReporter.InspectorRequest inspectorRequest) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            requestWillBeSentParams.frameId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
            requestWillBeSentParams.loaderId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
    ...
    public void responseHeadersReceived(NetworkEventReporter.InspectorResponse inspectorResponse) {
        ...
        if (peerManagerIfEnabled != null) {
            ...
            responseReceivedParams.frameId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
            responseReceivedParams.loaderId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
            double stethoNow = (double) stethoNow();
            Double.isNaN(stethoNow);
