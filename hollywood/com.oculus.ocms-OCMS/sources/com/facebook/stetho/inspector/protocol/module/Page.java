...
public class Page implements ChromeDevtoolsDomain {
    ...
    private void notifyExecutionContexts(JsonRpcPeer jsonRpcPeer) {
        ...
        executionContextDescription.frameId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
    ...
    public JsonRpcResult getResourceTree(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        FrameResourceTree createSimpleFrameResourceTree = createSimpleFrameResourceTree(ActivityConstants.Extras.WATCH_FEED_INJECTION, null, "Stetho", it.hasNext() ? it.next() : "");
        ...
        while (it.hasNext()) {
            ...
            createSimpleFrameResourceTree.childFrames.add(createSimpleFrameResourceTree(sb2, ActivityConstants.Extras.WATCH_FEED_INJECTION, "Child #" + sb2, it.next()));
            i = i2;
        }
    ...
    private static FrameResourceTree createSimpleFrameResourceTree(String str, String str2, String str3, String str4) {
        ...
        frame.id = str;
        frame.parentId = str2;
        frame.loaderId = ActivityConstants.Extras.WATCH_FEED_INJECTION;
        frame.name = str3;
        frame.url = "";
