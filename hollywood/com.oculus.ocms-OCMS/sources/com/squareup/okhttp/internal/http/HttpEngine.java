...
public final class HttpEngine {
            ...
            if (this.httpStream == null) {
                ...
                if (this.networkRequest != null) {
                    ...
                    if (response2 != null) {
                        ...
                        this.userResponse = new Response.Builder().request(this.userRequest).priorResponse(stripBody(this.priorResponse)).protocol(Protocol.HTTP_1_1).code(FragmentConstants.ContentFragmentType.GROUPS_POST_TAG_CONSUMPTION_FRAGMENT).message("Unsatisfiable Request (only-if-cached)").body(EMPTY_BODY).build();
                    }
    ...
    private HttpStream connect() throws RouteException, RequestException, IOException {
        return this.streamAllocation.newStream(this.client.getConnectTimeout(), this.client.getReadTimeout(), this.client.getWriteTimeout(), this.client.getRetryOnConnectionFailure(), !this.networkRequest.method().equals(TigonRequest.GET));
    }
    ...
    private Response unzip(Response response) throws IOException {
        if (!this.transparentGzip || !OkHttpConstants.GZIP.equalsIgnoreCase(this.userResponse.header("Content-Encoding")) || response.body() == null) {
            return response;
        }
    ...
    public static boolean hasBody(Response response) {
        if (response.request().method().equals(TigonRequest.HEAD)) {
            return false;
        }
    ...
    private static Headers combine(Headers headers, Headers headers2) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if ((!HttpHeaders.WARNING.equalsIgnoreCase(name) || !value.startsWith(ActivityConstants.Extras.WATCH_FEED_INJECTION)) && (!OkHeaders.isEndToEnd(name) || headers2.get(name) == null)) {
    ...
    public Request followUpRequest() throws IOException {
        ...
        if (this.userResponse != null) {
            ...
            } else if (!method.equals(TigonRequest.GET) && !method.equals(TigonRequest.HEAD)) {
                return null;
            }
