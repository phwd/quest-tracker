...
public final class Handshake {
    ...
    public int hashCode() {
        return ((((FragmentConstants.ContentFragmentType.NEW_APPOINTMENT_DETAIL_FRAGMENT + this.cipherSuite.hashCode()) * 31) + this.peerCertificates.hashCode()) * 31) + this.localCertificates.hashCode();
    }
}
