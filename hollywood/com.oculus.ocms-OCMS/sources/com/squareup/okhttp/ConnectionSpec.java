...
public final class ConnectionSpec {
    ...
    public int hashCode() {
        if (this.tls) {
            return ((((FragmentConstants.ContentFragmentType.NEW_APPOINTMENT_DETAIL_FRAGMENT + Arrays.hashCode(this.cipherSuites)) * 31) + Arrays.hashCode(this.tlsVersions)) * 31) + (!this.supportsTlsExtensions ? 1 : 0);
        }
        return 17;
    }
