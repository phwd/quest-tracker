...
public final class Route {
    ...
    public int hashCode() {
        return ((((FragmentConstants.ContentFragmentType.NEW_APPOINTMENT_DETAIL_FRAGMENT + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.inetSocketAddress.hashCode();
    }
}
