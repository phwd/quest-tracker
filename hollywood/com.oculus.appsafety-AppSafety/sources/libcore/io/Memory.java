...
public final class Memory {
    ...
    /* JADX INFO: Multiple debug info for r0v1 int: [D('l' int), D('offset' int)] */
    public static long peekLong(byte[] src, int offset, ByteOrder order) {
        if (order == ByteOrder.BIG_ENDIAN) {
            ...
            return (4294967295L & ((long) (((src[offset6] & 255) << 16) | ((src[offset5] & 255) << 24) | ((src[offset7] & 255) << 8) | ((src[offset7 + 1] & 255) << 0)))) | (((long) h) << 32);
        }
        int offset8 = offset + 1;
        int offset9 = offset8 + 1;
        int i3 = ((src[offset] & 255) << 0) | ((src[offset8] & 255) << 8);
        int offset10 = offset9 + 1;
        int i4 = i3 | ((src[offset9] & 255) << 16);
        int offset11 = offset10 + 1;
        int l = i4 | ((src[offset10] & 255) << 24);
        int offset12 = offset11 + 1;
        int offset13 = offset12 + 1;
        return (4294967295L & ((long) l)) | (((long) (((((src[offset12] & 255) << 8) | ((src[offset11] & 255) << 0)) | ((src[offset13] & 255) << 16)) | ((src[offset13 + 1] & 255) << 24))) << 32);
    }
