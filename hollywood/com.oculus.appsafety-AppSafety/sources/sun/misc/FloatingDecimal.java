...
public class FloatingDecimal {
    ...
    public static class BinaryToASCIIBuffer implements BinaryToASCIIConverter {
        ...
        /* JADX INFO: Multiple debug info for r0v23 int: [D('i' int), D('t' int)] */
    ...
    public static class ASCIIToBinaryBuffer implements ASCIIToBinaryConverter {
        ...
        /* JADX INFO: Multiple debug info for r4v5 int: [D('exp' int), D('bigIntNBits' int)] */
        ...
        /* JADX INFO: Multiple debug info for r3v2 float: [D('fValue' float), D('i' int)] */
    ...
    /* JADX INFO: Multiple debug info for r2v12 long: [D('significand' long), D('sticky' boolean)] */
