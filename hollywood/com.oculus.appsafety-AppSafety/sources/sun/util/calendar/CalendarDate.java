...
public abstract class CalendarDate implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if ((!hasZone || this.zoneinfo.equals(that.zoneinfo)) && getEra() == that.getEra() && this.year == that.year && this.month == that.month && this.dayOfMonth == that.dayOfMonth && this.hours == that.hours && this.minutes == that.minutes && this.seconds == that.seconds && this.millis == that.millis && this.zoneOffset == that.zoneOffset) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) hash) * ((int) (hash >> 32))) ^ era2) ^ isNormalized) ^ (timeZone != null ? timeZone.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        if (offset2 == 0) {
            ...
            sb.append(sign);
            CalendarUtils.sprintf0d(sb, offset3 / 60, 2);
            CalendarUtils.sprintf0d(sb, offset3 % 60, 2);
        } else {
