...
public class QName implements Serializable {
    ...
    public static QName valueOf(String qNameAsString2) {
        if (qNameAsString2 == null) {
            ...
            throw new IllegalArgumentException("Namespace URI .equals(XMLConstants.NULL_NS_URI), .equals(\"\"), only the local part, \"" + qNameAsString2.substring("".length() + 2) + "\", should be provided.");
        }
    }
