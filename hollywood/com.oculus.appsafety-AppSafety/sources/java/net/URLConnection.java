...
public abstract class URLConnection {
    ...
    public long getExpiration() {
        return getHeaderFieldDate(LicenseStoreSchema.LicenseTableSchema.COLUMN_NAME_EXPIRES, 0);
    }
    ...
    public synchronized ContentHandler getContentHandler() throws IOException {
    ...
    public static String guessContentTypeFromStream(InputStream is) throws IOException {
        ...
        if (c1 != 0 || c2 != 0 || c3 != 254 || c4 != 255) {
            c16 = c162;
        } else if (c5 == 0 && c6 == 0 && c7 == 0 && c8 == 60 && c9 == 0 && c10 == 0 && c11 == 0 && c12 == 63 && c13 == 0 && c14 == 0 && c15 == 0) {
            c16 = c162;
            if (c16 == 120) {
                return "application/xml";
            }
