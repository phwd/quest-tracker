...
public final class URL implements Serializable {
    ...
    static URLStreamHandler getURLStreamHandler(String protocol2) {
        ...
        if (handler2 == null) {
            ...
            if (uRLStreamHandlerFactory != null) {
                handler2 = uRLStreamHandlerFactory.createURLStreamHandler(protocol2);
            ...
            if (handler2 == null) {
                ...
                while (handler2 == null && packagePrefixIter.hasMoreTokens()) {
                    try {
                        String clsName = packagePrefixIter.nextToken().trim() + "." + protocol2 + ".Handler";
                        Class<?> cls = null;
                        try {
    ...
    private synchronized void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        if (getURLStreamHandler(protocol2) != null) {
            String host3 = (String) gf.get("host", (Object) null);
            int port2 = gf.get("port", -1);
            String authority4 = (String) gf.get("authority", (Object) null);
            String file2 = (String) gf.get("file", (Object) null);
            String ref2 = (String) gf.get("ref", (Object) null);
            if (authority4 != null || ((host3 == null || host3.length() <= 0) && port2 == -1)) {
                host2 = host3;
                ...
                if (port2 == -1) {
                    ...
                    authority3 = host3 + ":" + port2;
                }
                host2 = host3;
                authority2 = authority3;
            }
            this.tempState = new UrlDeserializedState(protocol2, host2, port2, authority2, file2, ref2, -1);
        } else {
    ...
    private URL setDeserializedFields(URLStreamHandler handler2) {
        ...
        } else if (!(authority2 == null || (ind = authority2.indexOf(64)) == -1)) {
