...
public final class Math {
    ...
    public static int round(float a) {
        ...
        int r = (8388607 & intBits) | UCharacterProperty.SCRIPT_X_WITH_INHERITED;
        if (intBits < 0) {
            r = -r;
        }
        return ((r >> shift) + 1) >> 1;
    ...
    public static double scalb(double d, int scaleFactor) {
        ...
        int exp_adjust = ((scaleFactor2 + t) & Opcodes.OP_CHECK_CAST_JUMBO) - t;
    ...
    public static float scalb(float f, int scaleFactor) {
        return (float) (((double) f) * powerOfTwoD(max(min(scaleFactor, (int) UCharacter.UnicodeBlock.SOYOMBO_ID), -278)));
    }
