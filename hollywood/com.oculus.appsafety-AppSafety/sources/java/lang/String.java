...
public final class String implements Serializable, Comparable<String>, CharSequence {
    ...
    public boolean regionMatches(boolean ignoreCase, int toffset, String other, int ooffset, int to) {
        ...
        while (true) {
            ...
            if (c1 != c2 && (!ignoreCase || ((u1 = Character.toUpperCase(c1)) != (u2 = Character.toUpperCase(c2)) && Character.toLowerCase(u1) != Character.toLowerCase(u2)))) {
                return false;
            }
            to2 = to3;
            to = len;
    ...
    static int indexOf(char[] source, int sourceOffset, int sourceCount, String target, int fromIndex) {
        return indexOf(source, sourceOffset, sourceCount, target.toCharArray(), 0, target.length(), fromIndex);
    }
    ...
    static int lastIndexOf(char[] source, int sourceOffset, int sourceCount, String target, int fromIndex) {
        return lastIndexOf(source, sourceOffset, sourceCount, target.toCharArray(), 0, target.length(), fromIndex);
    }
    ...
    public static String valueOf(char[] data, int offset, int count2) {
        return new String(data, offset, count2);
    }
