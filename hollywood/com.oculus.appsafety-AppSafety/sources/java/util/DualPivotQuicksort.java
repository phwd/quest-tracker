...
public final class DualPivotQuicksort {
    ...
    /* JADX INFO: Multiple debug info for r11v4 int: [D('t' int), D('less' int)] */
    /* JADX INFO: Multiple debug info for r4v2 int: [D('length' int), D('pivot' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v8 int: [D('t' long), D('less' int)] */
    /* JADX INFO: Multiple debug info for r5v7 long: [D('last' long), D('k' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v4 int: [D('t' short), D('less' int)] */
    ...
    /* JADX INFO: Multiple debug info for r5v23 short: [D('last' short), D('k' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v4 int: [D('t' char), D('less' int)] */
    /* JADX INFO: Multiple debug info for r4v2 char: [D('pivot' char), D('length' int)] */
    /* JADX INFO: Multiple debug info for r4v18 char: [D('length' int), D('ak' char)] */
    ...
    /* JADX INFO: Multiple debug info for r4v2 float: [D('length' int), D('pivot' float)] */
    /* JADX INFO: Multiple debug info for r5v7 float: [D('last' float), D('k' int)] */
    ...
    /* JADX INFO: Multiple debug info for r11v8 int: [D('t' double), D('less' int)] */
    /* JADX INFO: Multiple debug info for r5v7 double: [D('last' double), D('k' int)] */
