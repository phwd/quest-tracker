...
public class StampedLock implements Serializable {
    ...
    public long writeLock() {
        ...
        if ((s & ABITS) == 0) {
            ...
            long j = STATE;
            long j2 = s + WBIT;
            if (unsafe.compareAndSwapLong(this, j, s, j2)) {
                return j2;
            }
        }
        ...
        while (true) {
            ...
            if (m != 0) {
                if (m != WBIT) {
                    ...
                    long j = STATE;
                    long s2 = WBIT + s;
                    unsafe.putLongVolatile(this, j, s2 == 0 ? 256 : s2);
                    WNode h2 = this.whead;
    ...
    /* JADX INFO: Multiple debug info for r0v9 java.util.concurrent.locks.StampedLock$WNode: [D('h' java.util.concurrent.locks.StampedLock$WNode), D('wasInterrupted' boolean)] */
