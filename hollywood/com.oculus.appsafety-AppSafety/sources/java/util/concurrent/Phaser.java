    ...
    private int internalAwaitAdvance(int phase, QNode node) {
        ...
        while (true) {
            ...
            if (i != phase) {
                ...
                int unarrived = ((int) s) & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                if (unarrived != lastUnarrived2) {
                    ...
                    if (unarrived < NCPU) {
                        ...
                        if (interrupted || spins - 1 < 0) {
                            QNode node3 = new QNode(this, phase, false, false, STATE);
                ...
                lastUnarrived = lastUnarrived2;
                interrupted = Thread.interrupted();
                QNode node32 = new QNode(this, phase, false, false, STATE);
