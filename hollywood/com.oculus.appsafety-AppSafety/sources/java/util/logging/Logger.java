...
public class Logger {
    ...
    protected Logger(String name2, String resourceBundleName) {
        this(name2, resourceBundleName, null, LogManager.getLogManager(), false);
    }
    ...
    public static Logger getLogger(String name2) {
        return demandLogger(name2, null, Reflection.getCallerClass());
    }
    ...
    public static Logger getAnonymousLogger(String resourceBundleName) {
        ...
        Logger result = new Logger(null, resourceBundleName, Reflection.getCallerClass(), manager2, false);
    ...
    public void setResourceBundle(java.util.ResourceBundle r6) {
        /*
            ...
            monitor-enter(r5)
            java.util.logging.Logger$LoggerBundle r1 = r5.loggerBundle     // Catch:{ all -> 0x0034 }
            java.lang.String r2 = r1.resourceBundleName     // Catch:{ all -> 0x0034 }
            if (r2 == 0) goto L_0x0021
            java.lang.String r2 = r1.resourceBundleName     // Catch:{ all -> 0x0034 }
            boolean r2 = r2.equals(r0)     // Catch:{ all -> 0x0034 }
        ...
        L_0x0022:
            ...
            java.util.logging.Logger$LoggerBundle r3 = java.util.logging.Logger.LoggerBundle.get(r0, r6)     // Catch:{ all -> 0x0034 }
            r5.loggerBundle = r3     // Catch:{ all -> 0x0034 }
            monitor-exit(r5)     // Catch:{ all -> 0x0034 }
            return
        L_0x002c:
            java.lang.IllegalArgumentException r3 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x0034 }
