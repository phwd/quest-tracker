...
public final class ValueRange implements Serializable {
    ...
    private String genInvalidFieldMessage(TemporalField field, long value) {
        if (field != null) {
            return "Invalid value for " + ((Object) field) + " (valid values " + ((Object) this) + "): " + value;
        }
        return "Invalid value (valid values " + ((Object) this) + "): " + value;
    }
    ...
    public int hashCode() {
        ...
        long hash = ((j5 >> ((int) (32 + j6))) << ((int) (j6 + 48))) >> 16;
