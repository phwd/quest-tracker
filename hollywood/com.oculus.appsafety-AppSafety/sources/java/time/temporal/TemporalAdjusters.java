...
public final class TemporalAdjusters {
    ...
    public static TemporalAdjuster ofDateAdjuster(UnaryOperator<LocalDate> dateBasedAdjuster) {
        ...
        return new TemporalAdjuster() {
            /* class java.time.temporal.$$Lambda$TemporalAdjusters$CLbEgdXQzFe17bbP1cAR86Ccar4 */

            @Override // java.time.temporal.TemporalAdjuster
            public final Temporal adjustInto(Temporal temporal) {
                return temporal.with((LocalDate) UnaryOperator.this.apply(LocalDate.from((TemporalAccessor) temporal)));
            }
        };
    }
    ...
    public static TemporalAdjuster dayOfWeekInMonth(int ordinal, DayOfWeek dayOfWeek) {
        ...
        if (ordinal >= 0) {
            return new TemporalAdjuster(dowValue, ordinal) {
                /* class java.time.temporal.$$Lambda$TemporalAdjusters$tdo0RtAvE1xjo0CFx292T1yRzQ */
        ...
        return new TemporalAdjuster(dowValue, ordinal) {
            /* class java.time.temporal.$$Lambda$TemporalAdjusters$BioX0XAyDebBQX3h4Lqog9Ofj58 */
            private final /* synthetic */ int f$0;
            private final /* synthetic */ int f$1;
    ...
    public static TemporalAdjuster next(DayOfWeek dayOfWeek) {
        return new TemporalAdjuster(dayOfWeek.getValue()) {
            /* class java.time.temporal.$$Lambda$TemporalAdjusters$Aa2HtcpQrtdU2tm9WsArYNyfqM */
            private final /* synthetic */ int f$0;
    ...
    public static TemporalAdjuster previous(DayOfWeek dayOfWeek) {
        return new TemporalAdjuster(dayOfWeek.getValue()) {
            /* class java.time.temporal.$$Lambda$TemporalAdjusters$Hr69XZXcuTp7qqn22qJMcjGgXGw */
            private final /* synthetic */ int f$0;
