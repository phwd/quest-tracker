...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: java.time.LocalTime */
    ...
    public <R> R query(TemporalQuery<R> query) {
        ...
        return query == TemporalQueries.precision() ? (R) ChronoUnit.NANOS : query.queryFrom(this);
    }
    ...
    public String toString() {
        ...
        buf.append(hourValue < 10 ? AndroidHardcodedSystemProperties.JAVA_VERSION : "");
