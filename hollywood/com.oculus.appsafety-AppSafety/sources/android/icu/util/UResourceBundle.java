...
public abstract class UResourceBundle extends ResourceBundle {
    ...
    protected static UResourceBundle instantiateBundle(String baseName, String localeName, ClassLoader root, boolean disableFallback) {
        int i = AnonymousClass1.$SwitchMap$android$icu$util$UResourceBundle$RootType[getRootType(baseName, root).ordinal()];
        if (i == 1) {
        ...
        try {
            UResourceBundle b = ICUResourceBundle.getBundleInstance(baseName, localeName, root, disableFallback);
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            try {
                $SwitchMap$android$icu$util$UResourceBundle$RootType[RootType.ICU.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$android$icu$util$UResourceBundle$RootType[RootType.JAVA.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$android$icu$util$UResourceBundle$RootType[RootType.MISSING.ordinal()] = 3;
