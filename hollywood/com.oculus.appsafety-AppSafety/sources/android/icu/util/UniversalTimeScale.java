...
public final class UniversalTimeScale {
    ...
    public static final class TimeScaleData {
        ...
        TimeScaleData(long theUnits, long theEpochOffset, long theToMin, long theToMax, long theFromMin, long theFromMax) {
            ...
            long j = this.unitsRound;
            this.minRound = Long.MIN_VALUE + j;
            this.maxRound = Long.MAX_VALUE - j;
            ...
            if (theUnits == UniversalTimeScale.ticks) {
                ...
                this.epochOffsetP1 = j3 + UniversalTimeScale.ticks;
                this.epochOffsetM1 = j3 - UniversalTimeScale.ticks;
            }
            this.toMin = theToMin;
            this.toMax = theToMax;
