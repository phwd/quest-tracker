...
public class GregorianCalendar extends Calendar {
    ...
    public int getActualMaximum(int field) {
        ...
        Date d = cal.getTime();
        int[][] iArr = LIMITS;
        int lowGood = iArr[1][1];
        int highBad = iArr[1][2] + 1;
    ...
    public void handleComputeFields(int julianDay) {
        ...
        if (julianDay >= this.cutoverJulianDay) {
            ...
            month2 = (int) floorDivide((julianEpochDay * 4) + 1464, 1461);
            int dayOfYear2 = (int) (julianEpochDay - (((((long) month2) - 1) * 365) + floorDivide(((long) month2) - 1, 4)));
    ...
    /* JADX INFO: Multiple debug info for r0v3 int: [D('era' int), D('year' int)] */
    /* access modifiers changed from: protected */
    @Override // android.icu.util.Calendar
