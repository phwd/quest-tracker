...
public final class UCharacter implements UCharacterEnums.ECharacterCategory, UCharacterEnums.ECharacterDirection {
    ...
    public static final class UnicodeBlock extends Character.Subset {
        ...
        public static final UnicodeBlock CHESS_SYMBOLS = new UnicodeBlock("CHESS_SYMBOLS", CHESS_SYMBOLS_ID);
        ...
        public static final UnicodeBlock DOGRA = new UnicodeBlock("DOGRA", DOGRA_ID);
        ...
        public static final UnicodeBlock GEORGIAN_EXTENDED = new UnicodeBlock("GEORGIAN_EXTENDED", GEORGIAN_EXTENDED_ID);
        ...
        public static final UnicodeBlock GUNJALA_GONDI = new UnicodeBlock("GUNJALA_GONDI", GUNJALA_GONDI_ID);
        ...
        public static final UnicodeBlock HANIFI_ROHINGYA = new UnicodeBlock("HANIFI_ROHINGYA", HANIFI_ROHINGYA_ID);
        ...
        public static final UnicodeBlock INDIC_SIYAQ_NUMBERS = new UnicodeBlock("INDIC_SIYAQ_NUMBERS", INDIC_SIYAQ_NUMBERS_ID);
        ...
        public static final UnicodeBlock MAKASAR = new UnicodeBlock("MAKASAR", MAKASAR_ID);
        ...
        public static final UnicodeBlock MAYAN_NUMERALS = new UnicodeBlock("MAYAN_NUMERALS", MAYAN_NUMERALS_ID);
        public static final int MAYAN_NUMERALS_ID = 288;
        public static final UnicodeBlock MEDEFAIDRIN = new UnicodeBlock("MEDEFAIDRIN", MEDEFAIDRIN_ID);
        ...
        public static final UnicodeBlock OLD_SOGDIAN = new UnicodeBlock("OLD_SOGDIAN", OLD_SOGDIAN_ID);
        ...
        public static final UnicodeBlock SOGDIAN = new UnicodeBlock("SOGDIAN", SOGDIAN_ID);
        ...
        public static UnicodeBlock getInstance(int id) {
            if (id >= 0) {
                ...
                if (id < unicodeBlockArr.length) {
                    return unicodeBlockArr[id];
                }
            }
            return INVALID_CODE;
        }
    ...
    public static boolean isIdentifierIgnorable(int ch) {
        return ch <= 159 ? isISOControl(ch) && (ch < 9 || ch > 13) && (ch < 28 || ch > 31) : getType(ch) == 16;
    }
    ...
    public static boolean isLegal(int ch) {
        ...
        if (ch > 57343 && !UCharacterUtility.isNonCharacter(ch) && ch <= 1114111) {
            return true;
        }
        return false;
    }
    ...
    public static String toTitleCase(ULocale locale, String str, BreakIterator titleIter, int options) {
        ...
        BreakIterator titleIter2 = CaseMapImpl.getTitleBreakIterator(locale, options, titleIter);
        titleIter2.setText(str);
        return CaseMapImpl.toTitle(getCaseLocale(locale), options, titleIter2, str);
    }
    ...
    public static int foldCase(int ch, boolean defaultmapping) {
        return foldCase(ch, !defaultmapping ? 1 : 0);
    }

    public static String foldCase(String str, boolean defaultmapping) {
        return foldCase(str, !defaultmapping ? 1 : 0);
    }
    ...
    public static int getHanNumericValue(int ch) {
        switch (ch) {
            case IDEOGRAPHIC_NUMBER_ZERO_ /*{ENCODED_INT: 12295}*/:
            case CJK_IDEOGRAPH_COMPLEX_ZERO_ /*{ENCODED_INT: 38646}*/:
                return 0;
            case CJK_IDEOGRAPH_FIRST_ /*{ENCODED_INT: 19968}*/:
            case CJK_IDEOGRAPH_COMPLEX_ONE_ /*{ENCODED_INT: 22777}*/:
                return 1;
            case CJK_IDEOGRAPH_SEVENTH_ /*{ENCODED_INT: 19971}*/:
            case CJK_IDEOGRAPH_COMPLEX_SEVEN_ /*{ENCODED_INT: 26578}*/:
                return 7;
            case CJK_IDEOGRAPH_THIRD_ /*{ENCODED_INT: 19977}*/:
            case CJK_IDEOGRAPH_COMPLEX_THREE_ /*{ENCODED_INT: 21443}*/:
                return 3;
            case CJK_IDEOGRAPH_NINETH_ /*{ENCODED_INT: 20061}*/:
            case CJK_IDEOGRAPH_COMPLEX_NINE_ /*{ENCODED_INT: 29590}*/:
                return 9;
            case CJK_IDEOGRAPH_SECOND_ /*{ENCODED_INT: 20108}*/:
            case CJK_IDEOGRAPH_COMPLEX_TWO_ /*{ENCODED_INT: 36019}*/:
                return 2;
            case CJK_IDEOGRAPH_FIFTH_ /*{ENCODED_INT: 20116}*/:
            case CJK_IDEOGRAPH_COMPLEX_FIVE_ /*{ENCODED_INT: 20237}*/:
                return 5;
            case CJK_IDEOGRAPH_COMPLEX_THOUSAND_ /*{ENCODED_INT: 20191}*/:
            case CJK_IDEOGRAPH_THOUSAND_ /*{ENCODED_INT: 21315}*/:
                return 1000;
            case CJK_IDEOGRAPH_COMPLEX_HUNDRED_ /*{ENCODED_INT: 20336}*/:
            case CJK_IDEOGRAPH_HUNDRED_ /*{ENCODED_INT: 30334}*/:
                return 100;
            case CJK_IDEOGRAPH_HUNDRED_MILLION_ /*{ENCODED_INT: 20740}*/:
                return 100000000;
            case CJK_IDEOGRAPH_EIGHTH_ /*{ENCODED_INT: 20843}*/:
            case CJK_IDEOGRAPH_COMPLEX_EIGHT_ /*{ENCODED_INT: 25420}*/:
                return 8;
            case CJK_IDEOGRAPH_SIXTH_ /*{ENCODED_INT: 20845}*/:
            case CJK_IDEOGRAPH_COMPLEX_SIX_ /*{ENCODED_INT: 38520}*/:
                return 6;
            case CJK_IDEOGRAPH_TEN_ /*{ENCODED_INT: 21313}*/:
            case CJK_IDEOGRAPH_COMPLEX_TEN_ /*{ENCODED_INT: 25342}*/:
                return 10;
            case CJK_IDEOGRAPH_FOURTH_ /*{ENCODED_INT: 22235}*/:
            case CJK_IDEOGRAPH_COMPLEX_FOUR_ /*{ENCODED_INT: 32902}*/:
                return 4;
            case CJK_IDEOGRAPH_TEN_THOUSAND_ /*{ENCODED_INT: 33356}*/:
    ...
    public static String getStringPropertyValue(int propertyEnum, int codepoint, int nameChoice) {
        ...
        switch (propertyEnum) {
            ...
            case UProperty.CASE_FOLDING /*{ENCODED_INT: 16386}*/:
    ...
    /* JADX INFO: Multiple debug info for r4v1 char: [D('index' int), D('c1' char)] */
    ...
    public static final int codePointBefore(char[] text, int index, int limit) {
        ...
        int index2 = index - 1;
        char c2 = text[index2];
        if (isLowSurrogate(c2) && index2 > limit) {
            char c1 = text[index2 - 1];
            if (isHighSurrogate(c1)) {
                return toCodePoint(c1, c2);
            }
    ...
    public static int codePointCount(CharSequence text, int start, int limit) {
        ...
        while (limit > start) {
            ...
            while (true) {
                if (ch < 56320 || ch > 57343 || limit <= start) {
                    break;
                }
                limit--;
    ...
    public static int offsetByCodePoints(CharSequence text, int index, int codePointOffset) {
        ...
        if (codePointOffset >= 0) {
            ...
            while (true) {
                ...
                while (ch >= 55296 && ch <= 56319 && index2 < limit) {
                    int index3 = index2 + 1;
            ...
            while (true) {
                ...
                while (ch2 >= 56320 && ch2 <= 57343 && index > 0) {
                    index--;
                    ch2 = text.charAt(index);
                    if ((ch2 < 55296 || ch2 > 56319) && (codePointOffset = codePointOffset + 1) > 0) {
                        return index + 1;
                    }
                }
            }
        ...
        if (codePointOffset >= 0) {
            while (true) {
                ...
                if (index2 <= limit) {
                    ...
                    throw new IndexOutOfBoundsException("index ( " + index2 + ") > limit (" + limit + ")");
                }
            }
        } else {
            while (true) {
                ...
                char ch2 = text[index];
                if (index >= start) {
                    while (ch2 >= 56320 && ch2 <= 57343 && index > start) {
                        index--;
                        ch2 = text[index];
                        if ((ch2 < 55296 || ch2 > 56319) && (codePointOffset = codePointOffset + 1) > 0) {
                            return index + 1;
