...
public final class NFRuleSet {
    ...
    private NFRule findNormalRule(long number) {
        ...
        if (hi != 0) {
            ...
            throw new IllegalStateException("The rule set " + this.name + " cannot roll back from the rule '" + ((Object) result) + "'");
        }
