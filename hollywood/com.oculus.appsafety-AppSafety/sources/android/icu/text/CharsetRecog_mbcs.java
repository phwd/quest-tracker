...
abstract class CharsetRecog_mbcs extends CharsetRecognizer {
    ...
    /* access modifiers changed from: package-private */
    public int match(CharsetDetector det, int[] commonChars) {
    ...
    static class CharsetRecog_sjis extends CharsetRecog_mbcs {
        ...
        /* access modifiers changed from: package-private */
        @Override // android.icu.text.CharsetRecog_mbcs
        public boolean nextChar(iteratedChar it, CharsetDetector det) {
            it.error = false;
        ...
        /* access modifiers changed from: package-private */
        @Override // android.icu.text.CharsetRecognizer, android.icu.text.CharsetRecog_mbcs
