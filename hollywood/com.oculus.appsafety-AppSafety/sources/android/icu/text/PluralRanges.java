...
public final class PluralRanges implements Freezable<PluralRanges>, Comparable<PluralRanges> {
    ...
    public static final class Matrix implements Comparable<Matrix>, Cloneable {
        ...
        public void setIfNew(StandardPlural start, StandardPlural end, StandardPlural result) {
            ...
            throw new IllegalArgumentException("Previously set value for <" + ((Object) start) + ", " + ((Object) end) + ", " + ((Object) StandardPlural.VALUES.get(old)) + ">");
        }
        ...
        public String toString() {
            ...
            for (StandardPlural i : values) {
                StandardPlural[] values2 = StandardPlural.values();
                for (StandardPlural j : values2) {
                    StandardPlural x = get(i, j);
                    if (x != null) {
                        result.append(((Object) i) + " & " + ((Object) j) + " → " + ((Object) x) + ";\n");
                    }
                }
            }
