...
public final class RuleBasedCollator extends Collator {
    ...
    private final void internalBuildTailoring(String rules) throws Exception {
        ...
        try {
            ...
            CollationTailoring t = (CollationTailoring) builderClass.getMethod("parseAndBuild", String.class).invoke(builder, rules);
            t.actualLocale = null;
            adoptTailoring(t);
    ...
    @Override // android.icu.util.Freezable, android.icu.text.Collator
    public boolean isFrozen() {
        return this.frozenLock != null;
    }

    @Override // android.icu.util.Freezable, android.icu.text.Collator, android.icu.text.Collator
    ...
    /* Return type fixed from 'android.icu.text.RuleBasedCollator' to match base method */
    @Override // android.icu.util.Freezable, android.icu.text.Collator, android.icu.text.Collator
    ...
    public static final class CollationKeyByteSink extends CollationKeys.SortKeyByteSink {
        ...
        @Override // android.icu.impl.coll.CollationKeys.SortKeyByteSink
    ...
    public long[] internalGetCEs(CharSequence str) {
        ...
        try {
            ...
            System.arraycopy((Object) iter.getCEs(), 0, (Object) ces, 0, length);
            return ces;
        } finally {
            releaseCollationBuffer(buffer);
        }
    ...
    public static abstract class NFDIterator {
        ...
        public final int nextDecomposedCodePoint(Normalizer2Impl nfcImpl, int c) {
            ...
            int c2 = Character.codePointAt(str, 0);
    ...
    public ULocale getLocale(ULocale.Type type) {
        ...
        throw new IllegalArgumentException("unknown ULocale.Type " + ((Object) type));
    }
