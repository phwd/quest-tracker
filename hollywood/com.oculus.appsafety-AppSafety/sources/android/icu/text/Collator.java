...
public abstract class Collator implements Comparator<Object>, Freezable<Collator>, Cloneable {
            ...
            if (value8 != null) {
                ...
                while (codesLength != codes.length) {
                    ...
                    if (limit != value8.length()) {
                        ...
                        System.arraycopy((Object) codes, 0, (Object) args, 0, codesLength2);
    ...
    public static Locale[] getAvailableLocales() {
        ServiceShim serviceShim = shim;
        if (serviceShim == null) {
            return ICUResourceBundle.getAvailableLocales("android/icu/impl/data/icudt63b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
        }
    ...
    public static final ULocale[] getAvailableULocales() {
        ServiceShim serviceShim = shim;
        if (serviceShim == null) {
            return ICUResourceBundle.getAvailableULocales("android/icu/impl/data/icudt63b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER);
        }
    ...
    public static final String[] getKeywordValues(String keyword) {
        if (keyword.equals(KEYWORDS[0])) {
            return ICUResourceBundle.getKeywordValues("android/icu/impl/data/icudt63b/coll", RESOURCE);
        }
    ...
    public static final String[] getKeywordValuesForLocale(String key, ULocale locale, boolean commonlyUsed) {
        ...
        ((ICUResourceBundle) UResourceBundle.getBundleInstance("android/icu/impl/data/icudt63b/coll", locale)).getAllItemsWithFallback(RESOURCE, sink);
    ...
    public static final ULocale getFunctionalEquivalent(String keyword, ULocale locID, boolean[] isAvailable) {
        return ICUResourceBundle.getFunctionalEquivalent("android/icu/impl/data/icudt63b/coll", ICUResourceBundle.ICU_DATA_CLASS_LOADER, RESOURCE, keyword, locID, isAvailable, true);
    }
