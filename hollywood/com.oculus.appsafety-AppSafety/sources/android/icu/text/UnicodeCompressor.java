...
public final class UnicodeCompressor implements SCSU {
    ...
    /* JADX INFO: Multiple debug info for r5v25 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r11v1 int: [D('hiByte' int), D('loByte' int)] */
    /* JADX INFO: Multiple debug info for r5v36 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v43 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v49 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v59 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r11v3 int: [D('hiByte' int), D('loByte' int)] */
    /* JADX INFO: Multiple debug info for r5v64 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v75 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r10v5 int: [D('whichWindow' int), D('bytePos' int)] */
    /* JADX INFO: Multiple debug info for r5v113 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v126 int: [D('bytePos' int), D('ucPos' int)] */
    /* JADX INFO: Multiple debug info for r5v132 int: [D('whichWindow' int), D('ucPos' int)] */
