...
class RBBINode {
    ...
    public RBBINode cloneTree() {
        ...
        if (rBBINode != null) {
            n.fLeftChild = rBBINode.cloneTree();
        ...
        n.fRightChild = rBBINode2.cloneTree();
    ...
    public RBBINode flattenVariables() {
        ...
        if (retNode2 != null) {
            this.fLeftChild = retNode2.flattenVariables();
    ...
    static void printNode(RBBINode n) {
        if (n == null) {
            ...
            if (n.fType == 2) {
                ...
                printStream.print(Padder.FALLBACK_PADDING_STRING + n.fText);
            }
        }
        System.out.println("");
    }
