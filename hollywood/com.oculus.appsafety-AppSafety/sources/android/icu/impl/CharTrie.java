...
public class CharTrie extends Trie {
    ...
    public CharTrie(int initialValue, int leadUnitValue, Trie.DataManipulate dataManipulate) {
        ...
        int dataLength = leadUnitValue != initialValue ? 256 + 32 : 256;
    ...
    public boolean equals(Object other) {
        if (!super.equals(other) || !(other instanceof CharTrie) || this.m_initialValue_ != ((CharTrie) other).m_initialValue_) {
            return false;
        }
        return true;
    }
