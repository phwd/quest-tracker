...
public class BasicPeriodBuilderFactory implements PeriodBuilderFactory {
    ...
    public class Settings {
        ...
        public Period createLimited(long duration, boolean inPast) {
            ...
            if (this.maxLimit > 0) {
                ...
                int i = this.maxLimit;
                if (duration * 1000 > ((long) i) * maxUnitDuration) {
                    return Period.moreThan(((float) i) / 1000.0f, this.maxUnit).inPast(inPast);
                }
            }
            if (this.minLimit <= 0) {
                return null;
            ...
            if (emu == timeUnit) {
                ...
                eml = Math.max(1000L, (BasicPeriodBuilderFactory.approximateDurationOf(timeUnit) * ((long) this.minLimit)) / emud);
            }
    ...
    public PeriodBuilderFactory setAvailableUnitRange(TimeUnit minUnit, TimeUnit maxUnit) {
        ...
        throw new IllegalArgumentException("range " + ((Object) minUnit) + " to " + ((Object) maxUnit) + " is empty");
    }
