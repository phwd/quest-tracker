    ...
    public static int compareUTF16(char[] table, char[] primaries, int options, CharSequence left, CharSequence right, int startIndex) {
        ...
        while (true) {
            ...
            if (leftPair4 != rightPair3) {
                int leftPrimary = leftPair4 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                int rightPrimary = rightPair3 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
        ...
        if (CollationSettings.getStrength(options2) >= 1) {
            ...
            while (true) {
                ...
                if (leftPair6 != rightPair5) {
                    int leftSecondary = leftPair6 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                    int rightSecondary = rightPair5 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
        ...
        if ((options2 & 1024) != 0) {
            ...
            while (true) {
                ...
                if (leftPair7 != rightPair6) {
                    int leftCase = leftPair7 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                    int rightCase = rightPair6 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
        ...
        while (true) {
            ...
            if (leftPair9 != rightPair8) {
                int leftTertiary = leftPair9 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                int rightTertiary = rightPair8 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
        ...
        while (true) {
            ...
            if (leftPair11 != rightPair10) {
                int leftQuaternary = leftPair11 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
                int rightQuaternary = rightPair10 & DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH;
