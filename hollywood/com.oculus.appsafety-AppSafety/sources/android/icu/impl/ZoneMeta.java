...
public final class ZoneMeta {
    ...
    private static synchronized Set<String> getCanonicalSystemLocationZIDs() {
        ...
        synchronized (ZoneMeta.class) {
            ...
            if (canonicalSystemLocationZones == null) {
                ...
                for (String id : allIDs) {
                    if (!id.equals(TimeZone.UNKNOWN_ZONE_ID)) {
                        if (id.equals(getCanonicalCLDRID(id)) && (region = getRegion(id)) != null && !region.equals(kWorld)) {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            try {
                $SwitchMap$android$icu$util$TimeZone$SystemTimeZoneType[TimeZone.SystemTimeZoneType.ANY.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$android$icu$util$TimeZone$SystemTimeZoneType[TimeZone.SystemTimeZoneType.CANONICAL.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$android$icu$util$TimeZone$SystemTimeZoneType[TimeZone.SystemTimeZoneType.CANONICAL_LOCATION.ordinal()] = 3;
    ...
    public static Set<String> getAvailableIDs(TimeZone.SystemTimeZoneType type, String region, Integer rawOffset) {
        Set<String> baseSet;
        TimeZone z;
        int i = AnonymousClass1.$SwitchMap$android$icu$util$TimeZone$SystemTimeZoneType[type.ordinal()];
        if (i == 1) {
        ...
        for (String id : baseSet) {
            if ((region == null || region.equals(getRegion(id))) && (rawOffset == null || ((z = getSystemTimeZone(id)) != null && rawOffset.equals(Integer.valueOf(z.getRawOffset()))))) {
                result.add(id);
            }
        }
        if (result.isEmpty()) {
        ...
        synchronized (ZoneMeta.class) {
            ...
            if (index >= 0) {
                ...
                if (res != null) {
                    ...
                    if (zoneIdx >= 0 && (tmp = getZoneID(zoneIdx)) != null) {
                        result = tmp;
                    }
                }
            }
    ...
    public static String getCanonicalCountry(String tzid, Output<Boolean> isPrimary) {
        isPrimary.value = (T) Boolean.FALSE;
        String country = getRegion(tzid);
        if (country != null && country.equals(kWorld)) {
            return null;
        }
        ...
        if (singleZone.booleanValue()) {
            isPrimary.value = (T) Boolean.TRUE;
        } else {
            try {
    ...
    public static class SystemTimeZoneCache extends SoftCache<String, OlsonTimeZone, String> {
        ...
        /* synthetic */ SystemTimeZoneCache(AnonymousClass1 x0) {
            this();
        }
    ...
    public static class CustomTimeZoneCache extends SoftCache<Integer, SimpleTimeZone, int[]> {
        ...
        /* synthetic */ CustomTimeZoneCache(AnonymousClass1 x0) {
            this();
        }
