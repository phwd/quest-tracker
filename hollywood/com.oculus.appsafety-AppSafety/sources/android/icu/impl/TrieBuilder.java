...
public class TrieBuilder {
    ...
    public boolean isInZeroBlock(int ch) {
        if (this.m_isCompacted_ || ch > 1114111 || ch < 0 || this.m_index_[ch >> 5] == 0) {
            return true;
        }
        return false;
    }
