...
final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    private static Class<? extends Date> verifyDateType(Class<? extends Date> dateType2) {
        ...
        throw new IllegalArgumentException("Date type must be one of " + ((Object) Date.class) + ", " + ((Object) Timestamp.class) + ", or " + ((Object) java.sql.Date.class) + " but was " + ((Object) dateType2));
    }
