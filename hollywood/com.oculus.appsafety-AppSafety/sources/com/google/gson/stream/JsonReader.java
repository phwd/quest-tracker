...
public class JsonReader implements Closeable {
    ...
    public String nextName() throws IOException {
        ...
        if (p == 14) {
            ...
            result = nextQuotedValue(PatternTokenizer.SINGLE_QUOTE);
        } else if (p == 13) {
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == 16) {
            ...
            this.peekedString = nextQuotedValue(p == 8 ? PatternTokenizer.SINGLE_QUOTE : '\"');
        } else if (p == 10) {
    ...
    public void skipValue() throws IOException {
        ...
        do {
            ...
            if (p == 3) {
                ...
                skipQuotedValue(PatternTokenizer.SINGLE_QUOTE);
            } else if (p == 9 || p == 13) {
                skipQuotedValue('\"');
            } else if (p == 16) {
                this.pos += this.peekedNumberLength;
    ...
    private void push(int newTop) {
        ...
        if (i == iArr.length) {
            ...
            System.arraycopy((Object) iArr, 0, (Object) newStack, 0, i);
            System.arraycopy((Object) this.pathIndices, 0, (Object) newPathIndices, 0, this.stackSize);
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        if (i4 != i3) {
            this.limit = i4 - i3;
            System.arraycopy((Object) buffer2, i3, (Object) buffer2, 0, this.limit);
        } else {
            this.limit = 0;
        }
        this.pos = 0;
    ...
    public String getPath() {
        StringBuilder result = new StringBuilder().append(SymbolTable.SYMBOL_REF);
