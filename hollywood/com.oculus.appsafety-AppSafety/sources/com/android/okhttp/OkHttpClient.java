...
public class OkHttpClient implements Cloneable {
    ...
    static {
        Internal.instance = new Internal() {
            /* class com.android.okhttp.OkHttpClient.AnonymousClass1 */

            @Override // com.android.okhttp.internal.Internal
    ...
    public OkHttpClient() {
        ...
        this.connectTimeout = VMRuntime.SDK_VERSION_CUR_DEVELOPMENT;
        this.readTimeout = VMRuntime.SDK_VERSION_CUR_DEVELOPMENT;
        this.writeTimeout = VMRuntime.SDK_VERSION_CUR_DEVELOPMENT;
    ...
    public OkHttpClient setProtocols(List<Protocol> protocols2) {
        ...
        if (!protocols3.contains(Protocol.HTTP_1_1)) {
            throw new IllegalArgumentException("protocols doesn't contain http/1.1: " + ((Object) protocols3));
        } else if (protocols3.contains(Protocol.HTTP_1_0)) {
            throw new IllegalArgumentException("protocols must not contain http/1.0: " + ((Object) protocols3));
