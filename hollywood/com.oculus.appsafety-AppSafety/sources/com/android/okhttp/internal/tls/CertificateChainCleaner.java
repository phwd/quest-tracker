    ...
    public List<Certificate> clean(List<Certificate> chain) throws SSLPeerUnverifiedException {
        ...
        for (int c = 0; c < 9; c++) {
            ...
            if (trustedCert != null) {
                ...
                throw new SSLPeerUnverifiedException("Failed to find a trusted cert that signed " + ((Object) toVerify));
            }
        }
        throw new SSLPeerUnverifiedException("Certificate chain too long: " + ((Object) result));
    }
