    ...
    public Object invoke(T target, Object... args) throws InvocationTargetException {
        ...
        if (m != null) {
            try {
                ...
                AssertionError error = new AssertionError((Object) ("Unexpectedly could not call: " + ((Object) m)));
                error.initCause(e);
                throw error;
            }
        } else {
            throw new AssertionError((Object) ("Method " + this.methodName + " not supported for object " + ((Object) target)));
        }
    }
