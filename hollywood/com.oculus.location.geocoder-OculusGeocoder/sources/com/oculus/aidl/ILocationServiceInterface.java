        ...
        public static class Proxy implements ILocationServiceInterface {
            ...
            public void getLocation(ILocationCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_getLocation, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void getLocationUsingIPOnly(ILocationCallback callback) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (this.mRemote.transact(Stub.TRANSACTION_getLocationUsingIPOnly, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void getLocationWithTimezoneUsingIPOnly(ILocationCallback callback) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    if (this.mRemote.transact(Stub.TRANSACTION_getLocationWithTimezoneUsingIPOnly, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void getLocationByType(ILocationCallback callback, int requestType) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_getLocationByType, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
