...
public class Providers {
    private static final Set DEPRECATED_ALGORITHMS = new HashSet();
    private static volatile Provider SYSTEM_BOUNCY_CASTLE_PROVIDER = providerList.getProvider("BC");
    private static final String[] jarVerificationProviders = {"com.android.org.conscrypt.OpenSSLProvider", "com.android.org.bouncycastle.jce.provider.BouncyCastleProvider", "com.android.org.conscrypt.JSSEProvider", "sun.security.provider.VerificationProvider"};
    private static int maximumAllowableApiLevelForBcDeprecation = 27;
    private static volatile ProviderList providerList;
    private static final ThreadLocal threadLists = new InheritableThreadLocal();
    ...
    public static synchronized ProviderList beginThreadProviderList(ProviderList providerList2) {
        ...
        synchronized (Providers.class) {
            ...
            providerList3 = (ProviderList) threadLists.get();
            threadListsUsed++;
            threadLists.set(providerList2);
        }
    ...
    public static synchronized void checkBouncyCastleDeprecation(String str, String str2, String str3) {
        synchronized (Providers.class) {
    ...
    public static synchronized void checkBouncyCastleDeprecation(Provider provider, String str, String str2) {
        synchronized (Providers.class) {
    ...
    private static void checkBouncyCastleDeprecation(String str, String str2) {
        String str3 = str + "." + str2;
        if (!DEPRECATED_ALGORITHMS.contains(str3.toUpperCase(Locale.US))) {
            return;
        }
