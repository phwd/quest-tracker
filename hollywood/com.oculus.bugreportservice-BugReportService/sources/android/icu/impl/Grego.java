...
public class Grego {
    ...
    public static long fieldsToDay(int i, int i2, int i3) {
        int i4 = i - 1;
        long j = (long) i4;
        return (((((((((long) (i4 * 365)) + floorDivide(j, 4)) + 1721423) + floorDivide(j, 400)) - floorDivide(j, 100)) + 2) + ((long) DAYS_BEFORE[i2 + (isLeapYear(i) ? 12 : 0)])) + ((long) i3)) - 2440588;
    }
    ...
    public static int[] dayToFields(long j, int[] iArr) {
        ...
        int i3 = ((((i2 >= (isLeapYear ? 60 : 59) ? isLeapYear ? 1 : 2 : 0) + i2) * 12) + 6) / 367;
