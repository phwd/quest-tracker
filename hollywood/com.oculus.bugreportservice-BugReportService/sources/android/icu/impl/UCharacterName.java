...
public final class UCharacterName {
    ...
    public static final class AlgorithmName {
        ...
        public int getChar(java.lang.String r11) {
            /*
    ...
    private static int getExtendedChar(String str, int i) {
        ...
        if (i == 2) {
            ...
            if (str.charAt(length) == '>' && (lastIndexOf = str.lastIndexOf(45)) >= 0) {
                ...
                try {
                    int parseInt = Integer.parseInt(str.substring(i3, length), 16);
                    String substring = str.substring(1, i3 - 1);
                    int length2 = TYPE_NAMES_.length;
                    while (true) {
                        if (i2 >= length2) {
                            break;
                        } else if (substring.compareTo(TYPE_NAMES_[i2]) != 0) {
                            i2++;
                        } else if (getType(parseInt) == i2) {
                            return parseInt;
                        }
                    }
