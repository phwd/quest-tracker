...
public class UnicodeSetStringSpan {
    ...
    public UnicodeSetStringSpan(UnicodeSet unicodeSet, ArrayList arrayList, int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            String str = (String) this.strings.get(i4);
        ...
        while (true) {
            ...
            if (spanCondition == UnicodeSet.SpanCondition.CONTAINED) {
                for (int i6 = 0; i6 < size; i6++) {
                    ...
                    if (s != 255) {
                        String str = (String) this.strings.get(i6);
                ...
                while (i9 < size) {
                    ...
                    String str2 = (String) this.strings.get(i9);
    ...
    public int spanAndCount(java.lang.CharSequence r9, int r10, android.icu.text.UnicodeSet.SpanCondition r11, android.icu.util.OutputInt r12) {
        ...
        L_0x0009:
            ...
            return r8
        L_0x0012:
            java.util.ArrayList r11 = r8.strings
            int r11 = r11.size()
            int r0 = r9.length()
            int r1 = r0 - r10
            r2 = 0
        ...
        L_0x0021:
            ...
            android.icu.text.UnicodeSet r4 = r8.spanSet
        ...
        L_0x002f:
            ...
            java.util.ArrayList r6 = r8.strings
        ...
        while (true) {
            ...
            if (spanCondition == UnicodeSet.SpanCondition.CONTAINED) {
                ...
                while (i8 < size) {
                    ...
                    String str2 = (String) this.strings.get(i8);
                    int length2 = str2.length();
                    short s4 = s3;
                    if (s3 >= c) {
                        s4 = length2;
    ...
    private int spanNot(CharSequence charSequence, int i, OutputInt outputInt) {
        ...
        do {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                if (this.spanLengths[i5] != 255 && (length = (str = (String) this.strings.get(i5)).length()) <= i3 && matches16CPB(charSequence, i2, length2, str, length)) {
                    return i2;
                }
            }
            i = i2 - spanOne;
    ...
    private int spanNotBack(CharSequence charSequence, int i) {
        ...
        do {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                if (this.spanLengths[i3] != 255 && (length = (str = (String) this.strings.get(i3)).length()) <= spanBack && matches16CPB(charSequence, spanBack - length, i, str, length)) {
                    return spanBack;
                }
            }
