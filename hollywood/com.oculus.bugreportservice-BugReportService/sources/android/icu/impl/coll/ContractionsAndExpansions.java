...
public final class ContractionsAndExpansions {
    ...
    public void forData(CollationData collationData) {
        ...
        Iterator it = this.data.trie.iterator();
        while (it.hasNext()) {
        ...
        if (collationData.base != null) {
            ...
            Iterator it2 = this.data.trie.iterator();
            while (it2.hasNext()) {
                Trie2.Range range2 = (Trie2.Range) it2.next();
    ...
    private void handleCE32(int i, int i2, int i3) {
        while ((i3 & 255) >= 192) {
            switch (Collation.tagFromCE32(i3)) {
                ...
                case 7:
                case 13:
                    throw new AssertionError((Object) String.format("Unexpected CE32 tag type %d for ce32=0x%08x", Integer.valueOf(Collation.tagFromCE32(i3)), Integer.valueOf(i3)));
                case 4:
                    if (this.sink != null) {
