...
public class SimpleTimeZone extends BasicTimeZone {
    ...
    public void getOffsetFromLocal(long r23, int r25, int r26, int[] r27) {
        /*
        // Method dump skipped, instructions count: 114
        */
        throw new UnsupportedOperationException("Method not decompiled: android.icu.util.SimpleTimeZone.getOffsetFromLocal(long, int, int, int[]):void");
    }
