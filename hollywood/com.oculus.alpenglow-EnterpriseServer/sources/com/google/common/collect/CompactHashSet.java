...
public class CompactHashSet<E> extends AbstractSet<E> implements Serializable {
    ...
    public final boolean add(@NullableDecl E e) {
        ...
        int A022 = AnonymousClass0rg.A02(e);
        int[] iArr = this.A04;
        ...
        if (i2 == -1) {
            ...
            while (true) {
                long j = jArr[i2];
                if (((int) (j >>> 32)) == A022 && Objects.equal(e, objArr[i2])) {
                    return false;
                }
                int i3 = (int) j;
                if (i3 == -1) {
    ...
    public final boolean remove(@NullableDecl Object obj) {
        return A01(this, obj, AnonymousClass0rg.A02(obj));
    }
