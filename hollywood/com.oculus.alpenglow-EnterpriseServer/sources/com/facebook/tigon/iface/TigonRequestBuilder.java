...
public class TigonRequestBuilder {
    ...
    public C05550ju mHttpPriority = new C05550ju();
    public Map<C05590k4<?>, Object> mLayerInformation;
    ...
    public static TigonRequest create(String str, String str2, String[] strArr, int i, boolean z, FacebookLoggingRequestInfo facebookLoggingRequestInfo) {
        ...
        if ((length & 1) == 0) {
            ...
            if (facebookLoggingRequestInfo != null) {
                C05590k4<FacebookLoggingRequestInfo> r1 = C05600k5.A03;
            ...
            return new C02700ac(tigonRequestBuilder);
        }
