...
public final class HttpEngine {
    public static final ResponseBody EMPTY_BODY = new ResponseBody() {
        ...
        public AnonymousClass0Od source() {
            return new AnonymousClass0HR();
        }
    };
    public static final int MAX_FOLLOW_UPS = 20;
    public final boolean bufferRequestBody;
    public AnonymousClass0Oe bufferedRequestBody;
    ...
    public AnonymousClass0h1 requestBodyOut;
        ...
        public Response proceed(Request request2) throws IOException {
            ...
            if (i > 0) {
                ...
                if (!str2.equals(httpUrl2.host) || httpUrl.port != httpUrl2.port) {
                    str = "network interceptor " + interceptor + " must retain the same host and port";
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors.size()) {
                ...
                if (HttpMethod.permitsRequestBody(request2.method) && (requestBody = request2.body) != null) {
                    AnonymousClass0HP r1 = new AnonymousClass0HP(httpEngine.httpStream.createRequestBody(request2, requestBody.contentLength()));
                ...
                if (i2 == 204 || i2 == 205) {
                    ...
                    if (responseBody.contentLength() > 0) {
                        throw new ProtocolException("HTTP " + i2 + " had non-zero Content-Length: " + responseBody.contentLength());
                    }
                }
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        AnonymousClass0h1 body;
        if (cacheRequest == null || (body = cacheRequest.body()) == null) {
            return response;
        }
        final AnonymousClass0Od source = response.body.source();
        final AnonymousClass0HP r1 = new AnonymousClass0HP(body);
        AnonymousClass2 r0 = new AbstractC04550h0() {
            /* class com.squareup.okhttp.internal.http.HttpEngine.AnonymousClass2 */
            public boolean cacheRequestClosed;

            @Override // X.AbstractC04550h0
            public long read(AnonymousClass0HR r11, long j) throws IOException {
                try {
                    ...
                    r11.A0H(r1.A1Z(), r11.A00 - read, read);
                    r1.A2I();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
        ...
        builder.body = new RealResponseBody(response.headers, new AnonymousClass0HO(r0));
    ...
    private Response unzip(Response response) throws IOException {
        ...
        AnonymousClass0OV r4 = new AnonymousClass0OV(responseBody.source());
        ...
        builder.body = new RealResponseBody(headers, new AnonymousClass0HO(r4));
        return builder.build();
    }
    ...
    public StreamAllocation close() {
        AnonymousClass0Oe r0 = this.bufferedRequestBody;
        if (r0 != null) {
            Util.closeQuietly(r0);
        } else {
            AnonymousClass0h1 r02 = this.requestBodyOut;
            if (r02 != null) {
    ...
    public AnonymousClass0Oe getBufferedRequestBody() {
        AnonymousClass0Oe r0 = this.bufferedRequestBody;
        if (r0 != null) {
            return r0;
        }
        AnonymousClass0h1 requestBody = getRequestBody();
        if (requestBody == null) {
            return null;
        }
        AnonymousClass0HP r02 = new AnonymousClass0HP(requestBody);
    ...
    public AnonymousClass0h1 getRequestBody() {
    ...
    public void sendRequest() throws RequestException, RouteException, IOException {
        ...
        AnonymousClass0h1 createRequestBody;
        int i;
        if (this.cacheStrategy != null) {
            return;
        }
    ...
    public HttpEngine recover(IOException iOException, AnonymousClass0h1 r11) {
