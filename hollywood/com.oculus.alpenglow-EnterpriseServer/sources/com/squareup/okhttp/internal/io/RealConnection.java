...
public final class RealConnection implements Connection {
    ...
    private void connectSocket(int i, int i2, int i3, ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            this.source = new AnonymousClass0HO(C04600h6.A01(this.rawSocket));
            this.sink = new AnonymousClass0HP(C04600h6.A00(this.rawSocket));
    ...
    private void createTunnel(int i, int i2) throws IOException {
        ...
        String str2 = "CONNECT " + httpUrl.host + ":" + httpUrl.port + " HTTP/1.1";
        while (true) {
            AnonymousClass0Od r1 = this.source;
            Http1xStream http1xStream = new Http1xStream(null, r1, this.sink);
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            r1.timeout().timeout((long) i, timeUnit);
            this.sink.timeout().timeout((long) i2, timeUnit);
            http1xStream.writeRequest(createTunnelRequest.headers, str2);
            ...
            AbstractC04550h0 newFixedLengthSource = http1xStream.newFixedLengthSource(contentLength);
            Util.skipAll(newFixedLengthSource, Integer.MAX_VALUE, TimeUnit.MILLISECONDS);
            newFixedLengthSource.close();
            int i3 = build.code;
            if (i3 != 200) {
                if (i3 != 407) {
                    str = AnonymousClass006.A01("Unexpected response code for CONNECT: ", i3);
                    break;
                }
                Route route2 = this.route;
            ...
            } else if (!this.source.A1Z().A2T() || !this.sink.A1Z().A2T()) {
