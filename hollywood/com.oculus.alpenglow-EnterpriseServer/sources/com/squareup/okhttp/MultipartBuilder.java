...
public final class MultipartBuilder {
    ...
    public final C04610h7 boundary;
    ...
    public static final class MultipartRequestBody extends RequestBody {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: X.0HR */
        /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: X.0HR */
        /* JADX DEBUG: Multi-variable search result rejected for r4v2, resolved type: X.0HR */
        /* JADX WARN: Multi-variable type inference failed */
        private long writeOrCountBytes(AnonymousClass0Oe r12, boolean z) throws IOException {
            AnonymousClass0HR r4;
            if (z) {
                r12 = new AnonymousClass0HR();
                r4 = r12;
            } else {
                r4 = 0;
            }
            ...
            for (int i = 0; i < size; i++) {
                ...
                r12.A8w(MultipartBuilder.DASHDASH);
                r12.A8v(this.boundary);
                byte[] bArr = MultipartBuilder.CRLF;
                r12.A8w(bArr);
                if (headers != null) {
                    int length = headers.namesAndValues.length >> 1;
                    for (int i2 = 0; i2 < length; i2++) {
                        r12.A9F(headers.name(i2));
                        r12.A8w(MultipartBuilder.COLONSPACE);
                        r12.A9F(headers.value(i2));
                        r12.A8w(bArr);
                    }
                }
                MediaType contentType2 = requestBody.contentType();
                if (contentType2 != null) {
                    r12.A9F("Content-Type: ");
                    r12.A9F(contentType2.toString());
                    r12.A8w(bArr);
                }
                long contentLength2 = requestBody.contentLength();
                if (contentLength2 != -1) {
                    r12.A9F("Content-Length: ");
                    r12.A92(contentLength2);
                    r12.A8w(MultipartBuilder.CRLF);
                } else if (z) {
                    r4.A08();
                    return -1;
                }
        ...
        public MultipartRequestBody(MediaType mediaType, C04610h7 r4, List<Headers> list, List<RequestBody> list2) {
            if (mediaType != null) {
                this.boundary = r4;
                this.contentType = MediaType.parse(mediaType + "; boundary=" + r4.A0A());
    ...
    public MultipartBuilder(String str) {
        ...
        this.boundary = C04610h7.A04(str);
    }
