...
public final class HttpUrl {
    ...
    public static void canonicalize(AnonymousClass0HR r6, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        String str3;
        AnonymousClass0HR r4 = null;
        while (i < i2) {
    ...
    public static void percentDecode(AnonymousClass0HR r5, String str, int i, int i2, boolean z) {
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37) {
                int i3 = i + 2;
