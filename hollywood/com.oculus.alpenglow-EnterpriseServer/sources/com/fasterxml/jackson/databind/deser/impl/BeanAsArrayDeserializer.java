...
public final class BeanAsArrayDeserializer extends BeanDeserializerBase {
    ...
    public BeanAsArrayDeserializer(BeanDeserializerBase beanDeserializerBase, AbstractC01680Ku[] r3) {
        super(beanDeserializerBase, beanDeserializerBase._ignoreAllUnknown);
        this._delegate = beanDeserializerBase;
        this._orderedProperties = r3;
    }

    private final void A00(AnonymousClass0aT r3, AbstractC02570aK r4) throws IOException, C05910ld {
    ...
    @Override // com.fasterxml.jackson.databind.deser.BeanDeserializerBase
    public final BeanDeserializerBase A0Q(AnonymousClass0nL r4) {
        ...
        if (r9.A0G() != EnumC05930lf.START_ARRAY) {
            ...
            if (this._vanillaProcessing) {
                ...
                if (jsonDeserializer != null) {
                    return this._valueInstantiator.A09(r10, jsonDeserializer.A09(r9, r10));
                }
