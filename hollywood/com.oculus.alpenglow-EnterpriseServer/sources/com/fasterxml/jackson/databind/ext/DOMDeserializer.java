...
public abstract class DOMDeserializer<T> extends FromStringDeserializer<T> {
    ...
    public static class DocumentDeserializer extends DOMDeserializer<Document> {
        ...
        public final Document A0Q(String str, AbstractC02570aK r3) {
    ...
    public static class NodeDeserializer extends DOMDeserializer<Node> {
        ...
        /* Return type fixed from 'java.lang.Object' to match base method */
        @Override // com.fasterxml.jackson.databind.deser.std.FromStringDeserializer, com.fasterxml.jackson.databind.ext.DOMDeserializer
        public final Node A0Q(String str, AbstractC02570aK r3) {
            return DOMDeserializer.A00(str);
        }
    }

    @Override // com.fasterxml.jackson.databind.deser.std.FromStringDeserializer
    public abstract T A0Q(String str, AbstractC02570aK v);
