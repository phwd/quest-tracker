...
public class ActionBarContextView extends AbstractC001203i {
    public View A00;
    public View A01;
    ...
    public final void A05(X.AnonymousClass03D r5) {
        /*
        // Method dump skipped, instructions count: 120
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.ActionBarContextView.A05(X.03D):void");
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        AnonymousClass0Mm r0 = super.A00;
        if (r0 != null) {
            r0.A05();
            C01880Ms r02 = super.A00.A03;
            if (r02 != null) {
                r02.A03();
            }
        }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (view == null || view.getVisibility() == 8) {
            ...
            int A002 = i7 + AbstractC001203i.A00(this.A00, i7, paddingTop, paddingTop2, z2);
            i5 = A002 + i6;
            if (z2) {
                i5 = A002 - i6;
            }
        ...
        if (!(linearLayout == null || this.A01 != null || linearLayout.getVisibility() == 8)) {
            i5 += AbstractC001203i.A00(this.A08, i5, paddingTop, paddingTop2, z2);
        }
        View view2 = this.A01;
        if (view2 != null) {
            AbstractC001203i.A00(view2, i5, paddingTop, paddingTop2, z2);
        }
        if (z2) {
        ...
        if (actionMenuView != null) {
            AbstractC001203i.A00(actionMenuView, paddingRight, paddingTop, paddingTop2, !z2);
        }
    }
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        AnonymousClass05Y A002 = AnonymousClass05Y.A00(context, attributeSet, AnonymousClass18N.A03, i, 0);
