...
public class ActionBarContainer extends FrameLayout {
    ...
    public void setTabContainer(AnonymousClass058 r2) {
        View view = this.A05;
        if (view != null) {
            removeView(view);
        }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        Drawable drawable;
        setBackground(new C001303j(this));
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AnonymousClass18N.A00);
