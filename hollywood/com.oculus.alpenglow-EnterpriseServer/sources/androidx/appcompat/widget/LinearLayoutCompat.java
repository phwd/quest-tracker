...
public class LinearLayoutCompat extends ViewGroup {
    ...
    private void forceUniformHeight(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                C003604n r2 = (C003604n) childAt.getLayoutParams();
                if (r2.height == -1) {
                    int i4 = r2.width;
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                ...
                return i3 + ((C003604n) childAt.getLayoutParams()).topMargin + baseline;
    ...
    public void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        while (i13 < childCount) {
            ...
            if (childAt == null) {
                ...
                C003604n r7 = (C003604n) childAt.getLayoutParams();
                if (!z2 || r7.height == -1) {
                    i5 = -1;
                } else {
    ...
    public void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i11 < childCount) {
            ...
            if (childAt == null) {
                ...
                int measuredWidth = childAt.getMeasuredWidth();
                int measuredHeight = childAt.getMeasuredHeight();
                C003604n r6 = (C003604n) childAt.getLayoutParams();
                int i12 = r6.A01;
                if (i12 < 0) {
                    i12 = i10;
                }
    ...
    public void setBaselineAlignedChildIndex(int i) {
        if (i < 0 || i >= getChildCount()) {
            throw new IllegalArgumentException(AnonymousClass006.A02("base aligned child index out of range (0, ", getChildCount(), ")"));
        }
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i4))) {
                C003604n r0 = (C003604n) childAt.getLayoutParams();
                if (z) {
        ...
        if (hasDividerBeforeChildAt(childCount)) {
            ...
            if (childAt2 != null) {
                C003604n r02 = (C003604n) childAt2.getLayoutParams();
                if (z) {
                    i = childAt2.getLeft();
                    i2 = r02.leftMargin;
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (!(childAt == null || childAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i))) {
                drawHorizontalDivider(canvas, (childAt.getTop() - ((C003604n) childAt.getLayoutParams()).topMargin) - this.mDividerHeight);
            }
        }
        if (hasDividerBeforeChildAt(childCount)) {
            View childAt2 = getChildAt(childCount - 1);
            if (childAt2 == null) {
                ...
                bottom = childAt2.getBottom() + ((C003604n) childAt2.getLayoutParams()).bottomMargin;
            }
    ...
    public boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return layoutParams instanceof C003604n;
    }
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int[] iArr = AnonymousClass18N.A0C;
        AnonymousClass05Y A00 = AnonymousClass05Y.A00(context, attributeSet, iArr, i, 0);
    ...
    public C003604n generateDefaultLayoutParams() {
        ...
        return new C003604n(i2);
    }

    @Override // android.view.ViewGroup
    public C003604n generateLayoutParams(AttributeSet attributeSet) {
        return new C003604n(getContext(), attributeSet);
    }

    @Override // android.view.ViewGroup
    public C003604n generateLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return new C003604n(layoutParams);
    }
}
