...
public class DialogTitle extends C04090e2 {
    @Override // X.C04090e2
    public final void onMeasure(int i, int i2) {
        ...
        if (layout != null && (lineCount = layout.getLineCount()) > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
            setSingleLine(false);
            setMaxLines(2);
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, AnonymousClass18N.A0M, 16842817, 16973892);
