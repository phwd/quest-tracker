...
public final class NotificationCompat$CarExtender implements AnonymousClass077 {
    ...
    public AnonymousClass076 mUnreadConversation;

    @RequiresApi(21)
    public static AnonymousClass076 getUnreadConversationFromBundle(@Nullable Bundle bundle) {
        String[] strArr;
        int i;
        AnonymousClass07S r7 = null;
        if (bundle != null) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ...
                    r7 = new AnonymousClass07S(resultKey, label, choices, allowFreeFormInput, i, remoteInput.getExtras());
                }
                return new AnonymousClass076(strArr, r7, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
            }
        }
        return null;
    }
    ...
    @RequiresApi(21)
    public static Bundle getBundleForUnreadConversation(@NonNull AnonymousClass076 r10) {
        String str;
    ...
    public AnonymousClass074 extend(AnonymousClass074 r4) {
        Bundle bundle = new Bundle();
    ...
    @Deprecated
    public AnonymousClass076 getUnreadConversation() {
    ...
    @Deprecated
    public NotificationCompat$CarExtender setUnreadConversation(AnonymousClass076 r1) {
