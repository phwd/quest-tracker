...
public final class NotificationCompat$WearableExtender implements AnonymousClass077 {
    ...
    public ArrayList<AnonymousClass070> mActions = new ArrayList<>();
    ...
    public static Notification.Action getActionFromActionCompat(AnonymousClass070 r5) {
        Icon A03;
        Bundle bundle;
    ...
    public NotificationCompat$WearableExtender addAction(AnonymousClass070 r2) {
        this.mActions.add(r2);
        return this;
    }

    public NotificationCompat$WearableExtender addActions(List<AnonymousClass070> list) {
    ...
    public AnonymousClass074 extend(AnonymousClass074 r6) {
        Bundle bundle = new Bundle();
        ArrayList<AnonymousClass070> arrayList = this.mActions;
        if (!arrayList.isEmpty()) {
            ArrayList<? extends Parcelable> arrayList2 = new ArrayList<>(arrayList.size());
            Iterator<AnonymousClass070> it = arrayList.iterator();
            while (it.hasNext()) {
    ...
    public List<AnonymousClass070> getActions() {
