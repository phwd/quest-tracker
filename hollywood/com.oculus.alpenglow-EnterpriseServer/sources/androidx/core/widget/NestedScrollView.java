...
public class NestedScrollView extends FrameLayout implements AnonymousClass0MR {
    public static final C03690cy A0Q = new C03690cy();
    ...
    public final C00820Aa A0M;
    public final C00830Ab A0N;
    public final int[] A0O;
    public final int[] A0P;

    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new AnonymousClass0Bj();
        public int A00;

        @NonNull
        public final String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.A00 + "}";
        }
    ...
    private final boolean A09(int i) {
        int childCount;
        boolean z = false;
        if (i == 130) {
            z = true;
        ...
        return A0B(i, rect.top, rect.bottom);
    }

    /* JADX WARNING: Removed duplicated region for block: B:11:0x0038 A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:13:0x003c  */
    /* JADX WARNING: Removed duplicated region for block: B:5:0x0020  */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0028  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final boolean A0C(int r12, int r13, int r14, int r15) {
        /*
            r11 = this;
            r7 = 0
            int r1 = r11.getOverScrollMode()
        ...
        L_0x0021:
            ...
            android.widget.OverScroller r4 = r11.A07
        ...
        L_0x0040:
            ...
            goto L_0x0033
        L_0x0042:
            if (r13 < r5) goto L_0x001d
            r5 = r13
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.A0C(int, int, int, int):boolean");
    }

    public static boolean A0F(View view, View view2) {
        if (view != view2) {
            ViewParent parent = view.getParent();
            if (!(parent instanceof ViewGroup) || !A0F((View) parent, view2)) {
                return false;
            }
        }
        return true;
    ...
    public final void A6H(@NonNull View view, int i, int i2, @NonNull int[] iArr, int i3) {
        A0D(i, i2, iArr, null, i3);
    }

    @Override // X.AbstractC03790dG
    public final void A6I(@NonNull View view, int i, int i2, int i3, int i4, int i5) {
        A05(i4, i5, null);
    }

    @Override // X.AbstractC03790dG
    public final boolean A6a(@NonNull View view, @NonNull View view2, int i, int i2) {
        return (i & 2) != 0;
    }

    public final boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2) {
        return A0D(i, i2, iArr, iArr2, 0);
    }

    public final void onNestedPreScroll(@NonNull View view, int i, int i2, @NonNull int[] iArr) {
        A6H(view, i, i2, iArr, 0);
    }
    ...
    private final void A04(int i) {
        ...
        if (viewParent != null) {
            ...
            if (viewParent instanceof AbstractC03790dG) {
                ((AbstractC03790dG) viewParent).A6d(view, i);
            } else if (i == 0) {
                try {
    ...
    public static void A07(NestedScrollView nestedScrollView, int i, int i2, boolean z) {
        if (nestedScrollView.getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - nestedScrollView.A0D > 250) {
                ...
                if (z) {
                    nestedScrollView.A0A(2, 1);
                } else {
                    nestedScrollView.A04(1);
                }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x0062 A[SYNTHETIC] */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final boolean A0A(int r8, int r9) {
        /*
        // Method dump skipped, instructions count: 140
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.widget.NestedScrollView.A0A(int, int):boolean");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean A0B(int r18, int r19, int r20) {
        /*
    ...
    private final boolean A0D(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ViewParent viewParent;
        int i4;
        int i5;
        int[] iArr3 = iArr;
        C00820Aa r1 = this.A0M;
        if (r1.A02) {
            if (i3 == 0) {
                viewParent = r1.A01;
            } else if (i3 == 1) {
            ...
            if (viewParent != null) {
                if (i != 0 || i2 != 0) {
                    if (iArr2 != null) {
                        r1.A04.getLocationInWindow(iArr2);
                        i4 = iArr2[0];
                        i5 = iArr2[1];
                    } else {
                        i4 = 0;
                    ...
                    if (iArr == null && (iArr3 = r1.A03) == null) {
                        iArr3 = new int[2];
                        r1.A03 = iArr3;
                    }
                    iArr3[0] = 0;
                    ...
                    View view = r1.A04;
                    if (viewParent instanceof AbstractC03790dG) {
                        ((AbstractC03790dG) viewParent).A6H(view, i, i2, iArr3, i3);
                    } else if (i3 == 0) {
                        try {
    ...
    private boolean A0E(View view, int i, int i2) {
        Rect rect = this.A0L;
    ...
    public final boolean A0G(@NonNull KeyEvent keyEvent) {
        Rect rect = this.A0L;
        rect.setEmpty();
        boolean z = false;
        if (getChildCount() > 0) {
    ...
    @Override // X.AbstractC03790dG
    public final void A6K(@NonNull View view, @NonNull View view2, int i, int i2) {
        C00830Ab r1 = this.A0N;
        if (i2 == 1) {
            r1.A00 = i;
        } else {
            r1.A01 = i;
    ...
    @Override // X.AbstractC03790dG
    public final void A6d(@NonNull View view, int i) {
        C00830Ab r2 = this.A0N;
        if (i == 1) {
            r2.A00 = 0;
        } else {
            r2.A01 = 0;
    ...
    public final void computeScroll() {
        ...
        if (!this.A07.isFinished()) {
            ...
            if (i2 != 0) {
                ...
                A0C(i2, getScrollX(), scrollY, scrollRange);
                int scrollY2 = getScrollY() - scrollY;
                int i3 = i2 - scrollY2;
                iArr[1] = 0;
                C00820Aa.A00(this.A0M, 0, scrollY2, 0, i3, this.A0P, 1, iArr);
                int i4 = i3 - iArr[1];
                if (i4 != 0) {
    ...
    public final boolean dispatchNestedFling(float f, float f2, boolean z) {
        ViewParent viewParent;
        C00820Aa r1 = this.A0M;
        if (!r1.A02 || (viewParent = r1.A01) == null) {
            return false;
        }
        try {
            return viewParent.onNestedFling(r1.A04, f, f2, z);
        } catch (AbstractMethodError e) {
    ...
    public final boolean dispatchNestedPreFling(float f, float f2) {
        ...
        try {
            return viewParent.onNestedPreFling(r1.A04, f, f2);
        } catch (AbstractMethodError e) {
    ...
    public final boolean dispatchNestedScroll(int i, int i2, int i3, int i4, int[] iArr) {
        return C00820Aa.A00(this.A0M, i, i2, i3, i4, iArr, 0, null);
    }

    public int getNestedScrollAxes() {
        C00830Ab r0 = this.A0N;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:86:0x01c8, code lost:
        if (getChildCount() > 0) goto L_0x01ca;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void A05(int i, int i2, @Nullable int[] iArr) {
        int scrollY = getScrollY();
        scrollBy(0, i);
        int scrollY2 = getScrollY() - scrollY;
        if (iArr != null) {
        ...
        C00820Aa.A00(this.A0M, 0, scrollY2, 0, i - scrollY2, null, i2, iArr);
    }
                ...
                if (i == 2) {
                    ...
                    if (i2 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            Log.e("NestedScrollView", AnonymousClass006.A02("Invalid pointerId=", i2, " in onInterceptTouchEvent"));
                        } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0032, code lost:
        if (A0F((android.view.View) r1, r4) != false) goto L_0x0034;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    public void setOnScrollChangeListener(@Nullable AnonymousClass0Bi r1) {
        this.A0F = r1;
    }
    ...
    public final void A6J(@NonNull View view, int i, int i2, int i3, int i4, int i5, @NonNull int[] iArr) {
        A05(i4, i5, iArr);
    }
    ...
    public NestedScrollView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.A0N = new C00830Ab();
        this.A0M = new C00820Aa(this);
        setNestedScrollingEnabled(true);
        setAccessibilityDelegate(A0Q.A00);
    }
