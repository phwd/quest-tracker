...
public abstract class AnonymousClass06C<K, V> {
    @Nullable
    public AnonymousClass06C<K, V>.EntrySet A00;
    @Nullable
    public AnonymousClass06C<K, V>.KeySet A01;
    @Nullable
    public AnonymousClass06C<K, V>.ValuesCollection A02;
