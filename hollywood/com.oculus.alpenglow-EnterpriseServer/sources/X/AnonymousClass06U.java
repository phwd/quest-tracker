...
public class AnonymousClass06U extends SharedElementCallback {
    ...
    public final void onSharedElementsArrived(List<String> list, List<View> list2, SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
        new C03940dh(this, onSharedElementsReadyListener).A6W();
    }

    public AnonymousClass06U(AnonymousClass07Z r1) {
        this.A00 = r1;
    }
