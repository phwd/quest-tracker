...
public final class C08650xb {
    ...
    @Nullable
    public static Boolean A00(JSONObject jSONObject, EnumC08710xh r2) {
    ...
    @Nullable
    public static Long A01(JSONObject jSONObject, EnumC08710xh r2) {
        if (!jSONObject.has(r2.getJsonKey())) {
            return null;
        }
    ...
    @Nullable
    public static String A02(JSONObject jSONObject, EnumC08710xh r2) {
        if (!jSONObject.has(r2.getJsonKey())) {
            return null;
        }
    ...
    public C08650xb(@Nullable Long l, @Nullable String str, @Nullable Long l2, @Nullable Long l3, @Nullable Integer num, @Nullable Integer num2, Boolean bool, @Nullable Boolean bool2, @Nullable String str2, @Nullable String str3, Boolean bool3, @Nullable Long l4, int i, @Nullable String str4, @Nullable String str5, List list, @Nullable String str6, @Nullable String str7, @Nullable Byte b, @Nullable Map map, @Nullable Long l5) {
        this.A0B = l;
        this.A0I = str;
        this.A07 = l2;
        this.A0A = l3;
