...
public class C03880dR extends AnonymousClass08Y {
    ...
    public android.graphics.Typeface A05(android.content.Context r6, android.os.CancellationSignal r7, @androidx.annotation.NonNull X.AnonymousClass09U[] r8, int r9) {
        /*
        // Method dump skipped, instructions count: 101
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C03880dR.A05(android.content.Context, android.os.CancellationSignal, X.09U[], int):android.graphics.Typeface");
    }
    ...
    @Override // X.AnonymousClass08Y
    public Typeface A06(Context context, C03900dT r12, Resources resources, int i) {
        A01();
        Object newInstance = A01.newInstance(new Object[0]);
        AnonymousClass084[] r8 = r12.A00;
        for (AnonymousClass084 r2 : r8) {
            File A002 = AnonymousClass08Z.A00(context);
            if (A002 == null) {
                return null;
            }
            try {
                if (AnonymousClass08Z.A02(A002, resources, r2.A00)) {
