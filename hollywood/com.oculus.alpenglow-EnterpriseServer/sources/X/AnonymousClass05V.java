...
public final class AnonymousClass05V {
    ...
    public static int A01(@NonNull Context context, int i) {
        int[] iArr = A06;
        iArr[0] = i;
        AnonymousClass05Y r1 = new AnonymousClass05Y(context, context.obtainStyledAttributes((AttributeSet) null, iArr));
        try {
    ...
    public static void A03(@NonNull View view, @NonNull Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(AnonymousClass18N.A09);
        try {
