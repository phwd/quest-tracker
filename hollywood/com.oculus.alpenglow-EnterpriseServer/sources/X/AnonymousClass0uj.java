...
public final class AnonymousClass0uj {
    ...
    public final C08400xB A01;
    public final C07980wL A02;
    ...
    public static final void A01(@Nonnull AnonymousClass0uj r2, String str, Map map) {
        C07840w6 r1 = new C07840w6(str, r2.A04);
        r1.A01(map);
        r2.A02.A02(r1);
    }

    public final void A02(Integer num, @Nullable String str) {
        Map<String, String> A002 = C09120yh.A00("event_type", A00(num));
    ...
    public final void A03(Integer num, @Nullable String str) {
        ...
        Map<String, String> A002 = C09120yh.A00("event_type", str2);
        if (!TextUtils.isEmpty(str)) {
            A002.put("event_extra_info", str);
        }
    ...
    public final void A04(Integer num, @Nullable String str, @Nullable String str2) {
        Map<String, String> A002 = C09120yh.A00("event_type", AnonymousClass0vJ.A00(num));
        if (!TextUtils.isEmpty(str)) {
            A002.put("event_extra_info", str);
        }
    ...
    public final void A05(@Nullable String str) {
        Map<String, String> A002 = C09120yh.A00("event_type", "verify_sender_failed");
        if (!TextUtils.isEmpty(str)) {
            A002.put("event_extra_info", str);
        }
    ...
    public AnonymousClass0uj(Context context, C08400xB r4, RealtimeSinceBootClock realtimeSinceBootClock, C07980wL r6) {
