...
public final class C01660Ko<T> {
    ...
    public final AnonymousClass0LK A08;
    public final Class<T> A09;

    public static void A00(C01660Ko r4, int i) {
    ...
    public C01660Ko(Class<T> cls, int i, int i2, int i3, long j, ObjectPool.Allocator<T> allocator, AnonymousClass0LK r10) {
        this.A09 = cls;
