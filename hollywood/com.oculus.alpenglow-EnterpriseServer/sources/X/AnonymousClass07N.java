...
public final class AnonymousClass07N {
    ...
    public static AnonymousClass07N A00(@NonNull Person person) {
        IconCompat iconCompat;
        AnonymousClass07M r1 = new AnonymousClass07M();
        r1.A01 = person.getName();
        if (person.getIcon() != null) {
            iconCompat = IconCompat.A07(person.getIcon());
        } else {
            iconCompat = null;
        }
        r1.A00 = iconCompat;
        ...
        return new AnonymousClass07N(r1);
    }

    @NonNull
    public static AnonymousClass07N A01(@NonNull Bundle bundle) {
        IconCompat iconCompat;
        Bundle bundle2 = bundle.getBundle("icon");
        AnonymousClass07M r2 = new AnonymousClass07M();
        r2.A01 = bundle.getCharSequence(FileProvider.ATTR_NAME);
        if (bundle2 != null) {
            int i = bundle2.getInt(LoggerConstants.CONFIGURATION_FETCH_TYPE);
            ...
            switch (i) {
                ...
                case 0:
                default:
                    Log.w("IconCompat", AnonymousClass006.A01("Unknown type ", i));
                    iconCompat = null;
                    break;
                case 2:
                case 4:
        ...
        return new AnonymousClass07N(r2);
    }
    ...
    public final Person A02() {
        ...
        if (iconCompat != null) {
            icon = IconCompat.A03(iconCompat, null);
        } else {
            icon = null;
        }
    ...
    public final Bundle A03() {
        ...
        bundle2.putCharSequence(FileProvider.ATTR_NAME, this.A01);
        IconCompat iconCompat = this.A00;
        if (iconCompat != null) {
            bundle = new Bundle();
            ...
            bundle.putInt(LoggerConstants.CONFIGURATION_FETCH_TYPE, iconCompat.A02);
    ...
    public AnonymousClass07N(AnonymousClass07M r2) {
        this.A01 = r2.A01;
        this.A00 = r2.A00;
        this.A03 = r2.A03;
        this.A02 = r2.A02;
