...
public final class AnonymousClass0eQ extends AnonymousClass03N implements Menu {
    public final AbstractMenuC007608p A00;
    ...
    public final void clear() {
        AnonymousClass06D<AnonymousClass08q, MenuItem> r0 = super.A00;
        if (r0 != null) {
            r0.clear();
        }
        this.A00.clear();
    ...
    public final void removeGroup(int i) {
        if (super.A00 != null) {
            int i2 = 0;
            while (true) {
                AnonymousClass06D<AnonymousClass08q, MenuItem> r1 = super.A00;
                if (i2 >= r1.size()) {
                    break;
                }
                if (((AnonymousClass08q) r1.A02[i2 << 1]).getGroupId() == i) {
                    super.A00.A06(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (super.A00 != null) {
            ...
            while (true) {
                ...
                if (i2 >= r1.size()) {
                    break;
                } else if (((AnonymousClass08q) r1.A02[i2 << 1]).getItemId() == i) {
                    super.A00.A06(i2);
                    break;
                } else {
                    i2++;
    ...
    public AnonymousClass0eQ(Context context, AbstractMenuC007608p r4) {
        super(context);
        if (r4 != null) {
            this.A00 = r4;
            return;
