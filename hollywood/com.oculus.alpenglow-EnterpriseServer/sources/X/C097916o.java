...
public final class C097916o {
    ...
    public final void A01(byte[] bArr, byte[] bArr2) throws AnonymousClass11f {
        SSLException sSLException;
        int length;
        if (bArr == null || (length = bArr.length) != 16) {
            sSLException = new SSLException(AnonymousClass006.A05("Invalid key ", AnonymousClass11e.A03(bArr)));
        } else if (bArr2 == null || bArr2.length != 12) {
            throw new AnonymousClass11f((byte) 80, new SSLException(AnonymousClass006.A05("Invalid iv ", AnonymousClass11e.A03(bArr2))));
        } else {
            try {
        ...
        throw new AnonymousClass11f((byte) 80, sSLException);
    }
}
