...
public class AnonymousClass02e {
    ...
    public final void A00(AnonymousClass02i r6) {
        int i;
        View view = this.A04;
        if (view != null) {
            r6.A0E = view;
        ...
        if (this.A05 != null) {
            ...
            if (listAdapter == null) {
                listAdapter = new AnonymousClass02g(this.A08, i);
            }
            r6.A0J = listAdapter;
            r6.A05 = this.A00;
            if (this.A01 != null) {
                alertController$RecycleListView.setOnItemClickListener(new AnonymousClass02c(this, r6));
            }
            if (this.A07) {
    ...
    public AnonymousClass02e(Context context) {
        this.A08 = context;
