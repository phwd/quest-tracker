...
public enum AnonymousClass0NF {
    ...
    public static AnonymousClass0NF decode(String str) {
        if (str.startsWith("$")) {
    ...
    public String encode() {
        return AnonymousClass006.A05("$", super.toString());
    }
    ...
    public String getBuildConstant() {
        ...
        if (str != null) {
            try {
                return (String) AnonymousClass0JB.class.getField(str).get(this);
            } catch (Exception e) {
    ...
    AnonymousClass0NF(@Nullable String str) {
