...
public abstract class AbstractC01680Ku implements AbstractC02580aL, Serializable {
    ...
    public final transient AbstractC07080oh A00;
    public final boolean _isRequired;
    public String _managedReferenceName;
    public final C06580nK _nullProvider;
    public final String _propName;
    public int _propertyIndex;
    public final AnonymousClass0aI _type;
    public JsonDeserializer<Object> _valueDeserializer;
    public final AnonymousClass0o3 _valueTypeDeserializer;
    public AbstractC07310p7 _viewMatcher;
    public final C06350mc _wrapperName;

    public int A01() {
        return -1;
    }

    public abstract AbstractC01680Ku A02(JsonDeserializer<?> jsonDeserializer);

    public abstract AbstractC01680Ku A03(String str);

    public Object A04() {
        return null;
    }

    public abstract Object A06(AnonymousClass0aT v, AbstractC02570aK v2, Object obj) throws IOException, C05910ld;

    public abstract Object A07(Object obj, Object obj2) throws IOException;

    public abstract void A08(AnonymousClass0aT v, AbstractC02570aK v2, Object obj) throws IOException, C05910ld;

    public abstract void A0A(Object obj, Object obj2) throws IOException;

    @Override // X.AbstractC02580aL
    public abstract AbstractC02450Zr A41();
    ...
    public static final void A00(Exception exc) throws IOException {
        if (!(exc instanceof IOException)) {
            ...
            if (!z) {
                ...
                throw new AnonymousClass0aG(exc2.getMessage(), null, exc2);
            }
        }
        throw exc;
    }
    ...
    public final void A09(Exception exc, Object obj) throws IOException {
        ...
        if (exc instanceof IllegalArgumentException) {
            ...
            sb.append(message);
            throw new AnonymousClass0aG(sb.toString(), null, exc);
        }
        A00(exc);
    ...
    public final boolean A0B(Class<?> cls) {
        AbstractC07310p7 r0 = this._viewMatcher;
    ...
    public final Object A05(AnonymousClass0aT r3, AbstractC02570aK r4) throws IOException, C05910ld {
    ...
    public AbstractC01680Ku(AbstractC01680Ku r2) {
    ...
    public AbstractC01680Ku(AbstractC01680Ku r4, JsonDeserializer<?> jsonDeserializer) {
        this._propertyIndex = -1;
        this._propName = r4._propName;
        AnonymousClass0aI r2 = r4._type;
        this._type = r2;
        ...
        if (jsonDeserializer == null) {
            ...
            this._nullProvider = A08 != null ? new C06580nK(r2, A08) : r1;
        }
        this._valueDeserializer = jsonDeserializer;
        this._viewMatcher = r4._viewMatcher;
    }

    public AbstractC01680Ku(AbstractC01680Ku r2, String str) {
        this._propertyIndex = -1;
        this._propName = str;
        this._type = r2._type;
        this._wrapperName = r2._wrapperName;
    ...
    public AbstractC01680Ku(AbstractC02410Zn r8, AnonymousClass0aI r9, AnonymousClass0o3 r10, AbstractC07080oh r11) {
        this(r8.A0E(), r9, r8.A07(), r10, r11, r8.A0F());
    }

    public AbstractC01680Ku(String str, AnonymousClass0aI r4, C06350mc r5, AnonymousClass0o3 r6, AbstractC07080oh r7, boolean z) {
        String str2;
        this._propertyIndex = -1;
        if (str == null || str.length() == 0) {
            str2 = "";
        } else {
            C06210mL r1 = C06210mL.A00;
            synchronized (r1) {
