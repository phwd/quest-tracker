...
public class C02030Ru extends Thread {
    ...
    public final void run() {
        /*
            r5 = this;
        L_0x0000:
            java.lang.ref.ReferenceQueue r0 = X.C02050Ry.A02     // Catch:{ InterruptedException -> 0x0000 }
            java.lang.ref.Reference r4 = r0.remove()     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r4 = (X.AnonymousClass0Rv) r4     // Catch:{ InterruptedException -> 0x0000 }
            r4.destruct()     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r0 = r4.A01     // Catch:{ InterruptedException -> 0x0000 }
            if (r0 != 0) goto L_0x0030
            X.0Rx r0 = X.C02050Ry.A01     // Catch:{ InterruptedException -> 0x0000 }
            java.util.concurrent.atomic.AtomicReference<X.0Rv> r1 = r0.A00     // Catch:{ InterruptedException -> 0x0000 }
            r0 = 0
            java.lang.Object r3 = r1.getAndSet(r0)     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r3 = (X.AnonymousClass0Rv) r3     // Catch:{ InterruptedException -> 0x0000 }
        L_0x001a:
            if (r3 == 0) goto L_0x0030
            X.0Rv r2 = r3.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rw r0 = X.C02050Ry.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r1 = r0.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r0 = r1.A00     // Catch:{ InterruptedException -> 0x0000 }
            r3.A00 = r0     // Catch:{ InterruptedException -> 0x0000 }
            r1.A00 = r3     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r0 = r3.A00     // Catch:{ InterruptedException -> 0x0000 }
            r0.A01 = r3     // Catch:{ InterruptedException -> 0x0000 }
            r3.A01 = r1     // Catch:{ InterruptedException -> 0x0000 }
            r3 = r2
            goto L_0x001a
        L_0x0030:
            X.0Rv r1 = r4.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.0Rv r0 = r4.A01     // Catch:{ InterruptedException -> 0x0000 }
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C02030Ru.run():void");
    }
}
