...
public abstract class AnonymousClass0SV {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (!str2.isEmpty()) {
                        AnonymousClass0NK.A07("MobileConfigMmapHandle", "Cannot validate \"%s\", err:%s", str, str2);
                        channel.close();
            ...
            AnonymousClass0NK.A0D("MobileConfigMmapHandle", e, "Cannot open \"%s\"", str);
            return null;
        }
    }
}
