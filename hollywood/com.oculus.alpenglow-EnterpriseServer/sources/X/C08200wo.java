...
public final class C08200wo {
    ...
    public final AbstractC04970iB A0K = new C08250wt(this);
    ...
    @GuardedBy("this")
    public static void A01(C08200wo r3, long j) {
        int i = r3.A04;
        if (i >= 23 && r3.A0J) {
    ...
    public static void A02(C08200wo r5, long j, long j2) {
        if (r5.A04 < 23 || !r5.A0J) {
    ...
    public C08200wo(Context context, C08800xq r9, String str, AtomicInteger atomicInteger, RealtimeSinceBootClock realtimeSinceBootClock, Handler handler, C08110wa r14) {
        this.A0C = context;
        this.A0L = str;
        this.A0J = AnonymousClass0vB.A00(context.getPackageName());
        this.A0M = atomicInteger;
        AbstractC09150yk A002 = r9.A00("alarm", AlarmManager.class);
        if (A002.A02()) {
