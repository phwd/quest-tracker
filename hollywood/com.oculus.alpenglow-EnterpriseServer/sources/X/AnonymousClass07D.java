...
public class AnonymousClass07D {
    public int A00;
    ...
    public final String A02(int i) {
        ...
        if (this.A01.hasArray()) {
            return new String(this.A01.array(), this.A01.arrayOffset() + i2 + 4, this.A01.getInt(i2), AnonymousClass06i.A00);
        }
        ...
        order.position(i2 + 4);
        order.get(bArr);
        return new String(bArr, 0, i3, AnonymousClass06i.A00);
    }
}
