...
public final class AnonymousClass0OU implements AbstractC04550h0 {
    public int A00;
    public boolean A01;
    ...
    public final boolean A00() throws IOException {
        ...
        if (i != 0) {
            ...
            this.A00 -= remaining;
            this.A03.A8T((long) remaining);
        }
        if (inflater.getRemaining() == 0) {
            AnonymousClass0Od r1 = this.A03;
            if (r1.A2T()) {
                return true;
            }
            C04570h3 r0 = r1.A1Z().A01;
            int i2 = r0.A01;
            int i3 = r0.A02;
            int i4 = i2 - i3;
            this.A00 = i4;
    ...
    public final long read(AnonymousClass0HR r8, long j) throws IOException {
        boolean A002;
        if (j < 0) {
    ...
    public AnonymousClass0OU(AnonymousClass0Od r1, Inflater inflater) {
        this.A03 = r1;
        this.A02 = inflater;
    }
}
