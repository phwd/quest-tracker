...
public final class AnonymousClass0Hy {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0Hy.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }

    public static <T> AnonymousClass0H2<T> A00(AnonymousClass0H2<T> r4) {
        Type type = r4.type;
        if (!A06(type)) {
            throw new RuntimeException("Key not fully specified " + r4);
        } else if (r4.rawType == AbstractC07240oz.class) {
            return new AnonymousClass0H2<>(new AnonymousClass0Vu(null, AbstractC07240oz.class, ((ParameterizedType) type).getActualTypeArguments()[0]));
        } else {
            return r4;
        }
    }
    ...
    public static Type A03(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new AnonymousClass0Vv(A03(cls.getComponentType()));
            }
            return type2;
        }
        if (!(type instanceof AnonymousClass0H3)) {
            if (type instanceof ParameterizedType) {
                ParameterizedType parameterizedType = (ParameterizedType) type;
                return new AnonymousClass0Vu(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
            } else if (type instanceof GenericArrayType) {
                return new AnonymousClass0Vv(((GenericArrayType) type).getGenericComponentType());
            } else {
                if (type instanceof WildcardType) {
                    WildcardType wildcardType = (WildcardType) type;
                    return new AnonymousClass0Vt(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
                }
            }
        }
        return type;
    ...
    public static void A05(java.lang.reflect.Type r2, java.lang.String r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0Hy.A05(java.lang.reflect.Type, java.lang.String):void");
    }
    ...
    public static boolean A06(Type type) {
        ...
        return ((AnonymousClass0H3) type).A5Q();
    }
}
