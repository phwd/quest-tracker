...
public final class AnonymousClass0tE<E> implements Iterator<E> {
    public int A00;
    public int A01;
    @MonotonicNonNullDecl
    public Multiset.Entry<E> A02;
    public boolean A03;
    public final AnonymousClass0tC<E> A04;
    ...
    public AnonymousClass0tE(AnonymousClass0tC<E> r1, Iterator<Multiset.Entry<E>> it) {
        this.A04 = r1;
        this.A05 = it;
    }
    ...
    public final E next() {
        if (hasNext()) {
            int i = this.A00;
            if (i == 0) {
                AnonymousClass0Y0 next = this.A05.next();
                this.A02 = next;
                i = next.A00();
                this.A00 = i;
                this.A01 = i;
