...
public class C04540gz {
    public static final C04540gz NONE = new AnonymousClass0OQ();
    public long deadlineNanoTime;
    public boolean hasDeadline;
    public long timeoutNanos;

    public C04540gz clearDeadline() {
        this.hasDeadline = false;
        return this;
    }

    public C04540gz clearTimeout() {
        this.timeoutNanos = 0;
        return this;
    }

    public final C04540gz deadline(long j, TimeUnit timeUnit) {
        String str;
        if (j <= 0) {
    ...
    public C04540gz timeout(long j, TimeUnit timeUnit) {
        String str;
        if (j < 0) {
    ...
    public C04540gz deadlineNanoTime(long j) {
