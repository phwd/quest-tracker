...
public final class AnonymousClass0AS {
    ...
    public static boolean A00(@NonNull AnonymousClass0AR r4, @Nullable View view, @Nullable Window.Callback callback, @NonNull KeyEvent keyEvent) {
        ...
        if (callback instanceof Activity) {
            ...
            if (AnonymousClass0Aw.A04(decorView, keyEvent)) {
                return true;
            }
            if (decorView != null) {
            ...
            return (view != null && AnonymousClass0Aw.A04(view, keyEvent)) || r4.superDispatchKeyEvent(keyEvent);
        } else {
            ...
            if (AnonymousClass0Aw.A04(decorView2, keyEvent)) {
                return true;
            }
            if (decorView2 != null) {
