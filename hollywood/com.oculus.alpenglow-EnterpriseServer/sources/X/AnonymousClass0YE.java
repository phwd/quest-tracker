...
public final class AnonymousClass0YE extends AbstractC07330qw<K, V> {
    public int A00;
    @NullableDecl
    public final K A01;
    public final /* synthetic */ CompactHashMap A02;

    public AnonymousClass0YE(CompactHashMap compactHashMap, int i) {
    ...
    @Override // java.util.Map.Entry, X.AbstractC07330qw
