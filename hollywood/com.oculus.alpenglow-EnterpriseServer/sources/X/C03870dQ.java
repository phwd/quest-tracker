...
public final class C03870dQ extends AnonymousClass08Y {
    ...
    public final Typeface A05(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull AnonymousClass09U[] r13, int i) {
        ...
        if (obj != null) {
            AnonymousClass06D r8 = new AnonymousClass06D();
            int length = r13.length;
            int i2 = 0;
            while (true) {
                if (i2 < length) {
                    AnonymousClass09U r5 = r13[i2];
                    Uri uri = r5.A03;
                    ByteBuffer byteBuffer = (ByteBuffer) r8.get(uri);
                    if (byteBuffer == null) {
                        byteBuffer = AnonymousClass08Z.A01(context, cancellationSignal, uri);
    ...
    public final android.graphics.Typeface A06(android.content.Context r16, X.C03900dT r17, android.content.res.Resources r18, int r19) {
        /*
        // Method dump skipped, instructions count: 154
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C03870dQ.A06(android.content.Context, X.0dT, android.content.res.Resources, int):android.graphics.Typeface");
    }
}
