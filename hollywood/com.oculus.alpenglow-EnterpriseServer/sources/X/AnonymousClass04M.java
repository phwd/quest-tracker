...
public class AnonymousClass04M implements ListAdapter, SpinnerAdapter {
    ...
    public AnonymousClass04M(@Nullable SpinnerAdapter spinnerAdapter, @Nullable Resources.Theme theme) {
