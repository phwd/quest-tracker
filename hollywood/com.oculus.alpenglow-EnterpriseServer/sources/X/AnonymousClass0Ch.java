...
public final class AnonymousClass0Ch {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0Ch.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }
    ...
    public static Class<?> A00(Type type) {
        ...
        if (!(type instanceof Class)) {
            if (type instanceof ParameterizedType) {
                ...
                AnonymousClass0CT.A00(type instanceof Class);
    ...
    public static Type A02(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new AnonymousClass0CV(A02(cls.getComponentType()));
            }
            return type2;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new AnonymousClass0CW(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new AnonymousClass0CV(((GenericArrayType) type).getGenericComponentType());
        } else {
            if (!(type instanceof WildcardType)) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new C00960Cc(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        }
    }
    ...
    public static Type A03(Type type, Class<?> cls, Class<?> cls2) {
        ...
        AnonymousClass0CT.A00(cls2.isAssignableFrom(cls));
    ...
    public static java.lang.reflect.Type A05(java.lang.reflect.Type r7, java.lang.Class<?> r8, java.lang.reflect.Type r9, java.util.Collection<java.lang.reflect.TypeVariable> r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0Ch.A05(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static void A06(java.lang.reflect.Type r1) {
        ...
        L_0x000e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0Ch.A06(java.lang.reflect.Type):void");
    }
}
