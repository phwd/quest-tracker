...
public /* synthetic */ class C06480mx {
    ...
    static {
        /*
            X.0lf[] r0 = X.EnumC05930lf.values()
            int r0 = r0.length
            int[] r2 = new int[r0]
            X.C06480mx.A00 = r2
            X.0lf r0 = X.EnumC05930lf.VALUE_STRING     // Catch:{ NoSuchFieldError -> 0x0012 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
            r0 = 1
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0012 }
        L_0x0012:
            X.0lf r0 = X.EnumC05930lf.VALUE_NUMBER_INT     // Catch:{ NoSuchFieldError -> 0x001b }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x001b }
            r0 = 2
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x001b }
        L_0x001b:
            X.0lf r0 = X.EnumC05930lf.VALUE_NUMBER_FLOAT     // Catch:{ NoSuchFieldError -> 0x0024 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0024 }
            r0 = 3
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0024 }
        L_0x0024:
            X.0lf r0 = X.EnumC05930lf.VALUE_EMBEDDED_OBJECT     // Catch:{ NoSuchFieldError -> 0x002d }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x002d }
            r0 = 4
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x002d }
        L_0x002d:
            X.0lf r0 = X.EnumC05930lf.VALUE_TRUE     // Catch:{ NoSuchFieldError -> 0x0036 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0036 }
            r0 = 5
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0036 }
        L_0x0036:
            X.0lf r0 = X.EnumC05930lf.VALUE_FALSE     // Catch:{ NoSuchFieldError -> 0x003f }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x003f }
            r0 = 6
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x003f }
        L_0x003f:
            X.0lf r0 = X.EnumC05930lf.START_ARRAY     // Catch:{ NoSuchFieldError -> 0x0048 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0048 }
            r0 = 7
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0048 }
        L_0x0048:
            X.0lf r0 = X.EnumC05930lf.FIELD_NAME     // Catch:{ NoSuchFieldError -> 0x0052 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0052 }
            r0 = 8
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0052 }
        L_0x0052:
            X.0lf r0 = X.EnumC05930lf.END_OBJECT     // Catch:{ NoSuchFieldError -> 0x005c }
        ...
        L_0x005c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C06480mx.<clinit>():void");
    }
}
