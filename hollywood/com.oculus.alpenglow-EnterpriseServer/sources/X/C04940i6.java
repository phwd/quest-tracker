...
public final class C04940i6 {
    @Nullable
    public static AnonymousClass0i5 A00(@Nullable Intent intent) throws JSONException {
        Object obj;
        Uri uri;
        JSONObject jSONObject = new JSONObject();
        ArrayList arrayList = new ArrayList();
        jSONObject.put("action", intent.getAction());
        jSONObject.put(LoggerConstants.PACKAGE_KEY, intent.getPackage());
        jSONObject.put(LoggerConstants.CONFIGURATION_FETCH_TYPE, intent.getType());
        Uri data = intent.getData();
        if (data != null) {
            arrayList.add(data);
            jSONObject.put("data", C05030iM.A00(data).A00());
        }
        ClipData A00 = AnonymousClass0i4.A00(intent);
        if (A00 != null) {
            ...
            for (int i = 0; i < A00.getItemCount(); i++) {
                ...
                if (!(itemAt == null || (uri = itemAt.getUri()) == null)) {
                    arrayList.add(uri);
                    jSONArray.put(C05030iM.A00(uri).A00());
                }
            }
        ...
        if (extras != null && extras.size() > 0) {
            ...
            for (String str2 : extras.keySet()) {
                ...
                jSONObject2.put(FileProvider.ATTR_NAME, str2);
        ...
        return new AnonymousClass0i5(jSONObject, arrayList);
    }
}
