...
public class AnonymousClass0Aj implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
                ...
                if (z && ((AccessibilityManager) key.getContext().getSystemService("accessibility")).isEnabled()) {
                    ...
                    if (key.getAccessibilityLiveRegion() != 0 || (z2 && key.getVisibility() == 0)) {
                        ...
                        try {
                            ...
                            Log.e("ViewCompat", AnonymousClass006.A05(key.getParent().getClass().getSimpleName(), " does not fully implement ViewParent"), e);
                        }
                    }
                }
