...
public class C04980iE {
    ...
    public static int A00(C04980iE r5, int i) {
        if ((8 & r5.A01) != 0) {
            return i & -67108865;
        }
        return i | 67108864;
    ...
    @VisibleForTesting
    public static final Intent A01(C04980iE r9, Context context) {
        String packageName;
    ...
    public C04980iE(@Nullable ComponentName componentName) {
