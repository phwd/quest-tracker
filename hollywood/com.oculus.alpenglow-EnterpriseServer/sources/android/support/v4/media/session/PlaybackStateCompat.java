...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public final String toString() {
            return "Action:mName='" + ((Object) this.A02) + ", mIcon=" + this.A00 + ", mExtras=" + this.A01;
        }
    ...
    public final String toString() {
        return "PlaybackState {" + "state=" + this.A03 + ", position=" + this.A07 + ", buffered position=" + this.A06 + ", speed=" + this.A01 + ", updated=" + this.A08 + ", actions=" + this.A04 + ", error code=" + this.A02 + ", error message=" + this.A0A + ", custom actions=" + this.A00 + ", active item id=" + this.A05 + "}";
    }
