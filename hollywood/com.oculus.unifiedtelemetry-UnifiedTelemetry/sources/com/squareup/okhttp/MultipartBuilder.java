...
public final class MultipartBuilder {
    ...
    public static final class MultipartRequestBody extends RequestBody {
        ...
        public void writeTo(KJ kj) throws IOException {
            writeOrCountBytes(kj, false);
        }

        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: X.98 */
        /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: X.98 */
        /* JADX DEBUG: Multi-variable search result rejected for r4v2, resolved type: X.98 */
        /* JADX WARN: Multi-variable type inference failed */
        private long writeOrCountBytes(KJ kj, boolean z) throws IOException {
            AnonymousClass98 r4;
            if (z) {
                kj = new AnonymousClass98();
                r4 = kj;
            } else {
                r4 = 0;
            }
            ...
            for (int i = 0; i < size; i++) {
                ...
                kj.A5n(MultipartBuilder.DASHDASH);
                kj.A5m(this.boundary);
                byte[] bArr = MultipartBuilder.CRLF;
                kj.A5n(bArr);
                if (headers != null) {
                    int length = headers.namesAndValues.length >> 1;
                    for (int i2 = 0; i2 < length; i2++) {
                        kj.A5y(headers.name(i2));
                        kj.A5n(MultipartBuilder.COLONSPACE);
                        kj.A5y(headers.value(i2));
                        kj.A5n(bArr);
                    }
                }
                ...
                if (contentType2 != null) {
                    kj.A5y("Content-Type: ");
                    kj.A5y(contentType2.toString());
                    kj.A5n(bArr);
                }
                long contentLength2 = requestBody.contentLength();
                if (contentLength2 != -1) {
                    kj.A5y("Content-Length: ");
                    kj.A5r(contentLength2);
                    kj.A5n(MultipartBuilder.CRLF);
                } else if (z) {
                    r4.A08();
                    return -1;
                }
                ...
                if (z) {
                    ...
                    this.partBodies.get(i).writeTo(kj);
                }
                kj.A5n(bArr2);
            }
            kj.A5n(MultipartBuilder.DASHDASH);
        ...
        public MultipartRequestBody(MediaType mediaType, ci ciVar, List<Headers> list, List<RequestBody> list2) {
            if (mediaType != null) {
                this.boundary = ciVar;
