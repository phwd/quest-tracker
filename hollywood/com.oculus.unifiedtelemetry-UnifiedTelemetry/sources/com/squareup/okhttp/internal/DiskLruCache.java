...
public final class DiskLruCache implements Closeable {
    ...
    public static final AbstractC0313cc NULL_SINK = new AbstractC0313cc() {
        ...
        @Override // X.AbstractC0313cc
        public void write(AnonymousClass98 r1, long j) throws IOException {
            r1.A5F(j);
        }
    };
    ...
    public final class Editor {
        ...
        public AbstractC0313cc newSink(int i) throws IOException {
            AnonymousClass1 r0;
            synchronized (DiskLruCache.this) {
        ...
        public AbstractC0312cb newSource(int i) throws IOException {
            synchronized (DiskLruCache.this) {
                Entry entry2 = this.entry;
                if (entry2.currentEditor != this) {
                    throw new IllegalStateException();
    ...
    public final class Entry {
        ...
        private IOException invalidLengths(String[] strArr) throws IOException {
            throw new IOException(AnonymousClass06.A04("unexpected journal line: ", Arrays.toString(strArr)));
        }

        public Snapshot snapshot() {
            if (Thread.holdsLock(DiskLruCache.this)) {
                AbstractC0312cb[] cbVarArr = new AbstractC0312cb[DiskLruCache.this.valueCount];
                ...
                while (true) {
                    try {
                        ...
                        if (i2 >= diskLruCache.valueCount) {
                            return new Snapshot(this.key, this.sequenceNumber, cbVarArr, jArr);
                        }
                        cbVarArr[i2] = diskLruCache.fileSystem.source(this.cleanFiles[i2]);
                        i2++;
                    } catch (FileNotFoundException unused) {
                        while (i < DiskLruCache.this.valueCount && cbVarArr[i] != null) {
                            Util.closeQuietly(cbVarArr[i]);
                            i++;
                        }
                        return null;
                    }
        ...
        public void writeLengths(KJ kj) throws IOException {
    ...
    public final class Snapshot implements Closeable {
        ...
        public final AbstractC0312cb[] sources;

        @Override // java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            for (AbstractC0312cb cbVar : this.sources) {
                Util.closeQuietly(cbVar);
            }
        }
        ...
        public AbstractC0312cb getSource(int i) {
        ...
        public Snapshot(String str, long j, AbstractC0312cb[] cbVarArr, long[] jArr) {
            this.key = str;
            this.sequenceNumber = j;
            this.sources = cbVarArr;
            this.lengths = jArr;
        }
    }
    ...
    private synchronized void completeEdit(Editor editor, boolean z) throws IOException {
        ...
        if (entry.currentEditor == editor) {
            if (z && !entry.readable) {
                ...
                while (true) {
                    if (i >= this.valueCount) {
                        ...
                        editor.abort();
                        throw new IllegalStateException(AnonymousClass06.A01("Newly created entry didn't create value for index ", i));
            ...
            if (entry.readable || z) {
                entry.readable = true;
                KJ kj = this.journalWriter;
                kj.A5y(CLEAN);
                kj.A5q(32);
                this.journalWriter.A5y(entry.key);
                entry.writeLengths(this.journalWriter);
                this.journalWriter.A5q(10);
                if (z) {
    ...
    private synchronized void rebuildJournal() throws IOException {
        ...
        AnonymousClass94 r4 = new AnonymousClass94(this.fileSystem.sink(this.journalFileTmp));
        try {
            r4.A5y(MAGIC);
            r4.A5q(10);
            r4.A5y(VERSION_1);
            r4.A5q(10);
            r4.A5r((long) this.appVersion);
            r4.A5q(10);
            r4.A5r((long) this.valueCount);
            r4.A5q(10);
            r4.A5q(10);
    ...
    private KJ newJournalWriter() throws FileNotFoundException {
        return new AnonymousClass94(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
    ...
    private void readJournal() throws IOException {
        AnonymousClass93 r2 = new AnonymousClass93(this.fileSystem.source(this.journalFile));
        try {
            String A4c = r2.A4c();
            String A4c2 = r2.A4c();
            String A4c3 = r2.A4c();
            String A4c4 = r2.A4c();
            String A4c5 = r2.A4c();
            if (!MAGIC.equals(A4c) || !VERSION_1.equals(A4c2) || !Integer.toString(this.appVersion).equals(A4c3) || !Integer.toString(this.valueCount).equals(A4c4) || !"".equals(A4c5)) {
                StringBuilder sb = new StringBuilder();
    ...
    private void validateKey(String str) {
        if (!LEGAL_KEY_PATTERN.matcher(str).matches()) {
            throw new IllegalArgumentException(AnonymousClass06.A05("keys must match regex [a-z0-9_-]{1,120}: \"", str, "\""));
        }
    }
    ...
    private synchronized com.squareup.okhttp.internal.DiskLruCache.Editor edit(java.lang.String r7, long r8) throws java.io.IOException {
        ...
        L_0x0024:
            ...
            goto L_0x005b
        L_0x0029:
            X.KJ r1 = r6.journalWriter     // Catch:{ all -> 0x005d }
            java.lang.String r0 = "DIRTY"
            r1.A5y(r0)     // Catch:{ all -> 0x005d }
            r0 = 32
            r1.A5q(r0)     // Catch:{ all -> 0x005d }
            r1.A5y(r7)     // Catch:{ all -> 0x005d }
            r0 = 10
            r1.A5q(r0)     // Catch:{ all -> 0x005d }
            X.KJ r0 = r6.journalWriter     // Catch:{ all -> 0x005d }
