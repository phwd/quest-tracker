...
public final class RealConnection implements Connection {
    ...
    private void connectSocket(int i, int i2, int i3, ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            this.source = new AnonymousClass93(C0318ch.A01(this.rawSocket));
            this.sink = new AnonymousClass94(C0318ch.A00(this.rawSocket));
    ...
    private void createTunnel(int i, int i2) throws IOException {
        ...
        while (true) {
            KC kc = this.source;
            Http1xStream http1xStream = new Http1xStream(null, kc, this.sink);
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            kc.timeout().timeout((long) i, timeUnit);
            ...
            AbstractC0312cb newFixedLengthSource = http1xStream.newFixedLengthSource(contentLength);
            ...
            } else if (!this.source.A1V().A1z() || !this.sink.A1V().A1z()) {
