...
public final class FramedStream {
    ...
    public final class FramedDataSink implements AbstractC0313cc {
        public static final /* synthetic */ boolean $assertionsDisabled = false;
        public static final long EMIT_BUFFER_SIZE = 16384;
        public boolean closed;
        public boolean finished;
        public final AnonymousClass98 sendBuffer = new AnonymousClass98();
        ...
        @Override // X.AbstractC0313cc
        public void write(AnonymousClass98 r6, long j) throws IOException {
    ...
    public final class FramedDataSource implements AbstractC0312cb {
        public static final /* synthetic */ boolean $assertionsDisabled = false;
        public boolean closed;
        public boolean finished;
        public final long maxByteCount;
        public final AnonymousClass98 readBuffer;
        public final AnonymousClass98 receiveBuffer;
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public long read(X.AnonymousClass98 r14, long r15) throws java.io.IOException {
            /*
            // Method dump skipped, instructions count: 127
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.internal.framed.FramedStream.FramedDataSource.read(X.98, long):long");
        }

        public void receive(KC kc, long j) throws IOException {
            boolean z;
            boolean z2;
            boolean z3;
            while (j > 0) {
                ...
                if (z3) {
                    ...
                    long read = kc.read(this.receiveBuffer, j);
                    if (read != -1) {
                        j -= read;
                        synchronized (FramedStream.this) {
                            AnonymousClass98 r3 = this.readBuffer;
                            if (r3.A00 != 0) {
                                z2 = false;
                            }
                            r3.A5p(this.receiveBuffer);
                            if (z2) {
                                FramedStream.this.notifyAll();
                            }
                        }
        ...
        public FramedDataSource(long j) {
            this.receiveBuffer = new AnonymousClass98();
            this.readBuffer = new AnonymousClass98();
            this.maxByteCount = j;
        }
    }

    public class StreamTimeout extends KK {
    ...
    public AbstractC0313cc getSink() {
        synchronized (this) {
    ...
    public void receiveData(KC kc, int i) throws IOException {
        this.source.receive(kc, (long) i);
    }
    ...
    public AbstractC0312cb getSource() {
        return this.source;
    }

    public ca readTimeout() {
        return this.readTimeout;
    }

    public ca writeTimeout() {
