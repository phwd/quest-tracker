...
public final class Spdy3 implements Variant {
    ...
    public static final class Reader implements FrameReader {
            ...
            try {
                ...
                if (z2) {
                    ...
                    if (i3 == 3) {
                        ...
                        throw new ProtocolException(AnonymousClass06.A01("version != 3: ", i3));
                    }
                } else {
        ...
        private void readGoAway(FrameReader.Handler handler, int i, int i2) throws IOException {
            ...
            if (i2 == 8) {
                ...
                if (fromSpdyGoAway != null) {
                    handler.goAway(readInt, fromSpdyGoAway, ci.A03);
                    return;
                } else {
        ...
        public Reader(KC kc, boolean z) {
            this.source = kc;
            this.headerBlockReader = new NameValueBlockReader(kc);
            this.client = z;
        }
    ...
    public static final class Writer implements FrameWriter {
        ...
        public final AnonymousClass98 headerBlockBuffer;
        public final KJ headerBlockOut;
        ...
        @Override // com.squareup.okhttp.internal.framed.FrameWriter
        public synchronized void data(boolean z, int i, AnonymousClass98 r4, int i2) throws IOException {
            int i3 = 0;
            if (z) {
                i3 = 1;
            }
        ...
        public synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
            if (this.closed) {
                ...
                this.sink.A5t(-2147287033);
                this.sink.A5t(8);
                this.sink.A5t(i);
                this.sink.A5t(errorCode.spdyGoAwayCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A5t(-2147287032);
                this.sink.A5t((((int) (this.headerBlockBuffer.A00 + 4)) & 16777215) | 0);
                this.sink.A5t(i & Integer.MAX_VALUE);
                this.sink.A5p(this.headerBlockBuffer);
            } else {
                throw new IOException("closed");
            }
        }
        ...
        public synchronized void rstStream(int i, ErrorCode errorCode) throws IOException {
            if (this.closed) {
                ...
                this.sink.A5t(-2147287037);
                this.sink.A5t(8);
                this.sink.A5t(i & Integer.MAX_VALUE);
                this.sink.A5t(errorCode.spdyRstCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void settings(Settings settings) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A5t(-2147287036);
                int i = 0;
                this.sink.A5t((((bitCount << 3) + 4) & 16777215) | 0);
                this.sink.A5t(bitCount);
                do {
                    if (settings.isSet(i)) {
                        this.sink.A5t(((settings.flags(i) & 255) << 24) | (i & 16777215));
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A5t(-2147287038);
                this.sink.A5t(((i2 & 255) << 24) | (((int) (this.headerBlockBuffer.A00 + 4)) & 16777215));
                this.sink.A5t(i & Integer.MAX_VALUE);
                this.sink.A5p(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A5t(-2147287039);
                this.sink.A5t(((((z ? 1 : 0) | i4) & 255) << 24) | (i3 & 16777215));
                this.sink.A5t(i & Integer.MAX_VALUE);
                this.sink.A5t(Integer.MAX_VALUE & i2);
                this.sink.A5x(0);
                this.sink.A5p(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void windowUpdate(int i, long j) throws IOException {
            if (this.closed) {
                ...
                throw new IllegalArgumentException(AnonymousClass06.A03("windowSizeIncrement must be between 1 and 0x7fffffff: ", j));
            } else {
                this.sink.A5t(-2147287031);
                this.sink.A5t(8);
                this.sink.A5t(i);
                this.sink.A5t((int) j);
                this.sink.flush();
        ...
        private void writeNameValueBlockToBuffer(List<Header> list) throws IOException {
            this.headerBlockOut.A5t(list.size());
            int size = list.size();
            for (int i = 0; i < size; i++) {
                ci ciVar = list.get(i).name;
                this.headerBlockOut.A5t(ciVar.A07());
                this.headerBlockOut.A5m(ciVar);
                ci ciVar2 = list.get(i).value;
                this.headerBlockOut.A5t(ciVar2.A07());
                this.headerBlockOut.A5m(ciVar2);
            }
            this.headerBlockOut.flush();
        }

        public void sendDataFrame(int i, int i2, AnonymousClass98 r8, int i3) throws IOException {
            if (!this.closed) {
                long j = (long) i3;
                if (j <= 16777215) {
                    this.sink.A5t(i & Integer.MAX_VALUE);
                    this.sink.A5t(((i2 & 255) << 24) | (16777215 & i3));
                    if (i3 > 0) {
                ...
                throw new IllegalArgumentException(AnonymousClass06.A01("FRAME_TOO_LARGE max size is 16Mib: ", i3));
            }
            throw new IOException("closed");
        }
        ...
        public Writer(KJ kj, boolean z) {
            ...
            this.headerBlockBuffer = r1;
            this.headerBlockOut = new AnonymousClass94(new KB(new AnonymousClass94(r1), deflater));
        }
    }
