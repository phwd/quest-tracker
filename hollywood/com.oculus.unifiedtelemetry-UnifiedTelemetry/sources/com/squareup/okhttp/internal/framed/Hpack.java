...
public final class Hpack {
    public static final Map<ci, Integer> NAME_TO_FIRST_INDEX = nameToFirstIndex();
    ...
    public static final class Reader {
        ...
        public Reader(int i, AbstractC0312cb cbVar) {
            this.headerTableSizeSetting = i;
            this.maxDynamicTableByteCount = i;
            this.source = new AnonymousClass93(cbVar);
        }

        private ci getName(int i) {
            Header header;
            if (isStaticHeader(i)) {
        ...
        public ci readByteString() throws IOException {
            int readByte = readByte();
            boolean z = false;
            if ((readByte & 128) == 128) {
                z = true;
            ...
            if (z) {
                return ci.A05(Huffman.INSTANCE.decode(this.source.A4T((long) readInt)));
            }
            return this.source.A4U((long) readInt);
        }
    ...
    public static final class Writer {
        public final AnonymousClass98 out;
        ...
        public Writer(AnonymousClass98 r1) {
            this.out = r1;
        }

        public void writeByteString(ci ciVar) throws IOException {
            writeInt(ciVar.A07(), Hpack.PREFIX_7_BITS, 0);
            ciVar.A0F(this.out);
        }
    ...
    static {
        ...
        ci ciVar = Header.TARGET_METHOD;
        Header header2 = new Header(ciVar, TigonRequest.GET);
        Header header3 = new Header(ciVar, TigonRequest.POST);
        ci ciVar2 = Header.TARGET_PATH;
        Header header4 = new Header(ciVar2, "/");
        Header header5 = new Header(ciVar2, "/index.html");
        ci ciVar3 = Header.TARGET_SCHEME;
        Header header6 = new Header(ciVar3, "http");
        Header header7 = new Header(ciVar3, "https");
        ci ciVar4 = Header.RESPONSE_STATUS;
        System.arraycopy(new Header[]{header, header2, header3, header4, header5, header6, header7, new Header(ciVar4, "200"), new Header(ciVar4, "204"), new Header(ciVar4, "206"), new Header(ciVar4, "304"), new Header(ciVar4, "400"), new Header(ciVar4, "404"), new Header(ciVar4, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", "")}, 0, headerArr, 0, 27);
    ...
    public static Map<ci, Integer> nameToFirstIndex() {
    ...
    public static ci checkLowercase(ci ciVar) throws IOException {
        int A07 = ciVar.A07();
        for (int i = 0; i < A07; i++) {
