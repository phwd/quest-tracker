...
public final class Http1xStream implements HttpStream {
    ...
    public abstract class AbstractSource implements AbstractC0312cb {
        public boolean closed;
        public final K4 timeout;
        ...
        public AbstractSource() {
            this.timeout = new K4(Http1xStream.this.source.timeout());
        }
    }

    public final class ChunkedSink implements AbstractC0313cc {
        public boolean closed;
        public final K4 timeout;
        ...
        public void write(AnonymousClass98 r4, long j) throws IOException {
            if (this.closed) {
                throw new IllegalStateException("closed");
            } else if (j != 0) {
                Http1xStream.this.sink.A5s(j);
                Http1xStream.this.sink.A5y(HttpRequestMultipart.LINE_FEED);
        ...
        public ChunkedSink() {
            this.timeout = new K4(Http1xStream.this.sink.timeout());
        }
    }
    ...
    public class ChunkedSource extends AbstractSource {
        ...
        private void readChunkSize() throws IOException {
            if (this.bytesRemainingInChunk != -1) {
                Http1xStream.this.source.A4c();
            }
            try {
                this.bytesRemainingInChunk = Http1xStream.this.source.A4W();
                String trim = Http1xStream.this.source.A4c().trim();
        ...
        @Override // X.AbstractC0312cb
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public long read(X.AnonymousClass98 r9, long r10) throws java.io.IOException {
            /*
                r8 = this;
                r6 = 0
            ...
            L_0x004d:
                ...
                java.lang.String r1 = X.AnonymousClass06.A03(r0, r10)
                java.lang.IllegalArgumentException r0 = new java.lang.IllegalArgumentException
                r0.<init>(r1)
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.internal.http.Http1xStream.ChunkedSource.read(X.98, long):long");
        }
    }

    public final class FixedLengthSink implements AbstractC0313cc {
        ...
        @Override // X.AbstractC0313cc
        public void write(AnonymousClass98 r7, long j) throws IOException {
            if (!this.closed) {
    ...
    public class FixedLengthSource extends AbstractSource {
        ...
        @Override // X.AbstractC0312cb
        public long read(AnonymousClass98 r10, long j) throws IOException {
            if (j < 0) {
    ...
    public class UnknownLengthSource extends AbstractSource {
        ...
        @Override // X.AbstractC0312cb
        public long read(AnonymousClass98 r6, long j) throws IOException {
            if (j < 0) {
                throw new IllegalArgumentException(AnonymousClass06.A03("byteCount < 0: ", j));
            } else if (!this.closed) {
                if (!this.inputExhausted) {
    ...
    private void detachTimeout(K4 k4) {
        ca caVar = k4.A00;
        ca caVar2 = ca.NONE;
        if (caVar2 != null) {
            k4.A00 = caVar2;
    ...
    public AbstractC0313cc newChunkedSink() {
        int i = this.state;
        if (i == 1) {
            this.state = 2;
    ...
    public AbstractC0312cb newChunkedSource(HttpEngine httpEngine2) throws IOException {
        int i = this.state;
        if (i == 4) {
            this.state = 5;
    ...
    public AbstractC0313cc newFixedLengthSink(long j) {
        int i = this.state;
        if (i == 1) {
            this.state = 2;
    ...
    public AbstractC0312cb newFixedLengthSource(long j) throws IOException {
        int i = this.state;
        if (i == 4) {
            this.state = 5;
    ...
    public AbstractC0312cb newUnknownLengthSource() throws IOException {
        String str;
        int i = this.state;
        if (i == 4) {
    ...
    public Headers readHeaders() throws IOException {
        ...
        while (true) {
            String A4c = this.source.A4c();
            if (A4c.length() == 0) {
                return new Headers(builder);
            }
            Internal.instance.addLenient(builder, A4c);
        }
    }
    ...
    public Response.Builder readResponse() throws IOException {
        ...
        if (i == 1 || i == 3) {
            do {
                try {
                    parse = StatusLine.parse(this.source.A4c());
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        ...
        if (i == 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                KJ kj2 = this.sink;
                kj2.A5y(headers.name(i2));
                kj2.A5y(": ");
                kj2.A5y(headers.value(i2));
                kj2.A5y(HttpRequestMultipart.LINE_FEED);
            }
            this.sink.A5y(HttpRequestMultipart.LINE_FEED);
            this.state = 1;
            return;
        }
        throw new IllegalStateException(AnonymousClass06.A01("state: ", i));
    ...
    public Http1xStream(StreamAllocation streamAllocation2, KC kc, KJ kj) {
        this.streamAllocation = streamAllocation2;
        this.source = kc;
        this.sink = kj;
    }

    private AbstractC0312cb getTransferStream(Response response) throws IOException {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        return new RealResponseBody(response.headers, new AnonymousClass93(getTransferStream(response)));
    }
