...
public final class HttpEngine {
    public static final ResponseBody EMPTY_BODY = new ResponseBody() {
        ...
        @Override // com.squareup.okhttp.ResponseBody
        public KC source() {
            return new AnonymousClass98();
        }
    };
    public static final int MAX_FOLLOW_UPS = 20;
    public final boolean bufferRequestBody;
    public KJ bufferedRequestBody;
    ...
    public AbstractC0313cc requestBodyOut;
        ...
        public Response proceed(Request request2) throws IOException {
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors.size()) {
                ...
                if (HttpMethod.permitsRequestBody(request2.method) && (requestBody = request2.body) != null) {
                    AnonymousClass94 r1 = new AnonymousClass94(httpEngine.httpStream.createRequestBody(request2, requestBody.contentLength()));
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        AbstractC0313cc body;
        if (cacheRequest == null || (body = cacheRequest.body()) == null) {
            return response;
        }
        final KC source = response.body.source();
        final AnonymousClass94 r1 = new AnonymousClass94(body);
        AnonymousClass2 r0 = new AbstractC0312cb() {
            /* class com.squareup.okhttp.internal.http.HttpEngine.AnonymousClass2 */
            public boolean cacheRequestClosed;

            @Override // X.AbstractC0312cb
            public long read(AnonymousClass98 r11, long j) throws IOException {
                try {
                    ...
                    r11.A0I(r1.A1V(), r11.A00 - read, read);
                    r1.A1v();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
        ...
        builder.body = new RealResponseBody(response.headers, new AnonymousClass93(r0));
    ...
    private Response unzip(Response response) throws IOException {
        ...
        if (!this.transparentGzip || !"gzip".equalsIgnoreCase(this.userResponse.header(GzipInterceptor.HEADER_CONTENT_ENCODING, null)) || (responseBody = response.body) == null) {
            return response;
        }
        K1 k1 = new K1(responseBody.source());
        Headers.Builder newBuilder = response.headers.newBuilder();
        newBuilder.removeAll(GzipInterceptor.HEADER_CONTENT_ENCODING);
        newBuilder.removeAll("Content-Length");
        Headers headers = new Headers(newBuilder);
        Response.Builder builder = new Response.Builder(response);
        builder.headers = headers.newBuilder();
        builder.body = new RealResponseBody(headers, new AnonymousClass93(k1));
        return builder.build();
    }
    ...
    public StreamAllocation close() {
        KJ kj = this.bufferedRequestBody;
        if (kj != null) {
            Util.closeQuietly(kj);
        } else {
            AbstractC0313cc ccVar = this.requestBodyOut;
            if (ccVar != null) {
                Util.closeQuietly(ccVar);
            }
        }
    ...
    public KJ getBufferedRequestBody() {
        KJ kj = this.bufferedRequestBody;
        if (kj != null) {
            return kj;
        }
        AbstractC0313cc requestBody = getRequestBody();
        if (requestBody == null) {
            return null;
        }
        AnonymousClass94 r0 = new AnonymousClass94(requestBody);
        this.bufferedRequestBody = r0;
        return r0;
    }
    ...
    public AbstractC0313cc getRequestBody() {
    ...
    public void sendRequest() throws RequestException, RouteException, IOException {
        ...
        AbstractC0313cc createRequestBody;
        int i;
        if (this.cacheStrategy != null) {
            return;
        }
    ...
    public HttpEngine recover(IOException iOException, AbstractC0313cc ccVar) {
        if (!this.streamAllocation.recover(iOException, ccVar) || !this.client.retryOnConnectionFailure) {
            return null;
        }
        return new HttpEngine(this.client, this.userRequest, this.bufferRequestBody, this.callerWritesRequestBody, this.forWebSocket, close(), (RetryableSink) ccVar, this.priorResponse);
    }
}
