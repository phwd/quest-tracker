...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i < length) {
                if (i == i3) {
                    ...
                    r2.A0F((long) (((bArr[i] & 255) << 8) | (bArr[i + 1] & 255)));
                    i += 2;
                }
            }
            return r2.A04();
        ...
        public Builder setEncodedPathSegment(int i, String str) {
            ...
            if (str != null) {
                ...
                str2 = AnonymousClass06.A04("unexpected path segment: ", str);
            } else {
        ...
        public Builder encodedPath(String str) {
            ...
            if (str == null) {
                ...
                str2 = AnonymousClass06.A04("unexpected encodedPath: ", str);
            }
            throw new IllegalArgumentException(str2);
        }
        ...
        public Builder host(String str) {
            ...
            if (str != null) {
                ...
                str2 = AnonymousClass06.A04("unexpected host: ", str);
            } else {
                str2 = "host == null";
            }
            throw new IllegalArgumentException(str2);
                ...
                while (true) {
                    ...
                    if (delimiterOffset == skipTrailingAsciiWhitespace || (charAt = str.charAt(delimiterOffset)) == 65535 || charAt == '#' || charAt == '/' || charAt == '\\' || charAt == '?') {
                        ...
                        if (!z) {
                            ...
                            if (z2) {
                                canonicalize = AnonymousClass06.A05(this.encodedUsername, "%40", canonicalize);
                            }
                            ...
                            this.encodedPassword = AnonymousClass06.A05(this.encodedPassword, "%40", HttpUrl.canonicalize(str, i, delimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, true));
                        }
                        i = delimiterOffset + 1;
                    }
                }
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(AnonymousClass06.A01("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
        ...
        public Builder scheme(String str) {
            ...
            if (str != null) {
                ...
                if (!str.equalsIgnoreCase(str3)) {
                    str3 = "https";
                    if (!str.equalsIgnoreCase(str3)) {
                        str2 = AnonymousClass06.A04("unexpected scheme: ", str);
                    }
                }
                this.scheme = str3;
                return this;
    ...
    public static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        switch (parse.ordinal()) {
            ...
            case 4:
                throw new UnknownHostException(AnonymousClass06.A04("Invalid host: ", str));
        }
    }
    ...
    public URI uri() {
        try {
            ...
            throw new IllegalStateException(AnonymousClass06.A04("not valid as a java.net.URI: ", this.url));
        }
    }
    ...
    public static void canonicalize(AnonymousClass98 r6, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3) {
        String str3;
        AnonymousClass98 r4 = null;
        while (i < i2) {
    ...
    public static String percentDecode(String str, int i, int i2, boolean z) {
        for (int i3 = i; i3 < i2; i3++) {
            ...
            if (charAt == '%' || (charAt == '+' && z)) {
                AnonymousClass98 r0 = new AnonymousClass98();
                r0.A0H(str, i, i3);
    ...
    public static void percentDecode(AnonymousClass98 r5, String str, int i, int i2, boolean z) {
        while (i < i2) {
            int codePointAt = str.codePointAt(i);
            if (codePointAt == 37) {
                int i3 = i + 2;
