...
public class CustomApiEndpointValidator {
    ...
    public static void A00(C0365dm dmVar) {
        dmVar.A0I = new HostnameVerifier() {
        ...
        try {
            ...
            if (socketFactory != null) {
                ...
                dmVar.A0L = C0324cr.A00.A03(r4);
                return;
            }
            throw new NullPointerException("sslSocketFactory == null");
        } catch (NoSuchAlgorithmException e) {
            Mu.A08(TAG, e, "NoSuchAlgorithmException when trying to initialize SSL Context.");
            throw new RuntimeException(e);
        } catch (KeyManagementException e2) {
            Mu.A08(TAG, e2, "KeyManagementException when trying to initialize SSL Context.");
