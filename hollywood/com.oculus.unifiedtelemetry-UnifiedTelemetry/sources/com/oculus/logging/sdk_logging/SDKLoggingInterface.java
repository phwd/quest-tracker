...
public interface SDKLoggingInterface extends IInterface {
    ...
    public static class Default implements SDKLoggingInterface {
        ...
        public final void A4j(String str, String str2) throws RemoteException {
        }

        @Override // com.oculus.logging.sdk_logging.SDKLoggingInterface
        public final void A4k(String str, String str2) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements SDKLoggingInterface {
        ...
        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                parcel.enforceInterface(DESCRIPTOR);
                A4j(parcel.readString(), parcel.readString());
            } else if (i == 3) {
                parcel.enforceInterface(DESCRIPTOR);
                A4k(parcel.readString(), parcel.readString());
            ...
            public final void A4j(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(2, obtain, obtain2, 0) || (sDKLoggingInterface = sDefaultImpl) == null) {
                        ...
                        sDKLoggingInterface.A4j(str, str2);
                    }
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public final void A4k(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(3, obtain, obtain2, 0) || (sDKLoggingInterface = sDefaultImpl) == null) {
                        ...
                        sDKLoggingInterface.A4k(str, str2);
                    }
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
    ...
    void A4j(String str, String str2) throws RemoteException;

    void A4k(String str, String str2) throws RemoteException;
