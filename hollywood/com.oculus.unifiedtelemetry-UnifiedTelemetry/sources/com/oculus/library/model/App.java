...
public class App {
    ...
    public static class Editor {
        public Optional<String> appScopedUserId;
        public Optional<CloudStorageStatus> cloudStorageStatus;
        public Optional<Long> downloadSizeBytes;
        public Optional<Long> downloadedSizeBytes;
        public Optional<Boolean> isUnseen;
        public Optional<String> languagePack;
        public String packageName;
        public Optional<Long> recentActivityMs;
        public Optional<AppStatus> status;
        public Optional<Long> totalActivityMs;
        public Optional<String> trustedBinaryStatus;
    }

    public final String toString() {
        return AnonymousClass06.A07("App[id=", this.id, ", packageName=", this.packageName, "]");
    }
