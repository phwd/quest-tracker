...
public final class BeanAsArrayBuilderDeserializer extends BeanDeserializerBase {
    ...
    public BeanAsArrayBuilderDeserializer(BeanDeserializerBase beanDeserializerBase, AbstractC0073Cr[] crArr, AnonymousClass7P r4) {
    ...
    private final Object A00(AbstractC0226Wn wn, Object obj) throws IOException {
        try {
    ...
    private final void A01(AbstractC0232Ww ww, AbstractC0226Wn wn) throws IOException, q0 {
    ...
    public final BeanDeserializerBase A0Q(C0204Vm vm) {
        return new BeanAsArrayBuilderDeserializer(this._delegate.A0Q(vm), this._orderedProperties, this._buildMethod);
    }
            ...
            if (!this._vanillaProcessing) {
                if (this._nonStandardCreation) {
                    ...
                    if (jsonDeserializer != null) {
                        A05 = this._valueInstantiator.A09(wn, jsonDeserializer.A09(ww, wn));
                    ...
                    A05 = this._valueInstantiator.A05(wn);
                    if (this._injectables != null) {
                        A0d(wn);
                    }
                    ...
                    while (true) {
                        ...
                        if (A0a == q2Var) {
                            ...
                            AbstractC0073Cr cr = crArr[i];
                            i++;
                            if (cr == null || (cls != null && !cr.A0B(cls))) {
                                ww.A0Y();
                            } else {
                                try {
                                    cr.A06(ww, wn, A05);
