...
public class ACRA {
        ...
        if (context != null) {
            ...
            if (file.exists()) {
                try {
                    ...
                    Mu.A03("ACRA", "Failed to read fury traces file", e);
                    return null;
                }
            }
        }
    ...
    public static void writeSenderHost(String str) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Mu.A08("ACRA", e, "could not write to host file: ");
    ...
    public static void addFuryTracesToReportSourceRef(JSONObject jSONObject, String str) {
        ...
        if (furyTraces != null && !furyTraces.equals("")) {
            try {
                ...
                Mu.A06("ACRA", "Invalid fury file contents: %s", furyTraces, e);
            }
        }
    }
    ...
    public static void closeStreamNoException(@Nullable Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                Mu.A08("ACRA", e, "Error while closing stream: ");
            }
        }
    }
    ...
    public static void deleteHostsFileIfEmpty(Context context) {
        try {
            ...
            if (!fileStreamPath.canRead() || !fileStreamPath.canWrite()) {
                Mu.A00("ACRA", "cannot read or write host file");
            } else if (fileStreamPath.length() == 0 && !context.deleteFile(REPORT_HOST_FILE_NAME)) {
                Mu.A00("ACRA", "could not delete empty host file");
            }
        } catch (SecurityException e) {
            Mu.A08("ACRA", e, "could not delete empty host file: ");
        }
    }
            ...
            if (file.exists()) {
                ...
                if (file2.exists()) {
                    try {
                        ...
                        Mu.A03("ACRA", "Failed to read report source ref override file", e);
                        return null;
                    }
                }
            }
    ...
    public static void installPeriodicReporter(Context context, final ErrorReporter errorReporter) {
        int A00 = O9.A00(context, "acraconfig_logcat_native_crash_periodic_interval_mins", 0);
        if (A00 > 0) {
            long j = (long) A00;
    ...
    public static JSONObject jsonifyReportSourceRef(String str) {
        ...
        try {
            ...
            Mu.A06("ACRA", "Invalid report source ref override file contents: %s", str, e);
            return null;
        }
    }
    ...
    public static void nativeLibrarySuccessfullyLoaded(Context context) {
        ...
        String A06;
        File dir;
        boolean A01 = O9.A01(context, "acraconfig_enable_nightwatch");
        boolean A012 = O9.A01(context, "nightwatch_monitor_resources");
        int A00 = O9.A00(context, "nightwatch_tick_info_count", 0);
        if (A01 || A012 || A00 > 0) {
            String processName = getProcessName();
            if (!processName.contains(":")) {
                boolean A013 = O9.A01(context, "acraconfig_nightwatch_use_setsid");
                boolean A014 = O9.A01(context, "acraconfig_nightwatch_use_lss_on_exec");
                boolean A015 = O9.A01(context, "nightwatch_use_mmap");
                int A002 = O9.A00(context, "nightwatch_monitor_resources_interval_ms", ProcessAnrErrorMonitor.DEFAULT_POLLING_TIME_MS);
                boolean z = true;
                if (O9.A00(context, "nightwatch_split_mmap", 0) != 1) {
                    z = false;
                }
                int A003 = O9.A00(context, "nightwatch_mmap_update_min_interval_ms", 0);
                boolean z2 = true;
                if (O9.A00(context, "acra_nightwatch_turn_off_fast_jni_methods", 0) != 1) {
                    z2 = false;
                }
                NX nx = new NX(A01, A013, A014, A015, A012, A002, A00, z, A003, !z2);
                if (O9.A01(context, "acraconfig_nightwatch_use_asl_session_id")) {
                    A06 = AnonymousClass06.A06(processName.replace(':', '_'), "_", mConfig.getSessionId(), ".txt");
                    dir = context.getDir("watcher", 0);
                } else {
                    Random random = new Random();
                    A06 = AnonymousClass06.A06(processName.replace(':', '_'), "_", new UUID(random.nextLong(), random.nextLong()).toString(), ".txt");
                    dir = context.getDir("watcher", 0);
                }
                C0130Na.A00(new File(dir, A06), nx);
            }
        }
        synchronized (sANRDetectorLock) {
            IANRDetector iANRDetector = mANRDetector;
        ...
        if (O9.A01(context, "acraconfig_disable_fs_sync_syscalls")) {
            NoSync.disableFSSync(O9.A01(context, "acraconfig_use_fast_fs_sync_hooks"));
        }
        KN kn = KO.A00().A00;
        if (kn != null) {
            str = kn.A00;
        ...
        if ("videoplayer".equalsIgnoreCase(str) && O9.A01(context, "acraconfig_disable_fs_sync_syscalls_vps")) {
            NoSync.disableFSSync(O9.A01(context, "acraconfig_use_fast_fs_sync_hooks"));
        }
    ...
    public static boolean shouldRunNightwatch(Context context) {
        return O9.A01(context, "acraconfig_enable_nightwatch");
    }
    ...
    public static void writeSkipCertChecksFile(boolean z) {
        ...
        try {
            ...
            Mu.A05(str, str2, objArr);
        } catch (IOException e) {
            Mu.A08("ACRA", e, "could not create ssl cert checks file.");
        }
    }

    public static String getProcessName() {
        String str = KO.A00().A01;
        if (str == null) {
            return "unknown";
        }
        return str;
