...
public class JavaProcFileReader extends ProcFileReader {
    ...
    public ProcFileReader.OpenFDLimits getOpenFDLimits() {
        ...
        try {
            ...
            try {
                ...
                while ((read - 1) - i > bytes.length) {
                    ...
                    if (startsWithOffset(bArr, i, bytes)) {
                        if (KS.A00.A49(bArr, i, findNewLineOrEnd, PROC_OPEN_FD_LIMITS_FORMAT, strArr, null, null)) {
            ...
            Mu.A09(TAG, e, "Failed to read /proc/self/limits");
            return null;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00ad, code lost:
        X.Mu.A08(com.facebook.acra.util.JavaProcFileReader.TAG, r2, "Exception caught while reading open file descriptors");
     */
