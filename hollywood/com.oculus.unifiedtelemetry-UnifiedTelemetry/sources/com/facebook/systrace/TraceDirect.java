...
public class TraceDirect {
    public static final boolean sForceJavaImpl = "true".equals(C0092Hd.A02("debug.fbsystrace.force_java"));
    public static volatile TriState sNativeAvailable = TriState.UNSET;
    public static volatile int sPrevSoLoaderSourcesVersion = -1;
    public static final boolean sTraceLoad = "true".equals(C0092Hd.A02("debug.fbsystrace.trace_load"));
        ...
        if (sNativeAvailable == TriState.UNSET) {
            if (sForceJavaImpl) {
                ...
                if (i != sPrevSoLoaderSourcesVersion) {
                    ...
                    try {
                        C0431hn.A00("fbsystrace");
                        nativeSetEnabledTags(C0092Hd.A00("debug.fbsystrace.tags"));
