    ...
    public static String lenientFormat(@NullableDecl String str, @NullableDecl Object... objArr) {
        ...
        while (true) {
            ...
            try {
                ...
                Logger.getLogger("com.google.common.base.Strings").log(Level.WARNING, AnonymousClass06.A04("Exception during lenientFormat for ", A00), (Throwable) e);
                str2 = AnonymousClass06.A07("<", A00, " threw ", e.getClass().getName(), ">");
            }
            objArr[i2] = str2;
            i2++;
        }
