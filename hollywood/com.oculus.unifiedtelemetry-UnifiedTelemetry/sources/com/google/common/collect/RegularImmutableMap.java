...
public final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    public static class EntrySet<K, V> extends ImmutableSet<Map.Entry<K, V>> {
        ...
        public final ImmutableList<Map.Entry<K, V>> A0E() {
        ...
        /* renamed from: A0D */
        public final AnonymousClass8f<Map.Entry<K, V>> iterator() {
            return A0F().iterator();
        }
    ...
    public static final class KeySet<K> extends ImmutableSet<K> {
        ...
        @Override // com.google.common.collect.ImmutableSet, com.google.common.collect.ImmutableCollection
        /* renamed from: A0D */
        public final AnonymousClass8f<K> iterator() {
            return A0F().iterator();
        }

        @Override // com.google.common.collect.ImmutableSet
        public final ImmutableList<K> A0F() {
            return this.A00;
        }
    }
    ...
    public final ImmutableCollection<V> A02() {
        return new KeysOrValuesAsList(this.A00, 1, this.A01);
    }

    @Override // com.google.common.collect.ImmutableMap
    public final ImmutableSet<Map.Entry<K, V>> A03() {
        return new EntrySet(this, this.A00, this.A01);
    }

    @Override // com.google.common.collect.ImmutableMap
    public final ImmutableSet<K> A04() {
