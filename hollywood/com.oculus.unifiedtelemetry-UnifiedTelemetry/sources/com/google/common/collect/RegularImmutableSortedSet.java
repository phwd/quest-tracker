...
public final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public final boolean equals(@org.checkerframework.checker.nullness.compatqual.NullableDecl java.lang.Object r8) {
        /*
            ...
            X.8f r2 = r7.iterator()     // Catch:{ ClassCastException | NoSuchElementException -> 0x0041 }
        L_0x002a:
    ...
    public static boolean A03(Comparator<?> comparator, Iterable<?> iterable) {
        ...
        if (comparator == null) {
            ...
            } else if (!(iterable instanceof AnonymousClass6z)) {
                return false;
            } else {
                comparator2 = ((AnonymousClass6z) iterable).comparator();
            }
    ...
    public final ImmutableSortedSet<E> A0H() {
        Comparator reverseOrder = Collections.reverseOrder(this.A01);
        if (isEmpty()) {
            return ImmutableSortedSet.A04(reverseOrder);
        }
        return new RegularImmutableSortedSet(this.A00.A0E(), reverseOrder);
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    @GwtIncompatible
    public final AnonymousClass8f<E> A0L() {
        return this.A00.A0E().iterator();
    }
    ...
    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0I(E e, boolean z) {
        return A02(0, A00(e, z));
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0J(E e, boolean z) {
        return A02(A01(e, z), size());
    }

    @Override // com.google.common.collect.ImmutableSortedSet
    public final ImmutableSortedSet<E> A0K(E e, boolean z, E e2, boolean z2) {
        return A0J(e, z).A0I(e2, z2);
    }
    ...
    @Override // com.google.common.collect.ImmutableSet
    public final ImmutableList<E> A0F() {
        return this.A00;
    }
}
