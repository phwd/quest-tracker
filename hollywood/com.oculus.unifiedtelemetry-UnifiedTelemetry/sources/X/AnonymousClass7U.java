...
/* renamed from: X.7U  reason: invalid class name */
public class AnonymousClass7U implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
                ...
                if (z && ((AccessibilityManager) key.getContext().getSystemService("accessibility")).isEnabled()) {
                    ...
                    if (key.getAccessibilityLiveRegion() != 0 || (z2 && key.getVisibility() == 0)) {
                        ...
                        try {
                            ...
                            Log.e("ViewCompat", AnonymousClass06.A04(key.getParent().getClass().getSimpleName(), " does not fully implement ViewParent"), e);
                        }
                    }
                }
