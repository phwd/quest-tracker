...
public final class YL implements KR {
    @Nullable
        ...
        if (method != null) {
            try {
                ...
                if (Log.isLoggable("OldProcReader", 6)) {
                    Log.e("OldProcReader", AnonymousClass06.A05("Error (IllegalAccessException - ", e.getLocalizedMessage(), ")"), e);
                }
            } catch (InvocationTargetException e2) {
                if (Log.isLoggable("OldProcReader", 6)) {
                    Log.e("OldProcReader", AnonymousClass06.A05("Error (InvocationTargetException - ", e2.getLocalizedMessage(), ")"), e2);
                }
            }
        }
    ...
    public static Method A04(String str, Class<?>... clsArr) {
        try {
            ...
            Log.w("OldProcReader", AnonymousClass06.A04("Warning! Could not get access to JNI method - ", str), e);
            return null;
        }
    }

    @Override // X.KR
    public final boolean A49(byte[] bArr, int i, int i2, int[] iArr, @Nullable String[] strArr, @Nullable long[] jArr, @Nullable float[] fArr) {
    ...
    @Override // X.KR
    public final boolean A4Y(String str, int[] iArr, @Nullable String[] strArr, @Nullable long[] jArr, @Nullable float[] fArr) {
