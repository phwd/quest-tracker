...
public final class JB implements Thread.UncaughtExceptionHandler {
    @Nullable
    public static JB A04;
    public final boolean A00 = true;
    public final Object A01 = new Object();
    public final Thread.UncaughtExceptionHandler A02;
    public volatile List<JA> A03 = Collections.unmodifiableList(new ArrayList());
    @DoNotStrip
    @Nullable
    public byte[] mOomReservation = null;

    public JB(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
        this.A02 = uncaughtExceptionHandler;
        this.mOomReservation = new byte[4096];
    }

    public static synchronized JB A00() {
        JB jb;
        synchronized (JB.class) {
            jb = A04;
            if (jb == null) {
                JB jb2 = new JB(Thread.getDefaultUncaughtExceptionHandler());
                A04 = jb2;
                Thread.setDefaultUncaughtExceptionHandler(jb2);
                jb = A04;
            }
        }
        return jb;
    ...
    public static synchronized void A02(JC jc, int i) {
        synchronized (JB.class) {
            JB A002 = A00();
            synchronized (A002) {
    ...
    public static void A01() {
        ...
        L_0x001e:
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: X.JB.A01():void");
    }
