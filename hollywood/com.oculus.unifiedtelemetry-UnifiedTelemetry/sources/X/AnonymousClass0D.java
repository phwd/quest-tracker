...
public abstract class AnonymousClass0D<I, O, F, T> extends AbstractC00030p<O> implements Runnable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: X.0D<I, O, F, T> */
    ...
    public final void run() {
        ...
        if (!z3 && !z) {
            ...
            try {
                ...
                try {
                    Object A002 = A00(f, DE.A00(listenableFuture));
                    this.A01 = null;
                    A01(A002);
                } catch (Throwable th) {
                    this.A01 = null;
    ...
    public AnonymousClass0D(ListenableFuture<? extends I> listenableFuture, F f) {
