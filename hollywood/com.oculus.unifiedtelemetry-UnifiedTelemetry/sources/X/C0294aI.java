...
public class C0294aI implements AnonymousClass4K {
    public final HashMap<String, File> A00 = new HashMap<>();
    public final String A01;

    public C0294aI(String str) {
        this.A01 = str;
    }

    @Override // X.AnonymousClass4K
    public final File A2S(Uri uri) {
    ...
    @Override // X.AnonymousClass4K
    public final Uri A2x(File file) {
        try {
            ...
            throw new IllegalArgumentException(AnonymousClass06.A04("Failed to find configured root that contains ", canonicalPath));
        } catch (IOException unused) {
            StringBuilder sb = new StringBuilder("Failed to resolve canonical path for ");
            sb.append(file);
            throw new IllegalArgumentException(sb.toString());
