...
public final class C0375dy {
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C0375dy)) {
            return false;
        }
        C0375dy dyVar = (C0375dy) obj;
        if (dyVar.A02.equals(this.A02) && dyVar.A04.equals(this.A04) && dyVar.A01.equals(this.A01) && dyVar.A03.equals(this.A03) && dyVar.A00 == this.A00 && dyVar.A08 == this.A08 && dyVar.A06 == this.A06 && dyVar.A07 == this.A07 && dyVar.A05 == this.A05) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        ...
        if (this.A07) {
            ...
            if (j == Long.MIN_VALUE) {
                ...
                sb.append("; expires=");
                format = C0348dJ.A00.get().format(new Date(j));
            }
            sb.append(format);
        }
        if (!this.A05) {
    ...
    public C0375dy(String str, String str2, long j, String str3, String str4, boolean z, boolean z2, boolean z3, boolean z4) {
        this.A02 = str;
        this.A04 = str2;
        this.A00 = j;
        this.A01 = str3;
