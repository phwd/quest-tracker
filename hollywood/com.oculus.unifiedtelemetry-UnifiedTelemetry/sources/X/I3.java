...
public class I3<T> implements AbstractC0247Xu, AssistedProviderWithInjector<T> {
    ...
    public I3(AbstractC0247Xu xu) {
        this.mInjector = (AbstractC0247Xu) xu.getScopeAwareInjector();
    }
