...
public /* synthetic */ class C0307ah {
    ...
    static {
        /*
            X.q2[] r0 = X.EnumC0470q2.values()
            int r0 = r0.length
            int[] r2 = new int[r0]
            X.C0307ah.A00 = r2
            X.q2 r0 = X.EnumC0470q2.VALUE_STRING     // Catch:{ NoSuchFieldError -> 0x0012 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
            r0 = 1
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0012 }
        L_0x0012:
            X.q2 r0 = X.EnumC0470q2.VALUE_NUMBER_INT     // Catch:{ NoSuchFieldError -> 0x001b }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x001b }
            r0 = 2
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x001b }
        L_0x001b:
            X.q2 r0 = X.EnumC0470q2.VALUE_NUMBER_FLOAT     // Catch:{ NoSuchFieldError -> 0x0024 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0024 }
            r0 = 3
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0024 }
        L_0x0024:
            X.q2 r0 = X.EnumC0470q2.VALUE_EMBEDDED_OBJECT     // Catch:{ NoSuchFieldError -> 0x002d }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x002d }
            r0 = 4
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x002d }
        L_0x002d:
            X.q2 r0 = X.EnumC0470q2.VALUE_TRUE     // Catch:{ NoSuchFieldError -> 0x0036 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0036 }
            r0 = 5
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0036 }
        L_0x0036:
            X.q2 r0 = X.EnumC0470q2.VALUE_FALSE     // Catch:{ NoSuchFieldError -> 0x003f }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x003f }
            r0 = 6
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x003f }
        L_0x003f:
            X.q2 r0 = X.EnumC0470q2.START_ARRAY     // Catch:{ NoSuchFieldError -> 0x0048 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0048 }
            r0 = 7
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0048 }
        L_0x0048:
            X.q2 r0 = X.EnumC0470q2.FIELD_NAME     // Catch:{ NoSuchFieldError -> 0x0052 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0052 }
            r0 = 8
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0052 }
        L_0x0052:
            X.q2 r0 = X.EnumC0470q2.END_OBJECT     // Catch:{ NoSuchFieldError -> 0x005c }
        ...
        L_0x005c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C0307ah.<clinit>():void");
    }
}
