...
public class RZ implements WildcardType, px, Serializable {
    ...
    public final boolean A3C() {
        if (!pt.A06(this.upperBound)) {
            return false;
        }
        Type type = this.lowerBound;
        if (type == null || pt.A06(type)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof WildcardType) || !pt.A07(this, (Type) obj)) {
            return false;
        }
        return true;
    }
    ...
    public final String toString() {
        ...
        sb.append(pt.A02(type));
        return sb.toString();
    }

    public RZ(Type[] typeArr, Type[] typeArr2) {
