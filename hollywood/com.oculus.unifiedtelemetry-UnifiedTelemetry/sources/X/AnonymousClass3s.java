...
/* renamed from: X.3s  reason: invalid class name */
public class AnonymousClass3s<K> {
    ...
    public void A0A(int i, float f) {
        ...
        if (max > ((int) (((double) f) * ((double) highestOneBit))) && (highestOneBit = highestOneBit << 1) <= 0) {
        ...
        Arrays.fill(jArr, -1L);
        this.A06 = jArr;
        this.A03 = Math.max(1, (int) (((float) highestOneBit) * f));
    }

    public static int A00(@NullableDecl AnonymousClass3s r10, Object obj, int i) {
        int[] iArr = r10.A04;
    ...
    public final int A02(@NullableDecl Object obj) {
        int hashCode;
        if (obj == null) {
            hashCode = 0;
        } else {
        ...
        int[] iArr = this.A04;
        int i = iArr[(iArr.length - 1) & A002];
        while (i != -1) {
            long j = this.A06[i];
            if (((int) (j >>> 32)) == A002 && Objects.equal(obj, this.A07[i])) {
                return i;
            }
            i = (int) j;
        }
    ...
    public final int A03(@NullableDecl K k, int i) {
        int hashCode;
        if (i > 0) {
            long[] jArr = this.A06;
            ...
            int A002 = AnonymousClass3q.A00(hashCode);
            int[] iArr2 = this.A04;
            int length = (iArr2.length - 1) & A002;
            int i2 = this.A02;
            int i3 = iArr2[length];
            if (i3 == -1) {
                iArr2[length] = i2;
                ...
                while (true) {
                    long j = jArr[i3];
                    if (((int) (j >>> 32)) != A002 || !Objects.equal(k, objArr[i3])) {
                        int i4 = (int) j;
                        if (i4 == -1) {
    ...
    public AnonymousClass3s() {
        A0A(3, 1.0f);
    }

    public AnonymousClass3s(int i) {
        A0A(i, 1.0f);
    }

    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: X.3s<K> */
    /* JADX WARN: Multi-variable type inference failed */
    public AnonymousClass3s(AnonymousClass3s<? extends K> r4) {
        A0A(r4.A02, 1.0f);
        int A042 = r4.A04();
        while (A042 != -1) {
            Preconditions.checkElementIndex(A042, r4.A02);
            Object obj = r4.A07[A042];
            Preconditions.checkElementIndex(A042, r4.A02);
            A03(obj, r4.A05[A042]);
            A042 = r4.A05(A042);
        }
