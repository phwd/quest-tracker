...
public final class SV {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SV.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }
    ...
    public static Type A02(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new Rq(A02(cls.getComponentType()));
            }
            return type2;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new S4(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new Rq(((GenericArrayType) type).getGenericComponentType());
        } else {
            if (!(type instanceof WildcardType)) {
                return type;
            }
            WildcardType wildcardType = (WildcardType) type;
            return new SQ(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
        }
    }
    ...
    public static Type A03(Type type, Class<?> cls, Class<?> cls2) {
        ...
        Rn.A00(cls2.isAssignableFrom(cls));
    ...
    public static java.lang.reflect.Type A05(java.lang.reflect.Type r7, java.lang.Class<?> r8, java.lang.reflect.Type r9, java.util.Collection<java.lang.reflect.TypeVariable> r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SV.A05(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static void A06(java.lang.reflect.Type r1) {
        ...
        L_0x000e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SV.A06(java.lang.reflect.Type):void");
    }
}
