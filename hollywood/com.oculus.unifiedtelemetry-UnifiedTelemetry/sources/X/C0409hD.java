...
public final class C0409hD implements Serializable {
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C0409hD)) {
            return false;
        }
        C0409hD hDVar = (C0409hD) obj;
        String str = this.sha256Hash;
        String str2 = hDVar.sha256Hash;
        if (str != null && str2 != null) {
            return str.equals(str2);
        }
        String str3 = this.sha1Hash;
        String str4 = hDVar.sha1Hash;
    ...
    public C0409hD(String str, @Nullable String str2, @Nullable String str3) {
        String str4;
        this.name = str;
        if (str2 == null) {
