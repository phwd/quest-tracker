...
public final class C0430hk {
    public static Uri A00(String str) {
        ...
        String str2 = "";
        if (!equals) {
            str2 = AnonymousClass06.A04(str2, String.format(Locale.US, "javaUri scheme: \"%s\". androidUri scheme: \"%s\".", create.getScheme(), build.getScheme()));
        }
        if (!equals2) {
            str2 = AnonymousClass06.A04(str2, String.format(Locale.US, "javaUri authority: \"%s\". androidUri authority: \"%s\".", create.getAuthority(), build.getAuthority()));
        }
        if (!equals3) {
            str2 = AnonymousClass06.A04(str2, String.format(Locale.US, "javaUri path: \"%s\". androidUri path: \"%s\".", create.getPath(), build.getPath()));
        }
        if (!equals4) {
            str2 = AnonymousClass06.A04(str2, String.format(Locale.US, "javaUri query: \"%s\". androidUri query: \"%s\".", create.getQuery(), build.getQuery()));
        }
        if (!equals5) {
            str2 = AnonymousClass06.A04(str2, String.format(Locale.US, "javaUri fragment: \"%s\". androidUri fragment: \"%s\".", create.getFragment(), build.getFragment()));
        }
