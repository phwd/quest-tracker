...
public final class AnonymousClass7M implements View.OnAttachStateChangeListener, ViewTreeObserver.OnPreDrawListener {
    ...
    public static void A00(@NonNull View view, @NonNull Runnable runnable) {
        if (view != null) {
            AnonymousClass7M r1 = new AnonymousClass7M(view, runnable);
    ...
    public AnonymousClass7M(View view, Runnable runnable) {
        this.A01 = view;
