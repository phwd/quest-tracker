...
@OkToExtend
public class SP implements X509TrustManager {
    @Nullable
    public C0308cL A00;
    ...
    public final void A00(java.security.cert.X509Certificate[] r10) throws java.security.cert.CertificateException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SP.A00(java.security.cert.X509Certificate[]):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public SP(long r7, @javax.annotation.Nullable X.C0308cL r9) {
        /*
            r6 = this;
            r6.<init>()
        ...
        L_0x0058:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SP.<init>(long, X.cL):void");
    }
}
