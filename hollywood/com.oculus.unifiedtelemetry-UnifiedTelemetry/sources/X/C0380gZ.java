...
public final class C0380gZ {
    @Nullable
    public static C0379gY A00(@Nullable Intent intent) throws JSONException {
        Object obj;
        Uri uri;
        ...
        if (data != null) {
            arrayList.add(data);
            jSONObject.put("data", gp.A00(data).A00());
        }
        ClipData A00 = C0378gX.A00(intent);
        if (A00 != null) {
        ...
        return new C0379gY(jSONObject, arrayList);
    }
}
