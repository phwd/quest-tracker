...
public abstract class AnonymousClass2n<K, V> {
    @Nullable
    public AnonymousClass2n<K, V>.EntrySet A00;
    @Nullable
    public AnonymousClass2n<K, V>.KeySet A01;
    @Nullable
    public AnonymousClass2n<K, V>.ValuesCollection A02;
