...
public final class pt {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.pt.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }

    public static <T> C0474qC<T> A00(C0474qC<T> qCVar) {
        Type type = qCVar.type;
        if (!A06(type)) {
            StringBuilder sb = new StringBuilder("Key not fully specified ");
            sb.append(qCVar);
            throw new RuntimeException(sb.toString());
        } else if (qCVar.rawType == eJ.class) {
            return new C0474qC<>(new Rb(null, eJ.class, ((ParameterizedType) type).getActualTypeArguments()[0]));
        } else {
            return qCVar;
        }
    }
    ...
    public static Type A03(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new Rg(A03(cls.getComponentType()));
            }
            return type2;
        }
        if (!(type instanceof px)) {
            if (type instanceof ParameterizedType) {
                ParameterizedType parameterizedType = (ParameterizedType) type;
                return new Rb(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
            } else if (type instanceof GenericArrayType) {
                return new Rg(((GenericArrayType) type).getGenericComponentType());
            } else {
                if (type instanceof WildcardType) {
                    WildcardType wildcardType = (WildcardType) type;
                    return new RZ(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
                }
            }
        }
        return type;
    ...
    public static void A05(java.lang.reflect.Type r2, java.lang.String r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.pt.A05(java.lang.reflect.Type, java.lang.String):void");
    }
