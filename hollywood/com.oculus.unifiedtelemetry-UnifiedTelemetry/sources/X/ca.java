...
public class ca {
    public static final ca NONE = new Jw();
    ...
    public final ca deadline(long j, TimeUnit timeUnit) {
        String str;
        if (j <= 0) {
            str = AnonymousClass06.A03("duration <= 0: ", j);
    ...
    public ca timeout(long j, TimeUnit timeUnit) {
        String str;
        if (j < 0) {
            str = AnonymousClass06.A03("timeout < 0: ", j);
        } else if (timeUnit != null) {
