...
/* renamed from: X.45  reason: invalid class name */
public final class AnonymousClass45 {
    ...
    @RequiresApi(20)
    public static RemoteInput[] A00(AnonymousClass45[] r7) {
        int length = r7.length;
        RemoteInput[] remoteInputArr = new RemoteInput[length];
        for (int i = 0; i < length; i++) {
            AnonymousClass45 r6 = r7[i];
    ...
    public AnonymousClass45(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z, int i, Bundle bundle) {
        this.A03 = str;
