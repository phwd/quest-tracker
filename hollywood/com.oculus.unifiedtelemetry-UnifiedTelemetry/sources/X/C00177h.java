...
/* renamed from: X.7h  reason: invalid class name and case insensitive filesystem */
public final class C00177h {
    public static AnonymousClass7U A00 = new AnonymousClass7U();
    ...
    public static boolean A00(View view, KeyEvent keyEvent) {
        ...
        AnonymousClass7g r6 = (AnonymousClass7g) view.getTag(R.id.tag_unhandled_key_event_manager);
        if (r6 == null) {
            r6 = new AnonymousClass7g();
        ...
        if (keyEvent.getAction() == 0) {
            ...
            ArrayList<WeakReference<View>> arrayList = AnonymousClass7g.A03;
        ...
        View A002 = AnonymousClass7g.A00(r6, view, keyEvent);
        if (keyEvent.getAction() == 0) {
    ...
    public static boolean A01(android.view.View r3, android.view.KeyEvent r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C00177h.A01(android.view.View, android.view.KeyEvent):boolean");
    }
}
