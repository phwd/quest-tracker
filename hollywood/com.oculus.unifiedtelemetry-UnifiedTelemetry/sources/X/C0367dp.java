...
public final class C0367dp {
    ...
    public final String A0A() {
        ...
        String str = this.A04;
        return str.substring(length, dZ.A02(str, length, str.length(), ":@"));
    }

    public final List<String> A0C() {
        String str = this.A04;
        int indexOf = str.indexOf(47, this.A03.length() + 3);
        int A022 = dZ.A02(str, indexOf, str.length(), "?#");
        ArrayList arrayList = new ArrayList();
        while (indexOf < A022) {
            int i = indexOf + 1;
            indexOf = i;
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C0367dp) || !((C0367dp) obj).A04.equals(this.A04)) {
            return false;
        }
        return true;
    }
    ...
    public C0367dp(C0368dq dqVar) {
        List<String> list;
        this.A03 = dqVar.A05;
        String str = dqVar.A03;
        this.A07 = A03(str, 0, str.length(), false);
        String str2 = dqVar.A02;
        this.A06 = A03(str2, 0, str2.length(), false);
        this.A02 = dqVar.A04;
        int i = dqVar.A00;
        this.A00 = i == -1 ? A01(dqVar.A05) : i;
        this.A08 = A06(dqVar.A07, false);
        List<String> list2 = dqVar.A06;
        String str3 = null;
        if (list2 != null) {
            list = A06(list2, true);
        } else {
    ...
    public static String A02(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            ...
            AnonymousClass98 r3 = new AnonymousClass98();
            r3.A0H(str, i, i3);
            AnonymousClass98 r5 = null;
            while (i3 < i2) {
