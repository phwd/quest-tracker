...
public final class NotificationCompat$CarExtender implements AbstractC00093k {
    ...
    public C00083j mUnreadConversation;

    @RequiresApi(21)
    public static C00083j getUnreadConversationFromBundle(@Nullable Bundle bundle) {
        String[] strArr;
        int i;
        AnonymousClass45 r7 = null;
        if (bundle != null) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ...
                    r7 = new AnonymousClass45(resultKey, label, choices, allowFreeFormInput, i, remoteInput.getExtras());
                }
                return new C00083j(strArr, r7, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
            }
        }
        return null;
    }
    ...
    @RequiresApi(21)
    public static Bundle getBundleForUnreadConversation(@NonNull C00083j r10) {
        String str;
    ...
    public AnonymousClass3h extend(AnonymousClass3h r4) {
        Bundle bundle = new Bundle();
        ...
        C00083j r0 = this.mUnreadConversation;
        if (r0 != null) {
    ...
    @Deprecated
    public C00083j getUnreadConversation() {
    ...
    @Deprecated
    public NotificationCompat$CarExtender setUnreadConversation(C00083j r1) {
