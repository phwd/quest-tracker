...
public class FileProvider extends ContentProvider {
    ...
    @GuardedBy("sCache")
    public static HashMap<String, AnonymousClass4K> sCache = new HashMap<>();
    public AnonymousClass4K mStrategy;
    ...
    public static AnonymousClass4K getPathStrategy(Context context, String str) {
        AnonymousClass4K r1;
        synchronized (sCache) {
            r1 = sCache.get(str);
            if (r1 == null) {
    ...
    public static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(AnonymousClass06.A04("Invalid mode: ", str));
    }

    public static AnonymousClass4K parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        String A04;
        File[] externalMediaDirs;
        File file;
        C0294aI aIVar = new C0294aI(str);
        ...
        if (resolveContentProvider != null) {
            ...
            if (loadXmlMetaData == null) {
                A04 = "Missing android.support.FILE_PROVIDER_PATHS meta-data";
            } else {
                while (true) {
                    ...
                    if (next == 2) {
                        ...
                        if (file != null) {
                            ...
                            if (TextUtils.isEmpty(attributeValue)) {
                                A04 = "Name must not be empty";
                                break;
                            }
                            try {
                                aIVar.A00.put(attributeValue, buildPath.getCanonicalFile());
                            } catch (IOException e) {
            ...
            A04 = AnonymousClass06.A04("Couldn't find meta-data for provider with authority ", str);
        }
        throw new IllegalArgumentException(A04);
    }

    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        return this.mStrategy.A2S(uri).delete() ? 1 : 0;
    }

    public String getType(@NonNull Uri uri) {
        String mimeTypeFromExtension;
        File A2S = this.mStrategy.A2S(uri);
        int lastIndexOf = A2S.getName().lastIndexOf(46);
        if (lastIndexOf < 0 || (mimeTypeFromExtension = MimeTypeMap.getSingleton().getMimeTypeFromExtension(A2S.getName().substring(lastIndexOf + 1))) == null) {
    ...
    public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.mStrategy.A2S(uri), modeToMode(str));
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        for (String str3 : strArr) {
            if ("_display_name".equals(str3)) {
                ...
                i = i2 + 1;
                objArr[i2] = A2S.getName();
            } else if ("_size".equals(str3)) {
                strArr3[i2] = "_size";
                i = i2 + 1;
                objArr[i2] = Long.valueOf(A2S.length());
            }
            i2 = i;
        }
    ...
    public static Uri getUriForFile(@NonNull Context context, @NonNull String str, @NonNull File file) {
        return getPathStrategy(context, str).A2x(file);
    }
