...
public final class RequestBuilder implements RequestInterceptor.RequestFacade {
    ...
    private void addQueryParamMap(int i, Map<?, ?> map, boolean z, boolean z2) {
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            if (key != null) {
                ...
                throw new IllegalArgumentException(AnonymousClass06.A02("Parameter #", i + 1, " query map contained null key."));
            }
        }
    }
    ...
    private void addPathParam(String str, String str2, boolean z) {
        ...
        if (str == null) {
            ...
            str3 = AnonymousClass06.A05("Path replacement \"", str, "\" value must not be null.");
        } else if (z) {
            try {
                this.relativeUrl = this.relativeUrl.replace(AnonymousClass06.A05("{", str, "}"), URLEncoder.encode(str2, LogCatCollector.UTF_8_ENCODING).replace("+", "%20"));
                return;
            } catch (UnsupportedEncodingException e) {
                throw new RuntimeException(AnonymousClass06.A06("Unable to convert path parameter \"", str, "\" value to UTF-8:", str2), e);
            }
        } else {
            this.relativeUrl = this.relativeUrl.replace(AnonymousClass06.A05("{", str, "}"), str2);
            return;
        }
    ...
    private void addQueryParam(String str, String str2, boolean z, boolean z2) {
        ...
        if (str == null) {
            ...
            try {
                ...
                throw new RuntimeException(AnonymousClass06.A06("Unable to convert query parameter \"", str, "\" value to UTF-8: ", str2), e);
            }
        } else {
            str3 = AnonymousClass06.A05("Query param \"", str, "\" value must not be null.");
        }
        throw new IllegalArgumentException(str3);
    }
