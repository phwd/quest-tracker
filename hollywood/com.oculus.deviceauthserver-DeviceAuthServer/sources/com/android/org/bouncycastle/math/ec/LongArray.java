...
public class LongArray implements Cloneable {
    ...
    public LongArray(BigInteger bigInt) {
        if (bigInt == null || bigInt.signum() < 0) {
            ...
            if (barrStart < rem) {
                while (barrI < rem) {
                    temp = (temp << 8) | ((long) (barr[barrI] & UnsignedBytes.MAX_VALUE));
                    barrI++;
                }
            ...
            while (iarrJ >= 0) {
                ...
                int i = 0;
                while (i < 8) {
                    temp2 = (temp2 << 8) | ((long) (barr[barrI] & UnsignedBytes.MAX_VALUE));
                    i++;
                    barrI++;
                }
    ...
    /* JADX INFO: Multiple debug info for r3v1 int: [D('k' int), D('v' int)] */
    private static int bitLength(long w) {
        ...
        if (t == 0) {
            ...
            int v2 = t >>> 8;
            v = v2 == 0 ? bitLengths[t] + 16 : bitLengths[v2] + 24;
        }
        return b + v;
    }
    ...
    public LongArray modMultiplyLD(LongArray other, int m, int[] ks) {
        ...
        while (k >= 0) {
            ...
            while (j < aLen) {
                int aVal = (int) (a[j] >>> k);
                addBoth(c, j - 1, T0, ti[aVal & 15], T1, ti[(aVal >>> 4) & 15], bMax);
                j += 2;
                bDeg = bDeg;
                A = A;
            }
        ...
        while (k2 >= 0) {
            ...
            while (j2 < aLen) {
                ...
                addBoth(c, j2, T0, ti[aVal2 & 15], T1, ti[(aVal2 >>> 4) & 15], bMax);
                j2 += 2;
                B = B;
            }
            if (k2 > 0) {
    ...
    public LongArray modMultiply(LongArray other, int m, int[] ks) {
        ...
        while (aPos < aLen) {
            ...
            while (true) {
                long aVal2 = aVal >>> 4;
                addBoth(c, cOff, T0, ti[((int) aVal) & 15], T1, ti[((int) aVal2) & 15], bMax);
                aVal = aVal2 >>> 4;
                if (aVal == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            addShiftedUp(c, cOff3 - cLen, c, cOff3, cLen, 8);
            c = c;
            ti = ti;
            cOff2 = cOff3;
            a = a;
    ...
    /* JADX INFO: Multiple debug info for r10v9 int: [D('aVal' long), D('bank' int)] */
    /* JADX INFO: Multiple debug info for r14v9 'bLen'  int: [D('bLen' int), D('bMax' int)] */
    public LongArray modMultiplyAlt(LongArray other, int m, int[] ks) {
        ...
        if (aLen == 1) {
            ...
            long[] c0 = new long[cLen];
            multiplyWord(a0, B.m_ints, bMax2, c0, 0);
            return reduceResult(c0, 0, cLen, m, ks);
        }
        int bMax3 = ((bDeg + (64 < 64 ? 16 : 16 - 1)) + 63) >>> 6;
        int bTotal = bMax3 * 8;
        int stride = 4 * 8;
        int[] ci = new int[(1 << 4)];
        ci[0] = aLen;
        ...
        int bTotal2 = cTotal4 + cLen + 1;
        long[] c = new long[bTotal2];
        int bMax4 = bMax3;
        int bank = 8;
        int bTotal3 = bTotal;
        interleave(A.m_ints, 0, c, 0, aLen, 4);
        int bOff = aLen;
        System.arraycopy(B.m_ints, 0, c, bOff, bMax2);
        int bank2 = 1;
        while (bank2 < bank) {
            int bOff2 = bOff + bMax4;
            shiftUp(c, aLen, c, bOff2, bMax4, bank2);
            bank2++;
            bank = bank;
            B = B;
            bOff = bOff2;
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (index != 0) {
                        bLen = bMax2;
                        bMax = bMax4;
                        add(c, aPos + ci[index], c, bOff3, bMax);
                    } else {
                        bLen = bMax2;
                        bMax = bMax4;
                    }
    ...
    private static int reduceInPlace(long[] buf, int off, int len, int m, int[] ks) {
        ...
        if (vectorableWords > 1) {
            int vectorWiseWords = len3 - vectorableWords;
            int vectorWiseWords2 = vectorWiseWords;
            numBits2 = wordWiseLimit;
            reduceVectorWise(buf, off, len3, vectorWiseWords, m, ks);
            while (len3 > vectorWiseWords2) {
                len3--;
                buf[off + len3] = 0;
                vectorWiseWords2 = vectorWiseWords2;
            }
            numBits = len3;
            len2 = vectorWiseWords2 << 6;
        } else {
            numBits2 = wordWiseLimit;
            numBits = len3;
            len2 = numBits3;
        ...
        if (len2 > numBits2) {
            reduceWordWise(buf, off, numBits, numBits2, m, ks);
            len2 = numBits2;
        }
        if (len2 > m) {
    ...
    private static long interleave3_21to63(int x) {
        ...
        int r00 = iArr[x & 127];
        return ((((long) iArr[x >>> 14]) & 4294967295L) << 42) | ((((long) iArr[(x >>> 7) & 127]) & 4294967295L) << 21) | (4294967295L & ((long) r00));
    }
    ...
    private static long interleave3_13to65(int x) {
        ...
        return ((((long) iArr[x >>> 7]) & 4294967295L) << 35) | (4294967295L & ((long) iArr[x & 127]));
    }
    ...
    private static long interleave7(long x) {
        ...
        return jArr[((int) x) & 511] | (Long.MIN_VALUE & x) | (jArr[((int) (x >>> 9)) & 511] << 1) | (jArr[((int) (x >>> 18)) & 511] << 2) | (jArr[((int) (x >>> 27)) & 511] << 3) | (jArr[((int) (x >>> 36)) & 511] << 4) | (jArr[((int) (x >>> 45)) & 511] << 5) | (jArr[((int) (x >>> 54)) & 511] << 6);
    }
    ...
    private static long interleave4_16to64(int x) {
        ...
        return ((((long) iArr[x >>> 8]) & 4294967295L) << 32) | (4294967295L & ((long) iArr[x & 255]));
    }

    private static long interleave2_32to64(int x) {
        short[] sArr = INTERLEAVE2_TABLE;
        int r00 = sArr[x & 255] | (sArr[(x >>> 8) & 255] << 16);
        return ((((long) ((sArr[x >>> 24] << 16) | sArr[(x >>> 16) & 255])) & 4294967295L) << 32) | (4294967295L & ((long) r00));
    }
    ...
    public LongArray modInverse(int m, int[] ks) {
        ...
        if (dgg12 == 0) {
            ...
            while (true) {
                ...
                int duv2 = uv[b].degreeFrom(duv12);
                if (duv2 == 0) {
                    return gg[1 - b];
                }
                int dgg2 = ggDeg[1 - b];
