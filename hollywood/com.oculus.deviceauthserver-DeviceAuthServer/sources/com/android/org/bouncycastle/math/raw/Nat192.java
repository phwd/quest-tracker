...
public abstract class Nat192 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        for (int i2 = 6; i < i2; i2 = 6) {
            long x_i = ((long) x[i]) & M;
            long c7 = 0 + (x_i * y_0) + (((long) zz[i + 0]) & M);
            zz[i + 0] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_1) + (((long) zz[i + 1]) & M);
            zz[i + 1] = (int) c8;
            long c9 = (c8 >>> 32) + (x_i * y_2) + (((long) zz[i + 2]) & M);
            zz[i + 2] = (int) c9;
            long c10 = (c9 >>> 32) + (x_i * y_3) + (((long) zz[i + 3]) & M);
            zz[i + 3] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_4) + (((long) zz[i + 4]) & M);
            zz[i + 4] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_5) + (((long) zz[i + 5]) & M);
            zz[i + 5] = (int) c12;
            zz[i + 6] = (int) (c12 >>> 32);
            i++;
            y_1 = y_1;
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        while (i < 6) {
            ...
            long c7 = 0 + (x_i * y_0) + (((long) zz[zzOff2 + 0]) & M);
            zz[zzOff2 + 0] = (int) c7;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        while (i < 6) {
            long x_i = ((long) x[i]) & j;
            long c = 0 + (x_i * y_0) + (((long) zz[i + 0]) & j);
            zz[i + 0] = (int) c;
            ...
            zz[i + 5] = (int) c6;
            long c7 = (c6 >>> 32) + zc + (((long) zz[i + 6]) & M);
            zz[i + 6] = (int) c7;
            zc = c7 >>> 32;
            i++;
            y_5 = y_5;
    ...
    /* JADX INFO: Multiple debug info for r10v12 long: [D('zz_5' long), D('zz_6' long)] */
