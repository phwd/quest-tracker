...
public class SecP224R1Field {
    ...
    public static void addExt(int[] xx, int[] yy, int[] zz) {
        if (Nat.add(14, xx, yy, zz) != 0 || (zz[13] == -1 && Nat.gte(14, zz, PExt))) {
            int[] iArr = PExtInv;
    ...
    public static void multiplyAddToExt(int[] x, int[] y, int[] zz) {
        if (Nat224.mulAddTo(x, y, zz) != 0 || (zz[13] == -1 && Nat.gte(14, zz, PExt))) {
            int[] iArr = PExtInv;
            if (Nat.addTo(iArr.length, iArr, zz) != 0) {
                Nat.incAt(14, zz, PExtInv.length);
            }
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        z[4] = (int) cc5;
        long cc6 = (cc5 >> 32) + (((((long) xx[5]) & M) + t2) - xx12);
        z[5] = (int) cc6;
        long cc7 = (cc6 >> 32) + (((((long) xx[6]) & M) + xx10) - xx13);
        z[6] = (int) cc7;
        long cc8 = (cc7 >> 32) + 1;
        long z32 = z3 + cc8;
        long z02 = z0 - cc8;
        ...
        long cc9 = z02 >> 32;
        if (cc9 != 0) {
            long cc10 = cc9 + (((long) z[1]) & M);
            z[1] = (int) cc10;
            long cc11 = (cc10 >> 32) + (M & ((long) z[2]));
            z[2] = (int) cc11;
            z32 += cc11 >> 32;
        }
        z[3] = (int) z32;
        if (((z32 >> 32) != 0 && Nat.incAt(7, z, 4) != 0) || (z[6] == -1 && Nat224.gte(z, P))) {
            addPInvTo(z);
        }
    }
