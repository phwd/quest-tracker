...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(int strength2, SecureRandom random2) {
        ...
        DSAParameterSpec spec = BouncyCastleProvider.CONFIGURATION.getDSADefaultParameters(strength2);
        if (spec != null) {
            this.param = new DSAKeyGenerationParameters(random2, new DSAParameters(spec.getP(), spec.getQ(), spec.getG()));
