...
public class PKCS10CertificationRequest extends CertificationRequest {
        ...
        if (provider == null) {
            try {
                ...
                if (oids.get(this.sigAlgId.getAlgorithm()) != null) {
                    ...
                    if (provider == null) {
                        sig2 = Signature.getInstance(signatureAlgorithm);
                    } else {
                        sig2 = Signature.getInstance(signatureAlgorithm, provider);
                    }
                    sig = sig2;
                } else {
                    throw e;
    ...
    @Override // com.android.org.bouncycastle.asn1.ASN1Object, com.android.org.bouncycastle.util.Encodable
