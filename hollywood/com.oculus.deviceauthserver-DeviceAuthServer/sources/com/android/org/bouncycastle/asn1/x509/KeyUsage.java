...
public class KeyUsage extends ASN1Object {
    ...
    public String toString() {
        ...
        if (data.length == 1) {
            return "KeyUsage: 0x" + Integer.toHexString(data[0] & UnsignedBytes.MAX_VALUE);
        }
        return "KeyUsage: 0x" + Integer.toHexString((data[0] & UnsignedBytes.MAX_VALUE) | ((data[1] & UnsignedBytes.MAX_VALUE) << 8));
    }
