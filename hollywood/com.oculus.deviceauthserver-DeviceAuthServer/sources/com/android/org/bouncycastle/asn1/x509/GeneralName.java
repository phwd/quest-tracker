...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    public static GeneralName getInstance(Object obj2) {
        ...
        if (obj2 instanceof ASN1TaggedObject) {
            ...
            switch (tag2) {
                case 0:
                    return new GeneralName(tag2, ASN1Sequence.getInstance(tagObj, false));
                case 1:
                    return new GeneralName(tag2, DERIA5String.getInstance(tagObj, false));
                case 2:
                    return new GeneralName(tag2, DERIA5String.getInstance(tagObj, false));
                case 3:
                    throw new IllegalArgumentException("unknown tag: " + tag2);
                case 4:
                    return new GeneralName(tag2, X500Name.getInstance(tagObj, true));
                case 5:
                    return new GeneralName(tag2, ASN1Sequence.getInstance(tagObj, false));
                case 6:
                    return new GeneralName(tag2, DERIA5String.getInstance(tagObj, false));
                case 7:
                    return new GeneralName(tag2, ASN1OctetString.getInstance(tagObj, false));
                case 8:
                    return new GeneralName(tag2, ASN1ObjectIdentifier.getInstance(tagObj, false));
            }
        }
