...
public class CycleDetectingLockFactory {
    ...
    public static class LockGraphNode {
        ...
        /* JADX WARN: Type inference failed for: r0v4, types: [com.google.common.collect.MapMaker] */
        ...
        public void checkAcquiredLock(Policy policy, LockGraphNode acquiredLock) {
            ...
            Preconditions.checkState(z, "Attempted to acquire multiple locks with the same rank " + acquiredLock.getLockName());
