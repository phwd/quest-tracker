...
public final class Iterables {
    ...
    public static <T> T[] toArray(Iterable<? extends T> iterable, Class<T> type) {
        ...
        return (T[]) collection.toArray(ObjectArrays.newArray(type, collection.size()));
    }
            ...
            return new FluentIterable<T>() {
                ...
                public Iterator<T> iterator() {
                    ...
                    return new Iterator<T>() {
                        /* class com.google.common.collect.Iterables.AnonymousClass10.AnonymousClass1 */
    ...
    public static <T> Iterable<T> limit(final Iterable<T> iterable, final int limitSize) {
        ...
        return new FluentIterable<T>() {
            /* class com.google.common.collect.Iterables.AnonymousClass11 */
    ...
    public static <T> Iterable<T> consumingIterable(final Iterable<T> iterable) {
        if (iterable instanceof Queue) {
            return new FluentIterable<T>() {
                /* class com.google.common.collect.Iterables.AnonymousClass12 */
        ...
        Preconditions.checkNotNull(iterable);
        return new FluentIterable<T>() {
            /* class com.google.common.collect.Iterables.AnonymousClass13 */
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterables, final Comparator<? super T> comparator) {
        ...
        return new UnmodifiableIterable(new FluentIterable<T>() {
            /* class com.google.common.collect.Iterables.AnonymousClass14 */
    ...
    public static <T> Function<Iterable<? extends T>, Iterator<? extends T>> toIterator() {
        return new Function<Iterable<? extends T>, Iterator<? extends T>>() {
            /* class com.google.common.collect.Iterables.AnonymousClass15 */
