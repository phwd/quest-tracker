...
class DeviceConfigTelemetryLogger {
    ...
    private DeviceConfigTelemetryLogger setErrorMessage(@Nullable String errorMsg) {
        if (errorMsg != null) {
    ...
    private DeviceConfigTelemetryLogger setValue(@Nullable Object value) {
        if (value != null) {
    ...
    public static void logSubscriptionFailure(Context context, String errorMsg) {
        ...
        BLog.e(TAG, "onFailure(%s)", new Object[]{errorMsg});
    }

    public static void logGetValueSuccess(Context context, ValueType valueType, String paramName, @Nullable Object value, String source, long latency) {
    ...
    public static void logGetValueFailure(Context context, ValueType valueType, String paramName, Exception e) {
        ...
        BLog.e(TAG, "get%s(%s) threw an exception", new Object[]{valueType, paramName, e});
    }
    ...
    public static void logUnknownParam(Context context, String errorMessage, String paramNames) {
        ...
        BLog.e(TAG, "%s: %s", new Object[]{errorMessage, paramNames});
    }
    ...
    public static void logMissingDefaultFile(Context context, String errorMessage, String defaultFileName) {
        ...
        BLog.e(TAG, "%s: %s", new Object[]{errorMessage, defaultFileName});
    }
    ...
    public static void logInternalParamError(Context context, String errorMessage, String paramName) {
        ...
        BLog.e(TAG, "%s: %s", new Object[]{errorMessage, paramName});
    }
