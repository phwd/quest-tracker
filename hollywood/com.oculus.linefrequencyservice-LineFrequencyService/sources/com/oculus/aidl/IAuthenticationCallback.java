...
public interface IAuthenticationCallback extends IInterface {
    ...
    public static class Default implements IAuthenticationCallback {
        ...
        @Override // com.oculus.aidl.IAuthenticationCallback
        public void onFailure(int errorCode, Bundle extras) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IAuthenticationCallback {
        ...
        public static IAuthenticationCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IAuthenticationCallback)) {
                return new Proxy(obj);
            }
            return (IAuthenticationCallback) iin;
        }
        ...
        public static class Proxy implements IAuthenticationCallback {
            ...
            public void onFailure(int errorCode, Bundle extras) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onFailure(errorCode, extras);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(IAuthenticationCallback impl) {
