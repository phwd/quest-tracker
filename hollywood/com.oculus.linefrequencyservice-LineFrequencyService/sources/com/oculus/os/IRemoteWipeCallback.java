...
public interface IRemoteWipeCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRemoteWipeCallback {
        private static final String DESCRIPTOR = "com.oculus.os.IRemoteWipeCallback";
        ...
        public static IRemoteWipeCallback asInterface(IBinder obj) {
            ...
            if (iin == null || !(iin instanceof IRemoteWipeCallback)) {
                return new Proxy(obj);
            }
            return (IRemoteWipeCallback) iin;
        }
        ...
        public static class Proxy implements IRemoteWipeCallback {
            ...
            public void onFailure(String failureReason) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onFailure(failureReason);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
