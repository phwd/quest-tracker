...
public final class MethodType implements Serializable {
    ...
    public static MethodType methodType(Class cls, List list) {
        return null;
    }
    ...
    public MethodType appendParameterTypes(List list) {
        return null;
    }
    ...
    public MethodType insertParameterTypes(int i, List list) {
        return null;
    }
