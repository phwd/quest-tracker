...
public final class CriticalAppData {
    ...
    public static Map getAdditionalParamValues(Context context) {
        ...
        if (additionalParamKeySet != null && !additionalParamKeySet.isEmpty()) {
            ...
            for (String str : additionalParamKeySet) {
                String string = sharedPreferences.getString(str, OacrConstants.AUTO_SPEECH_DOMAIN);
    ...
    public static String getClientUserId(Context context) {
        return getSharedPreferences(context).getString(CLIENT_USER_ID, OacrConstants.AUTO_SPEECH_DOMAIN);
    }

    public static String getDeviceId(Context context) {
        return getSharedPreferences(context).getString(DEVICE_ID, OacrConstants.AUTO_SPEECH_DOMAIN);
    }

    public static String getUserId(Context context) {
        return getSharedPreferences(context).getString(USER_ID, OacrConstants.AUTO_SPEECH_DOMAIN);
    }
