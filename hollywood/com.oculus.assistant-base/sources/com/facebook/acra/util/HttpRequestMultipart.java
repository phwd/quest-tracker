...
public class HttpRequestMultipart {
    ...
    public void sendPost(URL url, Map map, Map map2, ACRAResponse aCRAResponse, String str, boolean z) {
        String str2;
        ...
        try {
            ...
            try {
                ...
                for (Map.Entry entry2 : map2.entrySet()) {
                    ...
                    boolean z2 = inputStreamField.mSendCompressed;
                    boolean z3 = inputStreamField.mSendAsAFile;
                    ...
                    copyStream(inputStreamField.mInputStream, compressionOutputStream);
                    if (z2) {
