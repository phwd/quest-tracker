    ...
    public void write(int i) {
        ...
        if (c2 == 0) {
            ...
            if (i3 < 2048) {
                ...
                i2 = ((c >> 6) & 63) | HTTPTransportCallback.BODY_BYTES_RECEIVED;
            ...
            writeHexByte((byte) ((c & '?') | HTTPTransportCallback.BODY_BYTES_RECEIVED));
            ...
            writeHexByte((byte) (((utf16GetSupplementary >> 12) & 63) | HTTPTransportCallback.BODY_BYTES_RECEIVED));
            writeHexByte((byte) (((utf16GetSupplementary >> 6) & 63) | HTTPTransportCallback.BODY_BYTES_RECEIVED));
            writeHexByte((byte) ((utf16GetSupplementary & 63) | HTTPTransportCallback.BODY_BYTES_RECEIVED));
            this.mUtf16State = 0;
        }
    }
