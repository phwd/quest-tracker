...
public class JavaProcFileReader extends ProcFileReader {
    ...
    public ProcFileReader.OpenFDLimits getOpenFDLimits() {
        ...
        try {
            ...
            try {
                ...
                while ((read - 1) - i > bytes.length) {
                    ...
                    if (startsWithOffset(bArr, i, bytes)) {
                        if (CY.A00.A4U(bArr, i, findNewLineOrEnd, PROC_OPEN_FD_LIMITS_FORMAT, strArr, null, null)) {
            ...
            C0139Dd.A0T(TAG, e, "Failed to read /proc/self/limits");
            return null;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x00b3, code lost:
        X.C0139Dd.A0S(com.facebook.acra.util.JavaProcFileReader.TAG, r2, "Exception caught while reading open file descriptors");
     */
