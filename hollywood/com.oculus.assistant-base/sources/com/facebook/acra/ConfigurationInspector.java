...
public class ConfigurationInspector {
    ...
    public static SparseArray mHardKeyboardHiddenValues = new SparseArray();
    public static SparseArray mKeyboardHiddenValues = new SparseArray();
    public static SparseArray mKeyboardValues = new SparseArray();
    public static SparseArray mNavigationHiddenValues = new SparseArray();
    public static SparseArray mNavigationValues = new SparseArray();
    public static SparseArray mOrientationValues = new SparseArray();
    public static SparseArray mScreenLayoutValues = new SparseArray();
    public static SparseArray mTouchScreenValues = new SparseArray();
    public static SparseArray mUiModeValues = new SparseArray();
        ...
        for (Field field : fields) {
            if (Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                ...
                try {
                    ...
                    C0139Dd.A0T("ACRA", e, "Error while inspecting device configuration: ");
                }
            }
        }
    }
    ...
    public static String toString(Configuration configuration) {
        ...
        for (Field field : fields) {
            try {
                ...
                C0139Dd.A0S("ACRA", e, "Error while inspecting device configuration: ");
            }
        }
        return sb.toString();
    }
    ...
    public static String getFieldValueName(Configuration configuration, Field field) {
        ...
        if (!name.equals(FIELD_MCC) && !name.equals(FIELD_MNC)) {
            if (name.equals(FIELD_UIMODE)) {
                ...
                sb.append('_');
                SparseArray sparseArray = (SparseArray) treeMap2.get(sb.toString());
