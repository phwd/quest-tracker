...
public class HTTPFlowStats {
    ...
    public HTTPFlowStats(String str, String str2, String str3, String str4, int i, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, String str5, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, String str6, ConnQuality connQuality, long j9, boolean z6, long j10, long j11, int i9) {
        this.mHostname = str;
        if (!str2.equals(OacrConstants.AUTO_SPEECH_DOMAIN)) {
            try {
