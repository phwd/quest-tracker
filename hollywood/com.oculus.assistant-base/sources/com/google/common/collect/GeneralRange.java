...
public final class GeneralRange implements Serializable {
    ...
    public final com.google.common.collect.GeneralRange A00(com.google.common.collect.GeneralRange r9) {
        /*
    ...
    public GeneralRange(Comparator comparator2, boolean z, Object obj, BoundType boundType, boolean z2, Object obj2, BoundType boundType2) {
        if (comparator2 != null) {
            ...
            if (boundType != null) {
                ...
                if (boundType2 != null) {
                    ...
                    if (z && z2) {
                        ...
                        boolean z3 = true;
                        if (!(compare <= 0)) {
                            throw new IllegalArgumentException(Strings.lenientFormat("lowerEndpoint (%s) > upperEndpoint (%s)", obj, obj2));
                        } else if (compare == 0) {
