...
public final class C0594cd {
    ...
    public static java.lang.reflect.Method A00(X.C0594cd r4, java.lang.Class r5) {
        /*
        ...
        L_0x0025:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C0594cd.A00(X.cd, java.lang.Class):java.lang.reflect.Method");
    }

    public C0594cd(Class cls, String str, Class... clsArr) {
        this.A01 = cls;
        this.A00 = str;
        this.A02 = clsArr;
    }

    public final Object A01(Object obj, Object... objArr) {
        try {
            Method A002 = A00(this, obj.getClass());
            if (A002 != null) {
                try {
                    return A002.invoke(obj, objArr);
