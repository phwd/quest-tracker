...
public final class C00010d<E> implements Collection<E>, Set<E> {
    ...
    public static int A00(C00010d r6) {
        int i = r6.A00;
        if (i == 0) {
            return -1;
        }
    ...
    public static int A01(C00010d r4, Object obj, int i) {
        int i2 = r4.A00;
        if (i2 == 0) {
            return -1;
        }
        try {
            int A002 = AnonymousClass0e.A00(r4.A02, i2, i);
