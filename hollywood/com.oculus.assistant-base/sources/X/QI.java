...
public final class QI extends DateFormat {
    public static final QI A05 = new QI();
    ...
    public final java.util.Date parse(java.lang.String r9, java.text.ParsePosition r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.QI.parse(java.lang.String, java.text.ParsePosition):java.util.Date");
    }
}
