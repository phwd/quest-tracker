...
public final class C0245Ne {
    ...
    static {
        ...
        int i4 = HTTPTransportCallback.BODY_BYTES_RECEIVED;
        loop2:
        while (true) {
            int i5 = -1;
            while (true) {
        ...
        Arrays.fill(iArr5, (int) HTTPTransportCallback.BODY_BYTES_RECEIVED, (int) HTTPTransportCallback.BODY_BYTES_RECEIVED, 0);
        A02 = iArr5;
        int[] iArr6 = new int[HttpRequest.CHAR_ARRAY_BUFFER_SIZE];
        A00 = iArr6;
        System.arraycopy(A01, HTTPTransportCallback.BODY_BYTES_RECEIVED, iArr6, HTTPTransportCallback.BODY_BYTES_RECEIVED, HTTPTransportCallback.BODY_BYTES_RECEIVED);
        int[] iArr7 = A00;
        ...
        iArr7[13] = 13;
        iArr7[42] = 42;
        int[] iArr8 = new int[HTTPTransportCallback.BODY_BYTES_RECEIVED];
        int i7 = 0;
        do {
            iArr8[i7] = -1;
            i7++;
        ...
        iArr8[13] = 114;
        A06 = iArr8;
        int[] iArr9 = new int[HTTPTransportCallback.BODY_BYTES_RECEIVED];
        A03 = iArr9;
        Arrays.fill(iArr9, -1);
        int i8 = 0;
        do {
