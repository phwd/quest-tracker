...
public final class C0544bh {
    ...
    public final String A09() {
        ...
        String str = this.A04;
        return str.substring(length, C0561by.A02(str, length, str.length(), ":@"));
    }

    public final List A0B() {
        String str = this.A04;
        int indexOf = str.indexOf(47, this.A03.length() + 3);
        int A022 = C0561by.A02(str, indexOf, str.length(), "?#");
        ArrayList arrayList = new ArrayList();
        while (indexOf < A022) {
            int i = indexOf + 1;
            indexOf = i;
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C0544bh) || !((C0544bh) obj).A04.equals(this.A04)) {
            return false;
        }
        return true;
    }
    ...
    public C0544bh(C0543bg bgVar) {
        List list;
        this.A03 = bgVar.A05;
        String str = bgVar.A03;
        this.A07 = A03(str, 0, str.length(), false);
        String str2 = bgVar.A02;
        this.A06 = A03(str2, 0, str2.length(), false);
        this.A02 = bgVar.A04;
        int i = bgVar.A00;
        this.A00 = i == -1 ? A01(bgVar.A05) : i;
        this.A08 = A05(bgVar.A07, false);
        List list2 = bgVar.A06;
        String str3 = null;
        if (list2 != null) {
            list = A05(list2, true);
        } else {
    ...
    public final URI A0A() {
        ...
        if (list2 != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                String str2 = (String) A0C.A06.get(i2);
                if (str2 != null) {
                    A0C.A06.set(i2, A02(str2, 0, str2.length(), "\\^`{|}", true, true, true, true));
                }
            }
        }
        String str3 = A0C.A01;
        if (str3 != null) {
            A0C.A01 = A02(str3, 0, str3.length(), " \"#<>\\^`{|}", true, true, false, false);
        }
        ...
        try {
            ...
            try {
                return URI.create(obj.replaceAll("[\\u0000-\\u001F\\u007F-\\u009F\\p{javaWhitespace}]", OacrConstants.AUTO_SPEECH_DOMAIN));
    ...
    public static String A02(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            ...
            AnonymousClass33 r3 = new AnonymousClass33();
            r3.A0D(str, i, i3);
            AnonymousClass33 r5 = null;
            while (i3 < i2) {
                ...
                if (!z || !(codePointAt2 == 9 || codePointAt2 == 10 || codePointAt2 == 12 || codePointAt2 == 13)) {
                    if (codePointAt2 == 43 && z3) {
                        ...
                        while (!r5.A1r()) {
                            ...
                            r3.A08(37);
                            char[] cArr = A09;
                            r3.A08(cArr[(readByte >> 4) & 15]);
                            r3.A08(cArr[readByte & 15]);
                        }
                    } else {
                        r3.A0B(codePointAt2);
                    }
