...
public final class C0582cN {
    public static final C0603cm A00 = C0603cm.A02("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        strArr2[0] = OacrConstants.AUTO_SPEECH_DOMAIN;
        strArr2[1] = "END_STREAM";
        int[] iArr = {1};
        strArr2[8] = "PADDED";
        for (int i2 = 0; i2 < 1; i2++) {
            int i3 = iArr[i2];
            strArr2[i3 | 8] = AnonymousClass08.A04(strArr2[i3], "|PADDED");
        }
