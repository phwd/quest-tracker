...
public class UQ {
    ...
    public static int A00(UQ uq, Object obj, int i) {
        int[] iArr = uq.A04;
        ...
        if (i2 != -1) {
            int i3 = -1;
            while (true) {
                if (((int) (uq.A06[i2] >>> 32)) != i || !Objects.equal(obj, uq.A07[i2])) {
                    int i4 = (int) uq.A06[i2];
                    if (i4 == -1) {
                        break;
                    }
                    i3 = i2;
    ...
    public final int A02() {
        if (this instanceof C1182ue) {
            int i = ((C1182ue) this).A00;
            if (i == -2) {
                return -1;
            }
            return i;
    ...
    public final int A05(Object obj, int i) {
        if (i > 0) {
            ...
            if (i3 == -1) {
                ...
                while (true) {
                    long j = jArr[i3];
                    if (((int) (j >>> 32)) != A022 || !Objects.equal(obj, objArr[i3])) {
                        int i4 = (int) j;
                        if (i4 == -1) {
    ...
    public void A0A(int i, Object obj, int i2, int i3) {
    ...
    public UQ(UQ uq) {
        ...
        int A022 = uq.A02();
        while (A022 != -1) {
            Preconditions.checkElementIndex(A022, uq.A02);
            Object obj = uq.A07[A022];
            Preconditions.checkElementIndex(A022, uq.A02);
            A05(obj, uq.A05[A022]);
            A022 = uq.A03(A022);
        }
