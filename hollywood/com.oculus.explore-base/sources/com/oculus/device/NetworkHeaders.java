...
public class NetworkHeaders {
    ...
    public static Map<String, String> getHeaderMap(Context context) {
        ...
        map.put("Accept-Language", headers.Accept_Language);
        map.put("User-Agent", headers.User_Agent);
    ...
    public static DeviceEnvironmentModule.DeviceEnvironmentHeadersType getHeaders(Context context) {
        ...
        headers.X_Build_Version_Incremental = SystemProperties.getString("ro.build.version.incremental", BuildConfig.PROVIDER_SUFFIX);
