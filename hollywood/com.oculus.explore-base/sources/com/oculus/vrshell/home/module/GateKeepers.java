...
public class GateKeepers extends RCTBaseJavaModule {
    ...
    public void removeOverride(String gkName, int resolveID, int rejectID) {
        ...
        nativeInvokeCallback(this.RVRCtxTag, resolveID, "[]");
    }
