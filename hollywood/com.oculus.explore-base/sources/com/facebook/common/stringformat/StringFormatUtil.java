...
public class StringFormatUtil {
    ...
    public static String formatStrLocaleSafe(String format, Object arg0) {
        return formatStrLocaleSafeInner(format, 1, arg0, null, null, null, null);
    }

    public static String formatStrLocaleSafe(String format, Object arg0, Object arg1) {
        return formatStrLocaleSafeInner(format, 2, arg0, arg1, null, null, null);
    }

    public static String formatStrLocaleSafe(String format, Object arg0, Object arg1, Object arg2) {
        return formatStrLocaleSafeInner(format, 3, arg0, arg1, arg2, null, null);
    }

    public static String formatStrLocaleSafe(String format, Object arg0, Object arg1, Object arg2, Object arg3) {
    ...
    private static String formatStrLocaleSafeInner(String format, int argCount, Object arg0, Object arg1, Object arg2, Object arg3, Object[] argsList) {
    ...
    static int doDryRun(String format, Object arg0) {
        return doFormatArgs(null, format, 1, arg0, null, null, null);
    }

    static int doDryRun(String format, Object arg0, Object arg1) {
        return doFormatArgs(null, format, 2, arg0, arg1, null, null);
    }

    static int doDryRun(String format, Object arg0, Object arg1, Object arg2) {
        return doFormatArgs(null, format, 3, arg0, arg1, arg2, null);
    }

    static int doDryRun(String format, Object arg0, Object arg1, Object arg2, Object arg3) {
        return doFormatArgs(null, format, 4, arg0, arg1, arg2, arg3);
    }

    static int doDryRun(String format, Object[] args) {
        return doFormatArray(null, format, args);
    }

    private static int doDryRunInternal(String format, int argCount, Object arg0, Object arg1, Object arg2, Object arg3, Object[] argsList) {
        switch (argCount) {
            case 0:
    ...
    private static int doFormatArgs(StringBuilder output, String format, int argCount, Object arg0, Object arg1, Object arg2, Object arg3) {
        int segIdx = 0;
        int length = 0;
    ...
    private static int appendSegmentFormatArgs(StringBuilder output, String format, int startIdx, Object arg0, Object arg1, Object arg2, Object arg3, int argIdx) {
        switch (argIdx) {
            case -1:
    ...
    private static int doFormatArray(StringBuilder output, String format, Object... args) {
        int segIdx = 0;
        int length = 0;
        boolean dryRun = output == null;
    ...
    private static int appendSegmentFormat(StringBuilder output, String format, int startIdx, Object arg, boolean considerArg) {
        int appendResult;
        int index = startIdx;
    ...
    private static int appendStringTypeArg(StringBuilder output, Object arg) {
    ...
    private static int appendIntTypeArg(StringBuilder output, Object arg) {
        int length = 0;
        if (arg == null) {
            if (output == null) {
    ...
    private static int processRemainingString(StringBuilder output, String format, int startIdx, int currLength, boolean dryRun) {
        int formatLen = format.length();
        int index = startIdx;
        int remainingLen = 0;
        while (index < formatLen) {
    ...
    private static String fallbackToSystem(String format, int argCount, Object arg0, Object arg1, Object arg2, Object arg3, Object[] argsList) {
        switch (argCount) {
            case 0:
    ...
    private static String doFallbackToSystem(String format, Object... args) {
        try {
