...
final class OldProcReader implements IProcReader {
    ...
    public boolean parseProcLine(byte[] buffer, int startIndex, int endIndex, int[] format, String[] outStrings, long[] outLongs, float[] outFloats) {
    ...
    @Override // com.facebook.common.procread.IProcReader
    public boolean readProcFile(String file, int[] format, String[] outStrings, long[] outLongs, float[] outFloats) {
    ...
    private static java.lang.Object invoke(java.lang.reflect.Method r4, java.lang.Object... r5) {
        /*
            r3 = 6
