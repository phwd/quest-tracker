...
public final class ErrorReporter implements ManagedExceptionHandler {
    ...
    private static void reportSoftError(Throwable throwable, String category, String message, String sessionId, ErrorReporter reporter) {
    ...
    /* access modifiers changed from: private */
    public static void purgeDirectory(File dir, final String extension) {
        File[] files;
    ...
    static class CachedANRReportHandler implements ReportHandler {
        ...
        private void addUpdatedProperties(CrashReportData crashReport, CrashReportData updatedData, String uploadedByProcess, File updateFile) throws IOException {
            ...
            if (ACRA.getCachedShouldUploadSystemANRTraces() && (((hasSigquit = (String) crashReport.get("anr_with_sigquit_traces")) == null || hasSigquit.equals("0")) && ((String) updatedData.get("SIGQUIT")) == null)) {
        ...
        /* access modifiers changed from: package-private */
        public int findANRTraces(String processName, long crashTime, String anrTracesFilePath, StringBuilder sb) {
            if (processName == null) {
                return -1;
            }
            try {
    ...
    public enum CrashReportType {
        ...
        private CrashReportType(String directory2, long maxSize, String attachmentField2, ReportHandler handler2, String[] extraFileExtensions2, String... fileExtensions2) {
    ...
    public final class ReportsSenderWorker extends Thread {
        ...
        public ReportsSenderWorker(ErrorReporter this$02, CrashReportData inMemoryReportToSend, Spool.FileBeingProduced reportFileUnderConstruction) {
        ...
        private ReportsSenderWorker(CrashReportData inMemoryReportToSend, Spool.FileBeingProduced reportFileUnderConstruction, CrashReportType[] reportTypesToSend) {
    ...
    public void setExcludedReportObserver(ExcludedReportObserver observer) {
    ...
    private void addCriticalData() {
        ...
        if (deviceId.length() > 0) {
            putCustomData("marauder_device_id", deviceId);
        }
    ...
    private void tryLogInternalError(String what, Throwable ex) {
        if (what == null) {
            what = "???";
        }
        try {
    ...
    public void handleUncaughtException(Thread t, Throwable e, CustomStackTracerInterface.CustomStackTrace customStackTrace) {
    ...
    static void put(String key, String value, CrashReportData crashReport, Writer writer) {
    ...
    public ReportsSenderWorker handleException(Throwable e, CrashReportData draft) {
    ...
    private ReportsSenderWorker handleExceptionInternal(Throwable e, CrashReportData draft, String overrideStackTrace, int flags) {
        if (!this.mInitializationComplete) {
            return null;
        }
        synchronized (UNCAUGHT_EXCEPTION_LOCK) {
        ...
        if (!this.mConfig.isZeroCrashlogBlocked()) {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    } else if (!(sender instanceof BaseHttpPostSender) || !this.mConfig.shouldUseUploadService()) {
                        throw e;
    ...
    private String genCrashReportFileName(Class cause, UUID reportUuid, String fileExtension) {
        return reportUuid.toString() + "-" + cause.getSimpleName() + (this.mAppVersionCode != null ? "-" + this.mAppVersionCode : com.oculus.common.build.BuildConfig.PROVIDER_SUFFIX) + fileExtension;
    }
    ...
    public String getLogcatOutputIfPidFound(boolean collectLogcatFromExternalProcess, Integer pid) {
    ...
    private void buildAttachmentWrapperCrashReport(CrashReportData wrapperCrashReport, CrashReportType type, Spool.FileBeingConsumed dumpFile, Writer writer, boolean captureProcessName) {
    ...
    private int keepNLatestDumpFiles(File directory) {
    ...
    public void writeLibsToFile(File syslibfile, HashSet<String> moduleList) {
        Throwable th;
    ...
    public HashSet<String> getNewLibs(File syslibfile, HashSet<String> moduleList) {
        Throwable th;
        if (moduleList == null || moduleList.isEmpty()) {
            return null;
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private int processCrashAttachmentsLocked(int r19, com.facebook.acra.ErrorReporter.CrashReportType r20, com.facebook.acra.FileGenerator r21, boolean r22) {
        /*
    ...
    private void processCrashAttachmentAfterSend(Spool.FileBeingConsumed dumpFile, CrashReportType type, File backUpDir, String logcatFilePath) throws IOException {
    ...
    private int buildCachedCrashReport(CrashReportType type, String stackTrace, File traceFile, FileGenerator outFileGenerator) {
    ...
    private int maybeSendCrashReport(CrashReportType type, CrashReportData reportData, Spool.FileBeingConsumed dumpFile, FileGenerator outFileGenerator, boolean recordInProgress) throws Throwable {
        String fname;
        String processName;
        Writer writer = null;
    ...
    private void attachIabInfo(CrashReportData crashReport) throws IOException {
        ...
        if ("NO_FILE".equals(iabOpenTimes)) {
            crashReport.put("IAB_OPEN_TIMES", "0");
    ...
    private CrashReportData loadCrashReport(File traceFile, RandomAccessFile file, CrashReportType crashReportType, long maxSize, boolean slurpAttachment) throws IOException {
        boolean tooOld;
