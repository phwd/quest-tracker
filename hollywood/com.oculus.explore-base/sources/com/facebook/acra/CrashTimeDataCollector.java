...
public class CrashTimeDataCollector {
    ...
    static void gatherCrashData(ErrorReporter errorReporter, AcraReportingConfig config, String stackTrace, Throwable e, CrashReportData crashReport, Writer w, Spool.FileBeingConsumed minidump, boolean captureProcessName, boolean isNonCrash) throws Exception {
    ...
    private static void populateCrashTimeData(Spool.FileBeingConsumed minidump, ErrorReporter reporter, AcraReportingConfig config, Throwable e, CrashReportData crashReport, Writer writer, boolean captureProcessName, boolean isNonCrash) {
        ...
        if (captureProcessName && shouldAddField("PROCESS_NAME", crashReport, config)) {
            if (!nativeCrash) {
                ...
                if (processName == null) {
                    processName = BuildConfig.PROVIDER_SUFFIX;
                }
                    ...
                    if (sDeviceSpecificFields.containsKey(field)) {
                        ...
                        switch (c) {
                            ...
                            case BreakpadManager.SIGBUS /*{ENCODED_INT: 7}*/:
                                ...
                                break;
                            case BreakpadManager.SIGFPE /*{ENCODED_INT: 8}*/:
    ...
    private static void reportInternalStorageUsage(AcraReportingConfig config, CrashReportData crashReport, Writer writer) {
