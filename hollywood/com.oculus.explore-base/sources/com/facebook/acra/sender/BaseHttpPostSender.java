...
public abstract class BaseHttpPostSender implements FlexibleReportSender {
    ...
    public BaseHttpPostSender(AcraReportingConfig acraConfig) {
    ...
    private void sendInternal(CrashReportData report) throws IOException {
        ...
        if (userId != null && !userId.equals(BuildConfig.PROVIDER_SUFFIX) && !userId.equals("0")) {
    ...
    public boolean setHost(String host) {
        if (host == null || host.equals(BuildConfig.PROVIDER_SUFFIX)) {
            return false;
        }
