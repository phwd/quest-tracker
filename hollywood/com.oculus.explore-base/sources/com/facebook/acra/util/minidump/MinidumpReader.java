...
public class MinidumpReader {
    ...
    public static boolean checkMinidumpErrLogStream(String errLog) {
    ...
    public String getCustomData(String key) {
        try {
            ...
            BLog.e(LOG_TAG, e, "getCustomData error: %s", BuildConfig.PROVIDER_SUFFIX);
            return null;
        }
    }
    ...
    private static JsonReader retrieveJsonNode(JsonReader jsonReader, String key) throws IOException {
        if (jsonReader == null) {
            return null;
        }
