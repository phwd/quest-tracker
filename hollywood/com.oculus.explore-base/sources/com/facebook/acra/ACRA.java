...
public class ACRA {
    ...
    public static ErrorReporter init(AcraReportingConfig config, long appStartTickTimeMs, AppStateUpdater appStateUpdater, ErrorReporter.ExcludedReportObserver excludedReportObserver) {
        sInitialized = true;
    ...
    private static String getProperty(String key) {
        ...
        if (prop == null || prop.equals(BuildConfig.PROVIDER_SUFFIX)) {
    ...
    private static void initReportSource() {
        ...
        if (reportSourceOverride != null && !reportSourceOverride.equals(BuildConfig.PROVIDER_SUFFIX)) {
            ...
            ErrorReporter.putCustomData("report_source_ref", BuildConfig.PROVIDER_SUFFIX);
        }
        ...
        if (reportSourceRefOverride != null) {
            ...
            if (furyTracesFileName != null && !furyTracesFileName.equals(BuildConfig.PROVIDER_SUFFIX)) {
        ...
        if (mobileBuildTargetOverride != null && !mobileBuildTargetOverride.equals(BuildConfig.PROVIDER_SUFFIX)) {
    ...
    private static JSONObject jsonifyReportSourceRef(String reportSourceRef) {
        ...
        if (reportSourceRef.startsWith("report_source_ref=")) {
            validationResult = reportSourceRef.replace("report_source_ref=", BuildConfig.PROVIDER_SUFFIX);
        } else {
    ...
    public static String getProcessName() {
        ...
        if (name == null) {
            return com.facebook.common.build.config.BuildConfig.VERSION_NAME;
        }
        return name;
    }
    ...
    private static void closeStreamNoException(Closeable stream) {
        if (stream != null) {
            try {
                stream.close();
            } catch (IOException e) {
