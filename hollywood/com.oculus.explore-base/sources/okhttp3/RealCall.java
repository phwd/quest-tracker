...
public final class RealCall implements Call {
    ...
    /* access modifiers changed from: package-private */
    public IOException timeoutExit(IOException cause) {
    ...
    public String toLoggableString() {
        return (isCanceled() ? "canceled " : BuildConfig.PROVIDER_SUFFIX) + (this.forWebSocket ? "web socket" : "call") + " to " + redactedUrl();
    }
