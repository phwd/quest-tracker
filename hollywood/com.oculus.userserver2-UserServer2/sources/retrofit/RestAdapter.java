...
public class RestAdapter {
        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (typedInput != null) {
                ...
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    j2 = (long) bArr.length;
                    this.log.log(new String(bArr, MimeUtil.parseCharset(typedInput.mimeType(), LogCatCollector.UTF_8_ENCODING)));
                }
            }
    ...
    public Request logAndReplaceRequest(String str, Request request, Object[] objArr) throws IOException {
        ...
        if (this.logLevel.ordinal() >= LogLevel.HEADERS.ordinal()) {
            ...
            if (typedOutput != null) {
                ...
                if (mimeType != null) {
                    this.log.log(AnonymousClass06.A03("Content-Type: ", mimeType));
                }
                ...
                str2 = sb.toString();
                if (length != -1) {
                    this.log.log(AnonymousClass06.A02("Content-Length: ", length));
                }
                if (this.logLevel.ordinal() >= LogLevel.FULL.ordinal()) {
                    ...
                    this.log.log(new String(((TypedByteArray) typedOutput).bytes, MimeUtil.parseCharset(typedOutput.mimeType(), LogCatCollector.UTF_8_ENCODING)));
    ...
    public void logException(Throwable th, String str) {
        ...
        log2.log(String.format("---- ERROR %s", str));
