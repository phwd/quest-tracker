...
public final class MultipartTypedOutput implements TypedOutput {
    ...
    public static byte[] buildBoundary(String str, boolean z, boolean z2) {
        try {
            ...
            sb.append(HttpRequestMultipart.LINE_FEED);
            return sb.toString().getBytes(LogCatCollector.UTF_8_ENCODING);
        } catch (IOException e) {
    ...
    public String mimeType() {
        return AnonymousClass06.A03("multipart/form-data; boundary=", this.boundary);
    }
    ...
    public void addPart(String str, String str2, TypedOutput typedOutput) {
        String str3;
        if (str == null) {
            str3 = "Part name must not be null.";
        } else if (str2 == null) {
            str3 = "Transfer encoding must not be null.";
            ...
            str3 = "Part body must not be null.";
        }
