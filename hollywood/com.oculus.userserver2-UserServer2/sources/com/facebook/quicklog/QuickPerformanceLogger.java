...
public interface QuickPerformanceLogger {
    ...
    @Deprecated
    void markerPoint(int i, int i2, @EventLevel int i3, String str, @Nullable C0121Rb rb, long j, int i4);

    void markerPoint(int i, int i2, @EventLevel int i3, String str, @Nullable C0121Rb rb, long j, TimeUnit timeUnit, int i4);
