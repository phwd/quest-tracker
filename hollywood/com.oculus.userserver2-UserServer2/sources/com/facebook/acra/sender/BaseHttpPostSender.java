...
public abstract class BaseHttpPostSender implements FlexibleReportSender {
    ...
    private void sendInternal(CrashReportData crashReportData) throws IOException {
        ...
        if (crashReportData.containsKey(ReportField.UID) && (str = (String) crashReportData.get(ReportField.UID)) != null && !str.equals("") && !str.equals(OculusConstants.DEFAULT_ENTERPRISE_USER_ID)) {
            hashMap.put("Cookie", AnonymousClass06.A03("c_user=", str));
        }
