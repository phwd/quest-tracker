...
public class DumpSysCollector {
    ...
    public static class Api17Utils {
        ...
        public static class Api11Utils {
            public static String collectLargerMemoryInfo(Context context) {
                ...
                sb.append(AnonymousClass06.A01("Large heap size =", ((ActivityManager) context.getSystemService(AppComponentStats.TAG_ACTIVITY)).getLargeMemoryClass()));
                return sb.toString();
            }
        }

        public static String collectUserInfo(Context context) {
            return Long.toString(((UserManager) context.getSystemService(ServiceContract.EXTRA_USER)).getSerialNumberForUser(Process.myUserHandle()));
        }
    }
    ...
    public static String collectMemInfo(Context context) {
        ...
        int i4 = (int) ((((float) i3) / f) * 100.0f);
        int i5 = (int) (((float) (i * 100)) / f);
        int i6 = memoryInfo2.otherPrivateDirty;
        int i7 = (int) (((float) ((i3 + i6) * 100)) / f);
        Locale locale = Locale.US;
        sb.append(String.format(locale, "percent dalvik+native / native / d+n+other / other %d / %d / %d / %d", Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i7), Integer.valueOf((int) (((float) (i6 * 100)) / f))));
        ...
        sb.append(String.format(locale, "           other: %7d / %7d / %7d", Integer.valueOf(i6), Integer.valueOf(memoryInfo2.otherPss), Integer.valueOf(memoryInfo2.otherSharedDirty)));
