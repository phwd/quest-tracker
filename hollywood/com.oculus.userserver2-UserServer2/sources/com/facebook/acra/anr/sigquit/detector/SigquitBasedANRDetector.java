...
public class SigquitBasedANRDetector extends AbstractANRDetector implements SigquitDetectorListener {
    ...
    public class ProcessAnrErrorMonitorListener extends DefaultProcessErrorStateListener {
        ...
        public void onCheckFailed() {
            Mi.A00(SigquitBasedANRDetector.LOG_TAG, "Failed when checking process error state");
        ...
        public void onMaxChecksReachedAfterError() {
            Mi.A01(SigquitBasedANRDetector.LOG_TAG, "Reached max number of checks after error was detected");
            SigquitBasedANRDetector.this.processMonitorStopped(2);
        }

        @Override // com.facebook.acra.anr.processmonitor.ProcessErrorStateListener, com.facebook.acra.anr.processmonitor.DefaultProcessErrorStateListener
        public void onMaxChecksReachedBeforeError() {
            Mi.A01(SigquitBasedANRDetector.LOG_TAG, "Reached max number of checks before error was detected");
    ...
    public void anrErrorClearedOnProcessMonitor() {
        setInAnrState(false);
        notifyStateListeners(EnumC0193eb.NO_ANR_DETECTED);
    ...
    private void installSignalHandlerAndMaybeStart(boolean z) {
        synchronized (this.mStateLock) {
            if (!sNativeInited) {
                ...
                aNRDetectorConfig.mAppStateUpdater = new AppStateUpdater() {
                    ...
                    public void updateAnrState(EnumC0193eb ebVar, @Nullable Runnable runnable) {
                        AnonymousClass1 r1;
                        if (ebVar != EnumC0193eb.DURING_ANR) {
                            r1 = new Runnable() {
                        ...
                        if (appStateUpdater != null) {
                            appStateUpdater.updateAnrState(ebVar, r1);
                        }
                    }
                };
            ...
            if (handler == null) {
                Mi.A01(LOG_TAG, "nativeLibraryLoaded has not been called yet");
            } else {
    ...
    private void maybeStartACRAReport(String str, String str2, long j) {
        if ((this.mInForegroundV1 || this.mInForegroundV2) && shouldCollectAndUploadANRReports()) {
            ...
            try {
                ...
                Mi.A06(LOG_TAG, e, "Error saving ANR report");
            }
        } else if (str2 != null) {
    ...
    public void sigquitDetected(final String str, final String str2, final boolean z, final boolean z2) {
        final boolean z3;
        Mi.A01(LOG_TAG, "On sigquitDetected call");
        ...
        if (!isDebuggerConnected() && this.mRunning) {
            ...
            if (inAnrState()) {
                Mi.A01(LOG_TAG, "Detected a new ANR before the end of the previous one");
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            synchronized (this.mProcessingThreadLock) {
                ...
                if (handler2 != null) {
                    handler2.post(new Runnable() {
                        ...
                        public void run() {
                            if (z3) {
                                Mi.A01(SigquitBasedANRDetector.LOG_TAG, "Clearing current ANR");
                                SigquitBasedANRDetector.this.anrErrorClearedOnProcessMonitor();
                            }
                            Mi.A01(SigquitBasedANRDetector.LOG_TAG, "On processing thread handling ANR start");
                            SigquitBasedANRDetector.this.updateForegroundState(z, z2);
                            SigquitBasedANRDetector.this.notifyStateListeners(EnumC0193eb.DURING_ANR);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            if (SigquitBasedANRDetector.this.inAnrState()) {
                                ...
                                SigquitBasedANRDetector.this.notifyStateListeners(EnumC0193eb.ANR_RECOVERED);
                            }
                        }
                    });
                }
            ...
            public void run() {
                synchronized (SigquitBasedANRDetector.this.mWaitingToClearANRLock) {
                    ...
                    if (sigquitBasedANRDetector.mWaitingForANRClearTimeout) {
                        sigquitBasedANRDetector.notifyStateListeners(EnumC0193eb.NO_ANR_DETECTED);
    ...
    private void notifyStateListeners(EnumC0193eb ebVar, boolean z) {
        EnumC0193eb ebVar2;
        AppStateUpdater appStateUpdater = this.mANRConfig.mAppStateUpdater;
        EnumC0193eb ebVar3 = EnumC0193eb.DURING_ANR;
        if (ebVar == ebVar3) {
            if (appStateUpdater != null) {
                appStateUpdater.updateAnrState(ebVar3, null);
            }
            maybeStartProcessErrorMonitor();
        } else if (appStateUpdater != null) {
            if (isProcessErrorMonitorMonitoring() || ebVar == EnumC0193eb.ANR_RECOVERED) {
                ebVar2 = EnumC0193eb.ANR_RECOVERED;
            } else {
                ebVar2 = EnumC0193eb.NO_ANR_DETECTED;
            }
            appStateUpdater.updateAnrState(ebVar2, null);
        }
    }
    ...
    public void notifyStateListeners(X.EnumC0193eb r3) {
        /*
            r2 = this;
        ...
        L_0x000a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.acra.anr.sigquit.detector.SigquitBasedANRDetector.notifyStateListeners(X.eb):void");
    }
}
