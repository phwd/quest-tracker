...
public final class HttpEngine {
    public static final ResponseBody EMPTY_BODY = new ResponseBody() {
        ...
        @Override // com.squareup.okhttp.ResponseBody
        public Dp source() {
            return new AnonymousClass8k();
        }
    };
    public static final int MAX_FOLLOW_UPS = 20;
    public final boolean bufferRequestBody;
    public Du bufferedRequestBody;
        ...
        public Response proceed(Request request2) throws IOException {
            ...
            if (this.index < HttpEngine.this.client.networkInterceptors.size()) {
                ...
                if (HttpMethod.permitsRequestBody(request2.method) && (requestBody = request2.body) != null) {
                    AnonymousClass8i r1 = new AnonymousClass8i(httpEngine.httpStream.createRequestBody(request2, requestBody.contentLength()));
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        final Dp source = response.body.source();
        final AnonymousClass8i r1 = new AnonymousClass8i(body);
        AnonymousClass2 r0 = new WF() {
            /* class com.squareup.okhttp.internal.http.HttpEngine.AnonymousClass2 */
            public boolean cacheRequestClosed;

            @Override // X.WF
            public long read(AnonymousClass8k r11, long j) throws IOException {
                try {
                    ...
                    r11.A0H(r1.A16(), r11.A00 - read, read);
                    r1.A1T();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
        ...
        builder.body = new RealResponseBody(response.headers, new C00148h(r0));
    ...
    private Request networkRequest(Request request) throws IOException {
        ...
        if (request.header(HttpRequestMultipart.USER_AGENT) == null) {
    ...
    private Response unzip(Response response) throws IOException {
        ...
        Dk dk = new Dk(responseBody.source());
        ...
        builder.body = new RealResponseBody(headers, new C00148h(dk));
        return builder.build();
    }
    ...
    public StreamAllocation close() {
        Du du = this.bufferedRequestBody;
        if (du != null) {
            Util.closeQuietly(du);
        } else {
            WG wg = this.requestBodyOut;
            if (wg != null) {
                Util.closeQuietly(wg);
            }
        }
    ...
    public Du getBufferedRequestBody() {
        Du du = this.bufferedRequestBody;
        if (du != null) {
            return du;
        }
        WG requestBody = getRequestBody();
        if (requestBody == null) {
            return null;
        }
        AnonymousClass8i r0 = new AnonymousClass8i(requestBody);
    ...
    public HttpEngine recover(IOException iOException, WG wg) {
        if (!this.streamAllocation.recover(iOException, wg) || !this.client.retryOnConnectionFailure) {
            return null;
        }
        return new HttpEngine(this.client, this.userRequest, this.bufferRequestBody, this.callerWritesRequestBody, this.forWebSocket, close(), (RetryableSink) wg, this.priorResponse);
    }
}
