...
public final class DistinguishedNameParser {
    ...
    public String findMostSpecific(String str) {
        ...
        if (nextAT != null) {
            ...
            throw new IllegalStateException(AnonymousClass06.A03("Malformed DN: ", this.dn));
        }
        return null;
    }
    ...
    private char getEscaped() {
        ...
        if (i != this.length) {
            ...
            throw new IllegalStateException(AnonymousClass06.A03("Unexpected end of DN: ", this.dn));
        }
    }
