...
public final class Spdy3 implements Variant {
    ...
    public static final class Reader implements FrameReader {
        ...
        private void readGoAway(FrameReader.Handler handler, int i, int i2) throws IOException {
            ...
            if (i2 == 8) {
                ...
                if (fromSpdyGoAway != null) {
                    handler.goAway(readInt, fromSpdyGoAway, WM.A03);
                    return;
                } else {
        ...
        public Reader(Dp dp, boolean z) {
            this.source = dp;
            this.headerBlockReader = new NameValueBlockReader(dp);
            this.client = z;
        }
    ...
    public static final class Writer implements FrameWriter {
        ...
        public final AnonymousClass8k headerBlockBuffer;
        public final Du headerBlockOut;
        ...
        @Override // com.squareup.okhttp.internal.framed.FrameWriter
        public synchronized void data(boolean z, int i, AnonymousClass8k r4, int i2) throws IOException {
            int i3 = 0;
            if (z) {
                i3 = 1;
            }
        ...
        public synchronized void goAway(int i, ErrorCode errorCode, byte[] bArr) throws IOException {
            if (this.closed) {
                ...
                this.sink.A41(-2147287033);
                this.sink.A41(8);
                this.sink.A41(i);
                this.sink.A41(errorCode.spdyGoAwayCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A41(-2147287032);
                this.sink.A41((((int) (this.headerBlockBuffer.A00 + 4)) & 16777215) | 0);
                this.sink.A41(i & Integer.MAX_VALUE);
                this.sink.A3x(this.headerBlockBuffer);
            } else {
                throw new IOException("closed");
            }
        }
        ...
        public synchronized void rstStream(int i, ErrorCode errorCode) throws IOException {
            if (this.closed) {
                ...
                this.sink.A41(-2147287037);
                this.sink.A41(8);
                this.sink.A41(i & Integer.MAX_VALUE);
                this.sink.A41(errorCode.spdyRstCode);
                this.sink.flush();
            } else {
        ...
        public synchronized void settings(Settings settings) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A41(-2147287036);
                int i = 0;
                this.sink.A41((((bitCount << 3) + 4) & 16777215) | 0);
                this.sink.A41(bitCount);
                do {
                    if (settings.isSet(i)) {
                        this.sink.A41(((settings.flags(i) & 255) << 24) | (i & 16777215));
        ...
        public synchronized void synReply(boolean z, int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A41(-2147287038);
                this.sink.A41(((i2 & 255) << 24) | (((int) (this.headerBlockBuffer.A00 + 4)) & 16777215));
                this.sink.A41(i & Integer.MAX_VALUE);
                this.sink.A3x(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.A41(-2147287039);
                this.sink.A41(((((z ? 1 : 0) | i4) & 255) << 24) | (i3 & 16777215));
                this.sink.A41(i & Integer.MAX_VALUE);
                this.sink.A41(Integer.MAX_VALUE & i2);
                this.sink.A43(0);
                this.sink.A3x(this.headerBlockBuffer);
                this.sink.flush();
            } else {
        ...
        public synchronized void windowUpdate(int i, long j) throws IOException {
            if (this.closed) {
                ...
                throw new IllegalArgumentException(AnonymousClass06.A02("windowSizeIncrement must be between 1 and 0x7fffffff: ", j));
            } else {
                this.sink.A41(-2147287031);
                this.sink.A41(8);
                this.sink.A41(i);
                this.sink.A41((int) j);
                this.sink.flush();
        ...
        private void writeNameValueBlockToBuffer(List<Header> list) throws IOException {
            this.headerBlockOut.A41(list.size());
            int size = list.size();
            for (int i = 0; i < size; i++) {
                WM wm = list.get(i).name;
                this.headerBlockOut.A41(wm.A07());
                this.headerBlockOut.A3u(wm);
                WM wm2 = list.get(i).value;
                this.headerBlockOut.A41(wm2.A07());
                this.headerBlockOut.A3u(wm2);
            }
            this.headerBlockOut.flush();
        }

        public void sendDataFrame(int i, int i2, AnonymousClass8k r8, int i3) throws IOException {
            if (!this.closed) {
                long j = (long) i3;
                if (j <= 16777215) {
                    this.sink.A41(i & Integer.MAX_VALUE);
                    this.sink.A41(((i2 & 255) << 24) | (16777215 & i3));
                    if (i3 > 0) {
        ...
        public Writer(Du du, boolean z) {
            ...
            this.headerBlockOut = new AnonymousClass8i(new Do(r0, deflater));
        }
    }
