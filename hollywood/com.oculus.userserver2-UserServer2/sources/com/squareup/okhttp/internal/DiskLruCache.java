...
public final class DiskLruCache implements Closeable {
    ...
    public static final WG NULL_SINK = new WG() {
        ...
        @Override // X.WG
        public void write(AnonymousClass8k r1, long j) throws IOException {
            r1.A3i(j);
        }
    };
    ...
    public final class Editor {
        ...
        public WG newSink(int i) throws IOException {
            AnonymousClass1 r0;
            synchronized (DiskLruCache.this) {
        ...
        public WF newSource(int i) throws IOException {
            synchronized (DiskLruCache.this) {
                Entry entry2 = this.entry;
                if (entry2.currentEditor != this) {
                    throw new IllegalStateException();
    ...
    public final class Entry {
        ...
        private IOException invalidLengths(String[] strArr) throws IOException {
            throw new IOException(AnonymousClass06.A03("unexpected journal line: ", Arrays.toString(strArr)));
        }

        public Snapshot snapshot() {
            if (Thread.holdsLock(DiskLruCache.this)) {
                WF[] wfArr = new WF[DiskLruCache.this.valueCount];
                ...
                while (true) {
                    try {
                        ...
                        if (i2 >= diskLruCache.valueCount) {
                            return new Snapshot(this.key, this.sequenceNumber, wfArr, jArr);
                        }
                        wfArr[i2] = diskLruCache.fileSystem.source(this.cleanFiles[i2]);
                        i2++;
                    } catch (FileNotFoundException unused) {
                        while (i < DiskLruCache.this.valueCount && wfArr[i] != null) {
                            Util.closeQuietly(wfArr[i]);
                            i++;
                        }
                        return null;
                    }
        ...
        public void writeLengths(Du du) throws IOException {
    ...
    public final class Snapshot implements Closeable {
        ...
        public final WF[] sources;

        @Override // java.io.Closeable, java.lang.AutoCloseable
        public void close() {
            for (WF wf : this.sources) {
                Util.closeQuietly(wf);
            }
        }
        ...
        public Snapshot(String str, long j, WF[] wfArr, long[] jArr) {
            this.key = str;
    ...
    private synchronized void completeEdit(Editor editor, boolean z) throws IOException {
        ...
        if (entry.currentEditor == editor) {
            ...
            if (entry.readable || z) {
                entry.readable = true;
                Du du = this.journalWriter;
                du.A44(CLEAN);
                du.A3y(32);
                this.journalWriter.A44(entry.key);
                entry.writeLengths(this.journalWriter);
                this.journalWriter.A3y(10);
                if (z) {
    ...
    private synchronized void rebuildJournal() throws IOException {
        ...
        AnonymousClass8i r4 = new AnonymousClass8i(this.fileSystem.sink(this.journalFileTmp));
        try {
            r4.A44(MAGIC);
            r4.A3y(10);
            r4.A44(VERSION_1);
            r4.A3y(10);
            r4.A3z((long) this.appVersion);
            r4.A3y(10);
            r4.A3z((long) this.valueCount);
            r4.A3y(10);
            r4.A3y(10);
    ...
    private Du newJournalWriter() throws FileNotFoundException {
        return new AnonymousClass8i(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) {
    ...
    private void readJournal() throws IOException {
        C00148h r2 = new C00148h(this.fileSystem.source(this.journalFile));
        try {
            String A3B = r2.A3B();
            String A3B2 = r2.A3B();
            String A3B3 = r2.A3B();
            String A3B4 = r2.A3B();
            String A3B5 = r2.A3B();
            if (!MAGIC.equals(A3B) || !VERSION_1.equals(A3B2) || !Integer.toString(this.appVersion).equals(A3B3) || !Integer.toString(this.valueCount).equals(A3B4) || !"".equals(A3B5)) {
                StringBuilder sb = new StringBuilder();
    ...
    private void validateKey(String str) {
        if (!LEGAL_KEY_PATTERN.matcher(str).matches()) {
            throw new IllegalArgumentException(AnonymousClass06.A04("keys must match regex [a-z0-9_-]{1,120}: \"", str, "\""));
        }
    }
    ...
    private synchronized com.squareup.okhttp.internal.DiskLruCache.Editor edit(java.lang.String r7, long r8) throws java.io.IOException {
        ...
        L_0x0024:
            ...
            goto L_0x005b
        L_0x0029:
            X.Du r1 = r6.journalWriter     // Catch:{ all -> 0x005d }
            java.lang.String r0 = "DIRTY"
            r1.A44(r0)     // Catch:{ all -> 0x005d }
            r0 = 32
            r1.A3y(r0)     // Catch:{ all -> 0x005d }
            r1.A44(r7)     // Catch:{ all -> 0x005d }
            r0 = 10
            r1.A3y(r0)     // Catch:{ all -> 0x005d }
            X.Du r0 = r6.journalWriter     // Catch:{ all -> 0x005d }
