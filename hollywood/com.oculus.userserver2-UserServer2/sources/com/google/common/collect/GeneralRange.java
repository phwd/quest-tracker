...
public final class GeneralRange<T> implements Serializable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x005b, code lost:
        if (r9.upperBoundType == com.google.common.collect.BoundType.OPEN) goto L_0x0022;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0072, code lost:
        if (r9.lowerBoundType == com.google.common.collect.BoundType.OPEN) goto L_0x0014;
     */
                ...
                if (boundType2 != null) {
                    ...
                    if (z && z2) {
                        ...
                        if (compare == 0) {
                            ...
                            if (!(boundType != boundType3) && !(boundType2 == boundType3 ? false : z3)) {
