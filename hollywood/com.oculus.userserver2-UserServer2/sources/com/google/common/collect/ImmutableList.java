...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    public static final MO<Object> A00 = new AnonymousClass6o(RegularImmutableList.A02, 0);
    ...
    public static class ReverseImmutableList<E> extends ImmutableList<E> {
        ...
        @Override // com.google.common.collect.ImmutableList
        public final ImmutableList<E> A0I() {
            return this.A00;
        }
        ...
        public final ImmutableList<E> subList(int i, int i2) {
            ...
            return this.A00.subList(A01(i2), A01(i)).A0I();
        }
    ...
    public static class SerializedForm implements Serializable {
        ...
        public Object readResolve() {
            return ImmutableList.A0B(this.elements);
        }
    ...
    private final ImmutableList<E> A07(int i, int i2) {
        return new SubList(i, i2 - i);
    }

    public static <E> ImmutableList<E> A0A(Object[] objArr) {
        return A0D(objArr, objArr.length);
    }

    public static <E> ImmutableList<E> A0B(E[] eArr) {
        if (eArr.length == 0) {
            return of();
        }
        return A0C((Object[]) eArr.clone());
    }

    public static <E> ImmutableList<E> A0C(Object... objArr) {
    ...
    /* renamed from: A0K */
    public final MO<E> listIterator() {
    ...
    public static ImmutableList A03() {
        return A0C(UserAgentBuilder.FB_DEVICE_WIDE_STATE, UserAgentBuilder.FB_APP_VERSION_MAP);
    }

    /* JADX WARN: Incorrect args count in method signature: <E:Ljava/lang/Object;>(TE;TE;TE;)Lcom/google/common/collect/ImmutableList<TE;>; */
    public static ImmutableList A04() {
        return A0C("android.intent.action.PACKAGE_ADDED", "android.intent.action.PACKAGE_REMOVED", "android.intent.action.PACKAGE_REPLACED");
    }
    ...
    public static ImmutableList A05() {
        return A0C(UserAgentBuilder.FB_BRAND, UserAgentBuilder.FB_BUILD_VERSION, UserAgentBuilder.FB_CPU_ABI, UserAgentBuilder.FB_MANUFACTURER, UserAgentBuilder.FB_PACKAGE_NAME);
    }
    ...
    public static ImmutableList A06() {
        return A0C(UserAgentBuilder.FB_APP_NAME, UserAgentBuilder.FB_APP_VERSION, UserAgentBuilder.FB_DEVICE, UserAgentBuilder.FB_CARRIER, UserAgentBuilder.FB_LOCALE, UserAgentBuilder.FB_SYSTEM_VERSION);
    }

    public static <E> ImmutableList<E> A09(Collection<? extends E> collection) {
        if (!(collection instanceof ImmutableCollection)) {
            return A0C(collection.toArray());
        }
        ImmutableList<E> A0G = ((ImmutableCollection) collection).A0G();
        if (A0G.A0E()) {
            return A0A(A0G.toArray());
        }
        return A0G;
    }

    public static <E> ImmutableList<E> A0D(Object[] objArr, int i) {
        if (i == 0) {
            return of();
        }
    ...
    public static <E> ImmutableList<E> A08(E e) {
        return A0C(e);
    }

    /* access modifiers changed from: private */
    /* renamed from: A0L */
    public final MO<E> listIterator(int i) {
        int size = size();
        if (i >= 0 && i <= size) {
            return isEmpty() ? (MO<E>) A00 : new AnonymousClass6o(this, i);
        }
    ...
    public static final class Builder<E> extends N8<E> {
        public Builder() {
            this(4);
        }
        ...
        public ImmutableList<E> build() {
            this.A01 = true;
            return ImmutableList.A0D(this.A02, this.A00);
        }
    }
}
