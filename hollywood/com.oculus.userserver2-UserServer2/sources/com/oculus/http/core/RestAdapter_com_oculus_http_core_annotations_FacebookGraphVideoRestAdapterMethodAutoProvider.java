...
public class RestAdapter_com_oculus_http_core_annotations_FacebookGraphVideoRestAdapterMethodAutoProvider extends AbstractC0029Ba<RestAdapter> {
    public final Object get() {
        RestAdapter.Builder builder = new RestAdapter.Builder();
        builder.setEndpoint((String) IX.A00(31, this));
