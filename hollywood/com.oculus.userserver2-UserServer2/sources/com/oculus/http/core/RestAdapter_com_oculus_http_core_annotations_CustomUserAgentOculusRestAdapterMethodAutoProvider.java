...
public class RestAdapter_com_oculus_http_core_annotations_CustomUserAgentOculusRestAdapterMethodAutoProvider extends AbstractC0029Ba<RestAdapter> {
    public final Object get() {
        RestAdapter.Builder builder = new RestAdapter.Builder();
        builder.setEndpoint((String) IX.A00(60, this));
        builder.setErrorHandler((ErrorHandler) IX.A00(82, this));
        builder.setClient(new K1((AbstractC0054Ej) IX.A00(34, this)));
