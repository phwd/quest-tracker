...
public class RestAdapter_com_oculus_http_core_annotations_FacebookGraphRestAdapterMethodAutoProvider extends AbstractC0029Ba<RestAdapter> {
    public final Object get() {
        RestAdapter.Builder builder = new RestAdapter.Builder();
        builder.setEndpoint((String) IX.A00(47, this));
