...
public interface BindingStrategy {
    public static final BindingStrategy DEFAULT = new BindingStrategy() {
        ...
        public final boolean A15(Context context, Intent intent, ServiceConnection serviceConnection, int i) {
            return context.bindService(intent, serviceConnection, i);
        }
    };

    boolean A15(Context context, Intent intent, ServiceConnection serviceConnection, int i);
}
