...
public final class AnonymousClass39 implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    public int A00;
    public int A01;
    public boolean A02 = false;
    public final /* synthetic */ AnonymousClass3B A03;

    public AnonymousClass39(AnonymousClass3B r2) {
        this.A03 = r2;
        this.A00 = r2.A00() - 1;
        this.A01 = -1;
    }
    ...
    public final V setValue(V v) {
        if (this.A02) {
            AnonymousClass3B r1 = this.A03;
            int i = this.A01;
            if (!(r1 instanceof UA)) {
                int i2 = (i << 1) + 1;
                Object[] objArr = ((UC) r1).A00.A02;
                V v2 = (V) objArr[i2];
                objArr[i2] = v;
                return v2;
            }
