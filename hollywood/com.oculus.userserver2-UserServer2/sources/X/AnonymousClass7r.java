...
public final class AnonymousClass7r {
    public static Field A00;
    public static Method A01;
    public static boolean A02;
    public static boolean A03;

    public static boolean A00(@NonNull AnonymousClass7q r4, @Nullable View view, @Nullable Window.Callback callback, @NonNull KeyEvent keyEvent) {
        ...
        if (callback instanceof Activity) {
            ...
            if (AnonymousClass8Q.A00(decorView, keyEvent)) {
                return true;
            }
            if (decorView != null) {
            ...
            return (view != null && AnonymousClass8Q.A00(view, keyEvent)) || r4.superDispatchKeyEvent(keyEvent);
        } else {
            ...
            if (AnonymousClass8Q.A00(decorView2, keyEvent)) {
                return true;
            }
            if (decorView2 != null) {
