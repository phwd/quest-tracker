...
/* renamed from: X.85  reason: invalid class name */
public final class AnonymousClass85 implements View.OnAttachStateChangeListener, ViewTreeObserver.OnPreDrawListener {
    ...
    public static void A00(@NonNull View view, @NonNull Runnable runnable) {
        if (view != null) {
            AnonymousClass85 r1 = new AnonymousClass85(view, runnable);
    ...
    public AnonymousClass85(View view, Runnable runnable) {
        this.A01 = view;
