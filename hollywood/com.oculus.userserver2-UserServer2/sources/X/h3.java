...
public final class h3 implements Closeable, Flushable {
    ...
    private void A01(int i, int i2, String str) throws IOException {
        ...
        if (i3 != 0) {
            ...
            if (i5 == i2 || i5 == i) {
                ...
                str2 = AnonymousClass06.A03("Dangling name: ", str3);
            } else {
    ...
    public static void A02(h3 h3Var) throws IOException {
        String str;
        int i = h3Var.A00;
        if (i != 0) {
            int[] iArr = h3Var.A05;
            ...
            if (i3 != 1) {
                if (i3 == 2) {
                    ...
                    h3Var.A07.append((CharSequence) h3Var.A01);
                    h3Var.A05[h3Var.A00 - 1] = 5;
                    return;
                }
            }
            iArr[i2] = i4;
    ...
    public static void A03(h3 h3Var) throws IOException {
        String str;
        if (h3Var.A06 != null) {
            int i = h3Var.A00;
            if (i != 0) {
                int i2 = h3Var.A05[i - 1];
                if (i2 == 5) {
                    h3Var.A07.write(44);
                } else if (i2 != 3) {
                    str = "Nesting problem.";
                }
                h3Var.A05[h3Var.A00 - 1] = 4;
                h3Var.A04(h3Var.A06);
                h3Var.A06 = null;
                return;
            }
    ...
    private void A04(java.lang.String r9) throws java.io.IOException {
        ...
        L_0x0047:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.h3.A04(java.lang.String):void");
    }
