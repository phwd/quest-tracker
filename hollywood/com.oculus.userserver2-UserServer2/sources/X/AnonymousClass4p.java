...
/* renamed from: X.4p  reason: invalid class name */
public final class AnonymousClass4p {
    ...
    @RequiresApi(20)
    public static RemoteInput[] A00(AnonymousClass4p[] r7) {
        int length = r7.length;
        RemoteInput[] remoteInputArr = new RemoteInput[length];
        for (int i = 0; i < length; i++) {
            AnonymousClass4p r6 = r7[i];
    ...
    public AnonymousClass4p(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z, int i, Bundle bundle) {
        this.A03 = str;
