...
public final class gt {
    ...
    public static boolean A07(java.lang.reflect.Type r3, java.lang.reflect.Type r4) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: X.gt.A07(java.lang.reflect.Type, java.lang.reflect.Type):boolean");
    }

    public static <T> gx<T> A00(gx<T> gxVar) {
        Type type = gxVar.type;
        if (!A06(type)) {
            StringBuilder sb = new StringBuilder("Key not fully specified ");
            sb.append(gxVar);
            throw new RuntimeException(sb.toString());
        } else if (gxVar.rawType == AbstractC0192Xx.class) {
            return new gx<>(new K7(null, AbstractC0192Xx.class, ((ParameterizedType) type).getActualTypeArguments()[0]));
        } else {
            return gxVar;
        }
    }
    ...
    public static Type A03(Type type) {
        if (type instanceof Class) {
            ...
            Type type2 = cls;
            if (isArray) {
                type2 = new K8(A03(cls.getComponentType()));
            }
            return type2;
        }
        if (!(type instanceof gu)) {
            if (type instanceof ParameterizedType) {
                ParameterizedType parameterizedType = (ParameterizedType) type;
                return new K7(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
            } else if (type instanceof GenericArrayType) {
                return new K8(((GenericArrayType) type).getGenericComponentType());
            } else {
                if (type instanceof WildcardType) {
                    WildcardType wildcardType = (WildcardType) type;
                    return new K6(wildcardType.getUpperBounds(), wildcardType.getLowerBounds());
                }
            }
        }
        return type;
    ...
    public static void A05(java.lang.reflect.Type r2, java.lang.String r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.gt.A05(java.lang.reflect.Type, java.lang.String):void");
    }
