...
public class AnonymousClass8D implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
                ...
                if (z && ((AccessibilityManager) key.getContext().getSystemService("accessibility")).isEnabled()) {
                    ...
                    if (key.getAccessibilityLiveRegion() != 0 || (z2 && key.getVisibility() == 0)) {
                        ...
                        try {
                            ...
                            Log.e("ViewCompat", AnonymousClass06.A03(key.getParent().getClass().getSimpleName(), " does not fully implement ViewParent"), e);
                        }
                    }
                }
