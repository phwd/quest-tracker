...
public final class Aj extends FrameLayout {
    ...
    public Aj(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull Au au) {
        super(context, attributeSet);
        String str;
        String str2;
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, AP.A01);
        classAttribute = classAttribute == null ? obtainStyledAttributes.getString(0) : classAttribute;
        String string = obtainStyledAttributes.getString(1);
        obtainStyledAttributes.recycle();
        int id = getId();
        Fragment A0F = au.A0F(id);
        if (classAttribute != null && A0F == null) {
            if (id <= 0) {
                if (string != null) {
                    str2 = AnonymousClass06.A03(" with tag ", string);
                } else {
                    str2 = "";
                }
                str = AnonymousClass06.A04("FragmentContainerView must have an android:id to add Fragment ", classAttribute, str2);
            } else {
                Fragment A012 = au.A0I().A01(context.getClassLoader(), classAttribute);
                A012.A02();
                Ts ts = new Ts(au);
                ts.A0E = true;
                A012.A0B = this;
                ts.A00(getId(), A012, string, 1);
                if (!ts.A0D) {
                    Au au2 = ts.A01;
                    if (au2.A05 != null && !au2.A0C) {
                        Au.A0A(au2, true);
                        if (ts.A1a(au2.A0A, au2.A09)) {
                            au2.A0D = true;
                            try {
                                Au.A09(au2, au2.A0A, au2.A09);
                            } finally {
                                Au.A02(au2);
                            }
                        }
                        ...
                        au2.A0O.A01.values().removeAll(Collections.singleton(null));
                        return;
                    }
                    return;
                }
