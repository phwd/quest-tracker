...
public class RB<K> {
    ...
    public static int A01(@NullableDecl RB rb, Object obj, int i) {
        int[] iArr = rb.A04;
        ...
        if (i2 != -1) {
            int i3 = -1;
            while (true) {
                if (((int) (rb.A06[i2] >>> 32)) != i || !Objects.equal(obj, rb.A07[i2])) {
                    int i4 = (int) rb.A06[i2];
                    if (i4 == -1) {
                        break;
                    }
                    i3 = i2;
    ...
    public final int A02() {
        if (this instanceof C0103Ma) {
            int i = ((C0103Ma) this).A00;
            if (i == -2) {
                return -1;
            }
            return i;
    ...
    public final int A05(@NullableDecl K k, int i) {
        if (i > 0) {
            long[] jArr = this.A06;
    ...
    public void A0A(int i, @NullableDecl K k, int i2, int i3) {
        this.A06[i] = (((long) i3) << 32) | 4294967295L;
        this.A07[i] = k;
        this.A05[i] = i2;
    }

    public final int A04(@NullableDecl Object obj) {
        int A022 = Qc.A02(obj);
        int[] iArr = this.A04;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: X.RB<K> */
    /* JADX WARN: Multi-variable type inference failed */
    public RB(RB<? extends K> rb) {
        A09(rb.A02, 1.0f);
        int A022 = rb.A02();
        while (A022 != -1) {
            Preconditions.checkElementIndex(A022, rb.A02);
            Object obj = rb.A07[A022];
            Preconditions.checkElementIndex(A022, rb.A02);
            A05(obj, rb.A05[A022]);
            A022 = rb.A03(A022);
        }
