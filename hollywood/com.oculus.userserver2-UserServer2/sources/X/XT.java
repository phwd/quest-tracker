...
public final class XT {
    ...
    public final String A09() {
        ...
        String str = this.A04;
        return str.substring(length, XD.A02(str, length, str.length(), ":@"));
    }

    public final List<String> A0B() {
        String str = this.A04;
        int indexOf = str.indexOf(47, this.A03.length() + 3);
        int A022 = XD.A02(str, indexOf, str.length(), "?#");
        ArrayList arrayList = new ArrayList();
        while (indexOf < A022) {
            int i = indexOf + 1;
            indexOf = i;
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof XT) || !((XT) obj).A04.equals(this.A04)) {
            return false;
        }
        return true;
    }
    ...
    public XT(XU xu) {
        ...
        this.A02 = xu.A04;
        int i = xu.A00;
        this.A00 = i == -1 ? A01(xu.A05) : i;
        this.A08 = A05(xu.A07, false);
        List<String> list2 = xu.A06;
        String str3 = null;
        if (list2 != null) {
            list = A05(list2, true);
        } else {
    ...
    public final URI A0A() {
        XU A0C = A0C();
        List<String> list = A0C.A07;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            String str = list.get(i);
            list.set(i, A02(str, 0, str.length(), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, true, true, false, true));
        }
        List<String> list2 = A0C.A06;
        if (list2 != null) {
            int size2 = list2.size();
            for (int i2 = 0; i2 < size2; i2++) {
                String str2 = A0C.A06.get(i2);
                if (str2 != null) {
                    A0C.A06.set(i2, A02(str2, 0, str2.length(), HttpUrl.QUERY_COMPONENT_ENCODE_SET_URI, true, true, true, true));
                }
            }
        }
        String str3 = A0C.A01;
        if (str3 != null) {
            A0C.A01 = A02(str3, 0, str3.length(), HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, false);
        }
    ...
    public static String A02(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            ...
            AnonymousClass8k r3 = new AnonymousClass8k();
            r3.A0G(str, i, i3);
            AnonymousClass8k r5 = null;
            while (i3 < i2) {
