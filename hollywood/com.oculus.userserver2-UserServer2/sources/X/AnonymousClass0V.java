...
@GwtIncompatible
/* renamed from: X.0V  reason: invalid class name */
public final class AnonymousClass0V extends AnonymousClass6f<Void> implements Runnable {
    ...
    public AnonymousClass0V(Runnable runnable) {
        if (runnable != null) {
            this.A00 = runnable;
            return;
        }
