...
public class K6 implements WildcardType, gu, Serializable {
    ...
    public final boolean A2B() {
        if (!gt.A06(this.upperBound)) {
            return false;
        }
        Type type = this.lowerBound;
        if (type == null || gt.A06(type)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof WildcardType) || !gt.A07(this, (Type) obj)) {
            return false;
        }
        return true;
    }
    ...
    public final String toString() {
        ...
        sb.append(gt.A02(type));
        return sb.toString();
    }

    public K6(Type[] typeArr, Type[] typeArr2) {
