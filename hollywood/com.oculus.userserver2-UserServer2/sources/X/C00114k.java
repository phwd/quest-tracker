...
/* renamed from: X.4k  reason: invalid class name and case insensitive filesystem */
public final class C00114k {
    @Nullable
    ...
    public static C00114k A00(@NonNull Person person) {
        ...
        return new C00114k(r1);
    }

    @NonNull
    public static C00114k A01(@NonNull Bundle bundle) {
        IconCompat iconCompat;
        Bundle bundle2 = bundle.getBundle("icon");
        AnonymousClass4j r2 = new AnonymousClass4j();
        r2.A01 = bundle.getCharSequence("name");
        if (bundle2 != null) {
            int i = bundle2.getInt(ExceptionUtils.KEY_TYPE);
    ...
    public final Bundle A03() {
        ...
        if (iconCompat != null) {
            ...
            bundle.putInt(ExceptionUtils.KEY_TYPE, iconCompat.A02);
    ...
    public C00114k(AnonymousClass4j r2) {
        this.A01 = r2.A01;
        this.A00 = r2.A00;
        this.A03 = r2.A03;
        this.A02 = r2.A02;
