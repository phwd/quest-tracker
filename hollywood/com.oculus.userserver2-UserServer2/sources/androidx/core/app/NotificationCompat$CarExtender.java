...
import X.AnonymousClass4T;
import X.AnonymousClass4U;
import X.AnonymousClass4p;
...
public final class NotificationCompat$CarExtender implements AnonymousClass4U {
    ...
    public AnonymousClass4T mUnreadConversation;

    @RequiresApi(21)
    public static AnonymousClass4T getUnreadConversationFromBundle(@Nullable Bundle bundle) {
        String[] strArr;
        int i;
        AnonymousClass4p r7 = null;
        if (bundle != null) {
            ...
            if (stringArray != null && stringArray.length == 1) {
                if (remoteInput != null) {
                    ...
                    r7 = new AnonymousClass4p(resultKey, label, choices, allowFreeFormInput, i, remoteInput.getExtras());
                }
                return new AnonymousClass4T(strArr, r7, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
            }
        }
        return null;
    }
    ...
    @RequiresApi(21)
    public static Bundle getBundleForUnreadConversation(@NonNull AnonymousClass4T r10) {
        String str;
    ...
    public AnonymousClass4R extend(AnonymousClass4R r4) {
        Bundle bundle = new Bundle();
        ...
        AnonymousClass4T r0 = this.mUnreadConversation;
        if (r0 != null) {
    ...
    @Deprecated
    public AnonymousClass4T getUnreadConversation() {
    ...
    @Deprecated
    public NotificationCompat$CarExtender setUnreadConversation(AnonymousClass4T r1) {
