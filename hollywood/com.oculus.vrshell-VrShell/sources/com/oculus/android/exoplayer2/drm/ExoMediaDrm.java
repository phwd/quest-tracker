...
public interface ExoMediaDrm<T extends ExoMediaCrypto> {
    ...
    public static final class DefaultKeyStatus implements KeyStatus {
        ...
        @Override // com.oculus.android.exoplayer2.drm.ExoMediaDrm.KeyStatus
    ...
    public static final class DefaultKeyRequest implements KeyRequest {
        ...
        @Override // com.oculus.android.exoplayer2.drm.ExoMediaDrm.KeyRequest
        public byte[] getData() {
            return this.data;
        }
    ...
    public static final class DefaultProvisionRequest implements ProvisionRequest {
        ...
        @Override // com.oculus.android.exoplayer2.drm.ExoMediaDrm.ProvisionRequest
        public byte[] getData() {
            return this.data;
        }
