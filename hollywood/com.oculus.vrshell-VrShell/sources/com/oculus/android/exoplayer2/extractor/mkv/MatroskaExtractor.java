...
public final class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {
        /* class com.oculus.android.exoplayer2.extractor.mkv.MatroskaExtractor.AnonymousClass1 */
    ...
    public void binaryElement(int r20, int r21, com.oculus.android.exoplayer2.extractor.ExtractorInput r22) throws java.io.IOException, java.lang.InterruptedException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oculus.android.exoplayer2.extractor.mkv.MatroskaExtractor.binaryElement(int, int, com.oculus.android.exoplayer2.extractor.ExtractorInput):void");
    }
    ...
    private final class InnerEbmlReaderOutput implements EbmlReaderOutput {
        ...
        @Override // com.oculus.android.exoplayer2.extractor.mkv.EbmlReaderOutput
        public int getElementType(int i) {
    ...
    public static final class Track {
        ...
        public void initializeOutput(ExtractorOutput extractorOutput, int i) throws ParserException {
            ...
            if (MimeTypes.isAudio(str)) {
                ...
                format = Format.createImageSampleFormat(Integer.toString(i), str, null, -1, i8, list, this.language, this.drmInitData);
            } else {
