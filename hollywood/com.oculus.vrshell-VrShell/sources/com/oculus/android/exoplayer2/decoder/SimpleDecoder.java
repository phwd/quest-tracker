...
public abstract class SimpleDecoder<I extends DecoderInputBuffer, O extends OutputBuffer, E extends Exception> implements Decoder<I, O, E> {
    ...
    protected SimpleDecoder(I[] iArr, O[] oArr) {
        ...
        this.decodeThread = new Thread() {
            /* class com.oculus.android.exoplayer2.decoder.SimpleDecoder.AnonymousClass1 */
    ...
    private boolean decode() throws java.lang.InterruptedException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oculus.android.exoplayer2.decoder.SimpleDecoder.decode():boolean");
    }
