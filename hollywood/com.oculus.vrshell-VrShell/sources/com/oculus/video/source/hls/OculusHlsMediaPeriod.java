...
import com.oculus.android.exoplayer2.source.hls.TimestampAdjusterProvider;
...
import com.oculus.video.source.hls.HlsSampleStreamWrapper;
...
public final class OculusHlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback, OculusHlsPlaylistTracker.PlaylistEventListener {
    ...
    private OculusHlsPlaylistTracker.PlaylistEventListener playlistEventListener;
    private final OculusHlsPlaylistTracker playlistTracker;
    ...
    public OculusHlsMediaPeriod(HlsExtractorFactory hlsExtractorFactory, OculusHlsPlaylistTracker oculusHlsPlaylistTracker, HlsDataSourceFactory hlsDataSourceFactory, int i, MediaSourceEventListener.EventDispatcher eventDispatcher2, Allocator allocator2, OculusHlsPlaylistTracker.PlaylistEventListener playlistEventListener2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory2, boolean z) {
        this.extractorFactory = hlsExtractorFactory;
        this.playlistTracker = oculusHlsPlaylistTracker;
        ...
        this.playlistEventListener = playlistEventListener2;
    }
    ...
    public long selectTracks(com.oculus.android.exoplayer2.trackselection.TrackSelection[] r21, boolean[] r22, com.oculus.android.exoplayer2.source.SampleStream[] r23, boolean[] r24, long r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oculus.video.source.hls.OculusHlsMediaPeriod.selectTracks(com.oculus.android.exoplayer2.trackselection.TrackSelection[], boolean[], com.oculus.android.exoplayer2.source.SampleStream[], boolean[], long):long");
    }
    ...
    @Override // com.oculus.video.source.hls.HlsSampleStreamWrapper.Callback
    ...
    public void onPlaylistChanged(IdentityHashMap<HlsMasterPlaylist.HlsUrl, OculusHlsPlaylistTracker.MediaPlaylistBundle> identityHashMap) {
        ...
        this.playlistEventListener.onPlaylistChanged(identityHashMap);
    }
