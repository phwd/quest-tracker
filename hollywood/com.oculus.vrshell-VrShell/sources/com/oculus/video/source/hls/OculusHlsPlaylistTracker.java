...
public final class OculusHlsPlaylistTracker implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    private static final double PLAYLIST_STUCK_TARGET_DURATION_COEFFICIENT = 3.5d;
    private final HlsDataSourceFactory dataSourceFactory;
    private final MediaSourceEventListener.EventDispatcher eventDispatcher;
    private final Loader initialPlaylistLoader = new Loader("OculusHlsPlaylistTracker:MasterPlaylist");
    ...
    public interface PlaylistEventListener {
        ...
        void onPlaylistChanged(IdentityHashMap<HlsMasterPlaylist.HlsUrl, MediaPlaylistBundle> identityHashMap);
    }

    public interface PrimaryPlaylistListener {
        void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist, HlsMasterPlaylist.HlsUrl hlsUrl, HlsMasterPlaylist hlsMasterPlaylist);
    }
    ...
    public OculusHlsPlaylistTracker(Uri uri, HlsDataSourceFactory hlsDataSourceFactory, MediaSourceEventListener.EventDispatcher eventDispatcher2, int i, PrimaryPlaylistListener primaryPlaylistListener2, ParsingLoadable.Parser<HlsPlaylist> parser) {
    ...
    private void onPlaylistUpdated(HlsMasterPlaylist.HlsUrl hlsUrl, HlsMediaPlaylist hlsMediaPlaylist) {
        if (hlsUrl == this.primaryHlsUrl) {
            ...
            this.primaryPlaylistListener.onPrimaryPlaylistRefreshed(hlsMediaPlaylist, this.primaryHlsUrl, this.masterPlaylist);
        }
        int size = this.listeners.size();
        for (int i = 0; i < size; i++) {
            this.listeners.get(i).onPlaylistChanged(this.playlistBundles);
        }
    }
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>>, Runnable {
        ...
        private final Loader mediaPlaylistLoader = new Loader("OculusHlsPlaylistTracker:MediaPlaylist");
        ...
        public MediaPlaylistBundle(HlsMasterPlaylist.HlsUrl hlsUrl) {
            ...
            this.mediaPlaylistLoadable = new ParsingLoadable<>(OculusHlsPlaylistTracker.this.dataSourceFactory.createDataSource(4), UriUtil.resolveToUri(OculusHlsPlaylistTracker.this.masterPlaylist.baseUri, hlsUrl.url), 4, OculusHlsPlaylistTracker.this.playlistParser);
        }
        ...
        public void loadPlaylist() {
            ...
            if (!this.loadPending && !this.mediaPlaylistLoader.isLoading()) {
                ...
                if (elapsedRealtime < this.earliestNextLoadTimeMs) {
                    ...
                    OculusHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(this, this.earliestNextLoadTimeMs - elapsedRealtime);
                    return;
                }
        ...
        public void onLoadCompleted(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2) {
            ...
            if (result instanceof HlsMediaPlaylist) {
                ...
                OculusHlsPlaylistTracker.this.eventDispatcher.loadCompleted(parsingLoadable.dataSpec, 4, j, j2, parsingLoadable.bytesLoaded());
                return;
            }
        ...
        public void onLoadCanceled(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, boolean z) {
            OculusHlsPlaylistTracker.this.eventDispatcher.loadCanceled(parsingLoadable.dataSpec, 4, j, j2, parsingLoadable.bytesLoaded());
        }

        public int onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2, IOException iOException) {
            boolean z = iOException instanceof ParserException;
            OculusHlsPlaylistTracker.this.eventDispatcher.loadError(parsingLoadable.dataSpec, 4, j, j2, parsingLoadable.bytesLoaded(), iOException, z);
            if (z) {
                return 3;
            }
            boolean z2 = true;
        ...
        private void loadPlaylistImmediately() {
            this.mediaPlaylistLoader.startLoading(this.mediaPlaylistLoadable, this, OculusHlsPlaylistTracker.this.minRetryCount);
        }
        ...
        private void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist) {
            ...
            this.playlistSnapshot = OculusHlsPlaylistTracker.this.getLatestPlaylistSnapshot(hlsMediaPlaylist2, hlsMediaPlaylist);
            HlsMediaPlaylist hlsMediaPlaylist3 = this.playlistSnapshot;
            if (hlsMediaPlaylist3 != hlsMediaPlaylist2) {
                this.playlistError = null;
                this.lastSnapshotChangeMs = elapsedRealtime;
                OculusHlsPlaylistTracker.this.onPlaylistUpdated(this.playlistUrl, hlsMediaPlaylist3);
                ...
                } else if (((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) C.usToMs(this.playlistSnapshot.targetDurationUs)) * OculusHlsPlaylistTracker.PLAYLIST_STUCK_TARGET_DURATION_COEFFICIENT) {
            ...
            if (this.playlistUrl == OculusHlsPlaylistTracker.this.primaryHlsUrl && !this.playlistSnapshot.hasEndTag) {
                loadPlaylist();
            }
        }
        ...
        private boolean blacklistPlaylist() {
            ...
            OculusHlsPlaylistTracker.this.notifyPlaylistBlacklisting(this.playlistUrl, ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            return OculusHlsPlaylistTracker.this.primaryHlsUrl == this.playlistUrl && !OculusHlsPlaylistTracker.this.maybeSelectNewPrimaryUrl();
        }
    }
}
