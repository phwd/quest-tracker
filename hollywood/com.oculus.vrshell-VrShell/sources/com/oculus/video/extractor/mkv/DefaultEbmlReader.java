...
public final class DefaultEbmlReader implements EbmlReader {
    ...
    @Override // com.oculus.video.extractor.mkv.EbmlReader
            ...
            if (this.masterElementsStack.isEmpty() || extractorInput.getPosition() < this.masterElementsStack.peek().elementEndPosition) {
                ...
                switch (elementType) {
                    ...
                    case 6:
                        ...
                        if (j4 <= 2147483647L) {
                            this.output.stringElement(this.elementId, readUTF8String(extractorInput, (int) j4));
                            this.elementState = 0;
                            return true;
                        }
                        throw new ParserException("String element size: " + this.elementContentSize);
    ...
    private String readUTF8String(ExtractorInput extractorInput, int i) throws IOException, InterruptedException {
        if (i == 0) {
            return "";
        }
        byte[] bArr = new byte[i];
