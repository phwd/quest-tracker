...
import com.oculus.android.exoplayer2.extractor.ts.ElementaryStreamReader;
...
public final class OculusH264Reader implements ElementaryStreamReader {
    ...
    public OculusH264Reader(SeiReader seiReader2, boolean z, boolean z2, Format format2) {
        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!this.hasOutputFormat) {
                if (this.sps.isCompleted() && this.pps.isCompleted()) {
                    ...
                    this.output.format(Format.createVideoSampleFormat(this.formatId, MimeTypes.VIDEO_H264, null, format2 != null ? format2.bitrate : -1, -1, parseSpsNalUnit.width, parseSpsNalUnit.height, -1.0f, arrayList, -1, parseSpsNalUnit.pixelWidthAspectRatio, null));
    ...
    public static final class SampleReader {
        ...
        public void appendToNalUnit(byte[] r24, int r25, int r26) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.oculus.video.extractor.hls.OculusH264Reader.SampleReader.appendToNalUnit(byte[], int, int):void");
        }
