...
import com.oculus.android.exoplayer2.upstream.cache.CacheSpan;
...
public final class OculusCacheDataSource implements DataSource {
    ...
    public OculusCacheDataSource(DataSource dataSource, Callback callback2) {
        this(dataSource, 0, 2097152, callback2);
    }

    public OculusCacheDataSource(DataSource dataSource, int i, long j, Callback callback2) {
        this(dataSource, new FileDataSource(), i, j, callback2);
    }

    public OculusCacheDataSource(DataSource dataSource, DataSource dataSource2, int i, long j, Callback callback2) {
        Cache cache2;
        ...
        if (callback2 == null) {
            ...
            cache2 = callback2.getCache();
        }
        this.cache = cache2;
        this.cacheWriteDataSource = new TeeDataSource(dataSource, new CacheDataSink(this.cache, j));
    ...
    public long open(DataSpec dataSpec) throws IOException {
        try {
            ...
            boolean z = true;
            boolean z2 = this.callback != null && this.callback.getCurrentPositionMs() >= 0 && this.callback.getCurrentPositionMs() <= 2500;
            ...
            handleBeforeThrow(e);
            if (this.currentDataSource == this.cacheReadDataSource && this.ignoreCacheOnError) {
