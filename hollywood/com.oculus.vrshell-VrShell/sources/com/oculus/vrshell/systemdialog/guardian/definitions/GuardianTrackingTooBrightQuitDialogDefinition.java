...
public final class GuardianTrackingTooBrightQuitDialogDefinition extends GuardianTrackingErrorDialogDefinition {
    public GuardianTrackingTooBrightQuitDialogDefinition(Context context) {
        super(context, new DialogDefinitionCustom(GuardianDialogDefinitions.getGuardianDialogId(GuardianDialogType.TRACKING_TOO_BRIGHT_QUIT), context.getResources().getString(R.string.guardian_error_tracking), context.getResources().getString(R.string.guardian_tracking_too_bright_quit)).setSecondaryButton(new DialogButtonText(GuardianDialogActions.QUIT_APPLICATION, context.getResources().getString(R.string.guardian_btn_quit_app))));
    }
}
