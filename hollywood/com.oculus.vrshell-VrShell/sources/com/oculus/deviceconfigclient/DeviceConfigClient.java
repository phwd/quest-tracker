            ...
            try {
                ...
                while (true) {
                    ...
                    if (!this.mAsyncFetchInstance.doWork()) {
                        if (DeviceConfigClient.getTimeNowInMs() - timeNowInMs > ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS && DeviceConfigClient.this.clearAsyncFetch(this.mAsyncFetchInstance, true)) {
