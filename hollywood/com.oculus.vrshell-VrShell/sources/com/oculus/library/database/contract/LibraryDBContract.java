...
public abstract class LibraryDBContract {
    ...
    public static abstract class Columns {
        ...
        public static Column NAME = new Column(ServiceContract.EXTRA_NAME, "TEXT");
        @Deprecated
        ...
        public static Column STATUS = new Column(NotificationCompat.CATEGORY_STATUS, "TEXT");
        ...
        public static Column USER_ID = new Column(ServiceContract.EXTRA_USER_ID, "TEXT");
        @Deprecated
