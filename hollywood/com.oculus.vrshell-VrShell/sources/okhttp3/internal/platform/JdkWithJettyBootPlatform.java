...
public class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(cls.getMethod("put", SSLSocket.class, cls2), cls.getMethod(MobileConfigServiceConstants.PATH_GET, SSLSocket.class), cls.getMethod("remove", SSLSocket.class), cls3, cls4);
