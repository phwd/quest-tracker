...
class MediaLibraryService2ImplBase extends MediaSessionService2ImplBase {
    @Override // android.support.v4.media.MediaSessionService2ImplBase
    ...
    public android.os.IBinder onBind(android.content.Intent r5) {
        ...
        L_0x0029:
            ...
            android.os.IBinder r4 = super.onBind(r5)
            return r4
        L_0x0032:
            android.support.v4.media.MediaLibraryService2$MediaLibrarySession r4 = r4.getSession()
            android.support.v4.media.MediaLibraryService2$MediaLibrarySession$SupportLibraryImpl r4 = r4.getImpl()
            android.os.IBinder r4 = r4.getLegacySessionBinder()
            return r4
        L_0x003f:
            android.support.v4.media.MediaLibraryService2$MediaLibrarySession r4 = r4.getSession()
            android.os.IBinder r4 = r4.getSessionBinder()
            return r4
        */
