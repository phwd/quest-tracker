        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (((ViewGroup.MarginLayoutParams) layoutParams).width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(((ViewGroup.MarginLayoutParams) layoutParams).width, 1073741824);
                }
                if (((ViewGroup.MarginLayoutParams) layoutParams).height == -2) {
                    ...
                    i12 = View.MeasureSpec.makeMeasureSpec(((ViewGroup.MarginLayoutParams) layoutParams).height, 1073741824);
                }
            ...
            while (i18 < childCount) {
                ...
                if (childAt2.getVisibility() != i5) {
                    ...
                    if (childAt2.getVisibility() != i5) {
                        ...
                        } else if (((ViewGroup.MarginLayoutParams) layoutParams2).width < 0 && (i7 > i17 || layoutParams2.weight > 0.0f)) {
                            if (!z5) {
                                i9 = 1073741824;
                                ...
                                i9 = 1073741824;
                                i10 = View.MeasureSpec.makeMeasureSpec(((ViewGroup.MarginLayoutParams) layoutParams2).height, 1073741824);
                            }
