...
public enum InstallerResultError {
    ...
    AUTHORIZATION_ERROR(30);
    
    public static final int INVALID_VALUE = 0;
    public final int code;

    private InstallerResultError(int code2) {
        this.code = code2;
    }

    public static InstallerResultError fromInt(int code2) {
        InstallerResultError[] values = values();
        for (InstallerResultError ovrError : values) {
            if (ovrError.code == code2) {
                return ovrError;
            }
        }
        Log.w(InstallerResultError.class.getSimpleName(), "Unable to parse error from code: " + code2);
