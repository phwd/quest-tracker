...
public class ApkUpdateInfoContract {
    ...
    public enum UpdateType implements IntegerBasedEnum {
        ...
        public static UpdateType fromInt(int code) {
            return (UpdateType) ApkUpdateInfoContract.fromEnumInt(UpdateType.class, code);
        }

        public boolean isOfType(int type) {
            return ((this.mCode & -65536) & type) != 0;
        }
    ...
    public enum UpdateState implements IntegerBasedEnum, Comparator<UpdateState> {
        ...
        private UpdateState(int code) {
            this.mCode = code;
        }

        public int compare(UpdateState lhs, UpdateState rhs) {
            return (rhs.asInt() & 65535) - (lhs.asInt() & 65535);
        }

        public int compare(UpdateState compareTo) {
        ...
        public static UpdateState fromInt(int code) {
            return (UpdateState) ApkUpdateInfoContract.fromEnumInt(UpdateState.class, code);
        }
    ...
    /* access modifiers changed from: private */
    public static <T extends Enum & IntegerBasedEnum> T fromEnumInt(Class<T> enumClass, int code) {
        ...
        throw new IllegalArgumentException(enumClass.getSimpleName() + " int : " + code);
    }
