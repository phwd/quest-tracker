    ...
    public void fetchFBConnectAccount(final int callbackID) {
        ThreadExecutor.getInstance().execute(new Callable<String>() {
            ...
            public String call() {
                ...
                Cursor cursor = null;
                try {
                    Cursor cursor2 = SocialModule.mFBConnectContentResolver.query(SocialModule.HORIZON_CONTENT_URI, new String[]{"userid", "user_name", "accesstoken", "profile_picture"}, null, null, null);
                    if (cursor2 != null) {
    ...
    private void fetchAccessToken(final String ocAppId, final String fbAppId, final int callbackID) {
        ThreadExecutor.getInstance().execute(new Callable<String>() {
            ...
            public void onFailure(Throwable throwable) {
                ...
                SocialModule.nativeInvokeCallback(SocialModule.this.RVRCtxTag, callbackID, XMPConst.ARRAY_ITEM_NAME);
            }
        });
    }
