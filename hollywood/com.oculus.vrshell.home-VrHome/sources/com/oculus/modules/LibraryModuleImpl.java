...
public final class LibraryModuleImpl extends LibraryModule {
    ...
    public static JSONObject convertAppToJSON(App app) throws JSONException {
        ...
        environmentSource.put("id", app.environmentSourceId);
        ...
        ThreadExecutor.getInstance().execute(new Callable<Void>() {
            ...
            public Void call() {
                try {
                    ...
                    for (ResolveInfo info : pm.queryIntentServices(new Intent("com.oculus.vrshell.SHELL_MAIN"), PropertyOptions.HAS_TYPE)) {
                    ...
                    if (displaySideloadedAppsEnabled) {
                        ...
                        for (ApplicationInfo application : pm.getInstalledApplications(PropertyOptions.HAS_TYPE)) {
    ...
    private boolean isPackageAPanelApp(String packageName, PackageManager packageManager) {
        Bundle metaData;
        for (ResolveInfo resolveInfo : packageManager.queryIntentServices(new Intent("com.oculus.vrshell.SHELL_MAIN").setPackage(packageName), PropertyOptions.HAS_TYPE)) {
