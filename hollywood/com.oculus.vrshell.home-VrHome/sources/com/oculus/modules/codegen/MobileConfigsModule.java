...
public abstract class MobileConfigsModule extends RCTBaseJavaModule {
    protected static final String MODULE_NAME = MobileConfigsModule.class.getSimpleName();
    ...
    /* access modifiers changed from: protected */
    public abstract void updateMCsImpl(Resolver<Void> resolver);
    ...
    protected static final List<Pair<String, String>> describe() {
        ...
        list.add(new Pair<>("updateMCs", "+ii"));
        return list;
    }
    ...
    /* access modifiers changed from: protected */
    public final void updateMCs(int resolveID, int rejectID) {
        updateMCsImpl(ResolverFactory.createVoidResolver(this, resolveID, rejectID));
    }
