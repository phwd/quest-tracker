...
public abstract class DialogsModule extends RCTBaseJavaModule {
    ...
    public static class DialogResult extends NativeModuleParcel {
        ...
        public static final DialogResult makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
    ...
    public static class DialogConfig extends NativeModuleParcel {
        ...
        public final JSONObject convertToJSONObject() {
            ...
            try {
                ...
                if (this.title != null) {
                    parcel.put(OculusContent.FriendList.ACTIVITY_TITLE_COLUMN, this.title);
                }
            } catch (JSONException e) {
            }
            return parcel;
        ...
        public final void setFromJSONObject(JSONObject json) {
            ...
            this.body = json.isNull(OculusContent.FriendList.MESSAGE_BODY_VALUE) ? null : json.optString(OculusContent.FriendList.MESSAGE_BODY_VALUE);
            ...
            if (!json.isNull(OculusContent.FriendList.ACTIVITY_TITLE_COLUMN)) {
                str = json.optString(OculusContent.FriendList.ACTIVITY_TITLE_COLUMN);
            }
            this.title = str;
        }
    ...
    public static class DialogInlineImage extends NativeModuleParcel {
        ...
        public static final DialogInlineImage makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            DialogInlineImage result = new DialogInlineImage();
            result.setFromJSONObject(json);
            return result;
        }
    }
    ...
    public static class DialogListItem extends NativeModuleParcel {
        ...
        public static final DialogListItem makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            DialogListItem result = new DialogListItem();
            result.setFromJSONObject(json);
            return result;
        }
    }
