...
public abstract class ControllerStateModule extends RCTBaseJavaModule {
    ...
    public static class ControllerStatusUpdate extends NativeModuleParcel {
        ...
        public static final ControllerStatusUpdate makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            ControllerStatusUpdate result = new ControllerStatusUpdate();
    ...
    public static class ControllerStatuses extends NativeModuleParcel {
        ...
        public static final ControllerStatuses makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            ControllerStatuses result = new ControllerStatuses();
            result.setFromJSONObject(json);
            return result;
        }
    }
