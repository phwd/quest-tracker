...
public abstract class WavRecorder extends Recorder {
    ...
    public void writeFileHeader(OutputStream os) throws IOException {
        ...
        os.write(new byte[]{82, 73, 70, 70, 0, 0, 0, 0, 87, 65, 86, 69, 102, 109, 116, 32, 16, 0, 0, 0, 1, 0, littleBytes[0], littleBytes[1], littleBytes[2], littleBytes[3], littleBytes[4], littleBytes[5], littleBytes[6], littleBytes[7], littleBytes[8], littleBytes[9], littleBytes[10], littleBytes[11], littleBytes[12], littleBytes[13], 100, 97, 116, 97, 0, 0, 0, 0});
    }

    /* access modifiers changed from: protected */
    @Override // com.oculus.vrshell.home.module.audio.Recorder
    public void writeFileFooter(File file) throws IOException {
        Throwable th;
        IOException ex;
