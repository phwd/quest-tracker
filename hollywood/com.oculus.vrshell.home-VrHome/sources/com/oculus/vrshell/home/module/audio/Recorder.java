...
public abstract class Recorder {
    ...
    /* access modifiers changed from: protected */
    public abstract void onRecordingStop(File file);

    /* access modifiers changed from: protected */
    public abstract void writeFileFooter(File file) throws IOException;

    /* access modifiers changed from: protected */
    public abstract void writeFileHeader(OutputStream outputStream) throws IOException;

    public Recorder(File path) {
        this.mPath = path;
    }
