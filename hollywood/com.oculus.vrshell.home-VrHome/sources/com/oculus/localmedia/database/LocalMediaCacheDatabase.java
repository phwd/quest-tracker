...
public class LocalMediaCacheDatabase {
    ...
    public Map<String, CachedMetadata> loadAllFromDatabase() {
        ...
        try {
            ...
            Cursor cursor = database.query(LocalMediaContract.ExtrasTable.TABLE_LOCALMEDIA_METADATA, new String[]{LocalMediaContract.ExtrasTable.Columns.PATH, LocalMediaContract.ExtrasTable.Columns.TYPE, LocalMediaContract.ExtrasTable.Columns.LAST_MODIFIED, LocalMediaContract.ExtrasTable.Columns.IS_360, LocalMediaContract.ExtrasTable.Columns.IS_180, LocalMediaContract.ExtrasTable.Columns.IS_3D, LocalMediaContract.ExtrasTable.Columns.IS_TB, LocalMediaContract.ExtrasTable.Columns.ORIENTATION, LocalMediaContract.ExtrasTable.Columns.HAS_AUDIO}, null, null, null, null, null);
            if (cursor != null) {
    ...
    public void put(String path, CachedMetadata metadata) {
        ...
        try {
            ...
            if (fileLastModified < Long.MAX_VALUE) {
                ...
                database.insert(LocalMediaContract.ExtrasTable.TABLE_LOCALMEDIA_METADATA, null, values);
    ...
    public void remove(String path) {
        this.mLocalMediaSQLHelper.getWritableDatabase().delete(LocalMediaContract.ExtrasTable.TABLE_LOCALMEDIA_METADATA, LocalMediaContract.ExtrasTable.Columns.PATH + " = ?", new String[]{path});
    }
