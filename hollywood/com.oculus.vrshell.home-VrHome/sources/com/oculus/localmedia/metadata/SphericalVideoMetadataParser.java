...
public class SphericalVideoMetadataParser {
    ...
    private static final String SPHERICAL_VIDEO_BOX_NAME = "sv3d";
    private static final boolean SPHERICAL_VIDEO_HEADER_V1_VR180_PROJECTION_SUPPORTED = false;
    private static final String SPHERICAL_VIDEO_STEREO_BOX_NAME = "st3d";
    ...
    private static String parseStereoMode(AbstractContainerBox parent) {
        UnknownBox box = getFirstBox(parent, SPHERICAL_VIDEO_STEREO_BOX_NAME);
        if (box != null) {
    ...
    private static String parseProjectionType(AbstractContainerBox parent) {
        UnknownBox box = getFirstBox(parent, SPHERICAL_VIDEO_BOX_NAME);
    ...
    private static void dump(AbstractContainerBox b, String prefix) {
        for (Box box : b.getBoxes()) {
            Log.d(LocalMediaManager.TAG, prefix + box.getType() + " - " + box.getClass().getSimpleName());
            if (box instanceof AbstractContainerBox) {
                dump((AbstractContainerBox) box, prefix + "    ");
            }
        }
    }
}
