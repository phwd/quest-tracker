...
public class MediaItem {
    ...
    public boolean isExternalStorage() {
        return this.mSource != null && this.mSource.equalsIgnoreCase("external_storage");
    }
    ...
    public JSONObject toJSON() {
        ...
        try {
            ...
            json.put(OculusContent.FriendList.FRIEND_REQUEST_SOURCE, getSource());
    ...
    public static class Builder {
        ...
        public static Builder from(MediaItem item) {
            Builder builder = new Builder();
            builder.mType = item.mType;
            builder.mDurationSecs = item.mDurationSecs;
            builder.mDateAdded = item.mDateAdded;
            builder.mFileSize = item.mFileSize;
            builder.mFilePath = item.mFilePath;
            builder.mInternalId = item.mInternalId;
            builder.mThumbnailFilePath = item.mThumbnailFilePath;
            builder.mRemoteFileId = item.mRemoteFileId;
            builder.mRemoteDeviceId = item.mRemoteDeviceId;
            builder.mName = item.mName;
            builder.mWidth = item.mWidth;
            builder.mHeight = item.mHeight;
            builder.mMimeType = item.mMimeType;
            builder.mSource = item.mSource;
            builder.mIsDownloadable = item.mIsDownloadable;
            builder.mDownloadUrl = item.mDownloadUrl;
            builder.mAuthHeader = item.mAuthHeader;
            builder.mLatitude = item.mLatitude;
            builder.mLongitude = item.mLongitude;
            builder.mIsPrivate = item.mIsPrivate;
            builder.mRequiresHydration = item.mRequiresHydration;
            builder.mThumbOrientation = item.mThumbOrientation;
            return builder;
        }
        ...
        public static Builder fromJson(String jsonItem) {
            ...
            try {
                ...
                builder.mSource = queryObject.getString(OculusContent.FriendList.FRIEND_REQUEST_SOURCE);
        ...
        public Builder setRemoteFileId(String fileId) {
            this.mRemoteFileId = fileId;
            return this;
        }

        public Builder setRemoteDeviceId(int deviceId) {
            this.mRemoteDeviceId = deviceId;
            return this;
        }
        ...
        public Builder setIsDownloadable(boolean isDownloadable) {
            this.mIsDownloadable = isDownloadable;
            return this;
        }
        ...
        public Builder setDownloadUrl(String downloadUrl) {
            this.mDownloadUrl = downloadUrl;
            this.mIsDownloadable = downloadUrl != null && !downloadUrl.isEmpty();
            return this;
        }

        public Builder setAuthHeader(String authHeader) {
            this.mAuthHeader = authHeader;
            return this;
        }
        ...
        public Builder setRequiresHydration(boolean requiresHydration) {
            this.mRequiresHydration = requiresHydration;
            return this;
        }

        public Builder setThumbOrientation(int thumbOrientation) {
            this.mThumbOrientation = thumbOrientation;
            return this;
        }
