...
public class MediaSmartQueryUtils {
    ...
    private static final long MONTH_SECS = 2678400;
    private static final long WEEK_SECS = 2073600;
    private static final long YEAR_SECS = 31536000;
    ...
    public static MediaQuery rewrite(MediaQuery query) {
        ...
        if (type != null) {
            ...
            switch (AnonymousClass2.$SwitchMap$com$oculus$localmedia$MediaSmartQueryType[type.ordinal()]) {
                case 5:
                    endDate = (new Date().getTime() / 1000) - DAY_SECS;
                    break;
                case 6:
                    startDate = (new Date().getTime() / 1000) - DAY_SECS;
                    endDate = (new Date().getTime() / 1000) - WEEK_SECS;
                    break;
                case 7:
                    startDate = (new Date().getTime() / 1000) - WEEK_SECS;
                    endDate = (new Date().getTime() / 1000) - MONTH_SECS;
                    break;
                case 8:
                    startDate = (new Date().getTime() / 1000) - MONTH_SECS;
                    endDate = (new Date().getTime() / 1000) - YEAR_SECS;
                    break;
                case 9:
                    startDate = (new Date().getTime() / 1000) - YEAR_SECS;
                    break;
                case 10:
                    endAlpha = "f";
                    break;
