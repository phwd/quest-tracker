...
public class FolderItem {
    ...
    public static class Builder {
        ...
        public Builder addMediaItems(ArrayList<MediaItem> items) {
            this.mItems.addAll(items);
            return this;
        }

        public Builder setCounts(MediaType type, int count) {
            this.mCounts.put(type, new FolderMediaCount(count, count));
            return this;
        }
        ...
        public Builder setActorPicture(String actorPicture) {
            this.mActorPicture = actorPicture;
            return this;
        }
