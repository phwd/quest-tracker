...
public class CoreAppAccessTokenFetcherModule extends RCTBaseJavaModule {
    ...
    public static Bundle generateArgsBundle() {
        ...
        bundle.putString("app_id", "1880592348624904");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (result.mBindError) {
                    ...
                    CoreAppAccessTokenFetcherModule.nativeInvokeCallback(CoreAppAccessTokenFetcherModule.this.RVRCtxTag, rejectID, XMPConst.ARRAY_ITEM_NAME);
                    return;
                }
                try {
                    try {
