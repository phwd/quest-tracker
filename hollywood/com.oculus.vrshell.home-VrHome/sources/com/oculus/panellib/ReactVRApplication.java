...
public class ReactVRApplication extends Application {
    ...
    public ReactVRApplication(String buildType) {
        boolean isSystraceEnabled = buildType != "release" || SystemProperties.getString("debug.reactvr.systrace.enable", OculusConstants.DEFAULT_ENTERPRISE_USER_ID).equals("1");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x005e A[ExcHandler: all (th java.lang.Throwable)] */
    ...
    private void initJni() {
        SystraceBlock block = new SystraceBlock(TAG, "initJni");
        Throwable th = null;
        try {
            SoLoader.loadLibrary("fbjni");
        } catch (Exception e) {
            Log.d(TAG, "Load JNI failed", e);
        }
        if (block == null) {
            return;
        }
