...
public class MobileConfigBaseClient {
        ...
        ContentObserver observer = new ContentObserver(new Handler(this.mContext.getMainLooper())) {
            ...
            public void onChange(boolean selfChange, Uri uri) {
                ...
                if (uri.equals(successCallbackUri)) {
                    ...
                    MobileConfigBaseClient.this.mLogger.logApiResponse("subscribe", "", true, "");
                    if (MobileConfigBaseClient.this.mQpl != null) {
                ...
                MobileConfigBaseClient.this.mLogger.logApiResponse("subscribe", "", false, splitUri[1]);
                if (MobileConfigBaseClient.this.mQpl != null) {
    ...
    public long getLongWithOptions(String configParamName, long defaultValue, MobileConfigOptions options) {
        try {
            ...
            Cursor cursor = queryMobileConfigContentProvider(configParamName, Long.toString(defaultValue), Constants.LONG_TYPE_JSON_VALUE, options2);
            if (cursor == null) {
    ...
    public String getStringWithOptions(String configParamName, String defaultValue, MobileConfigOptions options) {
        try {
            ...
            Cursor cursor = queryMobileConfigContentProvider(configParamName, defaultValue, Constants.STRING_TYPE_JSON_VALUE, options2);
            if (cursor == null) {
    ...
    public double getDoubleWithOptions(String configParamName, double defaultValue, MobileConfigOptions options) {
        try {
            ...
            Cursor cursor = queryMobileConfigContentProvider(configParamName, Double.toString(defaultValue), Constants.DOUBLE_TYPE_JSON_VALUE, options2);
            if (cursor == null) {
    ...
    public void logExposure(String loggingId, boolean isSessionLess) {
        try {
            ...
            if (client == null) {
                ...
                projection[0] = isSessionLess ? "1" : OculusConstants.DEFAULT_ENTERPRISE_USER_ID;
