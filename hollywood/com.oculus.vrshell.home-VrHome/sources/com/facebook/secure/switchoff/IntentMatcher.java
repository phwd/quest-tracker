...
public class IntentMatcher {
    ...
    public IntentMatcher(@Nullable String endpointClassNamePattern, @Nullable IntentFieldMatcher callerInfoMatcher, @Nullable UriMatcher uriMatcher, @Nullable IntentFieldMatcher intentFieldMatcher) {
        Pattern compile;
    ...
    public static boolean matches(Object endpoint, Intent intent, Context context, @Nullable IntentParser.ParsedIntent parsedIntent, @Nullable IntentMatcher[] intentMatchers) {
    ...
    public boolean matches(Object endpoint, Intent intent, Context context, @Nullable IntentParser.ParsedIntent parsedIntent) {
    ...
    private boolean matchesIntentField(@Nullable JSONObject intentContent, @Nullable Intent selectorIntent) {
    ...
    private boolean matchesUriComponent(@Nullable List<Uri> uris) {
