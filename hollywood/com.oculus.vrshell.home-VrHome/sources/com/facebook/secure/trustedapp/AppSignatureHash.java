...
public class AppSignatureHash implements Serializable {
    ...
    public AppSignatureHash(@Nullable String sha1Hash2, @Nullable String sha256Hash2) {
        this("test", sha1Hash2, sha256Hash2);
    }

    public AppSignatureHash(String name2, @Nullable String sha1Hash2, @Nullable String sha256Hash2) {
        this.name = name2;
        if (sha1Hash2 == null) {
