...
public class AppIdentity {
    ...
    public AppIdentity(int uid2, String packageName, @Nullable AppSignatureHash signatureHash2, @Nullable String versionName2, @Nullable String domainName2) {
        this(uid2, Collections.singletonList(packageName), signatureHash2, versionName2, domainName2);
    }

    public AppIdentity(int uid2, List<String> packageNames2, @Nullable AppSignatureHash signatureHash2, @Nullable String versionName2, @Nullable String domainName2) {
        this.uid = uid2;
