        ...
        if (string == null) {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    writeByte((c >> 6) | 192);
                    writeByte((c & 63) | PropertyOptions.HAS_TYPE);
                    i++;
                } else if (c < 55296 || c > 57343) {
                    writeByte((c >> 12) | 224);
                    writeByte(((c >> 6) & 63) | PropertyOptions.HAS_TYPE);
                    writeByte((c & 63) | PropertyOptions.HAS_TYPE);
                    i++;
                } else {
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        writeByte(((codePoint >> 12) & 63) | PropertyOptions.HAS_TYPE);
                        writeByte(((codePoint >> 6) & 63) | PropertyOptions.HAS_TYPE);
                        writeByte((codePoint & 63) | PropertyOptions.HAS_TYPE);
                        i += 2;
                    }
                }
            }
