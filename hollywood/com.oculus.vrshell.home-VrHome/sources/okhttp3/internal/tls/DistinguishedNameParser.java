...
public final class DistinguishedNameParser {
        ...
        while (this.pos < this.length) {
            switch (this.chars[this.pos]) {
                case ' ':
                    ...
                    break;
                case Version.VERSION_43:
                case Version.VERSION_44:
                case Version.VERSION_59:
                    return new String(this.chars, this.beg, this.end - this.beg);
                case '\\':
    ...
    private char getEscaped() {
        ...
        switch (this.chars[this.pos]) {
            ...
            case Version.VERSION_37:
            case Version.VERSION_42:
            case Version.VERSION_43:
            case Version.VERSION_44:
            case Version.VERSION_59:
            case Version.VERSION_60:
            case Version.VERSION_61:
            case Version.VERSION_62:
            case '\\':
            case '_':
