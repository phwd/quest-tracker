    ...
    public static final class Writer {
        ...
        public void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (headerIndex != -1) {
                    writeInt(headerIndex, Hpack.PREFIX_7_BITS, PropertyOptions.HAS_TYPE);
                } else if (headerNameIndex == -1) {
        ...
        public void writeByteString(ByteString data) throws IOException {
            ...
            writeInt(huffmanBytes.size(), Hpack.PREFIX_7_BITS, PropertyOptions.HAS_TYPE);
        ...
        public void setHeaderTableSizeSetting(int headerTableSizeSetting2) {
            this.headerTableSizeSetting = headerTableSizeSetting2;
            int effectiveHeaderTableSize = Math.min(headerTableSizeSetting2, (int) SETTINGS_HEADER_TABLE_SIZE_LIMIT);
