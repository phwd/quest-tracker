...
public class ActionId {
    ...
    public static String getActionName(int actionId) {
        switch (actionId) {
            ...
            case 48:
                return "QUEUED";
            case Version.VERSION_49 /*{ENCODED_INT: 49}*/:
                return "IN_PROGRESS";
            case 50:
                return "INIT";
            case Version.VERSION_51 /*{ENCODED_INT: 51}*/:
                return "UNKNOWN";
            case 52:
                return "RETRY_AFTER_FAILURE";
            case Version.VERSION_53 /*{ENCODED_INT: 53}*/:
                return "RETRY_AFTER_RECONNECT";
            case 54:
                return "QUEUEING_BEGIN";
            case Version.VERSION_55 /*{ENCODED_INT: 55}*/:
                return "QUEUEING_SUCCESS";
            case 56:
                return "QUEUEING_FAIL";
            case Version.VERSION_57 /*{ENCODED_INT: 57}*/:
            ...
            case TraceInternal.MAX_SECTION_NAME_LEN /*{ENCODED_INT: 127}*/:
