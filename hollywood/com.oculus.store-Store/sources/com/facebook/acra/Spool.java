...
public final class Spool {
    ...
    public com.facebook.acra.Spool.FileBeingProduced produceWithDonorFile(java.lang.String r14, @javax.annotation.Nullable java.io.File r15) throws java.io.IOException {
        /*
    ...
    public Snapshot snapshot(@Nullable Comparator<Descriptor> comparator, @Nullable FilenameFilter filter) {
    ...
    public boolean tryLock(RandomAccessFile raf) throws IOException {
        try {
            if (raf.getChannel().tryLock(0, Clock.MAX_TIME, false) != null) {
                return true;
            }
            return false;
