...
public class ProcessAnrErrorMonitor {
    ...
    public ProcessAnrErrorMonitor(Context context, String processName, int maxNumberOfChecksBeforeError, int maxNumberOfChecksAfterError) {
        this(context, processName, false, DEFAULT_POLLING_TIME_MS, false, maxNumberOfChecksBeforeError, maxNumberOfChecksAfterError);
    }

    public ProcessAnrErrorMonitor(Context context, String processName, boolean startThread, int maxNumberOfChecksBeforeError, int maxNumberOfChecksAfterError) {
        this(context, processName, startThread, DEFAULT_POLLING_TIME_MS, false, maxNumberOfChecksBeforeError, maxNumberOfChecksAfterError);
    }
    ...
    public class MonitorThread extends Thread {
        ...
        private MonitorThread(ActivityManager am, @Nullable ProcessErrorStateListener listener, long id, long delay) {
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public MonitorThread startMonitoringForTest(ProcessErrorStateListener listener) {
        ActivityManager am = (ActivityManager) this.mContext.getSystemService("activity");
        Assertions.assumeNotNull(am);
        synchronized (this) {
            if (this.mState != State.NOT_MONITORING) {
            ...
            this.mCurrentMonitorThreadId++;
            this.mErrorCheckThread = new MonitorThread(am, listener, this.mCurrentMonitorThreadId, 0);
        }
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public synchronized void setErrorCheckThread(MonitorThread t) {
        this.mErrorCheckThread = t;
    }
