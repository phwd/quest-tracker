...
final class OldProcReader implements IProcReader {
    ...
    @Override // com.facebook.common.procread.IProcReader
    public boolean readProcLines(String file, String[] reqFields, long[] outSizes) {
        return !Boolean.FALSE.equals(invoke(getReadProcLines(), new Object[]{file, reqFields, outSizes}));
    }
