...
public class SoftError {
    ...
    public static SoftError newError(String category, String message) {
        return new SoftErrorBuilder().setCategory(category).setMessage(message).build();
    }

    public static SoftError newError(String category, String message, int samplingFrequency) {
        return new SoftErrorBuilder().setCategory(category).setMessage(message).setSamplingFrequency(samplingFrequency).build();
    }
