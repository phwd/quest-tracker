...
public class AllFamilyPackageNames {
    ...
    public static final Set<String> ALL_FAMILY_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(ADSMANAGER, AKIRA, DAYKIRA, DIRECT, GAMES, HELLO, HOME, HOME_DEV, INSTAGRAM, INSTAGRAM_LITE, KATANA, KOTOTORO, LASSO, MESSENGER, MESSENGER_KIDS, MESSENGER_KIDS_DEV, "com.facebook.mlite", "com.oculus.vrshell", "com.oculus.horizon", OCULUS_HORIZON_DEV, "com.oculus.vrshell.home", "com.oculus.ocms", OCULUS_TWILIGHT, "com.facebook.pages.app", PARTIES, WAKIZASHI, WHATSAPP, WORK, WORKDEV, "com.facebook.workchat")));
    public static final Set<String> ALL_FB_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(ADSMANAGER, HELLO, HOME, HOME_DEV, KATANA, MESSENGER, MESSENGER_KIDS, MESSENGER_KIDS_DEV, "com.facebook.mlite", "com.facebook.pages.app", PARTIES, WAKIZASHI, WORK, WORKDEV, "com.facebook.workchat")));
