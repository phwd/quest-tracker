...
public class MessengerModuleImpl extends MessengerModule {
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                if (MessengerModuleImpl.this.hasInitedMessengerService.booleanValue()) {
                    ...
                    bundle.putInt(PartyCallsManagerModuleImpl.CALL_ID_COLUMN, callId);
                    msg.setData(bundle);
    ...
    private void initMessengerService() {
        ...
        Bundle b = new Bundle();
        b.putLong(ServiceContract.EXTRA_USER_ID, Long.parseLong(this.UserId));
    ...
    public void bindServiceImpl() {
        if (!this.mServiceBound.booleanValue()) {
            ...
            ComponentName componentName = new ComponentName(BuildConstants.PACKAGE_NAME_SOCIAL_PLATFORM, "com.oculus.messenger.service.MessengerService");
