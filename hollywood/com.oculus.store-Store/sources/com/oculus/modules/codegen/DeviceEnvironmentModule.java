...
public abstract class DeviceEnvironmentModule extends RCTBaseJavaModule {
    ...
    public final String marshallJSConstants() {
        ...
        try {
            result.put(ReportField.ENVIRONMENT, marshallJSConstantEnvironment().convertToJSONObject());
    ...
    public static class DeviceEnvironmentBlobType extends NativeModuleParcel {
        ...
        public final JSONObject convertToJSONObject() {
            ...
            try {
                ...
                parcel.put("deviceOTACode", this.deviceOTACode);
        ...
        public final void setFromJSONObject(JSONObject json) {
            ...
            this.deviceOTACode = json.optString("deviceOTACode");
        ...
        public static final DeviceEnvironmentBlobType makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            DeviceEnvironmentBlobType result = new DeviceEnvironmentBlobType();
    ...
    public static class RepositoryNodeDataType extends NativeModuleParcel {
        ...
        public static final RepositoryNodeDataType makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            RepositoryNodeDataType result = new RepositoryNodeDataType();
            result.setFromJSONObject(json);
            return result;
        }
    }
    ...
    public static class DeviceEnvironmentHeadersType extends NativeModuleParcel {
        ...
        public final JSONObject convertToJSONObject() {
            JSONObject parcel = new JSONObject();
            try {
                parcel.put(HttpHeaders.ACCEPT_LANGUAGE, this.Accept_Language);
                parcel.put(HttpHeaders.USER_AGENT, this.User_Agent);
        ...
        @Override // com.oculus.modules.codegen.NativeModuleParcel
        public final void setFromJSONObject(JSONObject json) {
            this.Accept_Language = json.optString(HttpHeaders.ACCEPT_LANGUAGE);
            this.User_Agent = json.optString(HttpHeaders.USER_AGENT);
        ...
        public static final DeviceEnvironmentHeadersType makeFromJSONObject(JSONObject json) {
            if (json == null) {
                return null;
            }
            DeviceEnvironmentHeadersType result = new DeviceEnvironmentHeadersType();
            result.setFromJSONObject(json);
            return result;
        }
    }
