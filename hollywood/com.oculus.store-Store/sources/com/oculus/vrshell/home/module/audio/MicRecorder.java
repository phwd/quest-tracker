...
public class MicRecorder extends RCTBaseJavaModule {
    ...
    @NonNull
    private Recorder createRecorder(@NonNull File outputFile) {
        return new WavRecorder(outputFile) {
            ...
            /* access modifiers changed from: protected */
            @Override // com.oculus.vrshell.home.module.audio.Recorder
            public void onRecordingStop(@NonNull File recordedFile) {
    ...
    public synchronized void startRecording(@NonNull String path, @NonNull String outputFileName) {
