    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT > 17) {
                ...
                SERVICES.put(UserManager.class, ServiceContract.EXTRA_USER);
            }
            if (Build.VERSION.SDK_INT > 16) {
                SERVICES.put(InputManager.class, QuickPromotionGraphQL.ARGUMENT_MUTATION_INPUT);
            ...
            SERVICES.put(DownloadManager.class, OCMSLibraryContract.DOWNLOAD_PATH);
