        ...
        while (low < high) {
            ...
            while (true) {
                if (expectDot) {
                    ...
                    byte0 = labels[currentLabelIndex][currentLabelByteIndex] & UnsignedBytes.MAX_VALUE;
                }
                compareResult = byte0 - (bytesToSearch[mid2 + publicSuffixByteIndex] & UnsignedBytes.MAX_VALUE);
                if (compareResult != 0) {
                    break;
                }
