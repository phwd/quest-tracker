...
public final class WebSocketReader {
    ...
    private void readHeader() throws IOException {
        ...
        try {
            int b0 = this.source.readByte() & UnsignedBytes.MAX_VALUE;
            ...
            if (!this.isControlFrame || this.isFinalFrame) {
                ...
                int b1 = this.source.readByte() & UnsignedBytes.MAX_VALUE;
                if ((b1 & 128) != 0) {
                    isMasked = true;
                } else {
                    isMasked = false;
                ...
                this.frameLength = (long) (b1 & TraceInternal.MAX_SECTION_NAME_LEN);
