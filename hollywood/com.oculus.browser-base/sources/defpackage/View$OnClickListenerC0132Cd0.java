...
public class View$OnClickListenerC0132Cd0 implements View.OnClickListener {
    public final /* synthetic */ MediaController F;

    public View$OnClickListenerC0132Cd0(MediaController mediaController) {
        this.F = mediaController;
    }

    public void onClick(View view) {
        MediaController mediaController = this.F;
        int i = MediaController.F;
