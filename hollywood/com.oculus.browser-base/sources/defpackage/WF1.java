        ...
        while (parcel.dataPosition() < u) {
            ...
            switch (65535 & readInt) {
                ...
                case Version.VERSION_7 /*{ENCODED_INT: 7}*/:
                    calendarDateTime = (Barcode.CalendarDateTime) AbstractC5588xO0.d(parcel, readInt, Barcode.CalendarDateTime.CREATOR);
                    break;
                case Version.VERSION_8 /*{ENCODED_INT: 8}*/:
                    calendarDateTime2 = (Barcode.CalendarDateTime) AbstractC5588xO0.d(parcel, readInt, Barcode.CalendarDateTime.CREATOR);
                    break;
                default:
