...
public class animation.InterpolatorC5286vf implements Interpolator {

    /* renamed from: a  reason: collision with root package name */
    public static final float[] f11491a;
    public static final float[] b;
    public static final float[] c;
    public static final float[] d;
    @Deprecated
    public static final animation.InterpolatorC5286vf e;
    @Deprecated
    public static final animation.InterpolatorC5286vf f;
    @Deprecated
    public static final animation.InterpolatorC5286vf g;
    ...
    public float getInterpolation(float f2) {
        ...
        float[] fArr2 = this.h;
        return AbstractC2531fV.a(fArr2[min + 1], fArr2[min], f4, fArr2[min]);
    }
}
