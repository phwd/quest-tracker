...
public abstract class AbstractC4573rR extends ViewGroup {
    public int F;
    public int G;
    public boolean H = false;
    public int I;

    public AbstractC4573rR(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, FJ0.L, 0, 0);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.H && measuredWidth > i7) {
                    i9 = this.F + paddingTop;
                    this.I++;
                    i8 = paddingRight;
                }
                ...
                i8 += childAt.getMeasuredWidth() + i5 + i6 + this.G;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt.getMeasuredWidth() + paddingLeft + i4 > paddingRight && !((ChipGroup) this).H) {
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i4 + i5 + this.G + paddingLeft;
