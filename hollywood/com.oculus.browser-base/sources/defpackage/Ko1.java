...
public abstract class Ko1 {
    ...
    public static C2265dw c(TypedArray typedArray, XmlPullParser xmlPullParser, Resources.Theme theme, String str, int i, int i2) {
        C2265dw dwVar;
        if (f(xmlPullParser, str)) {
            ...
            if (i3 >= 28 && i3 <= 31) {
                return new C2265dw(null, null, typedValue.data);
            }
            try {
                dwVar = C2265dw.a(typedArray.getResources(), typedArray.getResourceId(i, 0), theme);
            } catch (Exception e) {
        ...
        return new C2265dw(null, null, i2);
    }
