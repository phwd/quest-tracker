...
public class animation.InterpolatorC2005cO implements Interpolator {

    /* renamed from: a  reason: collision with root package name */
    public static final float[] f9605a;
    ...
    static {
        ...
        f9605a = fArr;
        b = 1.0f / ((float) (fArr.length - 1));
    }

    public float getInterpolation(float f) {
        return AbstractC4254pb0.a(f9605a, b, f);
    }
}
