            ...
            endViewTransitionAnimator.setAnimationListener(new AnimationListenerWrapper(getAnimationListener(endViewTransitionAnimator)) {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    viewGroup.post(new Runnable() {
                        /* class androidx.fragment.app.FragmentManagerImpl.AnonymousClass2.AnonymousClass1 */
        ...
        public void onAnimationEnd(Animation animation) {
            if (ViewCompat.isAttachedToWindow(this.mView) || Build.VERSION.SDK_INT >= 24) {
                this.mView.post(new Runnable() {
                    /* class androidx.fragment.app.FragmentManagerImpl.AnimateOnHWLayerIfNeededListener.AnonymousClass1 */
