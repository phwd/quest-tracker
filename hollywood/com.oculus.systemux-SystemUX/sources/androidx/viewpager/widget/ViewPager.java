...
public class ViewPager extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7, Ints.MAX_POWER_OF_TWO);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(i6, Ints.MAX_POWER_OF_TWO);
        this.mInLayout = true;
        populate();
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) i7) * layoutParams.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec((i8 - i11) - i9, Ints.MAX_POWER_OF_TWO));
                    }
