...
public class ConstraintWidget {
    ...
    public void reset() {
        ...
        this.mMatchConstraintMaxWidth = BytesRange.TO_END_OF_CONTENT;
        this.mMatchConstraintMaxHeight = BytesRange.TO_END_OF_CONTENT;
    ...
    public ConstraintWidget() {
        ...
        this.mResolvedDimensionRatio = 1.0f;
        this.mBelongingGroup = null;
        this.mMaxDimension = new int[]{BytesRange.TO_END_OF_CONTENT, BytesRange.TO_END_OF_CONTENT};
        this.mCircleConstraintAngle = 0.0f;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:107:0x01cd  */
