        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i16, Ints.MAX_POWER_OF_TWO);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, Ints.MAX_POWER_OF_TWO);
                }
                if (layoutParams.height == -2) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i12 = View.MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                } else {
                    i12 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, Ints.MAX_POWER_OF_TWO);
                }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                                } else if (layoutParams2.height == -2) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                } else if (layoutParams2.height == -1) {
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                                } else {
                                    i8 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Ints.MAX_POWER_OF_TWO);
                                }
                                if (z2) {
                                    int i19 = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                    i6 = i17;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i19, Ints.MAX_POWER_OF_TWO);
                                    if (i7 != i19) {
                                    ...
                                    i6 = i17;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i14))) / f)), Ints.MAX_POWER_OF_TWO), i8);
                                    i18++;
                                    i17 = i6;
                                    i5 = 8;
                                }
                            ...
                            if (!z5) {
                                ...
                                i10 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO);
                            } else if (layoutParams2.height == -2) {
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i9 = Ints.MAX_POWER_OF_TWO;
                            } else if (layoutParams2.height == -1) {
                                i9 = Ints.MAX_POWER_OF_TWO;
                                i10 = View.MeasureSpec.makeMeasureSpec(i3, Ints.MAX_POWER_OF_TWO);
                            } else {
                                i9 = Ints.MAX_POWER_OF_TWO;
                                i10 = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Ints.MAX_POWER_OF_TWO);
                            }
