...
public class AllFamilyPackageNames {
    ...
    public static final Set<String> ALL_FAMILY_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(ADSMANAGER, AKIRA, APPMANAGER, APPMANAGER_DEV, ASSISTANT_PLAYGROUND, BISHOP, CREATOR_STUDIO, DAYKIRA, DIRECT, FACEBOOK_LITE, GAMES, HELLO, HOME, HOME_DEV, INSTAGRAM, "com.instagram.lite", "com.instagram.lite", KATANA, MESSENGER, MESSENGER_KIDS, MESSENGER_KIDS_DEV, MESSENGER_LITE, OCULUS_ENTERPRISE_SERVER, "com.oculus.vrshell", "com.oculus.horizon", OCULUS_HORIZON_DEV, OCULUS_GEMINI_UPLOAD, "com.oculus.vrshell.home", "com.oculus.ocms", "com.oculus.systemutilities", OCULUS_TWILIGHT, OCULUS_USER_SERVER, "com.oculus.updater", PAGES, PARTIES, STUDY, THREADSAPP, WAKIZASHI, WHATSAPP, WHATSAPP_SMB, WORK, WORKDEV, WORK_CHAT)));
    public static final Set<String> ALL_FB_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(ADSMANAGER, FACEBOOK_LITE, HELLO, HOME, HOME_DEV, KATANA, MESSENGER, MESSENGER_KIDS, MESSENGER_KIDS_DEV, MESSENGER_LITE, PAGES, PARTIES, WAKIZASHI, WORK, WORKDEV, WORK_CHAT)));
    public static final Set<String> ALL_INHOUSE_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList(GS_CRISIS_MANAGEMENT, VIEWPOINTS)));
    ...
    public static final String OCULUS_ENTERPRISE_SERVER = "com.oculus.alpenglow";
    ...
    public static final Set<String> OCULUS_PACKAGE_NAMES = Collections.unmodifiableSet(new HashSet(Arrays.asList("com.oculus.assistant", "com.oculus.companion.server", OCULUS_ENTERPRISE_SERVER, "com.oculus.vrshell.home", "com.oculus.horizon", OCULUS_HORIZON_DEV, OCULUS_NUX_OTA, "com.oculus.ocms", "com.oculus.systemutilities", OCULUS_TWILIGHT, OCULUS_USER_SERVER, "com.oculus.updater")));
