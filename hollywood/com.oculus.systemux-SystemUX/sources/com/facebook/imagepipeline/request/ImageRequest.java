...
public class ImageRequest {
    public static final Fn<ImageRequest, Uri> REQUEST_TO_URI_FN = new Fn<ImageRequest, Uri>() {
        /* class com.facebook.imagepipeline.request.ImageRequest.AnonymousClass1 */
