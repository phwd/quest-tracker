...
public class CountingMemoryCache<K, V> implements MemoryCache<K, V>, MemoryTrimmable {
    ...
    public void trim(MemoryTrimType memoryTrimType) {
        ...
        synchronized (this) {
            trimExclusivelyOwnedEntries = trimExclusivelyOwnedEntries(BytesRange.TO_END_OF_CONTENT, Math.max(0, ((int) (((double) this.mCachedEntries.getSizeInBytes()) * (1.0d - trimRatio))) - getInUseSizeInBytes()));
