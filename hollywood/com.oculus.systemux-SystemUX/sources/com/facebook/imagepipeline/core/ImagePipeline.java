...
public class ImagePipeline {
    ...
    public Supplier<DataSource<CloseableReference<CloseableImage>>> getDataSourceSupplier(final ImageRequest imageRequest, final Object obj, final ImageRequest.RequestLevel requestLevel) {
        return new Supplier<DataSource<CloseableReference<CloseableImage>>>() {
            ...
            public String toString() {
                return Objects.toStringHelper(this).add(AssistantComponentContract.Components.RemoteImageViewComponent.URI, imageRequest.getSourceUri()).toString();
            }
        };
    }
    ...
    public static /* synthetic */ class AnonymousClass9 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.imagepipeline.core.ImagePipeline.AnonymousClass9.$SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice = r0
                int[] r0 = com.facebook.imagepipeline.core.ImagePipeline.AnonymousClass9.$SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = com.facebook.imagepipeline.core.ImagePipeline.AnonymousClass9.$SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice     // Catch:{ NoSuchFieldError -> 0x001f }
    ...
    private Predicate<CacheKey> predicateForUri(final Uri uri) {
        return new Predicate<CacheKey>() {
            /* class com.facebook.imagepipeline.core.ImagePipeline.AnonymousClass8 */
