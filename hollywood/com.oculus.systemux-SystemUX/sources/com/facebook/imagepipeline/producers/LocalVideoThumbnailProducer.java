...
public class LocalVideoThumbnailProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext) {
        ...
        producerContext.putOriginExtra("local", AssistantDialogContract.Dialog.VIDEO);
        final AnonymousClass1 r9 = new StatefulProducerRunnable<CloseableReference<CloseableImage>>(consumer, PRODUCER_NAME, producerListener, producerContext) {
