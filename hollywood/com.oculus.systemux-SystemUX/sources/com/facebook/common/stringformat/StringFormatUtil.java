...
public class StringFormatUtil {
    ...
    public static String formatBytes(long j) {
        ...
        if (f < 1024.0f) {
            ...
            return formatStrLocaleSafe("%.2fKB", Float.valueOf(f / 1024.0f));
        } else {
            if (f < 1.07374182E9f) {
                return formatStrLocaleSafe("%.2fMB", Float.valueOf(f / 1048576.0f));
            }
            return formatStrLocaleSafe("%.2fGB", Float.valueOf(f / 1.07374182E9f));
        }
    }
    ...
    private static int doFormatArgs(@Nullable StringBuilder sb, String str, int i, @Nullable Object obj, @Nullable Object obj2, @Nullable Object obj3, @Nullable Object obj4) {
        ...
        while (true) {
            ...
            if (i6 == i3) {
                i2 = NEXT_SEG_RESULT_FINISHED;
                if (i4 == NEXT_SEG_RESULT_FINISHED && z) {
                    return -2;
                }
            } else {
                i2 = NEXT_SEG_RESULT_FINISHED;
        ...
        if (i4 != i2 && i4 != NEXT_SEG_RESULT_FINISHED_PERCENT) {
    ...
    private static int doFormatArray(@Nullable StringBuilder sb, String str, @Nullable Object... objArr) {
        ...
        while (true) {
            if (i < length) {
                ...
                if (appendSegmentFormat != -1) {
                    ...
                    if (i2 == NEXT_SEG_RESULT_FINISHED) {
                        break;
                    } else if (i2 == NEXT_SEG_RESULT_FINISHED_PERCENT) {
                        z3 = true;
                        break;
                    } else {
                        i++;
        ...
        if (i2 != NEXT_SEG_RESULT_FINISHED && i2 != NEXT_SEG_RESULT_FINISHED_PERCENT) {
    ...
    private static int validateFormatPercent(String str, int i) {
        ...
        return (charAt == 's' || charAt == 'd' || charAt == '%') ? VALID_FORMAT_PERCENT : INVALID_FORMAT_PERCENT;
    }
