...
public class TraceDirect {
    ...
    private static final boolean sForceJavaImpl = SocialBundleConstants.FB_UPSELL_MUST_INTERACT.equals(SystemPropertiesInternal.get("debug.fbsystrace.force_java"));
    ...
    private static final boolean sTraceLoad = SocialBundleConstants.FB_UPSELL_MUST_INTERACT.equals(SystemPropertiesInternal.get("debug.fbsystrace.trace_load"));
