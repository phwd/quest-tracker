...
public class ImagesBuilder {
    ...
    public static Map<Image.ImageName, Image> createImages(String str, String str2, String str3, String str4, String str5) {
        ...
        if (str3 != null) {
            hashMap.put(Image.ImageName.SOURCE_TINY, new Image(Image.ImageName.SOURCE_TINY, str3, 360, 203));
        }
        if (str4 != null) {
            hashMap.put(Image.ImageName.LANDSCAPE_SMALL, new Image(Image.ImageName.LANDSCAPE_SMALL, str4, 360, 120));
        }
        if (str5 != null) {
