...
public class SocialGroupLaunchDialogs {
    public static DialogDefinitionBase getAppLaunchDialog(Resources resources, SocialGroupLaunchAppDestination socialGroupLaunchAppDestination) {
        DialogDefinitionCustom dialogDefinitionCustom = new DialogDefinitionCustom("anytime_tablet_social_modal_group_launch_app_launch_dialog", resources.getString(R.string.anytime_tablet_social_modal_group_launch_app_launch_title, socialGroupLaunchAppDestination.getAppDisplayName()), "");
        dialogDefinitionCustom.setSecondaryButton(new DialogButtonText("cancel", resources.getString(R.string.anytime_tablet_social_modal_group_launch_app_launch_cancel)));
    ...
    public static DialogDefinitionBase getRiftUsersNotSupportedDialog(Resources resources) {
        ...
        dialogDefinitionCustom.setPrimaryButton(new DialogButtonText("launch", resources.getString(R.string.anytime_tablet_social_modal_group_launch_rift_users_not_supported_launch_button)));
        dialogDefinitionCustom.setSecondaryButton(new DialogButtonText("cancel", resources.getString(R.string.anytime_tablet_social_modal_group_launch_rift_users_not_supported_cancel_button)));
        dialogDefinitionCustom.setControllerBackButton(new DialogButton("cancel"));
        return dialogDefinitionCustom;
    }
}
