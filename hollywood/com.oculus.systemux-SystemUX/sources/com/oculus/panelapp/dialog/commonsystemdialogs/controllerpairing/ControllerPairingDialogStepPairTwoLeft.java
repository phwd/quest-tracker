...
final class ControllerPairingDialogStepPairTwoLeft extends ControllerPairingDialogStepPairTwoBase {
    private static final String TAG = LoggingUtil.tag(ControllerPairingDialogStepPairTwoLeft.class);
    ...
    public String getDialogIdInfix() {
        return ControllerPairingConstants.CONTROLLER_PAIRING_DIALOG_ID_LEFT_CONTROLLER_INFIX;
    }
    ...
    public ControllerPairingDialogStepPairTwoLeft(Context context, ControllerPairingDialogStepHost controllerPairingDialogStepHost, SettingsManager settingsManager) {
    ...
    public DialogDefinitionCustom getDialogConfiguration(long j) {
        ...
        return new DialogDefinitionCustom(CommonSystemDialog.CONTROLLER_PAIRING.getDialogId() + ControllerPairingConstants.CONTROLLER_PAIRING_DIALOG_ID_LEFT_CONTROLLER_INFIX + ControllerPairingConstants.CONTROLLER_PAIRING_DIALOG_ID_PENDING_SUFFIX, resources.getString(R.string.controller_pairing_left_controller_title), resources.getString(R.string.controller_pairing_two_controllers_description)).setVideo(new DialogVideo(DeviceProperties.platformResourceAPK() + ControllerPairingDialogVideos.PAIR_TWO_CONTROLLERS_LEFT, 1.778f, ControllerPairingDialogVideos.BACKGROUND_COLOR)).setInformationBox(new DialogInformationBox(ControllerPairingUtil.getTimeoutMessage(this.mContext, j), DialogIcon.InformationBox.SPINNER)).setTertiaryButton(new DialogButtonText("close", resources.getString(R.string.controller_pairing_dialog_cancel)));
    }
    ...
    public void onPairingFailure() {
        ...
        this.mHost.setDialogConfiguration(ControllerPairingUtil.getFailureDialogConfiguration(this.mContext, this, ControllerPairingDialogActions.PAIR_TWO_LEFT, this.mSettingsManager.getBoolean(SettingsManager.HAND_TRACKING_OPT_IN, false)));
    }
}
