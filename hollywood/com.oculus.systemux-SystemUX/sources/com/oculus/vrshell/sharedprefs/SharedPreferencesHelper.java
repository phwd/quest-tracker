...
public class SharedPreferencesHelper {
    ...
    private static final String SHARED_PREFERENCES_FLAGS_FILE = "vrshell_flags";
    ...
    private static SharedPreferences getSharedPreferences(Context context, PrefKey prefKey) {
        ...
        if (prefKey.startsWith(SharedKeys.FLAGS)) {
            ...
            str = prefKey.startsWith(SharedKeys.SETTINGS) ? SHARED_PREFERENCES_SETTINGS_FILE : SHARED_PREFERENCES_FILE;
        }
