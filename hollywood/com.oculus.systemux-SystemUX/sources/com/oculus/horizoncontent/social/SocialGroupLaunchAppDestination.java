...
public final class SocialGroupLaunchAppDestination {
    ...
    private boolean mAppIsViewerEntitled;
    private String mCursor;
    private String mDeeplinkMessage;
    private String mDestinationDisplayName;
    private String mGroupLaunchID;
    private SocialGroupLaunchState mGroupLaunchState;
    private boolean mHasNext;
    private String mId;
    private String mImageUrl;
    private String mIsExternalDeeplinkable;
    private boolean mIsOnlyQuestUsersAccepted;
    private int mMaxCapacity;
    private Map<String, SocialGroupLaunchResponse> mUserResponses;
    ...
    public String toString() {
        return String.format(Locale.ROOT, "%s: id: %s, appDisplayName: $s, destinationDisplayName: %s, destinationName: %s, maxCapacity: %d, iconURL: %s, isExternalDeeplinkable: %s", SocialGroupLaunchAppDestination.class.getSimpleName(), this.mId, this.mAppDisplayName, this.mDestinationDisplayName, Integer.valueOf(this.mMaxCapacity), this.mImageUrl, this.mIsExternalDeeplinkable);
    }
