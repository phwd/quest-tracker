...
public class Controllers {
    ...
    public String getPairedDevice(int i) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }

    public int getBatteryLevel(int i) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }

    public ControllerStatus getPairedDeviceStatus(int i) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }

    public VerifyConnectableResult[] verifyConnectable(int[] iArr, int i) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }

    public VerifyConnectableResult[] verifyConnectable(int[] iArr, int i, int i2) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }

    public ControllerScanAndPairResult scanAndPairDevice(int i, int i2) throws InterruptedException {
        throw new RuntimeException("Stub!");
    }
