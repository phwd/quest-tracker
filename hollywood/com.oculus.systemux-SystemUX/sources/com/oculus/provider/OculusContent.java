...
public class OculusContent {
    ...
    public static class Profile {
        public static final Uri CONTENT_URI = Uri.parse("content://" + OculusContent.AUTHORITY + TabletDeepLinkingUriUtil.AUI_PROFILE_URI);
        ...
        public static Uri getUriFromNuxPref(String str) {
            if (!TextUtils.isEmpty(str)) {
                return new Uri.Builder().scheme(UriUtil.LOCAL_CONTENT_SCHEME).authority(OculusContent.AUTHORITY).path("profile").appendPath(str).build();
            }
    ...
    public static class FriendList {
        ...
        public static Uri GET_SOCIAL_SETTINGS = null;
        ...
        public static final String PRESENCE_PRIVACY_SETTING = "presence_privacy_setting";
        ...
        public static Uri SET_PRESENCE_PRIVACY = null;
        public static final String SOCIAL_SETTING_TYPE = "social_setting_type";
        ...
        public static void rebuild(String str) {
            ...
            GET_SOCIAL_SETTINGS = Uri.parse("content://" + AUTHORITY + "/get_social_settings");
            ...
            SET_PRESENCE_PRIVACY = Uri.parse("content://" + AUTHORITY + "/set_privacy");
            ...
            USER_SEARCH = UriParser.parseStrict("content://" + AUTHORITY + "/user_search");
            GET_BLOCKED_USER_ID = Uri.parse("content://" + AUTHORITY + "/get_blocked_id");
            SET_NUX_FLAG_FOR_USER = UriParser.parseStrict("content://" + AUTHORITY + "/set_nux_flag_for_user");
        }
    }
}
