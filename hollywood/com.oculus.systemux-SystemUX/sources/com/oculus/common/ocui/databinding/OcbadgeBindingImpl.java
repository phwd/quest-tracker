...
public class OcbadgeBindingImpl extends OcbadgeBinding {
    ...
    public OcbadgeBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, mapBindings(dataBindingComponent, view, 1, sIncludes, sViewsWithIds));
    }

    private OcbadgeBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
