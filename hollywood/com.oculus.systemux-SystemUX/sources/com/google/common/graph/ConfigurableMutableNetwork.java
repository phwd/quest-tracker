...
public final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        NetworkConnections<N, E> networkConnections = (NetworkConnections) this.nodeConnections.get(n);
        ...
        NetworkConnections<N, E> networkConnections2 = (NetworkConnections) this.nodeConnections.get(n2);
