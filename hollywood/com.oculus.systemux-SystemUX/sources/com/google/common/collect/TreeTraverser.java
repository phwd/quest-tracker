...
public abstract class TreeTraverser<T> {
    ...
    public final FluentIterable<T> preOrderTraversal(final T t) {
        ...
        return new FluentIterable<T>() {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.common.collect.TreeTraverser$2$1 */
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Iterable
    ...
    public final FluentIterable<T> postOrderTraversal(final T t) {
        ...
        return new FluentIterable<T>() {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.common.collect.TreeTraverser$3$1 */
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.lang.Iterable
            public void forEach(final Consumer<? super T> consumer) {
                Preconditions.checkNotNull(consumer);
