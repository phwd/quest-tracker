...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static <T, R, C, V> Collector<T, ?, ImmutableTable<R, C, V>> toImmutableTable(Function<? super T, ? extends R> function, Function<? super T, ? extends C> function2, Function<? super T, ? extends V> function3, BinaryOperator<V> binaryOperator) {
        ...
        return Collector.of($$Lambda$ImmutableTable$3nvOFXygdJjpD05SaQtUOm3ckKk.INSTANCE, new BiConsumer(function, function2, function3, binaryOperator) {
            ...
            public final void accept(Object obj, Object obj2) {
                ...
                collectorState.put(this.f$0.apply(obj2), this.f$1.apply(obj2), this.f$2.apply(obj2), this.f$3);
            }
    ...
    public static final class MutableCell<R, C, V> extends Tables.AbstractCell<R, C, V> {
        ...
        MutableCell(R r, C c, V v) {
            ...
            this.value = (V) Preconditions.checkNotNull(v, AssistantComponentContract.Components.TextComponent.VALUE);
        }
    ...
    static <R, C, V> Table.Cell<R, C, V> cellOf(R r, C c, V v) {
        return Tables.immutableCell(Preconditions.checkNotNull(r, "rowKey"), Preconditions.checkNotNull(c, "columnKey"), Preconditions.checkNotNull(v, AssistantComponentContract.Components.TextComponent.VALUE));
    }
    ...
    public static final class Builder<R, C, V> {
        ...
        public Builder<R, C, V> put(Table.Cell<? extends R, ? extends C, ? extends V> cell) {
            if (cell instanceof Tables.ImmutableCell) {
                ...
                Preconditions.checkNotNull(cell.getValue(), AssistantComponentContract.Components.TextComponent.VALUE);
                this.cells.add(cell);
            } else {
