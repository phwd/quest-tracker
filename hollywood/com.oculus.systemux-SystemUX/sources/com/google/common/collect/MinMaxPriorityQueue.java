...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    public static final class Builder<B> {
        ...
        private Builder(Comparator<B> comparator2) {
            this.expectedSize = -1;
            this.maximumSize = BytesRange.TO_END_OF_CONTENT;
        ...
        public <T extends B> MinMaxPriorityQueue<T> create(Iterable<? extends T> iterable) {
            MinMaxPriorityQueue<T> minMaxPriorityQueue = (MinMaxPriorityQueue<T>) new MinMaxPriorityQueue(this, MinMaxPriorityQueue.initialQueueSize(this.expectedSize, this.maximumSize, iterable));
    ...
    public class Heap {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: com.google.common.collect.Ordering<E> */
        /* JADX WARN: Multi-variable type inference failed */
        /* access modifiers changed from: package-private */
