...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public void forEachEntry(ObjIntConsumer<? super E> objIntConsumer) {
        ...
        while (firstNode != this.header && firstNode != null && !this.range.tooHigh(firstNode.getElement())) {
            ...
            firstNode = ((AvlNode) firstNode).succ;
        }
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        Serialization.getFieldSetter(TreeMultiset.class, AssistantDialogContract.MultiselectionDialog.Section.HEADER).set(this, avlNode);
        successor(avlNode, avlNode);
