...
public abstract class ImmutableMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public Spliterator<Map.Entry<K, V>> entrySpliterator() {
        return CollectSpliterators.flatMap(asMap().entrySet().spliterator(), $$Lambda$ImmutableMultimap$4WozpdkAAYTHkEWDf7l4joSUk.INSTANCE, (this instanceof SetMultimap ? 1 : 0) | 64, (long) size());
    }
