...
public final class IntMath {
    ...
    @VisibleForTesting
    static int[] biggestBinomials = {BytesRange.TO_END_OF_CONTENT, BytesRange.TO_END_OF_CONTENT, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    @VisibleForTesting
    static final int[] halfPowersOf10 = {3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, BytesRange.TO_END_OF_CONTENT};
    @VisibleForTesting
    ...
    public static int saturatedPow(int i, int i2) {
        ...
        if (i != -2) {
            ...
            if (i != 2) {
                int i3 = ((i >>> 31) & i2 & 1) + BytesRange.TO_END_OF_CONTENT;
                int i4 = i;
                int i5 = 1;
                while (i2 != 0) {
                    if (i2 == 1) {
            ...
            return (i2 & 1) + BytesRange.TO_END_OF_CONTENT;
        } else {
            return (i2 & 1) == 0 ? 1 << i2 : -1 << i2;
        }
    }
    ...
    public static int factorial(int i) {
        ...
        int[] iArr = factorials;
        return i < iArr.length ? iArr[i] : BytesRange.TO_END_OF_CONTENT;
    }
