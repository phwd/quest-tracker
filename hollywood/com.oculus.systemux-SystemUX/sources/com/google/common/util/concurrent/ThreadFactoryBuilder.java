...
public final class ThreadFactoryBuilder {
    ...
    private static ThreadFactory doBuild(ThreadFactoryBuilder threadFactoryBuilder) {
        ...
        final ThreadFactory threadFactory = threadFactoryBuilder.backingThreadFactory;
        ...
        return new ThreadFactory() {
            ...
            public Thread newThread(Runnable runnable) {
                ...
                String str = str;
                if (str != null) {
                    newThread.setName(ThreadFactoryBuilder.format(str, new Object[]{Long.valueOf(atomicLong.getAndIncrement())}));
                }
                Boolean bool = bool;
                if (bool != null) {
