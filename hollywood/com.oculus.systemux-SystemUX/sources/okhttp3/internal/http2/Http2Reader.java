...
public final class Http2Reader implements Closeable {
    ...
    public boolean nextFrame(boolean z, Handler handler) throws IOException {
        try {
            ...
            if (!z || readByte == 4) {
                ...
                int readInt = this.source.readInt() & BytesRange.TO_END_OF_CONTENT;
                if (logger.isLoggable(Level.FINE)) {
    ...
    private void readPriority(Handler handler, int i) throws IOException {
        ...
        handler.priority(i, readInt & BytesRange.TO_END_OF_CONTENT, (this.source.readByte() & UnsignedBytes.MAX_VALUE) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    private void readPushPromise(Handler handler, int i, byte b, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            handler.pushPromise(i2, this.source.readInt() & BytesRange.TO_END_OF_CONTENT, readHeaderBlock(lengthWithoutPadding(i - 4, b, s), s, b, i2));
            return;
        }
    ...
    public static final class ContinuationSource implements Source {
        ...
        private void readContinuationHeader() throws IOException {
            ...
            this.streamId = this.source.readInt() & BytesRange.TO_END_OF_CONTENT;
            if (readByte != 9) {
