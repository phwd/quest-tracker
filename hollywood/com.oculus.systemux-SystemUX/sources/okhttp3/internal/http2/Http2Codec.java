...
public final class Http2Codec implements HttpCodec {
    ...
    public static Response.Builder readHttp2HeadersList(List<Header> list, Protocol protocol2) throws IOException {
        ...
        if (statusLine != null) {
            return new Response.Builder().protocol(protocol2).code(statusLine.code).message(statusLine.message).headers(builder2.build());
        }
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(HttpHeaders.CONTENT_TYPE), okhttp3.internal.http.HttpHeaders.contentLength(response), Okio.buffer(new StreamFinishingSource(this.stream.getSource())));
    }
