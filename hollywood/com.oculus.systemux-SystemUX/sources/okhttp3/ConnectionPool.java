...
public final class ConnectionPool {
    ...
    private static final Executor executor = new ThreadPoolExecutor(0, (int) BytesRange.TO_END_OF_CONTENT, 60, TimeUnit.SECONDS, new SynchronousQueue(), Util.threadFactory("OkHttp ConnectionPool", true));
