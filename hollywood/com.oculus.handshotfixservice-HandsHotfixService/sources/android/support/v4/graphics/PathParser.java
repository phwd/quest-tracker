    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                ...
                case 'c':
                    incr = 6;
                    break;
                case Version.VERSION_72 /*{ENCODED_INT: 72}*/:
                case 'V':
                case 'h':
                case 'v':
                    incr = 1;
        ...
        private static void arcToBezier(Path p, double cx, double cy, double a, double b, double e1x, double e1y, double theta, double start, double sweep) {
            ...
            while (i < numSegments) {
                ...
                p.rLineTo(0.0f, 0.0f);
                p.cubicTo((float) (e1x2 + (alpha * ep1x)), (float) (e1y2 + (alpha * ep1y)), (float) (anglePerSegment2 - (alpha * ep2x)), (float) (cosEta12 - (alpha * ep2y)), (float) anglePerSegment2, (float) cosEta12);
                eta1 = eta2;
