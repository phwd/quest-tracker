...
public final class BuildConstants {
    ...
    public static final String FB4A_APP_PACKAGE_NAME = (IS_INTERNAL_BUILD ? "com.facebook.wakizashi" : "com.facebook.katana");
    ...
    private static final boolean IS_PLAYSTORE_TEST_BUILD = BuildConfig.IS_PLAYSTORE_TEST_BUILD;
    ...
    public static final String TALK_APP_PACKAGE_NAME = (IS_INTERNAL_BUILD ? "com.facebook.mk" : "com.facebook.talk");
    public static final String TALK_URL_SCHEME = BuildConfig.TALK_URL_SCHEME;
    public static final String WORKPLACE_URL_SCHEME = BuildConfig.WORKPLACE_URL_SCHEME;
    public static final String WORK_APP_PACKAGE_NAME = (IS_INTERNAL_BUILD ? "com.facebook.workdev" : "com.facebook.work");
    ...
    static {
        ...
        if (IS_WORK_BUILD) {
            ...
            str = IS_ALOHA_WORK_VC_BUILD ? "com.facebook.alohaworkvc" : "com.facebook.orca";
        }
