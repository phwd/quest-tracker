...
public class App {
    ...
    public final StuckReason stuckReason;
    ...
    public static class Editor {
        ...
        public Optional<StuckReason> stuckReason = Optional.empty();
        ...
        public Editor withStuckReason(StuckReason stuckReason2) {
            this.stuckReason = Optional.of(stuckReason2);
            return this;
        }
        ...
        public App apply(App app) {
            ...
            if (this.stuckReason.isPresent()) {
                builder.withStuckReason(this.stuckReason.get());
            }
    ...
    public static class Builder {
        ...
        private StuckReason stuckReason;
        ...
        public static class LocalData {
            ...
            public LocalData(App app) {
                ...
                this.stuckReason = app.stuckReason;
            }
            ...
            private void applyToBuilder(Builder builder) {
                ...
                builder.stuckReason = this.stuckReason;
            }
        }
        ...
        public Builder withStuckReason(StuckReason stuckReason2) {
            this.stuckReason = stuckReason2;
            return this;
        }
    }
