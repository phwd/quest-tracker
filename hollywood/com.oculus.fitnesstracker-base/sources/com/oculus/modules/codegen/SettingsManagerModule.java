...
public abstract class SettingsManagerModule extends RCTBaseJavaModule {
    protected static final String MODULE_NAME = "SettingsManagerModule";
    ...
    public final void emitOnUpdated(SettingUpdate settingUpdate) {
        nativeEmitEventWithJsonData(this.RVRCtxTag, "SettingsManagerModule_onUpdated", String.valueOf(settingUpdate.convertToJSONObject()));
    }
