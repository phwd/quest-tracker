...
public interface IDownloadService extends IInterface {
    ...
    public static class Default implements IDownloadService {
        ...
        public String enqueueDownload(RemoteResource remoteResource, String str, IntentSender intentSender, Bundle bundle) {
            throw new RuntimeException("Stub!");
        }

        @Override // com.oculus.os.yadi.IDownloadService
        public String enqueueSizeOf(RemoteResource remoteResource, IntentSender intentSender) {
            throw new RuntimeException("Stub!");
        }

        @Override // com.oculus.os.yadi.IDownloadService
        public void enqueueTaggedDownload(String str, RemoteResource remoteResource, String str2, IntentSender intentSender, Bundle bundle) {
            throw new RuntimeException("Stub!");
        }

        @Override // com.oculus.os.yadi.IDownloadService
        public void enqueueTaggedSizeOf(String str, RemoteResource remoteResource, IntentSender intentSender) {
            throw new RuntimeException("Stub!");
        }
    }
