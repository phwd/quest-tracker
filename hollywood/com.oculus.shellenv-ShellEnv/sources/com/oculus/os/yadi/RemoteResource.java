...
public final class RemoteResource implements Parcelable {
    ...
    RemoteResource(String str, String str2, HashType hashType, byte[] bArr, Uri uri, Uri uri2, ServerType serverType, Map map, long j, long j2) {
        throw new RuntimeException("Stub!");
    }
