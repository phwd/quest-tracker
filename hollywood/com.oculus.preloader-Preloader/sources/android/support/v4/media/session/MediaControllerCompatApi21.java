        ...
        private static int toLegacyStreamType(AudioAttributes audioAttributes) {
            ...
            switch (audioAttributes.getUsage()) {
                ...
                case 4:
                    return 4;
                case 5:
                case R.styleable.FontFamilyFont_fontVariationSettings /*{ENCODED_INT: 7}*/:
                case R.styleable.FontFamilyFont_fontWeight /*{ENCODED_INT: 8}*/:
                case R.styleable.FontFamilyFont_ttcIndex /*{ENCODED_INT: 9}*/:
                case 10:
                    return 5;
                case 6:
                    return 2;
